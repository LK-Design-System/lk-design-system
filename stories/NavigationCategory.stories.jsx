...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'variant·size·padding·vertical padding·scroll 조합을 제공하는 주제 내비게이션입니다.',
      },
    },
  },
};
...
export const RadioGroupSemantics = {
  ...
  play: async ({ canvasElement }) => {
    ...
    await userEvent.click(initialGroup.querySelector('[data-category-value="설비"]'));
    if (
      initialGroup.querySelector('[role="radio"][aria-checked="true"]')?.textContent !== '설비' ||
      checkedCount(initialGroup) !== 1
    ) {
