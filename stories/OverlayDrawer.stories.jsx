  ...
  return (
    <main style={{ minHeight: 180 }}>
      ...
      <Drawer
        ...
        footer={<Button size="sm" onClick={() => setOpen(false)}>적용</Button>}
      >
      ...
      <Drawer
        ...
        footer={(
          <>
            ...
            <Button data-testid="drawer-last-action" onClick={() => setDrawerOpen(false)}>필터 적용</Button>
          </>
        )}
      >
      ...
      <Sheet
        ...
        footer={(
          <>
            ...
            <Button data-testid="sheet-last-action" full onClick={() => setSheetOpen(false)}>적용</Button>
          </>
        )}
      >
