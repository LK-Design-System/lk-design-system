...
const fixedRows = [
  ...
  ['P1', 'Targeted parity stories', 'Dedicated Storybook parity stories added for high-mismatch form/status/overlay/viz/navigation cards so primary matching no longer falls back to broad inventory stories'],
