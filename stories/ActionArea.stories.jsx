...
const meta = {
  ...
  parameters: {
    storyGuide: {
      storyId: 'lds-core-components-action-action-area--bottom-action-area',
      eyebrow: 'Action / Action Area',
      title: 'Action Area가 하단 배치, 구분선, 캡션, 스티키, 세이프 에어리어 패딩을 담당합니다',
      description:
    ...
    return (
      <main style={{ display: 'grid', gap: 'var(--space-6)', maxWidth: 880 }}>
        <header style={{ display: 'grid', gap: 'var(--space-2)' }}>
          ...
          {/* type-title2 carries the step's tracking as well as its size; pinning only size left
              the heading on the element default, which changed when this stopped being an h1. */}
          <h2 className="type-title2" style={{ margin: 0, color: 'var(--color-semantic-label-strong)' }}>
