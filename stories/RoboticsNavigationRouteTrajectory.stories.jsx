...
const NAVIGATION_STATE_BADGE_SELECTOR = [
...
function paintedGeometryRect(container) {
...
function pathAreaCentroid(path) {
...
function expectedNavigationStateKind(group) {
...
function assertNavigationStateGlyphGeometry(root, label) {
...
function assertNavigationVectorGeometry(root, label) {
