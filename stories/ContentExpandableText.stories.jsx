...
const body =
  '원티드는 지원자와 회사를 잇는 채용 플랫폼입니다. 이 카드 본문은 목록에서 길이를 고르게 유지하기 위해 세 줄로 접혀 있고, 더 보기를 누르면 나머지가 펼쳐집니다. 접힘은 시각적 자르기일 뿐이라 보조기기는 펼침 여부와 상관없이 전문을 읽습니다. 이렇게 하면 정보를 숨기지 않으면서도 화면에서는 밀도를 유지할 수 있습니다.';
