  ...
  render: () => (
    ...
    >
      <ResourceSurface label="실시간 운영 현황">
        <ResourceState state="refreshing" messageVariant="embedded" lastUpdated="오늘 14:32">
          <ResourceRows />
        </ResourceState>
      </ResourceSurface>
      <ResourceSurface label="로봇 상태 요약">
        <ResourceState
          ...
          action={<Button size="sm" variant="secondary">새로고침</Button>}
        >
          <ResourceRows />
        </ResourceState>
      </ResourceSurface>
      ...
      <ResourceSurface label="현장 연결 현황">
        <ResourceState state="offline" messageVariant="embedded" lastUpdated="오늘 13:57">
          <ResourceRows />
        </ResourceState>
      </ResourceSurface>
    </main>
