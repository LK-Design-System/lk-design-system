...
const meta = {
  ...
  parameters: {
    storyGuide: {
      storyId: 'lds-core-components-status-skeleton--skeleton-overview',
      eyebrow: 'Status / Skeleton',
      title: 'Skeleton은 도착할 콘텐츠의 자리를 먼저 잡습니다',
      description:
    ...
    docs: {
      description: {
        component:
          'Skeleton은 콘텐츠가 도착하기 전 레이아웃의 자리를 잡아 두는 로딩 플레이스홀더입니다. 실제 콘텐츠의 모양(텍스트 줄, 카드, 아바타)을 흉내 내야 할 때 사용하고, 짧은 비결정적 대기에는 순환형 로딩 표시를 쓰세요.',
      },
    },
  },
};
