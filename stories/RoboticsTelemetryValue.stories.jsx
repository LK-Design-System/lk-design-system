...
import { TelemetryValue } from '../src/index.js';
...
const meta = {
  title: 'LDS Product/Status/Telemetry Value',
  tags: ['autodocs'],
  component: TelemetryValue,
  parameters: {
    storyGuide: {
      storyId: 'lds-product-status-telemetry-value--compact-readouts',
      eyebrow: 'Product / Telemetry Value',
    ...
    docs: {
      description: {
        component:
          '정확한 측정값과 단위, 상태, freshness, 보조 설명과 수집 시각을 압축해 표시하는 LDS Product TelemetryValue 패턴입니다.',
      },
    },
  },
};
