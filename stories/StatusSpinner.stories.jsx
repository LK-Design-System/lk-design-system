...
const meta = {
  ...
  parameters: {
    storyGuide: {
      storyId: 'lds-core-components-status-spinner--spinner-overview',
      eyebrow: 'Status / Spinner',
      title: 'Spinner는 완료 시점을 모르는 짧은 대기에 씁니다',
      description:
    ...
    docs: {
      description: {
        component:
          'Spinner는 완료 시점을 예측할 수 없는 짧은 대기를 나타내는 순환 로딩 표시입니다. 진행률을 알 수 있으면 진행 표시를, 레이아웃 자리를 잡아야 하면 콘텐츠 윤곽 로딩을 쓰세요.',
      },
    },
  },
};
