...
const componentItems = [
  ...
  ['버튼', '버튼', 'components/buttons/buttons.card.html', 'Button, IconButton, SocialButton', '컴포넌트/버튼, 컴포넌트/버튼 상세'],
  ['카드', 'Card', 'components/cards/cards-card.card.html', 'Card', '컴포넌트/카드'],
  ['카드', 'ChecklistItem', 'components/cards/cards-checklistitem.card.html', 'ChecklistItem', '컴포넌트/카드 상세'],
  ['카드', 'FeatureCard', 'components/cards/cards-featurecard.card.html', 'FeatureCard', '컴포넌트/카드 상세'],
  ['카드', 'NewsCard', 'components/cards/cards-newscard.card.html', 'NewsCard', '컴포넌트/카드 상세'],
  ['카드', 'ProductCard', 'components/cards/cards-productcard.card.html', 'ProductCard', '컴포넌트/카드 상세'],
  ['카드', 'SourceTag', 'components/cards/cards-sourcetag.card.html', 'SourceTag', '컴포넌트/콘텐츠'],
  ['카드', 'SpecRow', 'components/cards/cards-specrow.card.html', 'SpecRow', '컴포넌트/카드 상세'],
  ['카드', 'Stat', 'components/cards/cards-stat.card.html', 'Stat', '컴포넌트/카드 상세'],
  ...
  ['폼', 'AutoComplete', 'components/forms/forms-autocomplete.card.html', 'AutoComplete', '컴포넌트/폼 상세'],
  ['폼', 'DatePicker', 'components/forms/forms-datepicker.card.html', 'DatePicker', '컴포넌트/폼 상세'],
  ['폼', 'SearchField', 'components/forms/forms-searchfield.card.html', 'SearchField', '컴포넌트/폼 상세'],
  ['폼', 'Slider', 'components/forms/forms-slider.card.html', 'Slider, RangeSlider', '컴포넌트/폼 상세'],
  ...
  ['내비게이션', 'BottomNav', 'components/navigation/navigation-bottomnav.card.html', 'BottomNav', '컴포넌트/내비게이션 상세'],
  ['내비게이션', 'Breadcrumb', 'components/navigation/navigation-breadcrumb.card.html', 'Breadcrumb', '컴포넌트/내비게이션 상세'],
  ['내비게이션', 'Footer', 'components/navigation/navigation-footer.card.html', 'Footer', '컴포넌트/내비게이션 상세'],
  ['내비게이션', 'Pagination', 'components/navigation/navigation-pagination.card.html', 'Pagination', '컴포넌트/내비게이션 상세'],
  ['내비게이션', 'SideNav', 'components/navigation/navigation-sidenav.card.html', 'SideNav, UserMenu', '컴포넌트/내비게이션 상세'],
  ['내비게이션', 'Tabs', 'components/navigation/navigation-tabs.card.html', 'Tabs', '컴포넌트/내비게이션 상세'],
  ['내비게이션', 'Steps', 'components/navigation/steps.card.html', 'Steps', '컴포넌트/내비게이션 상세'],
  ['내비게이션', 'TopBar', 'components/navigation/topbar.card.html', 'TopBar, TopBarNavItem', '컴포넌트/내비게이션'],
  ...
  ['로보틱스', 'RobotStatusCard', 'components/robotics/robotics-robotstatuscard.card.html', 'RobotStatusCard', '컴포넌트/로보틱스'],
  ...
  ['상태', 'Banner', 'components/status/status-banner.card.html', 'Banner', '컴포넌트/데이터와 상태'],
