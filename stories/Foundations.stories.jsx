...
export const Color = {
  ...
  parameters: {
    ...
    ...storyDescription(
      'LDS semantic color token을 역할별로 살펴보는 기준 화면입니다. 구현할 표면의 의미에 맞는 토큰을 선택하고, 밝은 테마와 어두운 테마에서 정보 위계와 대비가 유지되는지 확인하세요. 하단의 선명한 상태색 경고를 함께 읽고, 텍스트와 텍스트 배경에는 신호색 대신 *-text 역할을 쓰세요.',
    ),
  },
};
