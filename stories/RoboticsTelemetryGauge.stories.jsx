...
const meta = {
  title: 'LDS Product/Status/Telemetry Gauge',
  tags: ['autodocs'],
  component: TelemetryGauge,
  parameters: {
    storyGuide: {
      storyId: 'lds-product-status-telemetry-gauge--telemetry-overview',
      eyebrow: 'Product / Telemetry Gauge',
    ...
    docs: {
      description: {
        component:
          '범위형 수치의 현재 수준과 severity를 meter로 표현하는 LDS Product TelemetryGauge 패턴입니다. 제품이 tone을 판정하고 값·단위·상태를 색에만 의존하지 않고 함께 전달합니다.',
      },
    },
  },
};
