...
export const ModalOpen = {
  ...
  render: () => (
    <Modal
      open
      title="항목 상세"
      footer={<Button variant="solid" color="primary">확인</Button>}
    >
...
export const DrawerOpen = {
  ...
  render: () => (
    <Drawer
      open
      title="필터"
      footer={<Button variant="solid" color="primary">적용</Button>}
    >
...
export const SheetOpen = {
  ...
  render: () => (
    <Sheet
      open
      title="모바일 액션"
      footer={<Button variant="solid" color="primary">선택</Button>}
    >
    ...
    return (
      <div>
        ...
        <Modal open={open} title="항목 정보 수정" onClose={() => setOpen(false)}
          footer={<><Button variant="outlined" color="assistive" onClick={() => setOpen(false)}>취소</Button><Button variant="solid" color="primary" onClick={() => setOpen(false)}>저장</Button></>}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
