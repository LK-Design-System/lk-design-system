const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          '인터랙션 장식 토큰입니다. WDS Decorate의 Interaction 축을 계승해, hover·pressed·focus 표현을 레이어 토큰과 상태 불투명도 토큰으로 고정합니다. 컴포넌트가 임의의 인터랙션 표현을 만들지 않도록 하는 것이 목적입니다.',
      },
    },
  },
};
...
export const InteractionTokens = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          '레이어 토큰(normal/default/light/strong)과 상태 불투명도 토큰(normal/hovered/focused/pressed)을 함께 봅니다. 같은 상태에는 항상 같은 토큰을 쓰는지, 다크 모드에서 레이어가 뒤집히지 않는지 확인하세요.',
      },
    },
  },
  render: () => (
