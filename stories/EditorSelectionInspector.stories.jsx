...
import { Button, ConfirmDialog, SelectionInspector } from '../src/index.js';
import { EditorStoryFrame, inspectorItem, inspectorSections } from './EditorShell.shared.jsx';
import { storyDescription } from './StoryGuide.shared.jsx';

const meta = {
  title: 'LDS Product/Editor/Selection Inspector',
  tags: ['autodocs'],
  component: SelectionInspector,
  parameters: {
    storyGuide: {
      storyId: 'lds-product-editor-selection-inspector--selected-object',
      eyebrow: 'Product / Selection Inspector',
