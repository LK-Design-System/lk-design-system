...
import { CanvasEditorShell } from '../src/index.js';
import { CanvasEditorShellEditorToolbarHistoryToolbarCard as CanvasEditorShellEditorToolbarHistoryToolbarCardStory } from './ProductEditorAndViz.shared.jsx';
...
const meta = {
  title: 'LDS Product/Editor/Canvas Shell',
  tags: ['autodocs'],
  component: CanvasEditorShell,
  parameters: {
    storyGuide: {
      storyId: 'lds-product-editor-canvas-shell--basic',
      eyebrow: 'Product / Canvas Shell',
    ...
    docs: {
      description: {
        component:
          'CanvasEditorShell은 문서 명령, 편집 도구, 계층, 중앙 뷰포트, 선택 속성, 수동 상태의 관계를 소유하는 LDS Product 확장 프레임입니다. 좌우 패널은 접기·복원·키보드 리사이즈를 지원하며 제품 워크플로 자체는 포함하지 않습니다.',
      },
    },
  },
};
