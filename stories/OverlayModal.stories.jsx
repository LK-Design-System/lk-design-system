  ...
  return (
    <main style={{ minHeight: 180 }}>
      ...
      <Modal
        ...
        footer={<Button variant="solid" color="primary" onClick={() => setOpen(false)}>확인</Button>}
      >
  ...
  return (
    <main data-testid="modal-focus-fixture" style={{ minHeight: 220, display: 'grid', alignContent: 'start', gap: 'var(--space-4)', maxWidth: 760 }}>
      ...
      <Modal
        ...
        footer={(
          <>
            ...
            <Button data-testid="modal-save" variant="solid" color="primary" onClick={closeMain}>저장</Button>
          </>
        )}
      >
      ...
      <Modal
        ...
        footer={<Button variant="solid" color="primary" onClick={() => setNestedOpen(false)}>계속 편집</Button>}
      >
      ...
      <Modal
        ...
        footer={(
          <>
            ...
            <Button variant="solid" color="primary" onClick={() => setOpen(false)}>변경 저장</Button>
          </>
        )}
      >
