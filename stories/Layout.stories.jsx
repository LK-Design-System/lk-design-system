...
const meta = {
  ...
  parameters: {
    storyGuide: {
      ...
      description:
        '헤더, 본문, 보조 영역처럼 화면 전체의 큰 구획과 너비 규칙을 설계할 때 적합합니다. 반복 항목 배치는 Grid나 Columns를, 한 방향의 내부 간격은 Stack을 사용하고 컴포넌트 내부의 작은 정렬까지 페이지 구조로 해결하지 마세요.',
    },
    docs: {
      description: {
...
export const PageStructure = {
  ...
  parameters: {
    ...
    ...storyDescription(
      '페이지의 컨테이너, 섹션, 주·보조 열을 조합해 데스크톱과 좁은 화면의 큰 구조를 검토하는 상황입니다. DOM 읽기 순서와 시각적 배치가 일치하고 너비가 줄어들 때 영역이 자연스럽게 쌓이는지 확인하세요.',
    ),
  },
};
