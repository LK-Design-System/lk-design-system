  ...
  render: () => (
    <main style={{ display: 'grid', gap: 'var(--space-6)', maxWidth: 920 }}>
      <section style={{ display: 'flex', alignItems: 'center', gap: 'var(--space-3)', flexWrap: 'wrap' }}>
        ...
        <SplitButton
          items={[
            ...
            { label: '예약 적용', icon: <Icon name="calendar" size={16} /> },
          ]}
        >
          적용
        </SplitButton>
      ...
      <section style={{ display: 'flex', alignItems: 'center', gap: 'var(--space-4)', flexWrap: 'wrap' }}>
        <Fab label="항목 추가" variant="signal">
          <Icon name="plus" size={24} />
        </Fab>
        <Fab label="문서 보기" variant="white">
...
export const ButtonIconButtonSocialButtonCard = {
  ...
  render: () => (
    <div data-visual-crop-root style={{ width: 700, height: 540, background: 'var(--color-semantic-background-normal-normal)', padding: 'var(--space-6)', boxSizing: 'border-box' }}>
      <style>
        {`
