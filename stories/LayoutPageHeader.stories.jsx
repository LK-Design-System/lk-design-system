...
export const ProfileMasthead = {
  name: '변형·상태 · 레코드 헤더(프로필)',
  parameters: storyDescription(
    '제목이 업무가 아니라 대상 자체인 갈래입니다 — 사람·로봇·주문 같은 레코드 상세와 프로필·계정이 여기 속하며, 별도 정체성 컴포넌트를 만들지 않고 같은 헤더로 조립합니다. 아바타가 이름 왼쪽에 붙고, 이름이 페이지 제목(h1)이 되며, 인증 배지는 제목 옆에, 라벨 붙은 스탯 행은 메타 슬롯에 놓이는지 확인하세요.',
  ),
  render: () => (
    <PageHeader
