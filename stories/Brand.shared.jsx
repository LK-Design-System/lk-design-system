            ...
            return (
              ...
              >
                ...
                <div style={{ display: 'grid', gap: 4 }}>
                  ...
                  <code style={{ color: isDark ? 'var(--inverse-label-neutral)' : 'var(--label-alternative)', fontSize: 12 }}>
                    tone="{tone}"
                  </code>
                </div>
              </div>
    ...
    <div style={{ background: 'var(--bw-paper)', padding: '22px 24px', fontFamily: 'var(--font-sans)' }}>
      <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
        <div>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 28, flexWrap: 'wrap', padding: '20px 24px', borderRadius: 'var(--radius-xl)', background: 'var(--surface-inverse)', marginTop: 12 }}>
