  ...
  return (
    <section
      style={{
        ...
        background: 'var(--color-semantic-status-info-surface)',
        border: '1px solid var(--color-semantic-status-info-border)',
      }}
    >
      <h2 style={{ margin: 0, fontSize: 18, fontWeight: 'var(--fw-semibold)', color: 'var(--color-semantic-label-strong)' }}>
        상태색은 용도별 토큰을 구분해 사용합니다
      </h2>
      <p style={{ margin: 0, color: 'var(--color-semantic-label-neutral)', lineHeight: 1.7 }}>
        ...
        선명색</strong>입니다. <strong>vivid 토큰은 텍스트나 텍스트 배경에 사용하지 마세요.</strong> 점·아이콘·테두리·진행 표시처럼
        <em> 텍스트가 아닌</em> 요소에만 쓰세요. 흰 배경 기준 대비가
...
export const Color = {
  ...
  render: () => (
    <main style={{ display: 'grid', gap: 32, width: '100%', maxWidth: 1040, minWidth: 0 }}>
      <section>
        <h2 style={{ margin: '0 0 16px', fontSize: 28, color: 'var(--color-semantic-label-strong)' }}>색상 토큰</h2>
...
export const SpacingScale = {
  ...
  render: () => (
    <main style={{ display: 'grid', gap: 32, width: '100%', maxWidth: 1040, minWidth: 0 }}>
      <section>
        <h2 style={{ margin: '0 0 16px', fontSize: 28, color: 'var(--color-semantic-label-strong)' }}>간격 스케일</h2>
...
function TypeSpecRow({ name, cls, sample }) {
  ...
  return (
    <div style={{ display: 'grid', gridTemplateColumns: 'minmax(150px, 190px) minmax(0, 1fr)', gap: 24, alignItems: 'baseline', padding: '14px 0', borderTop: '1px solid var(--color-semantic-line-normal-normal)', minWidth: 0 }}>
      <div style={{ display: 'grid', gap: 'var(--space-1)', alignSelf: 'center' }}>
...
function Swatch({ varName, caption, sub }) {
  return (
    <div style={{ display: 'grid', gap: 4, minWidth: 0 }}>
      ...
      <div style={{ display: 'grid', gap: 'var(--space-0-5)', minWidth: 0 }}>
  ...
  return (
    <main style={{ display: 'grid', gap: 40, width: '100%', maxWidth: 1040, minWidth: 0 }}>
      <header style={{ display: 'grid', gap: 10 }}>
        ...
        <h2 style={{ margin: 0 }} className="type-title2">원자 팔레트에서 역할과 컴포넌트 계약까지</h2>
