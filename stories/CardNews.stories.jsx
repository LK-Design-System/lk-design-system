...
export const NewsCards = {
  ...
  play: async ({ canvasElement }) => {
    ...
    for (const card of cards) {
      ...
      if (!heading) throw new Error('헤드라인은 실제 heading으로 렌더되어야 합니다(WCAG 1.3.1).');
...
export const CoverImage = {
  ...
  play: async ({ canvasElement }) => {
    ...
    const decorativeHeading = decorative.querySelector('h2');
    ...
    const informativeHeading = informative.querySelector('h2');
