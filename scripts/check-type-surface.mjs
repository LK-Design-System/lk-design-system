...
assert(
  entryNames.length === implementationExportNames.length,
  `Expected ${implementationExportNames.length} named public exports from ${jsxFiles.length} component entries, found ${entryNames.length}.`,
);
