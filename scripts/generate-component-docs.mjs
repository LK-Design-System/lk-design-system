...
assert(entries.length === 212, `Expected 212 public component entries, received ${entries.length}.`);
...
assert(guides.length === 181, `Expected 181 non-Foundation component pages, received ${guides.length}.`);
