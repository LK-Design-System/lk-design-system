...
assert(entries.length === 209, `Expected 209 public component entries, received ${entries.length}.`);
...
assert(guides.length === 178, `Expected 178 non-Foundation component pages, received ${guides.length}.`);
