...
assert(entries.length === 210, `Expected 210 public component entries, received ${entries.length}.`);
...
assert(guides.length === 179, `Expected 179 non-Foundation component pages, received ${guides.length}.`);
