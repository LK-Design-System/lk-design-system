...
assert(entries.length === 211, `Expected 211 public component entries, received ${entries.length}.`);
...
assert(guides.length === 180, `Expected 180 non-Foundation component pages, received ${guides.length}.`);
