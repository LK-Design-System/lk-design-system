...
const pairs = [
  ...
  ['side nav brand foreground', '--component-side-nav-brand-foreground', '--component-side-nav-brand-surface', 4.5],
  ...
  ['side nav brand foreground on active surface', '--component-side-nav-brand-foreground', '--component-side-nav-brand-active-surface', 4.5],
  ['side nav brand foreground on active hover surface', '--component-side-nav-brand-foreground', '--component-side-nav-brand-active-hover-surface', 4.5],
  ['side nav brand foreground on active surface', '--component-side-nav-brand-foreground', '--component-side-nav-brand-active-surface', 4.5],
  ['side nav brand foreground on active hover surface', '--component-side-nav-brand-foreground', '--component-side-nav-brand-active-hover-surface', 4.5],
  ...
  ['primary ink on page', '--color-semantic-primary-ink', '--color-semantic-background-normal-normal', 4.5],
  ...
  ['chip solid', '--component-chip-solid-fg', '--component-chip-solid-bg', 4.5],
  ['input required mark', '--component-input-required-color', '--color-semantic-background-normal-normal', 4.5],
  ['data-viz series 7 on page', '--color-semantic-data-viz-series-7', '--color-semantic-background-normal-normal', 3],
  ['button secondary', '--component-button-secondary-fg', '--component-button-secondary-bg', 4.5],
  ...
  ['status positive indicator on page', '--color-semantic-status-positive-foreground', '--color-semantic-background-normal-normal', 3],
  ['status cautionary indicator on page', '--color-semantic-status-cautionary-foreground', '--color-semantic-background-normal-normal', 3],
  ['status negative indicator on page', '--color-semantic-status-negative-foreground', '--color-semantic-background-normal-normal', 3],
