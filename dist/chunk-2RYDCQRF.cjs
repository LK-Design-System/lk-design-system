...
function ToolbarButton({ item, active, disabled, onAction, index, tabIndex, onFocus }) {
  ...
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
    "button",
    {
      ...
      children: item.icon ? /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkB6GRMPJUcjs.Icon, { name: item.icon, size: 17, "aria-hidden": "true" }) : item.children
    }
  );
}
...
//# sourceMappingURL=chunk-2RYDCQRF.cjs.map