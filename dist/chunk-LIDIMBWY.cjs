...
function LightboxStage({ url, alt, position, count, go, onClose, closeLabel, previousLabel, nextLabel, closeFocusRef, dialogRef, zIndex, ariaLabel, style, rest }) {
  ...
  return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "div", { ref: dialogRef, role: "dialog", "aria-modal": "true", "aria-label": ariaLabel, "aria-busy": loaded ? void 0 : "true", tabIndex: -1, onClick: (e) => {
    ...
    /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "button", { ref: closeFocusRef, type: "button", "aria-label": closeLabel, onClick: onClose, style: { position: "absolute", top: 20, right: 20, width: 44, height: 44, borderRadius: "50%", border: "none", background: "var(--color-semantic-inverse-fill-normal)", color: "var(--color-semantic-inverse-label)", cursor: "pointer", display: "inline-flex", alignItems: "center", justifyContent: "center" }, children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkOZR3K6TYcjs.Icon, { name: "close", size: 22, "aria-hidden": "true" }) }),
    /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "div", { style: { position: "relative", display: "inline-flex", alignItems: "center", justifyContent: "center", minWidth: loaded ? 0 : 280, minHeight: loaded ? 0 : 200 }, children: [
      ...
      multiple && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "button", { type: "button", "data-lightbox-previous": true, "aria-label": previousLabel, "aria-disabled": loaded ? void 0 : "true", onClick: () => step(-1), style: lbArrow("left", !loaded), children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkOZR3K6TYcjs.Icon, { name: "chevron-left", size: 26, "aria-hidden": "true" }) }),
      multiple && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "button", { type: "button", "data-lightbox-next": true, "aria-label": nextLabel, "aria-disabled": loaded ? void 0 : "true", onClick: () => step(1), style: lbArrow("right", !loaded), children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkOZR3K6TYcjs.Icon, { name: "chevron-right", size: 26, "aria-hidden": "true" }) })
    ] }),
...
//# sourceMappingURL=chunk-LIDIMBWY.cjs.map