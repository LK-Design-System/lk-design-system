...
function RobotMarker({
  ...
  const silhouette = (fill, strokeProps) => /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, _jsxruntime.Fragment, { children: [
    hasHeading && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
      "path",
      {
        d: _chunkAZGN4HJOcjs.NAV_ROBOT_POSE.nosePath,
        fill,
        strokeLinejoin: "round",
        ...strokeProps
      }
    ),
    /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "circle", { r: _chunkAZGN4HJOcjs.NAV_ROBOT_POSE.bodyRadius, fill, ...strokeProps })
  ] });
      ...
      children: [
        footprintRadius && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
          "circle",
          {
            ...
            r: footprintRadius,
            fill: bodyColor,
            opacity: _chunkAZGN4HJOcjs.NAV_ROBOT_POSE.footprintOpacity,
            stroke: bodyColor,
            strokeWidth: "1",
            ...
            children: [
              ...
              stale && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
                "circle",
                {
                  ...
                  r: _chunkAZGN4HJOcjs.NAV_ROBOT_POSE.bodyRadius + 3.5,
                  fill: "none",
                  stroke: muted,
                  strokeWidth: "1.5",
                  strokeDasharray: _chunkAZGN4HJOcjs.NAV_DASH.staleRing,
                  vectorEffect: "non-scaling-stroke"
                }
              ),
              focusVisible && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
                "g",
                {
                  ...
                  transform: `rotate(${headingDeg}) scale(${_chunkAZGN4HJOcjs.NAV_ROBOT_POSE.focusScale})`,
                  children: silhouette("none", {
                    stroke: "var(--color-semantic-focus-indicator)",
                    strokeWidth: _chunkAZGN4HJOcjs.NAV_FOCUS.strokeWidth,
                    vectorEffect: "non-scaling-stroke"
                  })
                }
              ),
              selected && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
                "g",
                {
                  ...
                  transform: `rotate(${headingDeg}) scale(${_chunkAZGN4HJOcjs.NAV_ROBOT_POSE.selectionRingScale})`,
                  children: silhouette("none", {
                    stroke: accent,
                    strokeWidth: "2",
                    vectorEffect: "non-scaling-stroke"
              ...
              /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, 
                "g",
                {
                  ...
                  children: [
                    silhouette(surface, {
                      stroke: surface,
                      strokeWidth: _chunkAZGN4HJOcjs.NAV_ROBOT_POSE.casingWidth * 2,
                      vectorEffect: "non-scaling-stroke"
                    }),
...
//# sourceMappingURL=chunk-YEXBBYOS.cjs.map