...
function RequiredMark() {
  return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, _jsxruntime.Fragment, { children: [
    /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "span", { "aria-hidden": "true", style: { color: "var(--color-semantic-status-negative-text)" }, children: " *" }),
...
function ToolbarButton({ item, active, disabled, onAction, index, tabIndex, onFocus }) {
  ...
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
    "button",
    {
      ...
      children: item.icon ? /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunk7OXVB7WXcjs.Icon, { name: item.icon, size: 17, "aria-hidden": "true" }) : item.children
    }
  );
}
function ContentEditor({
  ...
  const ring = invalid ? "var(--color-semantic-status-negative-foreground)" : titleFocus || bodyFocus ? "var(--color-semantic-primary-normal)" : "var(--color-semantic-line-normal-normal)";
        ...
        /* @__PURE__ */ _jsxruntime.jsxs.call(void 0,
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "div", { role: "status", "aria-live": "polite", style: { flexShrink: 0, color: "var(--color-semantic-label-alternative)", fontSize: "var(--label2-size)", lineHeight: 1.35 }, children: status })
            ]
          }
        ),
...
//# sourceMappingURL=chunk-V5ZOQ3OB.cjs.map