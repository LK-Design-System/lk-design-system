...
function SecretField({
  ...
  const actions = revealable || copyable ? /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "span", { style: { display: "inline-flex", alignItems: "center", gap: "var(--space-0)" }, children: [
    revealable && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkS7GFPUQYcjs.IconButton, { variant: "plain", round: false, size: "sm", disabled: disabled || !hasValue, "aria-controls": inputId, onClick: () => setShow(!show), label: revealActionLabel, children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkVGM7HVYYcjs.Icon, { name: show ? "eye-slash" : "eye", size: 16, "aria-hidden": "true" }) }),
    copyable && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkS7GFPUQYcjs.IconButton, { variant: "plain", round: false, size: "sm", disabled: disabled || !hasValue, "aria-controls": inputId, onClick: copy, label: copyActionLabel, style: copyTone ? { color: copyTone } : void 0, children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkVGM7HVYYcjs.Icon, { name: copyState === "success" ? "circle-check" : copyState === "error" ? "circle-close" : "copy", size: 16, "aria-hidden": "true" }) })
  ] }) : void 0;
  return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "div", { style: { display: "grid", gap: "var(--space-1)", ...style }, children: [
    /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
      _chunkMNEQOJXNcjs.Input,
      {
        ...rest,
        id: inputId,
        label,
        ...
        error,
        size,
        helper: _nullishCoalesce(helper, () => ( (show && revealDurationMs > 0 ? `${Math.ceil(revealDurationMs / 1e3)}\uCD08 \uD6C4 \uC790\uB3D9\uC73C\uB85C \uC228\uAE41\uB2C8\uB2E4.` : void 0))),
        actionRight: actions,
        autoComplete: "off",
        autoCapitalize: "off",
        autoCorrect: "off",
    ...
    /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "span", { role: "status", "aria-live": "polite", style: { position: "absolute", width: 1, height: 1, padding: 0, margin: -1, overflow: "hidden", clip: "rect(0, 0, 0, 0)", whiteSpace: "nowrap", border: 0 }, children: copyState === "success" || copyState === "error" ? copyActionLabel : "" })
  ] });
}
...
//# sourceMappingURL=chunk-ADY74PFF.cjs.map