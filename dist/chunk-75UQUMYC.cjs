...
function TelemetryValue({
  ...
  const resolvedStatusLabel = stale ? hasCustomStaleLabel ? staleLabel : "\uC9C0\uC5F0" : hasCustomStatusLabel ? statusLabel : tone === "neutral" ? null : _chunkCXJRK2V3cjs.TELEMETRY_STATUS_LABEL[tone];
  ...
  const normalizedValue = _chunk5R6MQTQFcjs.normalizeValueText.call(void 0, value);
...
//# sourceMappingURL=chunk-75UQUMYC.cjs.map