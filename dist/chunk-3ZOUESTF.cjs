...
function CheckMark({ variant, checked, disabled }) {
  ...
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
    "span",
    {
      ...
      children: checked && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkVHQHPPYQcjs.Icon, { name: "check", size: 11, "aria-hidden": "true" })
    }
  );
}
...
var SUBMENU_CHEVRON = /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkVHQHPPYQcjs.Icon, { name: "chevron-right-small", size: 16, "aria-hidden": "true", style: { flexShrink: 0, color: "var(--color-semantic-label-alternative)" } });
function DrillHeader({ title, onBack, itemMetrics }) {
  return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0,
    "button",
    {
      ...
      children: [
        /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkVHQHPPYQcjs.Icon, { name: "chevron-left-small", size: 16, "aria-hidden": "true" }),
          ...
          "button",
          {
            ...
            children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
              MenuItemContent,
              {
                ...
                disabled,
                description,
                trailing: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkVHQHPPYQcjs.Icon, { name: "chevron-right-small", size: 16, "aria-hidden": "true", style: { flexShrink: 0, color: "var(--color-semantic-label-alternative)" } })
              }
            )
          }
        ),
...
//# sourceMappingURL=chunk-3ZOUESTF.cjs.map