...
function ContentBadge({
  ...
  const solidFg = accentContentColor || (neutralColor ? "var(--color-semantic-label-neutral)" : resolvedTone === "navy" ? "var(--color-semantic-brand-on-surface)" : "var(--color-semantic-background-normal-normal)");
...
//# sourceMappingURL=chunk-7Y4CFYCN.cjs.map