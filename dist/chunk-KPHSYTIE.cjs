  ...
  return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, 
    "button",
    {
      ...
      style: {
        ...
        color: blocked ? "var(--color-semantic-label-disable)" : active ? "var(--color-semantic-primary-heavy)" : "var(--color-semantic-label-neutral)",
...
function ButtonGroup({
  ...
  if (!multiple) {
    return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
      _chunkONFWQZSJcjs.SegmentedControl,
      {
        options: norm,
...
//# sourceMappingURL=chunk-KPHSYTIE.cjs.map