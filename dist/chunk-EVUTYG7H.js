    ...
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxs(
        "div",
        {
          ...
          children: [
            (title != null || subtitle != null || onClose) && /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", gap: "var(--space-4)", padding: isCompact ? "var(--component-drawer-header-padding-compact, var(--space-4) var(--space-5))" : "var(--component-drawer-header-padding-comfortable, var(--space-5) var(--space-6))", borderBottom: "1px solid var(--color-semantic-line-solid-normal)" }, children: [
            ...
            footer != null && /* @__PURE__ */ jsx("div", { style: { padding: isCompact ? "var(--component-drawer-footer-padding-compact, var(--space-3) var(--space-5))" : "var(--component-drawer-footer-padding-comfortable, var(--space-4) var(--space-6))", borderTop: "1px solid var(--color-semantic-line-solid-normal)", display: "flex", justifyContent: "flex-end", gap: "var(--space-2)" }, children: footer })
          ]
        }
      )
    }
...
//# sourceMappingURL=chunk-EVUTYG7H.js.map