...
var _chunkWFEHGJNAcjs = require('./chunk-WFEHGJNA.cjs');


var _chunkFW42VGJKcjs = require('./chunk-FW42VGJK.cjs');





var _chunkGY2GH62Kcjs = require('./chunk-GY2GH62K.cjs');





var _chunk555WAC5Gcjs = require('./chunk-555WAC5G.cjs');


var _chunkE6D6YGBXcjs = require('./chunk-E6D6YGBX.cjs');


var _chunk4LVUUV5Fcjs = require('./chunk-4LVUUV5F.cjs');


var _chunk3YG66XT2cjs = require('./chunk-3YG66XT2.cjs');
...
// ../../lk-workspace/shared/lk-design-system/packages/core/dist/chunk-NTECDBQW.js
...
// ../../lk-workspace/shared/lk-design-system/packages/core/dist/chunk-ODZ5FCNW.js
...
// ../../lk-workspace/shared/lk-design-system/packages/core/dist/chunk-IRMN3WTR.js
...
function useMenuKeyboard({ open, onClose, getTrigger, menuKey = 0, zIndex, focusOnOpen = true }) {
  const { zIndex: resolvedZIndex, isTopmost } = _chunkGY2GH62Kcjs.useOverlayLayer.call(void 0, { open, zIndex });
...
// ../../lk-workspace/shared/lk-design-system/packages/core/dist/chunk-DZYC7ZGA.js
...
function useSubmenuBranch({ disabled = false } = {}) {
  ...
  const renderPanel = (children, panelStyle) => {
    if (!open) return null;
    return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkGY2GH62Kcjs.OverlayPortal, { open, anchorRef: triggerRef, layer: "anchored", children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
      "div",
      {
        ref: panelRef,
        "data-menu-portal": "",
...
// ../../lk-workspace/shared/lk-design-system/packages/core/dist/chunk-AA3WO2SA.js
...
function focusableActionControls(region) {
  return Array.from(_nullishCoalesce(_optionalChain([region, 'optionalAccess', _50 => _50.querySelectorAll, 'call', _51 => _51(ACTION_CONTROL_SELECTOR)]), () => ( [])));
}
function availableMenuItems(menu) {
  return Array.from(_nullishCoalesce(_optionalChain([menu, 'optionalAccess', _52 => _52.querySelectorAll, 'call', _53 => _53(MENU_ITEM_SELECTOR2)]), () => ( []))).filter(
...
function CheckMark({ variant, checked, disabled }) {
  ...
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
    "span",
    {
      ...
      children: checked && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunk3YG66XT2cjs.Icon, { name: "check", size: 11, "aria-hidden": "true" })
    }
  );
}
...
function MenuItemButton({ item, variant, itemMetrics, onSelect, trailing, haspopup, onTriggerKeyDown, classNames, styles }) {
  ...
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
    "button",
    {
      ...
      className: _chunk555WAC5Gcjs.partClassName.call(void 0, classNames, "item", item.className) || void 0,
      type: "button",
      ...
      onClick: () => {
        if (disabled) return;
        _optionalChain([item, 'access', _54 => _54.onClick, 'optionalCall', _55 => _55()]);
        _optionalChain([onSelect, 'optionalCall', _56 => _56(item)]);
      },
      onKeyDown: onTriggerKeyDown,
      onMouseEnter: () => setHover(true),
      onMouseLeave: () => setHover(false),
      style: { ...menuItemVisualStyle({ selected: current, checked, hovered: hover, disabled, danger: item.danger, hasDescription: Boolean(description), metrics: itemMetrics }), ..._chunk555WAC5Gcjs.partStyle.call(void 0, styles, "item"), ...item.style },
      children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, MenuItemContent, { item, variant, checked, disabled, description, trailing })
    }
  );
}
var SUBMENU_CHEVRON = /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunk3YG66XT2cjs.Icon, { name: "chevron-right-small", size: 16, "aria-hidden": "true", style: { flexShrink: 0, color: "var(--color-semantic-label-alternative)" } });
function DrillHeader({ title, onBack, itemMetrics }) {
  return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0,
    "button",
    {
      ...
      children: [
        /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunk3YG66XT2cjs.Icon, { name: "chevron-left-small", size: 16, "aria-hidden": "true" }),
  ...
  return items.map((item, index) => {
    if (item.divider) {
      return /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
        ...
        {
          "data-slot": "divider",
          className: _chunk555WAC5Gcjs.partClassName.call(void 0, ctx.classNames, "divider") || void 0,
          role: "separator",
          style: { height: 1, background: "var(--color-semantic-line-solid-normal)", margin: "6px 4px", ..._chunk555WAC5Gcjs.partStyle.call(void 0, ctx.styles, "divider") }
        },
        index
      );
    }
      ...
      children: [
        /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
          "button",
          {
            ...
            disabled,
            ...sub.triggerHandlers,
            style: { ...menuItemVisualStyle({ active: sub.open, hovered: hover, disabled, danger: item.danger, hasDescription: Boolean(description), metrics: itemMetrics }), ..._chunk555WAC5Gcjs.partStyle.call(void 0, styles, "item"), ...item.style },
            children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
              MenuItemContent,
              {
                ...
                disabled,
                description,
                trailing: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunk3YG66XT2cjs.Icon, { name: "chevron-right-small", size: 16, "aria-hidden": "true", style: { flexShrink: 0, color: "var(--color-semantic-label-alternative)" } })
              }
            )
          }
        ),
    ...
    if (item.divider) {
      return /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
        "div",
        {
          ...
          className: _chunk555WAC5Gcjs.partClassName.call(void 0, ctx.classNames, "divider") || void 0,
          role: "separator",
          style: { height: 1, flexShrink: 0, background: "var(--color-semantic-line-solid-normal)", margin: "6px 4px", ..._chunk555WAC5Gcjs.partStyle.call(void 0, ctx.styles, "divider") }
        },
        index
      );
    }
...
var DropdownMenu = _react2.default.forwardRef(function DropdownMenu2({
  ...
  const mergedRootRef = _chunk555WAC5Gcjs.useMergedRefs.call(void 0, ref, forwardedRef);
  const panelRef = _react2.default.useRef(null);
  const actionAreaRef = _react2.default.useRef(null);
  const menuId = _react2.default.useId();
  const generatedTriggerId = _react2.default.useId();
  const triggerId = _nullishCoalesce(_optionalChain([trigger, 'optionalAccess', _57 => _57.props, 'optionalAccess', _58 => _58.id]), () => ( generatedTriggerId));
  const setVisible = (next) => {
    if (!controlled) setInternalOpen(next);
    _optionalChain([onOpenChange, 'optionalCall', _59 => _59(next)]);
  };
  _react2.default.useEffect(() => {
  ...
  const { menuRef, requestItemFocus, closeMenu, handleMenuKeyDown, zIndex: resolvedZIndex, isTopmost } = useMenuKeyboard({
    ...
    getTrigger: () => _optionalChain([ref, 'access', _60 => _60.current, 'optionalAccess', _61 => _61.querySelector, 'call', _62 => _62('[aria-haspopup="menu"], button, [role="button"], a[href]')]),
    menuKey: drill ? drillPath.length : 0,
    zIndex
  });
  const toggleMenu = (event) => {
    _optionalChain([trigger, 'optionalAccess', _63 => _63.props, 'optionalAccess', _64 => _64.onClick, 'optionalCall', _65 => _65(event)]);
    if (_optionalChain([event, 'optionalAccess', _66 => _66.defaultPrevented])) return;
  ...
  const handleTriggerKeyDown = (event) => {
    _optionalChain([trigger, 'optionalAccess', _67 => _67.props, 'optionalAccess', _68 => _68.onKeyDown, 'optionalCall', _69 => _69(event)]);
    if (event.defaultPrevented) return;
  ...
  const position = _chunkGY2GH62Kcjs.useFloatingPosition.call(void 0, {
    open: visible,
    anchorRef: ref,
    panelRef,
  ...
  const focusOutsideMenu = (direction) => {
    const triggerElement = _optionalChain([ref, 'access', _70 => _70.current, 'optionalAccess', _71 => _71.querySelector, 'call', _72 => _72('[aria-haspopup="menu"], button, [role="button"], a[href]')]);
    const ownerDocument = _optionalChain([triggerElement, 'optionalAccess', _73 => _73.ownerDocument]);
    const controls = Array.from(_nullishCoalesce(_optionalChain([ownerDocument, 'optionalAccess', _74 => _74.querySelectorAll, 'call', _75 => _75(ACTION_CONTROL_SELECTOR)]), () => ( []))).filter(
    ...
    setVisible(false);
    _optionalChain([target, 'optionalAccess', _76 => _76.focus, 'call', _77 => _77({ preventScroll: true })]);
  };
  const handleActionAreaKeyDown = (event) => {
    ...
    const currentControl = _optionalChain([event, 'access', _78 => _78.target, 'access', _79 => _79.closest, 'optionalCall', _80 => _80(ACTION_CONTROL_SELECTOR)]);
  ...
  _react2.default.useEffect(() => {
    ...
    const onDoc = (e) => {
      if (!isTopmost()) return;
      if (ref.current && !ref.current.contains(e.target) && !_optionalChain([e, 'access', _82 => _82.target, 'access', _83 => _83.closest, 'optionalCall', _84 => _84("[data-menu-portal]")])) {
        setVisible(false);
      }
    };
    const ownerDocument = _nullishCoalesce(_optionalChain([ref, 'access', _85 => _85.current, 'optionalAccess', _86 => _86.ownerDocument]), () => ( document));
  ...
  return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0,
    "div",
    {
      ...
      className: _chunk555WAC5Gcjs.partClassName.call(void 0, classNames, "root", className) || void 0,
      style: { ..._chunk555WAC5Gcjs.componentVars.call(void 0, vars, "--lds-dropdown-menu-"), position: "relative", display: "inline-block", ..._chunk555WAC5Gcjs.partStyle.call(void 0, styles, "root"), ...style },
      ...rest,
      children: [
        /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
          "span",
          {
            "data-slot": "trigger",
            className: _chunk555WAC5Gcjs.partClassName.call(void 0, classNames, "trigger") || void 0,
            style: { display: "inline-flex", ..._chunk555WAC5Gcjs.partStyle.call(void 0, styles, "trigger") },
            children: renderedTrigger
          }
        ),
        /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkGY2GH62Kcjs.OverlayPortal, { open: visible, withinPortal, portalTarget, anchorRef: ref, layer: "anchored", children: /* @__PURE__ */ _jsxruntime.jsxs.call(void 0,
          "div",
          {
            ref: panelRef,
            "data-slot": "panel",
            ...
            className: _chunk555WAC5Gcjs.partClassName.call(void 0, classNames, "panel") || void 0,
            "data-placement": position.placement,
            style: {
              ..._chunk555WAC5Gcjs.componentVars.call(void 0, vars, "--lds-dropdown-menu-"),
              ...withinPortal ? { position: "fixed", top: _nullishCoalesce(position.y, () => ( -9999)), left: _nullishCoalesce(position.x, () => ( -9999)), right: "auto", bottom: "auto", translate: "none" } : _chunkGY2GH62Kcjs.inlineFloatingStyle.call(void 0, { placement: position.placement, align, offset, shiftX: position.shiftX, shiftY: position.shiftY }),
              ...
              flexDirection: "column",
              gap: "var(--component-menu-gap)",
              ..._chunk555WAC5Gcjs.partStyle.call(void 0, styles, "panel"),
            ...
            children: [
              /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
                "div",
                {
                  ref: menuRef,
                  "data-slot": "menu",
                  className: _chunk555WAC5Gcjs.partClassName.call(void 0, classNames, "menu", "lk-scroll-surface") || void 0,
                  ...
                  onFocus: (event) => {
                    ...
                    const cameFromMenu = event.relatedTarget && _optionalChain([menuRef, 'access', _87 => _87.current, 'optionalAccess', _88 => _88.contains, 'call', _89 => _89(event.relatedTarget)]);
                    ...
                    _optionalChain([nextTarget, 'optionalAccess', _90 => _90.focus, 'call', _91 => _91({ preventScroll: true })]);
                  },
                  ...
                  style: {
                    ...
                    ..._chunk555WAC5Gcjs.partStyle.call(void 0, styles, "menu"),
              ...
              showActionArea && /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
                "div",
                {
                  ...
                  className: _chunk555WAC5Gcjs.partClassName.call(void 0, classNames, "actionArea") || void 0,
                  role: "group",
                  "aria-label": "\uBA54\uB274 \uC791\uC5C5",
                  ...
                  style: {
                    ...
                    flexShrink: 0,
                    ..._chunk555WAC5Gcjs.partStyle.call(void 0, styles, "actionArea")
                  },
                  children: action || /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, _jsxruntime.Fragment, { children: [
                    onCancel && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkFW42VGJKcjs.Button, { variant: "outlined", color: "assistive", size: "sm", onClick: () => finishAction(onCancel), children: cancelLabel }),
                    onApply && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkFW42VGJKcjs.Button, { size: "sm", onClick: () => finishAction(onApply), children: applyLabel })
                  ] })
                }
              )
            ]
      ...
      /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "h4", { style: { margin: 0, font: "inherit", color: "inherit" }, children: /* @__PURE__ */ _jsxruntime.jsxs.call(void 0,
        "button",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunk3YG66XT2cjs.Icon, { name: expanded ? "chevron-up-small" : "chevron-down-small", size: 16, "aria-hidden": "true" })
          ]
        }
      ) })
...
function SelectionInspector({
  ...
  const hasMenu = hasItem && (_nullishCoalesce(_optionalChain([menuItems, 'optionalAccess', _92 => _92.length]), () => ( 0))) > 0;
  const selectionName = count > 1 ? `${count}\uAC1C \uAC1D\uCCB4 \uC120\uD0DD` : _optionalChain([item, 'optionalAccess', _93 => _93.label]);
    ...
    hasMenu && /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
      DropdownMenu,
      {
        ...
        trigger: (
          ...
          /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunk4LVUUV5Fcjs.IconButton, { type: "button", size: "sm", variant: "plain", round: false, label: menuLabel, children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunk3YG66XT2cjs.Icon, { name: "more-vertical", size: 16, "aria-hidden": "true" }) })
        )
      }
    ),
    canClearSelection && /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
      _chunk4LVUUV5Fcjs.IconButton,
      {
        type: "button",
        size: "sm",
        variant: "plain",
        ...
        children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunk3YG66XT2cjs.Icon, { name: "close", size: 16, "aria-hidden": "true" })
      }
    )
  ] }) : null;
    ...
    "section",
    {
      ...
      children: [
        /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "header", { style: { display: "grid", gap: "var(--space-2)", minWidth: 0, padding: headerHasContent ? "var(--space-3) var(--space-4)" : 0, borderBottom: headerHasContent ? "1px solid var(--color-semantic-line-normal-normal)" : "none", boxSizing: "border-box" }, children: [
          ...
          hasItem && /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "div", { style: { display: "grid", gap: "var(--space-2)", minWidth: 0 }, children: [
            ...
            /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "div", { style: { display: "flex", alignItems: "center", gap: "var(--space-2)", minWidth: 0, flexWrap: "wrap" }, children: [
              ...
              item.status != null && (item.statusPresentation === "indicator" ? /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkWFEHGJNAcjs.StatusIndicator, { tone: item.statusTone || "signal", children: item.status }) : /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkE6D6YGBXcjs.StatusBadge, { tone: item.statusTone || "signal", children: item.status }))
            ] })
          ] })
        ] }),
        /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "div", { style: { minHeight: 0, overflow: "auto", padding: hasItem ? "0 var(--space-4) var(--space-4)" : "var(--space-4)", boxSizing: "border-box" }, children: hasItem ? /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, _jsxruntime.Fragment, { children: [
          ...
          /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunk3YG66XT2cjs.Icon, { name: "crosshair", size: 24, "aria-hidden": "true" }),
...
//# sourceMappingURL=chunk-TRMNY35F.cjs.map