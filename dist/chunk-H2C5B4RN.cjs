...
function RailItemTooltip({ label, collapsed, children }) {
  ...
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkEBCBZ7WPcjs.Tooltip, { content: label, placement: "right", size: "small", open: collapsed ? open : false, onOpenChange: setOpen, style: { width: "100%" }, children });
}
function SideNav({
  items = [],
  value,
...
//# sourceMappingURL=chunk-H2C5B4RN.cjs.map