...
var _chunkPDGU2GE6cjs = require('./chunk-PDGU2GE6.cjs');
...
var _chunkTGRNUIFMcjs = require('./chunk-TGRNUIFM.cjs');


var _chunk3H3EZZTFcjs = require('./chunk-3H3EZZTF.cjs');


var _chunkJPRLXPYNcjs = require('./chunk-JPRLXPYN.cjs');
...
function useMenuKeyboard({ open, onClose, getTrigger, menuKey = 0, zIndex, focusOnOpen = true }) {
  const { zIndex: resolvedZIndex, isTopmost } = _chunkTGRNUIFMcjs.useOverlayLayer.call(void 0, { open, zIndex });
...
function useSubmenuBranch({ disabled = false } = {}) {
  ...
  const renderPanel = (children, panelStyle) => {
    if (!open) return null;
    return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkTGRNUIFMcjs.OverlayPortal, { open, anchorRef: triggerRef, layer: "anchored", children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
      "div",
      {
        ref: panelRef,
        "data-menu-portal": "",
...
// packages/core/dist/chunk-IZ34KH4H.js
...
var Button = _react2.default.forwardRef(function Button2({
  ...
  const composed = {
    ..._chunkTGRNUIFMcjs.componentVars.call(void 0, vars, "--lds-button-"),
    display: "inline-flex",
    alignItems: "center",
    ...
    ..._chunkTGRNUIFMcjs.partStyle.call(void 0, styles, "root"),
    ...style
  };
  const Comp = as;
  return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0,
    Comp,
    {
      ...
      className: _chunkTGRNUIFMcjs.partClassName.call(void 0, classNames, "root", "lk-btn", `lk-btn--${wdsVariant}`, className),
      style: composed,
      ...
      children: [
        loading === true && /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, _jsxruntime.Fragment, { children: [
          /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
            "span",
            {
              "aria-hidden": "true",
              "data-slot": "loader",
              className: _chunkTGRNUIFMcjs.partClassName.call(void 0, classNames, "loader") || void 0,
              style: { position: "absolute", inset: 0, display: "inline-flex", alignItems: "center", justifyContent: "center", ..._chunkTGRNUIFMcjs.partStyle.call(void 0, styles, "loader") },
              children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkPDGU2GE6cjs.Spinner, { size: 16, color: "currentColor" })
            }
          ),
        ...
        /* @__PURE__ */ _jsxruntime.jsxs.call(void 0,
          ...
          {
            "data-slot": "content",
            className: _chunkTGRNUIFMcjs.partClassName.call(void 0, classNames, "content") || void 0,
            ...
            style: {
              ...
              ..._chunkTGRNUIFMcjs.partStyle.call(void 0, styles, "content")
            },
            children: [
              loadingInline && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "span", { "aria-hidden": "true", style: { display: "inline-flex" }, children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkPDGU2GE6cjs.Spinner, { size: 14, color: "currentColor" }) }),
              content
            ]
          }
        )
...
// packages/core/dist/chunk-QH335PZD.js
...
function CheckMark({ variant, checked, disabled }) {
  ...
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
    "span",
    {
      ...
      children: checked && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkJPRLXPYNcjs.Icon, { name: "check", size: 11, "aria-hidden": "true" })
    }
  );
}
...
function MenuItemButton({ item, variant, itemMetrics, onSelect, trailing, haspopup, onTriggerKeyDown, classNames, styles }) {
  ...
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
    "button",
    {
      ...
      className: _chunkTGRNUIFMcjs.partClassName.call(void 0, classNames, "item", item.className) || void 0,
      type: "button",
      ...
      style: { ...menuItemVisualStyle({ selected: current, checked, hovered: hover, disabled, danger: item.danger, hasDescription: Boolean(description), metrics: itemMetrics }), ..._chunkTGRNUIFMcjs.partStyle.call(void 0, styles, "item"), ...item.style },
      children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, MenuItemContent, { item, variant, checked, disabled, description, trailing })
    }
  );
}
var SUBMENU_CHEVRON = /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkJPRLXPYNcjs.Icon, { name: "chevron-right-small", size: 16, "aria-hidden": "true", style: { flexShrink: 0, color: "var(--color-semantic-label-alternative)" } });
function DrillHeader({ title, onBack, itemMetrics }) {
  return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0,
    "button",
    {
      ...
      children: [
        /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkJPRLXPYNcjs.Icon, { name: "chevron-left-small", size: 16, "aria-hidden": "true" }),
  ...
  return items.map((item, index) => {
    if (item.divider) {
      return /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
        ...
        {
          "data-slot": "divider",
          className: _chunkTGRNUIFMcjs.partClassName.call(void 0, ctx.classNames, "divider") || void 0,
          role: "separator",
          style: { height: 1, background: "var(--color-semantic-line-solid-normal)", margin: "6px 4px", ..._chunkTGRNUIFMcjs.partStyle.call(void 0, ctx.styles, "divider") }
        },
        index
      );
    }
      ...
      children: [
        /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
          "button",
          {
            ...
            disabled,
            ...sub.triggerHandlers,
            style: { ...menuItemVisualStyle({ active: sub.open, hovered: hover, disabled, danger: item.danger, hasDescription: Boolean(description), metrics: itemMetrics }), ..._chunkTGRNUIFMcjs.partStyle.call(void 0, styles, "item"), ...item.style },
            children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
              MenuItemContent,
              {
                ...
                disabled,
                description,
                trailing: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkJPRLXPYNcjs.Icon, { name: "chevron-right-small", size: 16, "aria-hidden": "true", style: { flexShrink: 0, color: "var(--color-semantic-label-alternative)" } })
              }
            )
          }
        ),
    ...
    if (item.divider) {
      return /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
        "div",
        {
          ...
          className: _chunkTGRNUIFMcjs.partClassName.call(void 0, ctx.classNames, "divider") || void 0,
          role: "separator",
          style: { height: 1, flexShrink: 0, background: "var(--color-semantic-line-solid-normal)", margin: "6px 4px", ..._chunkTGRNUIFMcjs.partStyle.call(void 0, ctx.styles, "divider") }
        },
        index
      );
    }
...
var DropdownMenu = _react2.default.forwardRef(function DropdownMenu2({
  ...
  const mergedRootRef = _chunkTGRNUIFMcjs.useMergedRefs.call(void 0, ref, forwardedRef);
  const panelRef = _react2.default.useRef(null);
  ...
  const position = _chunkTGRNUIFMcjs.useFloatingPosition.call(void 0, {
    open: visible,
    anchorRef: ref,
    panelRef,
  ...
  return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0,
    "div",
    {
      ...
      className: _chunkTGRNUIFMcjs.partClassName.call(void 0, classNames, "root", className) || void 0,
      style: { ..._chunkTGRNUIFMcjs.componentVars.call(void 0, vars, "--lds-dropdown-menu-"), position: "relative", display: "inline-block", ..._chunkTGRNUIFMcjs.partStyle.call(void 0, styles, "root"), ...style },
      ...rest,
      children: [
        /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
          "span",
          {
            "data-slot": "trigger",
            className: _chunkTGRNUIFMcjs.partClassName.call(void 0, classNames, "trigger") || void 0,
            style: { display: "inline-flex", ..._chunkTGRNUIFMcjs.partStyle.call(void 0, styles, "trigger") },
            children: renderedTrigger
          }
        ),
        /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkTGRNUIFMcjs.OverlayPortal, { open: visible, withinPortal, portalTarget, anchorRef: ref, layer: "anchored", children: /* @__PURE__ */ _jsxruntime.jsxs.call(void 0,
          "div",
          {
            ref: panelRef,
            "data-slot": "panel",
            ...
            className: _chunkTGRNUIFMcjs.partClassName.call(void 0, classNames, "panel") || void 0,
            "data-placement": position.placement,
            style: {
              ..._chunkTGRNUIFMcjs.componentVars.call(void 0, vars, "--lds-dropdown-menu-"),
              ...withinPortal ? { position: "fixed", top: _nullishCoalesce(position.y, () => ( -9999)), left: _nullishCoalesce(position.x, () => ( -9999)), right: "auto", bottom: "auto", translate: "none" } : _chunkTGRNUIFMcjs.inlineFloatingStyle.call(void 0, { placement: position.placement, align, offset, shiftX: position.shiftX, shiftY: position.shiftY }),
              ...
              flexDirection: "column",
              gap: "var(--component-menu-gap)",
              ..._chunkTGRNUIFMcjs.partStyle.call(void 0, styles, "panel")
            },
            children: [
              /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
                "div",
                {
                  ref: menuRef,
                  "data-slot": "menu",
                  className: _chunkTGRNUIFMcjs.partClassName.call(void 0, classNames, "menu", "lk-scroll-surface") || void 0,
                  ...
                  style: {
                    ...
                    ..._chunkTGRNUIFMcjs.partStyle.call(void 0, styles, "menu")
                  },
              ...
              showActionArea && /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
                "div",
                {
                  ...
                  className: _chunkTGRNUIFMcjs.partClassName.call(void 0, classNames, "actionArea") || void 0,
                  role: "group",
                  "aria-label": "\uBA54\uB274 \uC791\uC5C5",
                  ...
                  style: {
                    ...
                    flexShrink: 0,
                    ..._chunkTGRNUIFMcjs.partStyle.call(void 0, styles, "actionArea")
                  },
      ...
      /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "h4", { style: { margin: 0, font: "inherit", color: "inherit" }, children: /* @__PURE__ */ _jsxruntime.jsxs.call(void 0,
        "button",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkJPRLXPYNcjs.Icon, { name: expanded ? "chevron-up-small" : "chevron-down-small", size: 16, "aria-hidden": "true" })
          ]
        }
      ) })
  ...
  const controls = hasMenu || canClearSelection ? /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "span", { style: { display: "flex", alignItems: "center", gap: "var(--space-1)", marginInlineStart: "auto", flexShrink: 0 }, children: [
    hasMenu && /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
      DropdownMenu,
      {
        ...
        trigger: (
          ...
          /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunk3H3EZZTFcjs.IconButton, { type: "button", size: "sm", variant: "plain", round: false, label: menuLabel, children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkJPRLXPYNcjs.Icon, { name: "more-vertical", size: 16, "aria-hidden": "true" }) })
        )
      }
    ),
    canClearSelection && /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
      _chunk3H3EZZTFcjs.IconButton,
      {
        ...
        children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkJPRLXPYNcjs.Icon, { name: "close", size: 16, "aria-hidden": "true" })
      }
    )
  ] }) : null;
    ...
    "section",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "div", { style: { minHeight: 0, overflow: "auto", padding: hasItem ? "0 var(--space-4) var(--space-4)" : "var(--space-4)", boxSizing: "border-box" }, children: hasItem ? /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, _jsxruntime.Fragment, { children: [
          ...
          /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkJPRLXPYNcjs.Icon, { name: "crosshair", size: 24, "aria-hidden": "true" }),
...
//# sourceMappingURL=chunk-VBWEU6LE.cjs.map