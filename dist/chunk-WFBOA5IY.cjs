...
function SocialButton({
  ...
  return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, 
    Comp,
    {
      ...
      type: isNativeButton ? _nullishCoalesce(type, () => ( "button")) : void 0,
      ...
      ...rest,
      children: [
        /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkUTM2KZOScjs.BrandLogo, { name: provider, size: iconOnly ? 22 : 20, mono: p.mono, decorative: true, style: { flexShrink: 0 } }),
        !iconOnly && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "span", { children: _nullishCoalesce(children, () => ( labels[provider])) })
      ]
    }
  );
}
...
//# sourceMappingURL=chunk-WFBOA5IY.cjs.map