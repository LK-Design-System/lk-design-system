...
var LOG_TOOL_SIDE = "var(--component-icon-button-size-custom)";
function LogViewer({
  lines = [],
  filter = true,
  search = true,
  ...
  return /* @__PURE__ */ jsxs("div", { style: { display: "grid", gap: "var(--space-2)", width: "100%", maxWidth: "100%", fontFamily: "var(--font-sans)", ...style }, ...rest, children: [
    (streamStatus != null || lastUpdatedAt != null || droppedCount > 0) && /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", gap: "var(--space-3)", flexWrap: "wrap", color: "var(--color-semantic-label-neutral)", fontSize: "var(--caption1-size)" }, children: [
      /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", gap: "var(--space-2)", flexWrap: "wrap" }, children: [
        streamStatus != null && (() => {
          ...
          return /* @__PURE__ */ jsx(StatusIndicator, { tone: cfg.tone, pulse: cfg.pulse, "data-status": streamStatus, children: cfg.label });
        })(),
    ...
    (filter || search || tools) && /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap" }, children: [
      filter && /* @__PURE__ */ jsx("div", { style: { display: "flex", gap: "var(--space-1-5)", flexWrap: "wrap", flex: "1 1 220px" }, children: ORDER.map((lvl) => {
      ...
      tools && /* @__PURE__ */ jsxs("div", { role: "group", "aria-label": "\uB85C\uADF8 \uB3C4\uAD6C", style: { display: "inline-flex", gap: "var(--space-1-5)", flex: "0 0 auto" }, children: [
        /* @__PURE__ */ jsx(
          ToggleIcon,
          {
            size: "sm",
            ...
            children: /* @__PURE__ */ jsx(Icon, { name: paused ? "play" : "pause", size: 15, "aria-hidden": "true" })
          }
        ),
        /* @__PURE__ */ jsxs(
          IconButton,
          {
            ...
            children: [
              /* @__PURE__ */ jsx(Icon, { name: "arrow-down", size: 15, "aria-hidden": "true" }),
              /* @__PURE__ */ jsx("span", { "aria-hidden": "true", style: { position: "absolute", left: 8, right: 8, bottom: 6, height: 1.5, borderRadius: "var(--radius-pill)", background: "currentColor" } }),
              latestCount > 0 && /* @__PURE__ */ jsx("span", { "aria-hidden": "true", style: { position: "absolute", top: -5, right: -5, minWidth: 16, height: 16, padding: "0 4px", boxSizing: "border-box", borderRadius: "var(--radius-pill)", background: "var(--color-semantic-status-negative)", color: "var(--color-semantic-static-white)", fontSize: "var(--caption2-size)", lineHeight: "16px", fontWeight: "var(--fw-bold)" }, children: latestCount > 99 ? "99+" : `+${latestCount}` })
            ]
          }
        ),
        /* @__PURE__ */ jsx(IconButton, { variant: "ghost", round: false, size: "custom", label: "\uD45C\uC2DC \uB85C\uADF8 \uC9C0\uC6B0\uAE30", title: "\uD45C\uC2DC \uB85C\uADF8 \uC9C0\uC6B0\uAE30", disabled: currentLines.length === 0, onClick: clearVisible, children: /* @__PURE__ */ jsx(Icon, { name: "trash", size: 15, "aria-hidden": "true" }) }),
        onExport && /* @__PURE__ */ jsx(IconButton, { variant: "ghost", round: false, size: "custom", label: "\uB85C\uADF8 \uB0B4\uBCF4\uB0B4\uAE30", title: "\uB85C\uADF8 \uB0B4\uBCF4\uB0B4\uAE30", disabled: shown.length === 0, onClick: () => onExport(shown), children: /* @__PURE__ */ jsx(Icon, { name: "download", size: 15, "aria-hidden": "true" }) })
      ] })
    ] }),
...
//# sourceMappingURL=chunk-ITRQBSB3.js.map