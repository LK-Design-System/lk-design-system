  ...
  return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, 
    Row,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "dd", { style: { margin: 0, fontSize: "var(--fs-small)", fontWeight: "var(--fw-semibold)", lineHeight: "var(--lh-small)", letterSpacing: "var(--ls-small)", color: "var(--color-semantic-label-normal)", fontVariantNumeric: "tabular-nums", wordBreak: "keep-all" }, children: value })
      ]
    }
  );
}
...
//# sourceMappingURL=chunk-PGBTAKSU.cjs.map