...
function Spinner({ size, thickness, color = "var(--color-semantic-primary-normal)", label, variant = "circular", style, ...rest }) {
  ...
  if (variant === "brand") {
    ...
    return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "span", { role: "status", "aria-live": "polite", style: { display: "inline-flex", alignItems: "center", gap: 10, fontFamily: "var(--font-sans)", fontSize: "var(--label1-size)", color: "inherit", ...style }, ...rest, children: [
      mark,
...
//# sourceMappingURL=chunk-5BTJQMJB.cjs.map