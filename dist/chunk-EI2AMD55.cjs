...
function isPlainTextContent(content) {
  const nodes = _react2.default.Children.toArray(content);
  const plain = nodes.length > 0 && nodes.every((child) => typeof child === "string" || typeof child === "number");
  return plain && nodes.some((child) => typeof child === "number" || child.trim().length > 0);
}
function ConversationMessage({
  ...
  const defaultStatusLabel = lifecycleKind === "static" || lifecycleKind === "response" && lifecycleState === "complete" ? null : LIFECYCLE_LABELS[lifecycleKind][lifecycleState];
  const resolvedStatusLabel = statusLabel !== void 0 ? statusLabel : defaultStatusLabel;
  ...
  const bodySurfaceStyle = systemDirection ? {
    ...
    whiteSpace: solidSurface ? "pre-wrap" : void 0,
    overflowWrap: "anywhere",
    wordBreak: "break-word",
    color: solidSurface ? "var(--color-semantic-static-white)" : "var(--color-semantic-label-normal)",
    background: solidSurface ? "var(--color-semantic-primary-heavy)" : outbound ? "var(--color-semantic-primary-surface-normal)" : "var(--color-semantic-background-elevated-normal)",
    border: solidSurface ? "1px solid transparent" : "1px solid var(--color-semantic-line-normal-normal)",
  ...
  return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, 
    "article",
    {
      ...
      "data-source-presentation": Array.isArray(sources) && sources.length > 0 ? sourcePresentation : void 0,
      style: {
        display: "grid",
        gridTemplateColumns,
      ...
      children: [
              ...
              /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, 
                "span",
                {
                  ...
                  children: [
                    ...
                    timestamp != null && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
                      "time",
                      {
                        dateTime,
                        style: {
        ...
        systemDirection ? /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "div", { "data-message-part": "body", "data-message-surface": true, "data-message-surface-variant": "system", style: bodySurfaceStyle, children: [
          ...
          /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "div", { style: { minWidth: 0, maxWidth: "min(42rem, calc(100% - 64px))", overflowWrap: "anywhere" }, children }),
          /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "span", { "aria-hidden": "true", style: { flex: "1 1 0", minWidth: "var(--space-4)", height: 1, background: "var(--color-semantic-line-normal-alternative)" } })
        ] }) : /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "div", { "data-message-part": "body", "data-message-surface": true, "data-message-surface-variant": variant, style: bodySurfaceStyle, children }),
        ...
        lifecycleKind !== "response" && statusPart,
        hasActions && /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, 
          "div",
          {
            ...
            children: [
              actions,
              canRetry && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunk3BBCS67Wcjs.Button, { size: "sm", variant: "ghost", onClick: () => onRetry(), children: retryLabel }),
              canStop && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunk3BBCS67Wcjs.Button, { size: "sm", variant: "ghost", onClick: () => onStop(), children: stopLabel })
            ]
          }
        )
      ]
...
//# sourceMappingURL=chunk-EI2AMD55.cjs.map