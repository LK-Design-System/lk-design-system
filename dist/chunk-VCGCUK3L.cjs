...
function Textarea({
  ...
  usePlaceholderStyle();
  const ring = _chunk4KUVQPIKcjs.fieldBorderColor.call(void 0, { disabled, readOnly, invalid: isInvalid, status, focused: activeFocus, hovered: activeHover });
  ...
  return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "div", { "data-readonly": readOnly ? "true" : void 0, style: { display: "flex", flexDirection: "column", gap: "var(--component-input-stack-gap)", ...style }, children: [
    /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunk4KUVQPIKcjs.FieldLabel, { htmlFor: taId, label, required }),
    /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "div", { style: { position: "relative" }, children: [
      /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
        "textarea",
        {
          ...
          readOnly,
          required,
          "aria-describedby": _chunk4KUVQPIKcjs.mergeIds.call(void 0, rest["aria-describedby"], messageId),
          ...
          style: {
            ...
            background: _chunk4KUVQPIKcjs.fieldBackground.call(void 0, { disabled, readOnly }),
      ...
      (isInvalid || status === "positive") && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "span", { style: { position: "absolute", top: "var(--space-3)", right: "var(--space-3)", display: "inline-flex", pointerEvents: "none" }, children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunk4KUVQPIKcjs.FieldStatusIcon, { invalid: isInvalid, status }) })
    ] }),
...
//# sourceMappingURL=chunk-VCGCUK3L.cjs.map