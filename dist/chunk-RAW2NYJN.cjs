...
function UserMenu({ name, detail, src, status, items = [], collapsed = false, viewportPadding = 12, style, ...rest }) {
  ...
  const { menuRef, requestItemFocus, closeMenu, handleMenuKeyDown } = _chunk3XBWOCOFcjs.useMenuKeyboard.call(void 0, {
    open,
  ...
  return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "div", { ref, style: { position: "relative", ...style }, ...rest, children: [
    ...
    /* @__PURE__ */ _jsxruntime.jsxs.call(void 0,
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunk4RSJTSP6cjs.Avatar, { name: typeof name === "string" ? name : void 0, src, status, size: 30, style: { flexShrink: 0 } }),
          !collapsed && /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "span", { style: { flex: 1, minWidth: 0, display: "flex", flexDirection: "column", gap: "var(--space-0-5)" }, children: [
            /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "span", { style: { fontSize: "var(--label2-size)", fontWeight: "var(--fw-bold)", letterSpacing: 0, color: "var(--component-user-menu-label, var(--color-semantic-label-normal))", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }, children: name }),
            detail != null && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "span", { style: { fontSize: "var(--caption1-size)", color: "var(--component-user-menu-detail, var(--color-semantic-label-alternative))", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }, children: detail })
          ] }),
          !collapsed && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunk7OXVB7WXcjs.Icon, { name: "chevron-up-small", size: 14, color: "var(--component-user-menu-indicator, var(--color-semantic-label-assistive))", "aria-hidden": "true", style: { flexShrink: 0, transform: open ? "rotate(180deg)" : "none", transition: "transform var(--dur-fast) var(--ease-out)" } })
        ]
      }
    )
  ] });
...
//# sourceMappingURL=chunk-RAW2NYJN.cjs.map