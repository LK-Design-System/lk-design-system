  ...
  return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, 
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "span", { style: { position: "relative", width: size, height: size, flexShrink: 0 }, children: [
          /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "svg", { "aria-hidden": "true", focusable: "false", width: size, height: size, style: { display: "block", transform: "rotate(-90deg)" }, children: [
            /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "circle", { cx: size / 2, cy: size / 2, r, fill: "none", stroke: "var(--color-semantic-fill-strong)", strokeWidth: thickness }),
            hasPositiveTotal && segments.map((segment, index) => {
              ...
              const el = /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
                ...
                _nullishCoalesce(segment.id, () => ( index))
              );
              offset += dash;
              return el;
            })
        ...
        legend && segments.length > 0 && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "div", { "aria-hidden": "true", style: { display: "flex", flex: "1 1 132px", minWidth: 0, flexDirection: "column", gap: 8 }, children: segments.map((segment, index) => {
          const percentage = hasPositiveTotal ? Math.round(values[index] / total * 100) : 0;
          return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "span", { style: { display: "grid", gridTemplateColumns: "10px minmax(0, 1fr) auto", alignItems: "center", gap: 8, minWidth: 0, fontFamily: "var(--font-sans)", fontSize: "var(--label2-size)", color: "var(--color-semantic-label-neutral)" }, children: [
            /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "span", { style: { width: 10, height: 10, borderRadius: 3, background: segment.color || PALETTE[index % PALETTE.length] } }),
            /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "span", { "data-chart-label": true, style: { minWidth: 0, lineHeight: "var(--label2-line)", overflowWrap: "anywhere" }, children: segment.label }),
            /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "b", { style: { marginLeft: "var(--space-0-5)", color: "var(--color-semantic-label-normal)", fontVariantNumeric: "tabular-nums" }, children: [
              percentage,
              "%"
            ] })
          ] }, _nullishCoalesce(segment.id, () => ( index)));
...
//# sourceMappingURL=chunk-2BVPYW2P.cjs.map