...
var LANE_ENDPOINT_ORIENTATION_ARROW = "M -5 0 H 5 M 2 -3 L 5 0 L 2 3";
...
function LaneOverlay({
  ...
  const directionMaskId = `lk-lane-direction-${_react2.default.useId().replace(/[^a-zA-Z0-9_-]/g, "")}`;
  ...
  return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, 
    "g",
    {
      ...
      onFocus: (event) => {
        if (!pointerOnly) setHasFocus(_chunkAZGN4HJOcjs.isFocusVisibleTarget.call(void 0, event.currentTarget));
      ...
      children: [
        pathData && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "defs", { "aria-hidden": "true", children: /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "mask", { id: directionMaskId, maskUnits: "userSpaceOnUse", children: [
          /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
            "rect",
            {
          ...
          /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "g", { transform: `translate(${directionPoint.x} ${directionPoint.y}) rotate(${directionPoint.angle}) scale(${inverseScale})`, children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
            "rect",
            {
              "data-lane-direction-window": "",
              x: _chunkAZGN4HJOcjs.NAV_DIRECTION_CHEVRON.window.from,
              y: -_chunkAZGN4HJOcjs.NAV_DIRECTION_CHEVRON.window.clearWidth / 2,
              width: _chunkAZGN4HJOcjs.NAV_DIRECTION_CHEVRON.window.to - _chunkAZGN4HJOcjs.NAV_DIRECTION_CHEVRON.window.from,
              height: _chunkAZGN4HJOcjs.NAV_DIRECTION_CHEVRON.window.clearWidth,
              fill: "black"
            }
          ) })
        ] }) }),
        visibleFocus && pathData && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
          "path",
          {
            ...
            strokeWidth: _chunkAZGN4HJOcjs.NAV_FOCUS.pathHaloWidth,
            strokeLinecap: "round",
            strokeLinejoin: "round",
            vectorEffect: "non-scaling-stroke",
            pointerEvents: "none"
        ...
        selected && pathData && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
          "path",
          {
            ...
            strokeWidth: _chunkAZGN4HJOcjs.NAV_SELECTION.pathHaloWidth,
            strokeLinecap: "round",
            strokeLinejoin: "round",
            ...
            children: [
              ...
              /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
                "path",
                {
                  ...
                  d: _chunkAZGN4HJOcjs.NAV_DIRECTION_CHEVRON.path,
                  fill: "none",
                  stroke: baseColor,
                  strokeWidth: selected ? 3.5 : 2.5,
                  strokeLinecap: "round",
                ...
                children: [
                  ...
                  metadata && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
                    "text",
                    {
                      ...
                      fill: VIEWER_MUTED,
                      stroke: VIEWER_SURFACE,
                      strokeWidth: _chunkAZGN4HJOcjs.NAV_LABEL_HALO.secondary,
                      paintOrder: "stroke",
                      vectorEffect: "non-scaling-stroke",
                      fontFamily: "var(--font-sans)",
                      fontSize: "var(--caption2-size)",
...
//# sourceMappingURL=chunk-5BQLSE3L.cjs.map