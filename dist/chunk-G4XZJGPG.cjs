...
function Meter({
  ...
  return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "div", { style: { ...style }, ...rest, children: [
    showCaption && /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "div", { style: { display: "flex", justifyContent: "space-between", gap: 12, marginBottom: 6, fontFamily: "var(--font-sans)", fontSize: "var(--label2-size)", fontWeight: "var(--fw-semibold)", color: "var(--color-semantic-label-neutral)" }, children: [
...
exports.Meter = Meter;
//# sourceMappingURL=chunk-G4XZJGPG.cjs.map