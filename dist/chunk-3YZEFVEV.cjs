...
var _chunk26AXEFA6cjs = require('./chunk-26AXEFA6.cjs');
...
function Combobox({
  ...
  const {
    ...
    describedBy,
    hasMetadata
  } = _chunk26AXEFA6cjs.useFieldMetadata.call(void 0, { prefix: "combobox", id, label, helper, error, describedBy: ariaDescribedBy });
  ...
  const borderColor = _chunk26AXEFA6cjs.fieldBorderColor.call(void 0, { disabled, readOnly, invalid: isInvalid, status, focused: open, hovered });
        ...
        /* @__PURE__ */ _jsxruntime.jsxs.call(void 0,
          "button",
          {
            ...
            style: {
              ...
              background: _chunk26AXEFA6cjs.fieldBackground.call(void 0, { disabled, readOnly }),
              ...
              ..._chunk26AXEFA6cjs.fieldTypography.call(void 0, normalizedSize),
              textAlign: "left",
            ...
            children: [
              ...
              /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "span", { style: { display: "inline-flex", alignItems: "center", gap: "var(--space-2)", flex: "0 0 auto" }, children: [
                /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunk26AXEFA6cjs.FieldStatusIcon, { invalid: isInvalid, status }),
                /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunk7OXVB7WXcjs.Icon, { name: "chevron-down-small", size: 18, color: "var(--color-semantic-label-alternative)", "aria-hidden": "true", style: { transform: open ? "rotate(180deg)" : "none", transition: "var(--component-button-transition)" } })
              ] })
            ]
          }
        ),
            ...
            children: normalized.map((option, index) => {
              ...
              return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0,
                "div",
                {
                  ...
                  style: { display: "flex", alignItems: "center", gap: "var(--space-2)", padding: "9px 10px", borderRadius: "var(--radius-md)", background: selected ? "var(--color-semantic-primary-surface-strong)" : active ? "var(--color-semantic-fill-normal)" : "transparent", color: option.disabled ? "var(--color-semantic-label-disable)" : "var(--color-semantic-label-normal)", cursor: option.disabled ? "not-allowed" : "pointer", fontFamily: "var(--font-sans)", ..._chunk26AXEFA6cjs.fieldTypography.call(void 0, normalizedSize) },
                  children: [
                    /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "span", { "aria-hidden": "true", style: { width: 18, height: 18, borderRadius: "var(--radius-5)", border: `1.5px solid ${selected ? "var(--color-semantic-primary-normal)" : "var(--color-semantic-line-solid-normal)"}`, background: selected ? "var(--color-semantic-primary-normal)" : "var(--color-semantic-background-elevated-normal)", display: "inline-flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }, children: selected && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunk7OXVB7WXcjs.Icon, { name: "check", size: 16, color: "var(--color-semantic-static-white)", "aria-hidden": "true" }) }),
  ...
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunk26AXEFA6cjs.FieldStack, { fieldId, labelId, label, required, messageId, message, error, status, fieldStyle, children: control });
}



exports.Combobox = Combobox;
//# sourceMappingURL=chunk-3YZEFVEV.cjs.map