        ...
        /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "div", { style: { position: "relative", minWidth: 0 }, children: [
          /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, 
            "div",
            {
              ...
              children: [
                selectedOptions.map((option) => /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, _chunk53XYQH2Kcjs.Chip, { size: "sm", variant: "outlined", disabled, style: { maxWidth: "100%", paddingRight: locked ? void 0 : "var(--space-0)" }, children: [
                  ...
                  !locked && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
                    _chunkS7GFPUQYcjs.IconButton,
                    {
                      ...
                      children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkVGM7HVYYcjs.Icon, { name: "close", size: 14, "aria-hidden": "true" })
                    }
                  )
                ] }, String(option.value))),
          ...
          popupOpen && /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "div", { style: { position: "absolute", zIndex: 40, left: 0, right: 0, top: "calc(100% + 6px)", padding: 6, display: "grid", gap: 2, boxSizing: "border-box", border: "1px solid var(--color-semantic-line-solid-normal)", borderRadius: "var(--radius-lg)", background: "var(--color-semantic-background-elevated-normal)", boxShadow: "var(--shadow-md)" }, children: [
            /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "div", { id: listboxId, role: "listbox", "aria-multiselectable": "true", "aria-busy": loading || void 0, style: { maxHeight: 248, overflowY: "auto", display: "flex", flexDirection: "column", gap: 2 }, children: hasOptionList && filteredOptions.map((option, index) => {
              ...
              return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, 
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "span", { "aria-hidden": "true", style: { display: "grid", placeItems: "center", width: 18, height: 18, boxSizing: "border-box", border: `1.5px solid ${selectedOption ? "var(--color-semantic-primary-normal)" : "var(--color-semantic-line-solid-normal)"}`, borderRadius: "var(--radius-5)", background: selectedOption ? "var(--color-semantic-primary-normal)" : "var(--color-semantic-background-elevated-normal)", color: "var(--color-semantic-static-white)" }, children: selectedOption && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkVGM7HVYYcjs.Icon, { name: "check", size: 12, "aria-hidden": "true" }) }),
            ...
            !hasOptionList && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "div", { role: "status", "aria-live": "polite", style: { padding: "var(--space-4)", color: "var(--color-semantic-label-neutral)", fontSize: "var(--label1-size)", textAlign: "center" }, children: loading ? loadingLabel : emptyLabel }),
            hasOptionList && maxReached && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "div", { role: "status", "aria-live": "polite", style: { padding: "var(--space-2) var(--space-3)", borderTop: "1px solid var(--color-semantic-line-normal-neutral)", color: "var(--color-semantic-label-neutral)", fontSize: "var(--caption1-size)" }, children: resolvedMaxLabel })
          ] })
        ] }),
...
//# sourceMappingURL=chunk-TJXF5RNK.cjs.map