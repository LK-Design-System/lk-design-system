...
var Input = _react2.default.forwardRef(function Input2({
  ...
  usePlaceholderStyle();
  const ring = _chunkZF2ZP65Lcjs.fieldBorderColor.call(void 0, { disabled, readOnly, invalid: isInvalid, status, focused: activeFocus, hovered: activeHover });
  ...
  return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0,
    "div",
    {
      ...
      children: [
            ...
            children: [
              ...
              /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
                "input",
                {
                  ...
                  "aria-describedby": _chunkZF2ZP65Lcjs.mergeIds.call(void 0, rest["aria-describedby"], messageId),
                  ...
                  style: { flex: 1, minWidth: 0, height: "100%", boxSizing: "border-box", border: "none", outline: "none", background: "transparent", cursor: disabled ? "not-allowed" : readOnly ? "text" : void 0, fontFamily: "var(--font-sans)", ..._chunkZF2ZP65Lcjs.fieldTypography.call(void 0, normalizedSize), color: disabled ? "var(--color-semantic-label-disable)" : "var(--color-semantic-label-normal)", ..._chunkGWMGPLNWcjs.partStyle.call(void 0, styles, "input"), ...inputStyle }
                }
              ),
        ...
        /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkZF2ZP65Lcjs.FieldMessage, { "data-slot": "message", className: _chunkGWMGPLNWcjs.partClassName.call(void 0, classNames, "message") || void 0, style: _chunkGWMGPLNWcjs.partStyle.call(void 0, styles, "message"), id: messageId, message, error, status })
      ]
    }
  );
});
...
exports.Input = Input;
//# sourceMappingURL=chunk-R6V73WR5.cjs.map