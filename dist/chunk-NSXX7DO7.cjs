  ...
  const renderStepBtn = (kind) => {
    ...
    return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
      "button",
      {
        ...
        children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunk3ATRKSQ7cjs.Icon, { name: isMinus ? "minus" : "plus", size: 18, "aria-hidden": "true" })
      },
      kind
    );
  };
...
//# sourceMappingURL=chunk-NSXX7DO7.cjs.map