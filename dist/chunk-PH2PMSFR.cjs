...
function PropertyField({
  ...
  const { fieldId: inputId } = _chunkDSYH34X7cjs.useFieldMetadata.call(void 0, { prefix: "property" });
  ...
  const descriptionIds = _chunkDSYH34X7cjs.mergeIds.call(void 0, hintId, unitId, dirty ? dirtyId : null);
  const apply = () => {
...
//# sourceMappingURL=chunk-PH2PMSFR.cjs.map