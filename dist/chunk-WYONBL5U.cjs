...
function TrajectoryOverlay({
  ...
  return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, 
    "g",
    {
      ...
      "data-trajectory-id": _optionalChain([trajectory, 'optionalAccess', _15 => _15.id]),
      "data-map-id": _optionalChain([trajectory, 'optionalAccess', _16 => _16.mapId]),
      "data-trajectory-status": _optionalChain([trajectory, 'optionalAccess', _17 => _17.status]),
      ...
      "aria-label": _nullishCoalesce(ariaLabel, () => ( trajectoryAccessibleName(trajectory, selected, invalid, stale))),
      ...
      onFocus: (event) => {
        setHasDomFocus(true);
        _optionalChain([onFocus, 'optionalCall', _18 => _18(event)]);
      },
      onBlur: (event) => {
        setHasDomFocus(false);
        _optionalChain([onBlur, 'optionalCall', _19 => _19(event)]);
      },
      style: {
      ...
      children: [
        ...
        pathData && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
          "path",
          {
            ...
            fill: "none",
            stroke: tone,
            strokeWidth: selected || _optionalChain([trajectory, 'optionalAccess', _20 => _20.status]) === "active" ? 3.5 : 2.5,
        ...
        pathData && currentSample && /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, 
          "g",
          {
            ...
            children: [
              ...
              headingDegrees == null ? /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "circle", { r: "3", fill: tone }) : /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
                "path",
                {
        ...
        pathData && /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, 
          "g",
          {
            ...
            "data-trajectory-status-glyph": _optionalChain([trajectory, 'optionalAccess', _21 => _21.status]),
            ...
            children: [
              ...
              /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "text", { x: "0", y: "3", textAnchor: "middle", fill: tone, fontFamily: "var(--font-sans)", fontSize: "9", fontWeight: "var(--fw-bold)", children: _nullishCoalesce(STATUS_GLYPH[_optionalChain([trajectory, 'optionalAccess', _22 => _22.status])], () => ( "\u2022")) })
            ]
          }
        ),
        showLabel && _optionalChain([trajectory, 'optionalAccess', _23 => _23.label]) && pathData && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
          "text",
          {
...
//# sourceMappingURL=chunk-WYONBL5U.cjs.map