...
function Bubble({ children, tone = "navy", tail = "bottom", style, ...rest }) {
  ...
  const fg = dark ? "var(--color-semantic-brand-on-surface)" : "var(--color-semantic-label-normal)";
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        children,
        /* @__PURE__ */ jsx("span", { style: tails[tail] || tails.bottom })
      ]
    }
  );
}
...
//# sourceMappingURL=chunk-BWQZ5HKZ.js.map