  ...
  if (showFollow || showMenu) {
    trailing = /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "div", { style: { display: "flex", alignItems: "center", gap: "var(--space-2)", marginLeft: "var(--space-2)" }, children: [
      ...
      showMenu && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
        _chunkHK5EYES2cjs.DropdownMenu,
        {
          align: "right",
          items: menuItems,
          trigger: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkNFE2XSRZcjs.IconButton, { variant: "plain", round: true, size: "sm", label: menuLabel, style: { color: "var(--color-semantic-label-alternative)" }, children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkX5XHQEI5cjs.Icon, { name: "more-vertical", size: 20, "aria-hidden": "true" }) })
        }
      )
    ] });
  }
...
//# sourceMappingURL=chunk-RDR6H4DS.cjs.map