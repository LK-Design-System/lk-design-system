...
function Avatar({
  ...
  const statusColor = status === "online" ? "var(--color-semantic-primary-normal)" : status === "busy" ? "var(--color-semantic-status-negative-foreground)" : "var(--color-semantic-interaction-inactive)";
      ...
      children: [
        src ? /* @__PURE__ */ jsx(
          ...
          "span",
          {
            ...
            children: showInitials ? initials : /* @__PURE__ */ jsx(
              PlaceholderGlyph,
              {
        ...
        renderAlternativeText && alternatives.map((text, index) => /* @__PURE__ */ jsx(VisuallyHidden, { id: alternativeIds[index], children: text }, alternativeIds[index])),
        showPushBadge && /* @__PURE__ */ jsx(
          "span",
          {
            "aria-hidden": "true",
            style: {
...
//# sourceMappingURL=chunk-X7J7UK5X.js.map