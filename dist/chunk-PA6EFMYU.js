...
function Lockup({ variant = "inline", tone = "ink", adaptive = false, color, height, title, decorative = false, style, ...rest }) {
  ...
  const fill = color || (tone === "white" ? LK_LOGO_COLORS.white : tone === "current" ? "currentColor" : adaptive ? `var(--component-lockup-auto-fill, ${LK_LOGO_COLORS.navy})` : LK_LOGO_COLORS.navy);
...
//# sourceMappingURL=chunk-PA6EFMYU.js.map