...
function PropertyField({
  ...
  const { fieldId: inputId } = _chunk26AXEFA6cjs.useFieldMetadata.call(void 0, { prefix: "property" });
  ...
  const descriptionIds = _chunk26AXEFA6cjs.mergeIds.call(void 0, hintId, unitId, dirty ? dirtyId : null);
  const apply = () => {
              ...
              /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
                "input",
                {
                  ...
                  style: {
                    ...
                    height: 34,
                    padding: "0 10px",
                    border: `1px solid ${focused ? "var(--component-input-border-color-focus)" : dirty ? "var(--color-semantic-status-cautionary-foreground)" : "var(--component-input-border-color)"}`,
...
//# sourceMappingURL=chunk-NN3OQ2FZ.cjs.map