...
function Combobox({
  ...
  const {
    ...
    describedBy,
    hasMetadata
  } = _chunk3NOYASLPcjs.useFieldMetadata.call(void 0, { prefix: "combobox", id, label, helper, error, describedBy: ariaDescribedBy });
  ...
  const borderColor = _chunk3NOYASLPcjs.fieldBorderColor.call(void 0, { disabled, readOnly, invalid: isInvalid, status, focused: open, hovered });
          ...
          "button",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "span", { style: { display: "inline-flex", alignItems: "center", gap: "var(--space-2)", flex: "0 0 auto" }, children: [
                /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunk3NOYASLPcjs.FieldStatusIcon, { invalid: isInvalid, status }),
  ...
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunk3NOYASLPcjs.FieldStack, { fieldId, labelId, label, required, messageId, message, error, status, fieldStyle, children: control });
}



exports.Combobox = Combobox;
//# sourceMappingURL=chunk-KGE7L363.cjs.map