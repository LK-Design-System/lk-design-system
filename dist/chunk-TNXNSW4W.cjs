...
function CheckboxGroup({ options = [], value, defaultValue = [], onChange, direction = "column", size, style, ...rest }) {
  ...
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "div", { role: "group", "data-size": compact ? "sm" : "md", style: { display: "flex", flexDirection: direction === "row" ? "row" : "column", gap: direction === "row" ? compact ? 16 : 20 : compact ? 12 : 14, flexWrap: "wrap", ...style }, ...rest, children: norm.map((o) => {
    const on = Array.isArray(val) && val.includes(o.value);
    return /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
      _chunkUYWU6OVTcjs.Checkbox,
      {
        value: o.value,
        checked: on,
        disabled: o.disabled,
...
//# sourceMappingURL=chunk-TNXNSW4W.cjs.map