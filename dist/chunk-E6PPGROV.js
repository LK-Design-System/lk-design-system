...
function MoveButton({ direction, label, disabled, onClick }) {
  ...
  return /* @__PURE__ */ jsx(
    "button",
    {
      ...
      children: /* @__PURE__ */ jsx(Icon, { name: icon, size: 15, "aria-hidden": "true" })
    }
  );
}
function ReorderList({
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx("span", { id: instructionId, style: hiddenStyle, children: "Alt\uC640 \uC704\uCABD \uB610\uB294 \uC544\uB798\uCABD \uD654\uC0B4\uD45C \uD0A4\uB85C \uD56D\uBAA9 \uC21C\uC11C\uB97C \uBC14\uAFC0 \uC218 \uC788\uC2B5\uB2C8\uB2E4." }),
    /* @__PURE__ */ jsx("span", { id: liveId, role: "status", "aria-live": "polite", style: hiddenStyle, children: announcement }),
    /* @__PURE__ */ jsxs(
      "ul",
      {
        role,
          ...
          items.map((item, index) => {
            ...
            return /* @__PURE__ */ jsxs(
              "li",
              {
                ...
                children: [
                  (dropBefore || dropAfter) && /* @__PURE__ */ jsx(
                    "span",
                    {
                      "aria-hidden": "true",
                      style: {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ jsx(
                          "span",
                          {
                            ...
                            children: /* @__PURE__ */ jsx(Icon, { name: "handle", size: 18, "aria-hidden": "true" })
                          }
                        ),
                        showIndex && /* @__PURE__ */ jsx(
                          "span",
                          {
                            "aria-hidden": "true",
                            style: {
                        ...
                        (item.trailing != null || showMoveButtons) && /* @__PURE__ */ jsxs(
                          "span",
                          {
                            style: {
                              display: "inline-flex",
                            ...
                            children: [
                              item.trailing != null && /* @__PURE__ */ jsx("span", { style: { minWidth: 0, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }, children: item.trailing }),
                              showMoveButtons && /* @__PURE__ */ jsxs("span", { style: { display: "inline-flex", alignItems: "center", gap: 4, flexShrink: 0 }, children: [
                                /* @__PURE__ */ jsx(
                                  MoveButton,
                                  {
                                    direction: "up",
...
//# sourceMappingURL=chunk-E6PPGROV.js.map