  ...
  const stars = Array.from({ length: max }).map((_, i) => {
    ...
    return /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
      "span",
      {
        ...
        children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkVHQHPPYQcjs.Icon, { name: filled ? "star-fill" : "star", size, "aria-hidden": "true" })
      },
      i
    );
  });
...
//# sourceMappingURL=chunk-ANZ6JOVD.cjs.map