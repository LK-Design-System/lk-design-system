...
function Map2DCanvas({
  ...
  const interactionState = _chunkGG7OZWPGcjs.resolveViewerState.call(void 0, {
    state,
    availability,
    connection,
    freshness,
  ...
  const interactionBlocked = _chunkGG7OZWPGcjs.VIEWER_BLOCKING_STATES.includes(interactionState);
  const {
    rootRef,
    renderedViewport,
    commitViewport,
...
//# sourceMappingURL=chunk-JLGGB2F6.cjs.map