...
function useSubmenuBranch({ disabled = false } = {}) {
  ...
  const { menuRef, requestItemFocus, handleMenuKeyDown, zIndex } = _chunk3XBWOCOFcjs.useMenuKeyboard.call(void 0, {
    open,
  ...
  const renderPanel = (children, panelStyle) => {
    if (!open) return null;
    return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkXGKLO45Tcjs.OverlayPortal, { open, anchorRef: triggerRef, layer: "anchored", children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
      "div",
      {
        ref: panelRef,
        "data-menu-portal": "",
...
//# sourceMappingURL=chunk-3H62VNPD.cjs.map