  ...
  return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, 
    "g",
    {
      ...
      onFocus: !hiddenFromAccessibility ? (event) => {
        setHasDomFocus(_chunkRP2TJYB7cjs.isFocusVisibleTarget.call(void 0, event.currentTarget));
          ...
          return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, 
            "g",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkHFPBSCJZcjs.NavigationStateGlyph, { kind: item.glyphKind, size: 10, color: foreground })
              ]
            },
            item.state
          );
...
//# sourceMappingURL=chunk-FZG2EFUX.cjs.map