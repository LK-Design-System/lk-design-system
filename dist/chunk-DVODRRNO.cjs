...
function IconButton({ label, icon, active = false, disabled = false, rail = false, children, onClick }) {
  return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, 
    "button",
    {
      ...
      children: [
        /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkVGM7HVYYcjs.Icon, { name: icon, size: 15, "aria-hidden": "true" }),
...
function LogViewer({
  ...
  const shown = _react2.default.useMemo(() => sourceLines.filter((line) => {
  ...
  return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "div", { style: { display: "grid", gap: "var(--space-2)", width: "100%", maxWidth: "100%", fontFamily: "var(--font-sans)", ...style }, ...rest, children: [
    (streamStatus != null || lastUpdatedAt != null || droppedCount > 0) && /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "div", { role: "status", "aria-live": "polite", style: { display: "flex", alignItems: "center", justifyContent: "space-between", gap: "var(--space-3)", flexWrap: "wrap", color: "var(--color-semantic-label-neutral)", fontSize: "var(--caption1-size)" }, children: [
      /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "div", { style: { display: "flex", alignItems: "center", gap: "var(--space-2)", flexWrap: "wrap" }, children: [
        streamStatus != null && (() => {
          ...
          return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunk3ECMDGKZcjs.StatusBadge, { tone: cfg.tone, pulse: cfg.pulse, "data-status": streamStatus, children: cfg.label });
        })(),
    ...
    (filter || search || tools) && /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "div", { style: { display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap" }, children: [
      filter && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "div", { style: { display: "flex", gap: 6, flexWrap: "wrap", flex: "1 1 220px" }, children: ORDER.map((lvl) => {
      ...
      search && /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "label", { style: { flex: "1 1 180px", maxWidth: 260, minWidth: 160, height: 28, display: "inline-flex", alignItems: "center", gap: 7, padding: "0 9px", boxSizing: "border-box", border: "1px solid var(--color-semantic-line-normal-normal)", borderRadius: "var(--radius-sm)", background: "var(--color-semantic-background-elevated-normal)", color: "var(--color-semantic-label-assistive)" }, children: [
        /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkVGM7HVYYcjs.Icon, { name: "search", size: 14, "aria-hidden": "true" }),
        ...
        query && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "button", { type: "button", "aria-label": "\uAC80\uC0C9\uC5B4 \uC9C0\uC6B0\uAE30", onClick: () => setQuery(""), style: { width: 18, height: 18, border: "none", background: "transparent", color: "var(--color-semantic-label-assistive)", cursor: "pointer", padding: 0, display: "inline-flex", alignItems: "center", justifyContent: "center" }, children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkVGM7HVYYcjs.Icon, { name: "close", size: 12, "aria-hidden": "true" }) })
      ] }),
      tools && /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "div", { role: "group", "aria-label": "\uB85C\uADF8 \uB3C4\uAD6C", style: { display: "inline-flex", gap: 6, flex: "0 0 auto" }, children: [
        ...
        return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "div", { style: { display: "grid", gridTemplateColumns, columnGap: 10, alignItems: "baseline", minHeight: metrics.rowMinHeight, height: virtualActive ? rowHeight : void 0, overflow: virtualActive ? "hidden" : void 0, whiteSpace: virtualActive || !wrap ? "nowrap" : "pre-wrap", wordBreak: virtualActive || !wrap ? "normal" : "break-word" }, children: [
          ...
          copyable && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
            "button",
            {
              ...
              children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkVGM7HVYYcjs.Icon, { name: copied ? "circle-check" : "copy", size: 14, "aria-hidden": "true" })
            }
          )
        ] }, index);
      }),
...
//# sourceMappingURL=chunk-DVODRRNO.cjs.map