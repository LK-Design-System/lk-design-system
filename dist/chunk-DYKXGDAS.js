  ...
  return /* @__PURE__ */ jsxs(
    "a",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs("div", { style: { position: "relative", padding: "16px", display: "flex", flexDirection: "column", gap: 8 }, children: [
          /* @__PURE__ */ jsxs("div", { style: { display: "flex", flexDirection: "column", gap: 3 }, children: [
            category && /* @__PURE__ */ jsx("span", { style: { fontSize: "var(--caption1-size)", lineHeight: "var(--caption1-line)", fontWeight: "var(--fw-bold)", letterSpacing: "var(--ls-overline)", textTransform: "uppercase", color: "var(--color-semantic-inverse-primary)" }, children: category }),
...
//# sourceMappingURL=chunk-DYKXGDAS.js.map