...
var Tooltip = _react2.default.forwardRef(function Tooltip2({
  ...
  const [visible, setVisible] = _chunkTGRNUIFMcjs.useControllableOpen.call(void 0, { open, defaultOpen, onOpenChange });
  const requestedPlace = position || placement || "top";
  const wrapperRef = _react2.default.useRef(null);
  const mergedWrapperRef = _chunkTGRNUIFMcjs.useMergedRefs.call(void 0, wrapperRef, forwardedRef);
  const bubbleRef = _react2.default.useRef(null);
  const tooltipId = _react2.default.useId();
  const getTrigger = _react2.default.useCallback(() => _chunkTGRNUIFMcjs.findOverlayTrigger.call(void 0, wrapperRef.current), []);
  const floating = _chunkTGRNUIFMcjs.useFloatingPosition.call(void 0, {
    open: visible,
  ...
  const layer = _chunkTGRNUIFMcjs.useLightDismiss.call(void 0, {
    open: visible,
    rootRef: wrapperRef,
    getTrigger,
    onDismiss: () => {
  ...
  const renderedChildren = validTrigger ? _react2.default.cloneElement(children, {
    ...
    "aria-describedby": _chunkTGRNUIFMcjs.appendAriaReference.call(void 0, children.props["aria-describedby"], tooltipId)
  }) : children;
  return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0,
    "span",
    {
      ...
      style: { ..._chunkTGRNUIFMcjs.componentVars.call(void 0, vars, "--lds-tooltip-"), position: "relative", display: "inline-flex", ..._chunkTGRNUIFMcjs.partStyle.call(void 0, styles, "root"), ...style },
      ...
      children: [
        renderedChildren,
        /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkTGRNUIFMcjs.OverlayPortal, { open: visible, withinPortal, portalTarget, anchorRef: wrapperRef, layer: "anchored", children: /* @__PURE__ */ _jsxruntime.jsxs.call(void 0,
          "span",
          {
            ref: bubbleRef,
            id: tooltipId,
            "data-slot": "bubble",
            className: _chunkTGRNUIFMcjs.partClassName.call(void 0, classNames, "bubble") || void 0,
            role: "tooltip",
            "aria-hidden": visible ? false : void 0,
            "data-placement": place,
            style: {
              ..._chunkTGRNUIFMcjs.componentVars.call(void 0, vars, "--lds-tooltip-"),
              ...
              ..._chunkTGRNUIFMcjs.partStyle.call(void 0, styles, "bubble")
            },
            children: [
              bubblePath && /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
                "svg",
                {
                  ...
                  "data-slot": "surface",
                  className: _chunkTGRNUIFMcjs.partClassName.call(void 0, classNames, "surface") || void 0,
                  ...
                  style: {
                    ...
                    overflow: "visible",
                    pointerEvents: "none",
                    ..._chunkTGRNUIFMcjs.partStyle.call(void 0, styles, "surface")
                  },
                ...
                "span",
                {
                  ...
                  children: [
                    ...
                    shortcut != null && /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
                      ...
                      {
                        "data-slot": "shortcut",
                        className: _chunkTGRNUIFMcjs.partClassName.call(void 0, classNames, "shortcut") || void 0,
                        style: {
                          color: "var(--color-semantic-inverse-label-alternative-soft)",
                          fontWeight: "var(--fw-bold)",
                          ..._chunkTGRNUIFMcjs.partStyle.call(void 0, styles, "shortcut")
                        },
                        children: shortcut
                      }
                    )
...
//# sourceMappingURL=chunk-EZ5QZ7KI.cjs.map