  ...
  const stars = Array.from({ length: max }).map((_, i) => {
    ...
    return /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
      "span",
      {
        ...
        children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkOZR3K6TYcjs.Icon, { name: filled ? "star-fill" : "star", size, "aria-hidden": "true" })
      },
      i
    );
  });
...
//# sourceMappingURL=chunk-D24BJNMT.cjs.map