...
function BrandLogo({ name, size = 24, title, mono = false, style, ...rest }) {
  const g = LOGOS[name];
...
function Button({
  ...
  const [press, setPress] = import_react3.default.useState(false);
  const heights = {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime103.jsxs)(
    "header",
    {
      ...
      children: [
        ...
        children != null ? /* @__PURE__ */ (0, import_jsx_runtime103.jsx)("nav", { style: { display: "flex", alignItems: "center", alignSelf: "stretch", gap: 4, flex: 1, minWidth: 0, justifyContent: navAlign === "center" ? "center" : "flex-start" }, children }) : /* @__PURE__ */ (0, import_jsx_runtime103.jsx)("div", { style: { flex: 1 } }),
