...
function CommandPalette({ open = false, onClose, commands = [], placeholder = "\uBA85\uB839 \uAC80\uC0C9\u2026", style, ...rest }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime107.jsx)("div", { role: "presentation", onClick: (e) => {
    ...
    /* @__PURE__ */ (0, import_jsx_runtime107.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: 12, padding: "16px 20px", borderBottom: "1px solid var(--bw-border)" }, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime107.jsx)("input", { autoFocus: true, value: q, onChange: (e) => setQ(e.target.value), placeholder, style: { flex: 1, border: "none", outline: "none", background: "transparent", fontFamily: "var(--font-sans)", fontSize: 17, color: "var(--label-normal)" } })
    ] }),
