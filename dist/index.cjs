...
function RobotStatusCard({ name, image, status = "online", battery, mode, selected = false, onClick, style, ...rest }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime121.jsxs)("div", { onClick, style: {
    ...
    /* @__PURE__ */ (0, import_jsx_runtime121.jsx)("div", { style: {
      ...
      alignItems: "center",
      justifyContent: "center"
    }, children: image ? /* @__PURE__ */ (0, import_jsx_runtime121.jsx)("img", { src: image, alt: "", style: { width: "100%", height: "100%", objectFit: "cover" } }) : /* @__PURE__ */ (0, import_jsx_runtime121.jsx)("span", { style: { fontSize: 17, fontWeight: 800, color: "var(--label-assistive)" }, children: String(name || "?").slice(0, 2) }) }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime121.jsxs)("div", { style: { display: "flex", flexDirection: "column", alignItems: "flex-end", gap: 7, flexShrink: 0 }, children: [
      mode != null && /* @__PURE__ */ (0, import_jsx_runtime121.jsx)("span", { style: { fontSize: 11, fontWeight: 700, letterSpacing: ".3px", padding: "2px 8px", borderRadius: "var(--radius-pill)", background: "var(--lk-accent-tint)", color: "var(--lk-accent-ink)", whiteSpace: "nowrap" }, children: mode }),
      /* @__PURE__ */ (0, import_jsx_runtime121.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: 8 }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime121.jsx)("span", { title: status, "aria-label": status, style: { display: "inline-flex", alignItems: "flex-end", gap: 2, height: 12 }, children: [0, 1, 2].map((i) => /* @__PURE__ */ (0, import_jsx_runtime121.jsx)("span", { style: { width: 3, height: BAR_H[i], borderRadius: 1, background: i < conn.bars ? conn.c : "var(--fill-strong)" } }, i)) }),
