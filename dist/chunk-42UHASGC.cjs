...
function resolveTone(tone) {
  if (tone === "critical") return _chunkFWPYBG53cjs.statusToneStyle.call(void 0, "negative");
  return _chunkFWPYBG53cjs.statusToneStyle.call(void 0, tone);
}
...
//# sourceMappingURL=chunk-42UHASGC.cjs.map