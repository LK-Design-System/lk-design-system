...
function Map2DCanvas({
  ...
  const interactionState = _chunkTZCJ33XOcjs.resolveViewerState.call(void 0, {
    state,
    availability,
    connection,
    freshness,
  ...
  const interactionBlocked = _chunkTZCJ33XOcjs.VIEWER_BLOCKING_STATES.includes(interactionState);
  const {
    rootRef,
    renderedViewport,
    commitViewport,
...
//# sourceMappingURL=chunk-3YRDM6TJ.cjs.map