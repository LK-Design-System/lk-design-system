...
function FileUpload({
  ...
  const { fieldId: inputId, describedBy } = _chunkIDTVAPZEcjs.useFieldMetadata.call(void 0, { prefix: "file-upload", describedBy: inputAriaDescribedBy });
...
//# sourceMappingURL=chunk-EESPGXIJ.cjs.map