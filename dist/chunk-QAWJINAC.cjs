...
var BRAND_LETTER_COUNT = _chunk3IQWXGU2cjs.LK_PATHS.length + _chunk3IQWXGU2cjs.ROBOTICS_PATHS.length;
...
var ROBOTICS_WAVE_AMPLITUDE = (BRAND_WAVE_AMPLITUDE * matrixScaleY(_chunk3IQWXGU2cjs.LK_PATHS[0].transform) / (_chunk3IQWXGU2cjs.ROBOTICS_INLINE_SCALE * matrixScaleY(_chunk3IQWXGU2cjs.ROBOTICS_PATHS[0].transform))).toFixed(6);
...
function Spinner({ size, thickness, color = "var(--color-semantic-primary-normal)", label, variant = "circular", style, ...rest }) {
  ...
  if (variant === "brand") {
    const mark = /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "svg", { viewBox: _chunk3IQWXGU2cjs.LK_LOGO_VIEWBOX.inline, height: resolvedSize, "aria-hidden": "true", style: { display: "block", overflow: "visible" }, children: /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "g", { fill: _chunk3IQWXGU2cjs.LK_LOGO_COLORS.navy, fillRule: "nonzero", children: [
      _chunk3IQWXGU2cjs.LK_PATHS.map((path, i) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "g", { transform: path.transform, children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "path", { "data-wave": true, d: path.d, style: { animation: `lk-brand-wave-lk 1.15s ease-in-out ${brandDelay(i)}s infinite` } }) }, `lk${i}`)),
      /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "g", { transform: _chunk3IQWXGU2cjs.ROBOTICS_INLINE_TRANSFORM, children: _chunk3IQWXGU2cjs.ROBOTICS_PATHS.map((path, i) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "g", { transform: path.transform, children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "path", { "data-wave": true, d: path.d, style: { animation: `lk-brand-wave-robo 1.15s ease-in-out ${brandDelay(_chunk3IQWXGU2cjs.LK_PATHS.length + i)}s infinite` } }) }, `ro${i}`)) })
    ] }) });
...
//# sourceMappingURL=chunk-QAWJINAC.cjs.map