...
function SearchField({
  ...
  const metadata = _chunkGYQC2LMQcjs.useFieldMetadata.call(void 0, {
    prefix: "search-field",
    id,
    label,
    helper,
  ...
  const borderColor = _chunkGYQC2LMQcjs.fieldBorderColor.call(void 0, {
    disabled,
    readOnly,
    invalid: isInvalid,
    status,
...
//# sourceMappingURL=chunk-UFAX6SEG.cjs.map