...
function ChoiceCard({
  ...
  const inheritedDensity = useResolvedDensity(void 0, "comfortable");
  ...
  return /* @__PURE__ */ jsxs(
    Root,
    {
      ...
      "aria-labelledby": !nativeChoice && resolvedRole ? rootProps["aria-labelledby"] ?? (ariaLabel ? void 0 : titleId) : rootProps["aria-labelledby"],
      ...
      children: [
        nativeChoice && /* @__PURE__ */ jsx(
          "input",
          {
            ...
            "aria-labelledby": explicitName ? void 0 : inputProps["aria-labelledby"] ?? titleId,
        ...
        /* @__PURE__ */ jsxs("div", { style: isFrame ? void 0 : { flex: 1, minWidth: 0 }, children: [
          !isFrame && title != null && /* @__PURE__ */ jsx("div", { id: titleId, style: { fontSize: "var(--body2-size)", lineHeight: "var(--body2-line)", fontWeight: "var(--fw-bold)", letterSpacing: 0, color: disabled ? "var(--color-semantic-label-disable)" : "var(--color-semantic-label-strong)", wordBreak: "keep-all" }, children: title }),
          !isFrame && description != null && /* @__PURE__ */ jsx("div", { id: descriptionId, style: { marginTop: "var(--space-1)", fontSize: "var(--label2-size)", lineHeight: "var(--label2-line)", color: disabled ? "var(--color-semantic-label-disable)" : "var(--color-semantic-label-neutral)", wordBreak: "keep-all" }, children: description }),
          children
        ] }),
...
//# sourceMappingURL=chunk-DYEYIJID.js.map