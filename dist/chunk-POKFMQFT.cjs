...
function variantStyle(variant, palette) {
  if (variant === "embedded") {
    return {
      ...
      ..._chunk3UPIIXAKcjs.embeddedBandStyle.call(void 0, palette)
    };
  }
  return {
    padding: "14px 16px",
...
function Banner({ tone = "info", variant = "standalone", title, children, action, onClose, closeLabel = "\uB2EB\uAE30", style, ...rest }) {
  const normalizedTone = _chunk3UPIIXAKcjs.normalizeStatusTone.call(void 0, tone);
  const t = _chunk3UPIIXAKcjs.statusToneStyle.call(void 0, normalizedTone);
  ...
  return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, 
    "div",
    {
      ...
      ...rest,
      children: [
        /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkX5XHQEI5cjs.Icon, { name: t.icon, size: 20, color: t.foreground, "aria-hidden": "true", style: { flexShrink: 0, marginTop: "var(--space-0-5)" } }),
        ...
        onClose && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "button", { type: "button", "aria-label": closeLabel, onClick: onClose, style: { flexShrink: 0, display: "inline-flex", alignItems: "center", justifyContent: "center", minWidth: 24, minHeight: 24, padding: 4, margin: -3, border: "none", background: "transparent", cursor: "pointer", color: "var(--color-semantic-label-neutral)" }, children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkX5XHQEI5cjs.Icon, { name: "close", size: 18, "aria-hidden": "true" }) })
      ]
    }
  );
}
...
//# sourceMappingURL=chunk-POKFMQFT.cjs.map