...
function focusableActionControls(region) {
  return Array.from(_nullishCoalesce(_optionalChain([region, 'optionalAccess', _14 => _14.querySelectorAll, 'call', _15 => _15(ACTION_CONTROL_SELECTOR)]), () => ( [])));
}
function availableMenuItems(menu) {
  return Array.from(_nullishCoalesce(_optionalChain([menu, 'optionalAccess', _16 => _16.querySelectorAll, 'call', _17 => _17(MENU_ITEM_SELECTOR)]), () => ( []))).filter(
  ...
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
    "button",
    {
      ...
      onClick: () => {
        ...
        _optionalChain([onSelect, 'optionalCall', _20 => _20(item)]);
      },
        ...
        sub.renderPanel(
          /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
            "div",
            {
              ...
              children: renderMenuItems(item.items || [], { variant, itemMetrics, closeAll })
            }
          ),
          MENU_PANEL_STYLE
        )
...
function DropdownMenu({
  ...
  const triggerId = _nullishCoalesce(_optionalChain([trigger, 'optionalAccess', _21 => _21.props, 'optionalAccess', _22 => _22.id]), () => ( generatedTriggerId));
  const setVisible = (next) => {
    if (!controlled) setInternalOpen(next);
    _optionalChain([onOpenChange, 'optionalCall', _23 => _23(next)]);
  };
  ...
  const { menuRef, requestItemFocus, closeMenu, handleMenuKeyDown } = _chunkRP4ROXV5cjs.useMenuKeyboard.call(void 0, {
    ...
    getTrigger: () => _optionalChain([ref, 'access', _24 => _24.current, 'optionalAccess', _25 => _25.querySelector, 'call', _26 => _26('[aria-haspopup="menu"], button, [role="button"], a[href]')]),
    menuKey: drill ? drillPath.length : 0
  });
  const toggleMenu = (event) => {
    _optionalChain([trigger, 'optionalAccess', _27 => _27.props, 'optionalAccess', _28 => _28.onClick, 'optionalCall', _29 => _29(event)]);
    if (_optionalChain([event, 'optionalAccess', _30 => _30.defaultPrevented])) return;
  ...
  const handleTriggerKeyDown = (event) => {
    _optionalChain([trigger, 'optionalAccess', _31 => _31.props, 'optionalAccess', _32 => _32.onKeyDown, 'optionalCall', _33 => _33(event)]);
  ...
  const portalTarget = _nullishCoalesce(_optionalChain([ref, 'access', _34 => _34.current, 'optionalAccess', _35 => _35.ownerDocument, 'optionalAccess', _36 => _36.body]), () => ( (typeof document !== "undefined" ? document.body : null)));
  ...
  const focusOutsideMenu = (direction) => {
    const triggerElement = _optionalChain([ref, 'access', _37 => _37.current, 'optionalAccess', _38 => _38.querySelector, 'call', _39 => _39('[aria-haspopup="menu"], button, [role="button"], a[href]')]);
    const ownerDocument = _optionalChain([triggerElement, 'optionalAccess', _40 => _40.ownerDocument]);
    const controls = Array.from(_nullishCoalesce(_optionalChain([ownerDocument, 'optionalAccess', _41 => _41.querySelectorAll, 'call', _42 => _42(ACTION_CONTROL_SELECTOR)]), () => ( []))).filter(
    ...
    setVisible(false);
    _optionalChain([target, 'optionalAccess', _43 => _43.focus, 'call', _44 => _44({ preventScroll: true })]);
  };
  const handleActionAreaKeyDown = (event) => {
    ...
    const currentControl = _optionalChain([event, 'access', _45 => _45.target, 'access', _46 => _46.closest, 'optionalCall', _47 => _47(ACTION_CONTROL_SELECTOR)]);
  ...
  const finishAction = (callback) => {
    _optionalChain([callback, 'optionalCall', _48 => _48()]);
    closeMenu({ restoreFocus: true });
  };
  _react2.default.useEffect(() => {
    if (!visible) return void 0;
    const onDoc = (e) => {
      if (ref.current && !ref.current.contains(e.target) && !_optionalChain([e, 'access', _49 => _49.target, 'access', _50 => _50.closest, 'optionalCall', _51 => _51("[data-menu-portal]")])) {
        setVisible(false);
      }
    };
  ...
  return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, 
    "div",
    {
      ...
      children: [
        ...
        visible && portalTarget && _reactdom.createPortal.call(void 0, 
          /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, 
            "div",
            {
              ...
              style: {
                position: "fixed",
                top: _nullishCoalesce(position.y, () => ( -9999)),
                left: _nullishCoalesce(position.x, () => ( -9999)),
                ...
                /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
                  "div",
                  {
                    ...
                    onFocus: (event) => {
                      ...
                      const cameFromMenu = event.relatedTarget && _optionalChain([menuRef, 'access', _52 => _52.current, 'optionalAccess', _53 => _53.contains, 'call', _54 => _54(event.relatedTarget)]);
                      ...
                      _optionalChain([nextTarget, 'optionalAccess', _55 => _55.focus, 'call', _56 => _56({ preventScroll: true })]);
                    },
                ...
                showActionArea && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
                  "div",
                  {
                    ...
                    children: action || /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, _jsxruntime.Fragment, { children: [
                      onCancel && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkJM32VGPMcjs.Button, { variant: "outlined", color: "assistive", size: "sm", onClick: () => finishAction(onCancel), children: cancelLabel }),
                      onApply && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkJM32VGPMcjs.Button, { size: "sm", onClick: () => finishAction(onApply), children: applyLabel })
                    ] })
                  }
                )
              ]
...
//# sourceMappingURL=chunk-HK5EYES2.cjs.map