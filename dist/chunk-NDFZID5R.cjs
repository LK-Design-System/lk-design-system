...
function Badge({ children, tone = "signal", dot = false, style, ...rest }) {
  ...
  if (dot) {
    return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "span", { style: { display: "inline-block", width: 8, height: 8, borderRadius: "50%", background: palette.dot, ...style }, ...rest });
  }
...
exports.Badge = Badge;
//# sourceMappingURL=chunk-NDFZID5R.cjs.map