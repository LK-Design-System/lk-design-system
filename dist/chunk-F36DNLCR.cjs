...
function NewsCard({ image, imageAlt = "", category, title, excerpt, source, date, dateTime, cta, href = "#", headingLevel = 3, style, onFocus, onBlur, "aria-label": ariaLabel, ...rest }) {
  ...
  const ArrowR = /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunk7OXVB7WXcjs.Icon, { name: "arrow-right", size: 15, "aria-hidden": "true" });
...
//# sourceMappingURL=chunk-F36DNLCR.cjs.map