...
var _chunkDRECIMHEcjs = require('./chunk-DRECIMHE.cjs');

// components/editor/EditorToolbar.jsx
var _react = require('react'); var _react2 = _interopRequireDefault(_react);

// ../../lk-workspace/shared/lk-design-system/packages/core/dist/chunk-A4M3FBLH.js
...
var Tooltip = _react2.default.forwardRef(function Tooltip2({
  ...
  const [visible, setVisible] = _chunkGY2GH62Kcjs.useControllableOpen.call(void 0, { open, defaultOpen, onOpenChange });
  const requestedPlace = position || placement || "top";
  const wrapperRef = _react2.default.useRef(null);
  const mergedWrapperRef = _chunk555WAC5Gcjs.useMergedRefs.call(void 0, wrapperRef, forwardedRef);
  const bubbleRef = _react2.default.useRef(null);
  const tooltipId = _react2.default.useId();
  const getTrigger = _react2.default.useCallback(() => _chunkGY2GH62Kcjs.findOverlayTrigger.call(void 0, wrapperRef.current), []);
  const floating = _chunkGY2GH62Kcjs.useFloatingPosition.call(void 0, {
    open: visible,
  ...
  const layer = _chunkGY2GH62Kcjs.useLightDismiss.call(void 0, {
    open: visible,
    rootRef: wrapperRef,
    getTrigger,
    onDismiss: () => {
  ...
  const renderedChildren = validTrigger ? _react2.default.cloneElement(children, {
    ...
    "aria-describedby": _chunkGY2GH62Kcjs.appendAriaReference.call(void 0, children.props["aria-describedby"], tooltipId)
  }) : children;
  return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0,
    "span",
    {
      ...
      style: { ..._chunk555WAC5Gcjs.componentVars.call(void 0, vars, "--lds-tooltip-"), position: "relative", display: "inline-flex", ..._chunk555WAC5Gcjs.partStyle.call(void 0, styles, "root"), ...style },
      ...
      children: [
        renderedChildren,
        /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkGY2GH62Kcjs.OverlayPortal, { open: visible, withinPortal, portalTarget, anchorRef: wrapperRef, layer: "anchored", children: /* @__PURE__ */ _jsxruntime.jsxs.call(void 0,
          "span",
          {
            ref: bubbleRef,
            id: tooltipId,
            "data-slot": "bubble",
            className: _chunk555WAC5Gcjs.partClassName.call(void 0, classNames, "bubble") || void 0,
            role: "tooltip",
            "aria-hidden": visible ? false : void 0,
            "data-placement": place,
            style: {
              ..._chunk555WAC5Gcjs.componentVars.call(void 0, vars, "--lds-tooltip-"),
              ...
              ..._chunk555WAC5Gcjs.partStyle.call(void 0, styles, "bubble")
            },
            children: [
              bubblePath && /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
                "svg",
                {
                  ...
                  "data-slot": "surface",
                  className: _chunk555WAC5Gcjs.partClassName.call(void 0, classNames, "surface") || void 0,
                  ...
                  style: {
                    ...
                    overflow: "visible",
                    pointerEvents: "none",
                    ..._chunk555WAC5Gcjs.partStyle.call(void 0, styles, "surface")
                  },
              ...
              /* @__PURE__ */ _jsxruntime.jsxs.call(void 0,
                "span",
                {
                  ...
                  "data-slot": "content",
                  className: _chunk555WAC5Gcjs.partClassName.call(void 0, classNames, "content") || void 0,
                  style: {
                    position: "relative",
                    zIndex: 1,
                    display: "inline-flex",
                    ...
                    ..._chunk555WAC5Gcjs.partStyle.call(void 0, styles, "content")
                  },
                  children: [
                    ...
                    shortcut != null && /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
                      ...
                      {
                        "data-slot": "shortcut",
                        className: _chunk555WAC5Gcjs.partClassName.call(void 0, classNames, "shortcut") || void 0,
                        style: {
                          color: "var(--color-semantic-inverse-label-alternative-soft)",
                          fontWeight: "var(--fw-bold)",
                          ..._chunk555WAC5Gcjs.partStyle.call(void 0, styles, "shortcut")
                        },
                        children: shortcut
                      }
                    )
...
//# sourceMappingURL=chunk-CK3S35E5.cjs.map