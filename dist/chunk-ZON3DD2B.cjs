...
function LaneOverlay({
  ...
  const baseColor = invalid ? "var(--viewer-danger, var(--color-semantic-status-negative-foreground))" : resolvedAvailability === "available" ? VIEWER_MUTED : "var(--viewer-muted, var(--color-semantic-label-alternative))";
  const stateGlyphs = [
  ...
  return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, 
    "g",
    {
      ...
      onFocus: (event) => {
        if (!pointerOnly) setHasFocus(_chunkYXXTXTP5cjs.isFocusVisibleTarget.call(void 0, event.currentTarget));
        ...
        pathData && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "defs", { "aria-hidden": "true", children: /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "mask", { id: directionMaskId, maskUnits: "userSpaceOnUse", children: [
          ...
          /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "g", { transform: `translate(${directionPoint.x} ${directionPoint.y}) rotate(${directionPoint.angle}) scale(${inverseScale})`, children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
            "rect",
            {
              ...
              x: _chunkYXXTXTP5cjs.NAV_DIRECTION_CHEVRON.window.from,
              y: -_chunkYXXTXTP5cjs.NAV_DIRECTION_CHEVRON.window.clearWidth / 2,
              width: _chunkYXXTXTP5cjs.NAV_DIRECTION_CHEVRON.window.to - _chunkYXXTXTP5cjs.NAV_DIRECTION_CHEVRON.window.from,
              height: _chunkYXXTXTP5cjs.NAV_DIRECTION_CHEVRON.window.clearWidth,
              fill: "black"
            }
          ) })
        ] }) }),
            ...
            children: [
              ...
              /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
                "path",
                {
                  ...
                  d: _chunkYXXTXTP5cjs.NAV_DIRECTION_CHEVRON.path,
                  fill: "none",
                  stroke: baseColor,
                  strokeWidth: selected ? 3.5 : 2.5,
                  strokeLinecap: "round",
                ...
                children: [
                  ...
                  metadata && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
                    "text",
                    {
                      ...
                      fill: VIEWER_MUTED,
                      stroke: VIEWER_SURFACE,
                      strokeWidth: _chunkYXXTXTP5cjs.NAV_LABEL_HALO.secondary,
                      paintOrder: "stroke",
                      vectorEffect: "non-scaling-stroke",
                      fontFamily: "var(--font-sans)",
                      fontSize: "var(--caption2-size)",
...
//# sourceMappingURL=chunk-ZON3DD2B.cjs.map