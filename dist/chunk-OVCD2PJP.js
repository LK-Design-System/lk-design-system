  ...
  return /* @__PURE__ */ jsx(
    "g",
    {
      ...
      children: /* @__PURE__ */ jsxs("g", { "data-hazard-screen-space": "", "data-viewport-scale": scale, transform: `scale(${inverseScale})`, children: [
        ...
        focusVisible && /* @__PURE__ */ jsx("path", { d: PIN_PATH, transform: `scale(${NAV_PIN.focusRing.scale})`, fill: "none", stroke: "var(--color-semantic-focus-indicator)", strokeWidth: NAV_PIN.focusRing.strokeWidth, strokeLinejoin: "round", vectorEffect: "non-scaling-stroke", pointerEvents: "none", "data-hazard-focus-ring": "" }),
        selected && /* @__PURE__ */ jsx("path", { d: PIN_PATH, transform: `scale(${NAV_PIN.selectionRing.scale})`, fill: "none", stroke: "var(--viewer-accent, var(--color-semantic-primary-normal))", strokeWidth: NAV_PIN.selectionRing.strokeWidth, strokeLinejoin: "round", vectorEffect: "non-scaling-stroke", pointerEvents: "none", "data-hazard-selection-ring": "" }),
...
//# sourceMappingURL=chunk-OVCD2PJP.js.map