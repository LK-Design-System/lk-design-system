      ...
      children: [
        ...
        /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "div", { style: { position: "relative", padding: "var(--space-6)", display: "flex", flexDirection: "column", gap: "var(--space-2)" }, children: [
          /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "div", { style: { display: "flex", flexDirection: "column", gap: "var(--space-1)" }, children: [
            category && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "span", { style: { fontSize: "var(--caption1-size)", lineHeight: "var(--caption1-line)", fontWeight: "var(--fw-bold)", letterSpacing: "var(--ls-overline)", textTransform: "uppercase", color: "var(--color-semantic-brand-on-surface-muted)" }, children: category }),
            /* @__PURE__ */ _jsxruntime.jsx.call(void 0, HeadingTag, { style: { margin: 0, fontSize: "var(--fs-h5)", lineHeight: "var(--lh-h5)", fontWeight: "var(--fw-extra)", letterSpacing: "var(--ls-h5)", color: "var(--color-semantic-brand-on-surface)", whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }, children: id })
          ] }),
          description && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "p", { style: { margin: 0, fontSize: "var(--label1-size)", lineHeight: "var(--label1-reading-line)", color: "var(--color-semantic-brand-on-surface-muted)", wordBreak: "keep-all", display: "-webkit-box", WebkitBoxOrient: "vertical", WebkitLineClamp: 2, overflow: "hidden" }, children: description }),
...
//# sourceMappingURL=chunk-WRHZU5SS.cjs.map