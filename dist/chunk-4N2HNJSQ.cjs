...
function SecretField({
  ...
  const actions = revealable || copyable ? /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "span", { style: { display: "inline-flex", alignItems: "center", gap: "var(--space-0)" }, children: [
    revealable && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkI6NJHF3Lcjs.IconButton, { variant: "plain", round: false, size: "sm", disabled: disabled || !hasValue, "aria-controls": inputId, onClick: () => setShow(!show), label: revealActionLabel, children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkOZR3K6TYcjs.Icon, { name: show ? "eye-slash" : "eye", size: 16, "aria-hidden": "true" }) }),
    copyable && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkI6NJHF3Lcjs.IconButton, { variant: "plain", round: false, size: "sm", disabled: disabled || !hasValue, "aria-controls": inputId, onClick: copy, label: copyActionLabel, style: copyTone ? { color: copyTone } : void 0, children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkOZR3K6TYcjs.Icon, { name: copyState === "success" ? "circle-check" : copyState === "error" ? "circle-close" : "copy", size: 16, "aria-hidden": "true" }) })
  ] }) : void 0;
...
//# sourceMappingURL=chunk-4N2HNJSQ.cjs.map