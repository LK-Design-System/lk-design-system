...
function RailItemTooltip({ label, collapsed, children }) {
  ...
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkYPBHYJQ4cjs.Tooltip, { content: label, placement: "right", size: "small", open: collapsed ? open : false, onOpenChange: setOpen, style: { width: "100%" }, children });
}
function SideNav({
  items = [],
  value,
  ...
  const panelContent = /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "div", { id: panelId, className: "lk-sidenav__panel-content", "data-collapsed": col ? "true" : "false", style: { display: "flex", flexDirection: "column", flex: "1 1 auto", minHeight: 0 }, children: [
    ...
    /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "ul", { className: "lk-sidenav__scroll", style: { display: "flex", flexDirection: "column", gap: 2, flex: "1 1 auto", minHeight: 0, margin: 0, padding: 0, listStyle: "none", overflowX: col ? "visible" : "hidden", overflowY: col ? "visible" : "auto", scrollbarWidth: "none", msOverflowStyle: "none" }, children: items.map((o, i) => {
      ...
      if (kids.length > 0) {
        ...
        return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "li", { style: LIST_ITEM_STYLE, children: [
          /* @__PURE__ */ _jsxruntime.jsx.call(void 0, RailItemTooltip, { label: accessibleLabel, collapsed: col, children: /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, 
            "button",
            {
              type: "button",
          ...
          !col && isOpen && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "ul", { style: { display: "flex", flexDirection: "column", gap: 2, margin: "0 0 4px", padding: 0, listStyle: "none" }, children: kids.map((c) => {
      ...
      return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "li", { style: LIST_ITEM_STYLE, children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, RailItemTooltip, { label: accessibleLabel, collapsed: col, children: renderLeafControl(o, {
        active,
...
//# sourceMappingURL=chunk-FNQVJ4TQ.cjs.map