...
var Chevron = ({ open }) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkF72KSGF7cjs.Icon, { name: "chevron-down-small", size: 14, "aria-hidden": "true", style: { flexShrink: 0, transform: open ? "rotate(180deg)" : "none", transition: "transform var(--dur-fast) var(--ease-out)" } });
...
function RailItemTooltip({ label, collapsed, enabled = true, children }) {
  ...
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkVEOYEN7Tcjs.Tooltip, { content: label, placement: "right", size: "small", open: collapsed ? open : false, onOpenChange: setOpen, style: { width: "100%" }, children });
}
var SideNav = _react2.default.forwardRef(function SideNav2({
  ...
  const dot = /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "span", { "data-slot": "badge", className: _chunkGWMGPLNWcjs.partClassName.call(void 0, classNames, "badge") || void 0, style: { position: "absolute", top: 7, right: 7, width: 7, height: 7, borderRadius: "50%", background: appearanceTokens.badgeDot, ..._chunkGWMGPLNWcjs.partStyle.call(void 0, styles, "badge") } });
...
//# sourceMappingURL=chunk-O4457SG3.cjs.map