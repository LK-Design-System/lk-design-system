...
function SearchField({
  ...
  const metadata = _chunk3NOYASLPcjs.useFieldMetadata.call(void 0, {
    prefix: "search-field",
    id,
    label,
    helper,
  ...
  const borderColor = _chunk3NOYASLPcjs.fieldBorderColor.call(void 0, {
    disabled,
    readOnly,
    invalid: isInvalid,
    status,
    ...
    _chunk3NOYASLPcjs.FieldStack,
    {
      ...
      children: /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, 
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkX5XHQEI5cjs.Icon, { name: "search", size: 18, color: "var(--component-input-icon-color)", "aria-hidden": "true", style: { flex: "0 0 auto" } }),
            ...
            currentValue && !readOnly && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
              _chunkITIFTVTBcjs.IconButton,
              {
                ...
                children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkX5XHQEI5cjs.Icon, { name: "circle-close-fill", size: 16, "aria-hidden": "true" })
              }
            )
          ]
        }
...
//# sourceMappingURL=chunk-YTWWFUTK.cjs.map