...
function Lockup({ variant = "inline", tone = "ink", color, height, title, decorative = false, style, ...rest }) {
  ...
  const vb = variant === "portal" ? PORTAL_LOCKUP_VIEWBOX : LK_LOGO_VIEWBOX[variant] || LK_LOGO_VIEWBOX.inline;
  ...
  return /* @__PURE__ */ jsx("svg", { viewBox: vb, height: h, ...a11y, style: { display: "block", ...style }, ...rest, children: /* @__PURE__ */ jsxs("g", { fill, fillRule: "nonzero", children: [
    ...
    variant === "portal" && /* @__PURE__ */ jsx("g", { transform: PORTAL_INLINE_TRANSFORM, children: PORTAL_PATHS.map((path, index) => /* @__PURE__ */ jsx("path", { d: path.d }, `${path.letter}-${index}`)) })
  ] }) });
}
...
//# sourceMappingURL=chunk-P2MXOZ7B.js.map