...
function StatusValue({ item }) {
  const renderedValue = _chunk5R6MQTQFcjs.normalizeValueText.call(void 0, item.value);
  const normalizedUnit = _chunk5R6MQTQFcjs.normalizeUnit.call(void 0, item.unit);
...
//# sourceMappingURL=chunk-7FTMPIZQ.cjs.map