...
function EventChip({ event, timed, compact, onActivate, style }) {
  ...
  return /* @__PURE__ */ jsxs(
    "button",
    {
      ...
      children: [
        timed && !event.allDay && /* @__PURE__ */ jsx("span", { className: "lk-schedule-calendar__chip-time", style: { flexShrink: 0, fontVariantNumeric: "tabular-nums", fontWeight: "var(--fw-bold)" }, children: formatClock(event.start) }),
        /* @__PURE__ */ jsx("span", { style: { minWidth: 0, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: compact ? "nowrap" : "normal", overflowWrap: "anywhere" }, children: event.title })
      ]
    }
  );
}
...
function MonthView({ anchor, events, today, weekStartsOn, maxVisibleEvents, onSlotSelect, onEventActivate, onOverflowActivate, onNavigatePeriod, roving, classNames, styles }) {
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      "data-slot": "grid",
      className: partClassName(classNames, "grid") || void 0,
      ...
      children: [
        /* @__PURE__ */ jsx("div", { role: "row", style: { display: "grid", gridTemplateColumns: "repeat(7, minmax(0, 1fr))" }, children: weekdayOrder.map((weekday) => /* @__PURE__ */ jsx(
          "div",
          {
            role: "columnheader",
        ...
        weeks.map((week, weekIndex) => /* @__PURE__ */ jsx("div", { role: "row", style: { display: "grid", gridTemplateColumns: "repeat(7, minmax(0, 1fr))" }, children: week.map((day) => {
          const key = ymd(day);
          ...
          return /* @__PURE__ */ jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsx(
                  "button",
                  {
                    ...
                    style: {
                      ...
                      background: isToday ? "var(--color-semantic-primary-fill)" : "transparent",
                ...
                /* @__PURE__ */ jsxs("div", { style: { display: "grid", alignContent: "start", gap: 2, minWidth: 0 }, children: [
                  visible.map((event) => /* @__PURE__ */ jsx(EventChip, { event, timed: true, compact: true, onActivate: onEventActivate }, event.id)),
...
function TimeGridView({ view, anchor, events, today, now, weekStartsOn, minMinutes, maxMinutes, slotMinutes, nowIndicator, timeGridHeight, onSlotSelect, onEventActivate, onNavigatePeriod, roving, classNames, styles }) {
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxs("div", { role: "row", style: { display: "grid", gridTemplateColumns: columnTemplate }, children: [
          /* @__PURE__ */ jsx("div", { role: "columnheader", "aria-label": "\uC2DC\uAC04", style: { borderBottom: "1px solid var(--color-semantic-line-normal-normal)" } }),
          days.map((day) => {
            ...
            return /* @__PURE__ */ jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsx("span", { children: WEEKDAYS[day.getDay()] }),
                  /* @__PURE__ */ jsx(
                    "span",
                    {
                      style: {
        ...
        /* @__PURE__ */ jsxs("div", { role: "row", "data-schedule-all-day": "", hidden: !hasAllDay, style: { display: hasAllDay ? "grid" : "none", gridTemplateColumns: columnTemplate }, children: [
          /* @__PURE__ */ jsx("div", { role: "rowheader", style: { padding: "var(--space-1) var(--space-2)", borderBottom: "1px solid var(--color-semantic-line-normal-normal)", fontSize: "var(--caption1-size)", color: "var(--color-semantic-label-alternative)", textAlign: "right" }, children: "\uC885\uC77C" }),
          days.map((day, index) => /* @__PURE__ */ jsx("div", { role: "gridcell", style: { display: "grid", gap: 2, padding: "var(--space-1)", minWidth: 0, borderLeft: "1px solid var(--color-semantic-line-normal-normal)", borderBottom: "1px solid var(--color-semantic-line-normal-normal)" }, children: allDayByDay[index].map((event) => /* @__PURE__ */ jsx(EventChip, { event, compact: true, onActivate: onEventActivate }, event.id)) }, ymd(day)))
        ] }),
        /* @__PURE__ */ jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxs("div", { style: { display: "grid", gridTemplateColumns: columnTemplate, minWidth: 0, paddingTop: 10, paddingBottom: 10 }, children: [
              /* @__PURE__ */ jsx("div", { "aria-hidden": "true", style: { position: "relative", height: totalHeight }, children: hours.map((hour, index) => /* @__PURE__ */ jsxs(
                "div",
                {
                  style: {
                    position: "absolute",
              ...
              days.map((day) => {
                ...
                return /* @__PURE__ */ jsxs("div", { role: "row", "data-schedule-day": ymd(day), style: { position: "relative", height: totalHeight, minWidth: 0, borderLeft: "1px solid var(--color-semantic-line-normal-normal)" }, children: [
                  hours.map((hour, index) => {
                    const key = slotKey(day, hour);
                    return /* @__PURE__ */ jsx("div", { role: "gridcell", style: { position: "absolute", top: index * HOUR_HEIGHT, left: 0, right: 0, height: HOUR_HEIGHT, borderBottom: "1px solid var(--color-semantic-line-normal-normal)" }, children: /* @__PURE__ */ jsx(
                      "button",
                      {
                        type: "button",
                        ref: roving.register(key),
                  ...
                  /* @__PURE__ */ jsxs("div", { role: "gridcell", "aria-label": `${formatLongDate(day)} \uC2DC\uAC04 \uC77C\uC815`, style: { position: "absolute", inset: 0, pointerEvents: "none" }, children: [
...
var ScheduleCalendar = React.forwardRef(function ScheduleCalendar2({
  view: viewProp,
  defaultView = "month",
  onViewChange,
  ...
  const [internalDate, setInternalDate] = React.useState(() => startOfDay(toDate(defaultDate) ?? /* @__PURE__ */ new Date()));
  const anchor = dateControlled ? startOfDay(toDate(dateProp) ?? /* @__PURE__ */ new Date()) : internalDate;
  ...
  return /* @__PURE__ */ jsxs(
    "section",
    {
      ...
      "data-slot": "root",
      "data-view": view,
      className: partClassName(classNames, "root", "lk-schedule-calendar", className) || void 0,
      style: {
            ...
            children: [
              /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", gap: "var(--space-2)", minWidth: 0, flexWrap: "wrap" }, children: [
                /* @__PURE__ */ jsxs("div", { style: { display: "flex", gap: 4 }, children: [
                  /* @__PURE__ */ jsx("button", { type: "button", "aria-label": view === "month" ? "\uC774\uC804 \uB2EC" : view === "week" ? "\uC774\uC804 \uC8FC" : "\uC774\uC804 \uB0A0", onClick: () => step(-1), style: HEADER_BUTTON, children: /* @__PURE__ */ jsx(Icon, { name: "chevron-left-small", size: 16, "aria-hidden": "true" }) }),
                  /* @__PURE__ */ jsx("button", { type: "button", "aria-label": view === "month" ? "\uB2E4\uC74C \uB2EC" : view === "week" ? "\uB2E4\uC74C \uC8FC" : "\uB2E4\uC74C \uB0A0", onClick: () => step(1), style: HEADER_BUTTON, children: /* @__PURE__ */ jsx(Icon, { name: "chevron-right-small", size: 16, "aria-hidden": "true" }) })
                ] }),
                /* @__PURE__ */ jsx("button", { type: "button", onClick: () => setDate(today), style: { ...HEADER_BUTTON, width: "auto", padding: "0 var(--space-3)", fontSize: "var(--label1-size)", fontWeight: "var(--fw-semibold)", color: "var(--color-semantic-label-normal)" }, children: todayLabel }),
                /* @__PURE__ */ jsx("div", { "data-slot": "title", className: partClassName(classNames, "title") || void 0, "aria-live": "polite", style: { fontSize: "var(--body1-size)", fontWeight: "var(--fw-bold)", color: "var(--color-semantic-label-strong)", minWidth: 0, ...partStyle(styles, "title") }, children: title })
              ] }),
              viewOptions.length > 1 && /* @__PURE__ */ jsx(SegmentedControl, { "aria-label": "\uBCF4\uAE30 \uC804\uD658", size: "sm", options: viewOptions, value: view, onChange: setView })
            ]
          }
        ),
...
//# sourceMappingURL=chunk-ZENHPOAY.js.map