    ...
    /* @__PURE__ */ _jsxruntime.jsxs.call(void 0,
      "button",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkF72KSGF7cjs.Icon, { name: "chevron-down-small", size: compact ? 14 : 18, color: "var(--color-semantic-label-alternative)", "aria-hidden": "true", style: { transform: open ? "rotate(180deg)" : "none", transition: "transform var(--dur-base) var(--ease-out)", flexShrink: 0 } })
        ]
      }
    ),
...
//# sourceMappingURL=chunk-Q4HVRKZP.cjs.map