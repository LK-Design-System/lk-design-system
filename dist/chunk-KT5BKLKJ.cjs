                ...
                showActionArea && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
                  "div",
                  {
                    ...
                    children: menu.action || /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, _jsxruntime.Fragment, { children: [
                      cancelAction && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkYQ33OVLEcjs.Button, { variant: "outlined", color: "assistive", size: "sm", onClick: () => finishAction(cancelAction), children: _nullishCoalesce(menu.cancelLabel, () => ( cancelLabel)) }),
                      applyAction && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkYQ33OVLEcjs.Button, { size: "sm", onClick: () => finishAction(applyAction), children: _nullishCoalesce(menu.applyLabel, () => ( applyLabel)) })
                    ] })
                  }
                )
              ]
...
//# sourceMappingURL=chunk-KT5BKLKJ.cjs.map