...
var VARIANT_VIEWBOX = Object.freeze({ ..._chunk3IQWXGU2cjs.LK_LOGO_VIEWBOX, portal: PORTAL_LOCKUP_VIEWBOX });
var MINIMUM_HEIGHT = Object.freeze({
  ..._chunk3IQWXGU2cjs.LK_LOGO_USAGE.minimumRenderedHeightPx,
...
function Lockup({ variant = "inline", tone = "ink", adaptive = false, color, height, title, decorative = false, style, ...rest }) {
  const resolvedVariant = Object.prototype.hasOwnProperty.call(VARIANT_VIEWBOX, variant) ? variant : "inline";
  const fill = color || (tone === "white" ? _chunk3IQWXGU2cjs.LK_LOGO_COLORS.white : tone === "current" ? "currentColor" : adaptive ? `var(--component-lockup-auto-fill, ${_chunk3IQWXGU2cjs.LK_LOGO_COLORS.navy})` : _chunk3IQWXGU2cjs.LK_LOGO_COLORS.navy);
  ...
  const logo = /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
    "svg",
    {
      viewBox: vb,
      ...
      children: /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "g", { fill, fillRule: "nonzero", children: [
        ...
        resolvedVariant === "stacked" && _chunk3IQWXGU2cjs.ROBOTICS_PATHS.map((path, index) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "path", { d: path.d, transform: path.transform }, `${path.letter}-${index}`)),
        resolvedVariant === "inline" && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "g", { transform: _chunk3IQWXGU2cjs.ROBOTICS_INLINE_TRANSFORM, children: _chunk3IQWXGU2cjs.ROBOTICS_PATHS.map((path, index) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "path", { d: path.d, transform: path.transform }, `${path.letter}-${index}`)) }),
...
//# sourceMappingURL=chunk-N37YB5IS.cjs.map