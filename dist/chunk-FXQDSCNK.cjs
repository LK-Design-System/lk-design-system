...
function FacilityTransition({
  ...
  const stateBadges = [
    ...
    stale ? { kind: "stale", tone: "var(--viewer-muted, var(--color-semantic-label-alternative))", dash: _chunkAZGN4HJOcjs.NAV_DASH.staleRing } : null
  ...
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
    "g",
    {
      ...
      onFocus: (event) => {
        if (!pointerOnly) setFocusVisible(_chunkAZGN4HJOcjs.isFocusVisibleTarget.call(void 0, event.currentTarget));
      ...
      children: /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "g", { transform: `scale(${inverseScale})`, "data-transition-screen-space": "", children: [
        /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "path", { d: PIN_PATH, transform: _chunkAZGN4HJOcjs.NAV_PIN.shadow.transform, fill: _chunkAZGN4HJOcjs.NAV_PIN.shadow.fill, opacity: _chunkAZGN4HJOcjs.NAV_PIN.shadow.opacity, pointerEvents: "none", "data-transition-shadow": "" }),
        activeFocus && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "path", { d: PIN_PATH, transform: `scale(${_chunkAZGN4HJOcjs.NAV_PIN.focusRing.scale})`, fill: "none", stroke: "var(--color-semantic-focus-indicator)", strokeWidth: _chunkAZGN4HJOcjs.NAV_PIN.focusRing.strokeWidth, strokeLinejoin: "round", vectorEffect: "non-scaling-stroke", pointerEvents: "none", "data-transition-focus-ring": "" }),
        ...
        /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
          "circle",
          {
            r: _chunkAZGN4HJOcjs.NAV_HIT.radius,
            fill: "transparent",
            stroke: "none",
...
//# sourceMappingURL=chunk-FXQDSCNK.cjs.map