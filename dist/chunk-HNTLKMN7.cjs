...
function StateMark({ presentation, icon, size = 22 }) {
  ...
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
    "span",
    {
      ...
      children: _nullishCoalesce(icon, () => ( /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkXETQ3OW3cjs.Icon, { name: _nullishCoalesce(presentation.icon, () => ( "circle-info")), size })))
    }
  );
}
...
//# sourceMappingURL=chunk-HNTLKMN7.cjs.map