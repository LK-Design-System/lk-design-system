...
function trajectoryProgressGeometry(points, pointIndex, viewportScale = 1) {
  ...
  const headVisible = fullPrefix.length >= 2;
  const { paintedPrefix, tipSetbackPx } = applyTipSetback(fullPrefix, _chunkYXXTXTP5cjs.NAV_PROGRESS_HEAD.tipSetback / scale, scale);
  return {
    point,
...
//# sourceMappingURL=chunk-ETVYZPQL.cjs.map