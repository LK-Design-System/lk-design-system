    ...
    Root,
    {
      ...
      children: [
        ...
        sources.length === 0 ? /* @__PURE__ */ jsx("p", { style: { margin: 0, color: "var(--color-semantic-label-neutral)", fontSize: "var(--label1-size)", lineHeight: "var(--label1-line)" }, children: emptyMessage }) : compact ? (
          ...
          /* @__PURE__ */ jsx("ul", { style: { margin: 0, padding: 0, listStyle: "none", display: "flex", flexWrap: "wrap", gap: "var(--space-2)", minWidth: 0 }, children: sources.map((source) => {
...
//# sourceMappingURL=chunk-ZWRHCV4Y.js.map