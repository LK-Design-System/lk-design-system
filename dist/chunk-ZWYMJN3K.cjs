...
function RailItemTooltip({ label, collapsed, enabled = true, children }) {
  ...
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkJSU4HM2Ecjs.Tooltip, { content: label, placement: "right", size: "small", open: collapsed ? open : false, onOpenChange: setOpen, style: { width: "100%" }, children });
}
...
//# sourceMappingURL=chunk-ZWYMJN3K.cjs.map