...
function InputGroup({
  ...
  const Addon = ({ node, side }) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
    "span",
    {
    ...
    _chunk64JQMMMOcjs.FieldStack,
    {
      ...
      children: /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, 
        "div",
        {
          ...
          children: [
            prefix != null && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, Addon, { node: prefix, side: "left" }),
            /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
              "input",
              {
                ...
                onFocus: (event) => {
                  setFocused(true);
                  _optionalChain([onInputFocus, 'optionalCall', _4 => _4(event)]);
                },
                onBlur: (event) => {
                  setFocused(false);
                  _optionalChain([onInputBlur, 'optionalCall', _5 => _5(event)]);
                },
                style: {
                  flex: 1,
                  minWidth: 0,
            ...
            (isInvalid || status === "positive") && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "span", { style: { display: "inline-flex", alignItems: "center", paddingInline: suffix == null ? "var(--space-2)" : 0 }, children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunk64JQMMMOcjs.FieldStatusIcon, { invalid: isInvalid, status }) }),
            suffix != null && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, Addon, { node: suffix, side: "right" })
          ]
        }
      )
    }
...
//# sourceMappingURL=chunk-IOEGH4WH.cjs.map