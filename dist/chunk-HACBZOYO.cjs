...
function Map2DCanvas({
  ...
  const interactionState = _chunkILMPYUGAcjs.resolveViewerState.call(void 0, {
    state,
    availability,
    connection,
    freshness,
  ...
  const interactionBlocked = _chunkILMPYUGAcjs.VIEWER_BLOCKING_STATES.includes(interactionState);
  const {
    rootRef,
    renderedViewport,
    commitViewport,
...
//# sourceMappingURL=chunk-HACBZOYO.cjs.map