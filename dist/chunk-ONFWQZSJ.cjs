...
function SegmentedControl({
  ...
  const fallbackValue = _nullishCoalesce(defaultValue, () => ( _optionalChain([normalizedOptions, 'access', _ => _[enabledIndices[0]], 'optionalAccess', _2 => _2.value])));
  const isControlled = value !== void 0;
  const [internalValue, setInternalValue] = _react2.default.useState(fallbackValue);
  const currentValue = isControlled ? value : internalValue;
  const disabledState = disabled || disable || interaction === "inactive";
  const buttonRefs = _react2.default.useRef([]);
  ...
  const pick = (index, { focus = false } = {}) => {
    ...
    if (focus) _optionalChain([buttonRefs, 'access', _4 => _4.current, 'access', _5 => _5[index], 'optionalAccess', _6 => _6.focus, 'call', _7 => _7()]);
  };
        ...
        return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, 
          "button",
          {
            ...
            style: {
              ...
              letterSpacing: 0,
              color: optionDisabled ? "var(--color-semantic-label-disable)" : active ? "var(--color-semantic-primary-heavy)" : activeFocus ? "var(--color-semantic-label-normal)" : "var(--color-semantic-label-neutral)",
            ...
            children: [
              option.icon && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "span", { "aria-hidden": "true", style: { display: "inline-flex", flex: "0 0 auto" }, children: option.icon }),
              option.label
            ]
          },
          option.value
...
//# sourceMappingURL=chunk-ONFWQZSJ.cjs.map