...
function TopBar({ brand, children, actions, navigationLabel = "\uC8FC \uD0D0\uC0C9", navAlign = "start", sticky = false, bordered = true, dark = false, height = 64, style, ...rest }) {
  ...
  return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0,
    "header",
    {
      ...
      ...rest,
      children: [
        /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "style", { children: TOP_BAR_STYLES }),
        ...
        children != null ? /* @__PURE__ */ _jsxruntime.jsx.call(void 0, TopBarToneContext.Provider, { value: tone, children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "nav", { "aria-label": navigationLabel, "data-top-bar-nav": true, "data-scrollbar-exception": "single-row-global-navigation", style: { display: "flex", alignItems: "center", alignSelf: "stretch", flex: "1 1 auto", minWidth: 0, overflowX: "auto", overflowY: "hidden", scrollbarWidth: "none", WebkitOverflowScrolling: "touch", justifyContent: navAlign === "center" ? "safe center" : "flex-start" }, children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "ul", { style: { display: "flex", alignItems: "center", alignSelf: "stretch", gap: 4, margin: 0, padding: 0, listStyle: "none" }, children: _react2.default.Children.map(children, (child) => child == null || typeof child === "boolean" ? child : /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "li", { style: { display: "flex", alignSelf: "stretch", gap: 4, minWidth: 0 }, children: child })) }) }) }) : /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "div", { style: { flex: 1 } }),
        actions != null && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "div", { "data-top-bar-actions": true, "data-scrollbar-exception": "single-row-global-actions", style: { minWidth: 0, maxWidth: "100%", flex: "0 1 auto", overflowX: "auto", overflowY: "hidden", scrollbarWidth: "none", WebkitOverflowScrolling: "touch" }, children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "div", { style: { display: "flex", alignItems: "center", gap: "var(--space-2-5)", width: "max-content", minWidth: "100%" }, children: actions }) })
      ]
    }
  );
}
function TopBarNavItem({
  ...
  _chunkGJS3WBHUcjs.useLightDismiss.call(void 0, {
    open,
    rootRef: wrapperRef,
    getTrigger: () => _optionalChain([wrapperRef, 'access', _27 => _27.current, 'optionalAccess', _28 => _28.ownerDocument, 'access', _29 => _29.getElementById, 'call', _30 => _30(triggerId)]),
    onDismiss: dismissMenu
  });
  const handleMenuKeyboard = (event) => {
    _optionalChain([onKeyDown, 'optionalCall', _31 => _31(event)]);
    ...
    if (event.key === "ArrowDown" || event.key === "ArrowUp") {
      ...
      _optionalChain([items, 'access', _32 => _32[(itemIndex + offset + items.length) % items.length], 'optionalAccess', _33 => _33.focus, 'call', _34 => _34({ preventScroll: true })]);
    } else if (event.key === "Home" || event.key === "End") {
      event.preventDefault();
      _optionalChain([items, 'access', _35 => _35[event.key === "Home" ? 0 : items.length - 1], 'optionalAccess', _36 => _36.focus, 'call', _37 => _37({ preventScroll: true })]);
    }
  };
  const handlePrimaryClick = (event) => {
    _optionalChain([onClick, 'optionalCall', _38 => _38(event)]);
  ...
  return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0,
    "span",
    {
      ...
      onMouseEnter: (event) => {
        _optionalChain([onMouseEnter, 'optionalCall', _39 => _39(event)]);
        if (!event.defaultPrevented) revealFromPointer();
      },
      onMouseLeave: (event) => {
        _optionalChain([onMouseLeave, 'optionalCall', _40 => _40(event)]);
        if (!event.defaultPrevented) schedulePointerLeave();
      },
      onFocus: (event) => {
        _optionalChain([onFocus, 'optionalCall', _41 => _41(event)]);
        if (event.defaultPrevented) return;
        if (!event.currentTarget.contains(event.relatedTarget)) setDismissed(false);
        setFocusWithin(true);
      },
      onBlur: (event) => {
        _optionalChain([onBlur, 'optionalCall', _42 => _42(event)]);
        if (event.defaultPrevented) return;
          ...
          "button",
          {
            ...
            children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
              "svg",
              {
                ...
                children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "path", { d: "m3.5 5.25 3.5 3.5 3.5-3.5" })
              }
            )
          }
        ) : null,
            ...
            children: menuItems.map((item, index) => {
              ...
              return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "li", { style: { display: "block" }, children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
                ItemComp,
                {
                  ...
                  onClick: (event) => {
                    dismissMenu();
                    _optionalChain([item, 'access', _44 => _44.onClick, 'optionalCall', _45 => _45(event)]);
                  },
                  style: {
                    display: "flex",
                    alignItems: "center",
...
//# sourceMappingURL=chunk-Y2JTSEVN.cjs.map