  ...
  return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "div", { ref, style: { position: "relative", ...style }, ...rest, children: [
    ...
    /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, 
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkQV6BZEQ3cjs.Avatar, { name: typeof name === "string" ? name : void 0, src, status, size: 30, style: { flexShrink: 0 } }),
          ...
          !collapsed && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkX5XHQEI5cjs.Icon, { name: "chevron-up-small", size: 14, color: "var(--color-semantic-label-assistive)", "aria-hidden": "true", style: { flexShrink: 0, transform: open ? "rotate(180deg)" : "none", transition: "transform var(--dur-fast) var(--ease-out)" } })
        ]
      }
    )
  ] });
...
//# sourceMappingURL=chunk-PLZVP7FM.cjs.map