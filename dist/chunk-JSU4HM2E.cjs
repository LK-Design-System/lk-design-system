...
var Tooltip = _react2.default.forwardRef(function Tooltip2({
  ...
  const getTrigger = _react2.default.useCallback(() => _chunk7ECMFW7Hcjs.findOverlayTrigger.call(void 0, wrapperRef.current), []);
  const floating = _chunk7ECMFW7Hcjs.useFloatingPosition.call(void 0, {
    open: visible,
  ...
  const renderedChildren = validTrigger ? _react2.default.cloneElement(children, {
    ...
    "aria-describedby": _chunk7ECMFW7Hcjs.appendAriaReference.call(void 0, children.props["aria-describedby"], tooltipId)
  }) : children;
...
//# sourceMappingURL=chunk-JSU4HM2E.cjs.map