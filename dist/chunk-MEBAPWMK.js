      ...
      "button",
      {
        ...
        children: [
          ...
          !collapsed && /* @__PURE__ */ jsxs("span", { style: { flex: 1, minWidth: 0, display: "flex", flexDirection: "column", gap: "var(--space-0-5)" }, children: [
            /* @__PURE__ */ jsx("span", { style: { fontSize: "var(--label2-size)", fontWeight: "var(--fw-bold)", letterSpacing: 0, color: "var(--component-user-menu-label, var(--color-semantic-label-normal))", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }, children: name }),
            detail != null && /* @__PURE__ */ jsx("span", { style: { fontSize: "var(--caption1-size)", color: "var(--component-user-menu-detail, var(--color-semantic-label-alternative))", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }, children: detail })
          ] }),
          !collapsed && /* @__PURE__ */ jsx(Icon, { name: "chevron-up-small", size: 14, color: "var(--component-user-menu-indicator, var(--color-semantic-label-assistive))", "aria-hidden": "true", style: { flexShrink: 0, transform: open ? "rotate(180deg)" : "none", transition: "transform var(--dur-fast) var(--ease-out)" } })
        ]
      }
    )
  ] });
...
//# sourceMappingURL=chunk-MEBAPWMK.js.map