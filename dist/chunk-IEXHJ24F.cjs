...
function Pagination({
  ...
  const Arrow = ({ dir, disabled }) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
    "button",
    {
      ...
      children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkOZR3K6TYcjs.Icon, { name: dir === "prev" ? "chevron-left-small" : "chevron-right-small", size: 18, "aria-hidden": "true" })
    }
  );
...
//# sourceMappingURL=chunk-IEXHJ24F.cjs.map