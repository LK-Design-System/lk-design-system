...
function actionIcon(icon) {
  if (typeof icon === "string") return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunk3YG66XT2cjs.Icon, { name: icon, size: 16, "aria-hidden": "true" });
  return icon;
}
  ...
  if (showHistory) {
    groups.push({
      ...
      node: /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
        _chunkX7MHZ3UXcjs.HistoryToolbar,
        {
          label: historyLabel,
          canUndo,
          canRedo,
...
//# sourceMappingURL=chunk-7UYTY35O.cjs.map