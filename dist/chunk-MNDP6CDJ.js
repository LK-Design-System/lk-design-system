...
function IconButton({ label, icon, active = false, disabled = false, rail = false, children, onClick }) {
  return /* @__PURE__ */ jsxs(
    "button",
    {
      ...
      children: [
        /* @__PURE__ */ jsx(Icon, { name: icon, size: 15, "aria-hidden": "true" }),
        rail && /* @__PURE__ */ jsx("span", { "aria-hidden": "true", style: { position: "absolute", left: 8, right: 8, bottom: 6, height: 1.5, borderRadius: "var(--radius-pill)", background: "currentColor" } }),
        children
      ]
    }
  );
    ...
    (streamStatus != null || lastUpdatedAt != null || droppedCount > 0) && /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", gap: "var(--space-3)", flexWrap: "wrap", color: "var(--color-semantic-label-neutral)", fontSize: "var(--caption1-size)" }, children: [
      /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", gap: "var(--space-2)", flexWrap: "wrap" }, children: [
        streamStatus != null && (() => {
          ...
          return /* @__PURE__ */ jsx(StatusBadge, { tone: cfg.tone, pulse: cfg.pulse, "data-status": streamStatus, children: cfg.label });
        })(),
        lastUpdatedAt != null && /* @__PURE__ */ jsxs("span", { children: [
          "\uB9C8\uC9C0\uB9C9 \uC218\uC2E0 ",
          /* @__PURE__ */ jsx("strong", { children: lastUpdatedAt })
        ] })
      ] }),
      droppedCount > 0 && /* @__PURE__ */ jsxs("span", { style: { color: "var(--color-semantic-status-cautionary)", fontWeight: "var(--fw-semibold)" }, children: [
        "\uB204\uB77D ",
        droppedCount,
        "\uC904"
      ] })
    ] }),
    (filter || search || tools) && /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap" }, children: [
      filter && /* @__PURE__ */ jsx("div", { style: { display: "flex", gap: 6, flexWrap: "wrap", flex: "1 1 220px" }, children: ORDER.map((lvl) => {
        ...
        return /* @__PURE__ */ jsxs(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ jsx("span", { "aria-hidden": "true", style: { width: 6, height: 6, borderRadius: "50%", background: LEVELS[lvl].c } }),
              LEVELS[lvl].label
            ]
          },
          lvl
      ...
      search && /* @__PURE__ */ jsxs("label", { style: { flex: "1 1 180px", maxWidth: 260, minWidth: 160, height: 28, display: "inline-flex", alignItems: "center", gap: 7, padding: "0 9px", boxSizing: "border-box", border: "1px solid var(--color-semantic-line-normal-normal)", borderRadius: "var(--radius-sm)", background: "var(--color-semantic-background-elevated-normal)", color: "var(--color-semantic-label-assistive)" }, children: [
        ...
        query && /* @__PURE__ */ jsx("button", { type: "button", "aria-label": "\uAC80\uC0C9\uC5B4 \uC9C0\uC6B0\uAE30", onClick: () => setQuery(""), style: { width: 18, height: 18, border: "none", background: "transparent", color: "var(--color-semantic-label-assistive)", cursor: "pointer", padding: 0, display: "inline-flex", alignItems: "center", justifyContent: "center" }, children: /* @__PURE__ */ jsx(Icon, { name: "close", size: 12, "aria-hidden": "true" }) })
      ] }),
      tools && /* @__PURE__ */ jsxs("div", { role: "group", "aria-label": "\uB85C\uADF8 \uB3C4\uAD6C", style: { display: "inline-flex", gap: 6, flex: "0 0 auto" }, children: [
        /* @__PURE__ */ jsx(IconButton, { label: paused ? "\uB85C\uADF8 tail \uC7AC\uAC1C" : "\uB85C\uADF8 tail \uC77C\uC2DC\uC815\uC9C0", icon: paused ? "play" : "pause", active: paused, onClick: togglePause }),
        /* @__PURE__ */ jsx(IconButton, { label: latestCount > 0 ? `\uCD5C\uC2E0 \uB85C\uADF8\uB85C \uC774\uB3D9, \uC0C8 \uB85C\uADF8 ${latestCount > 99 ? "99+" : latestCount}\uC904` : "\uCD5C\uC2E0 \uB85C\uADF8\uB85C \uC774\uB3D9", icon: "arrow-down", rail: true, onClick: jumpToLatest, children: latestCount > 0 && /* @__PURE__ */ jsx("span", { "aria-hidden": "true", style: { position: "absolute", top: -5, right: -5, minWidth: 16, height: 16, padding: "0 4px", boxSizing: "border-box", borderRadius: "var(--radius-pill)", background: "var(--color-semantic-status-negative)", color: "var(--color-semantic-static-white)", fontSize: "var(--caption2-size)", lineHeight: "16px", fontWeight: "var(--fw-bold)" }, children: latestCount > 99 ? "99+" : `+${latestCount}` }) }),
        /* @__PURE__ */ jsx(IconButton, { label: "\uD45C\uC2DC \uB85C\uADF8 \uC9C0\uC6B0\uAE30", icon: "trash", disabled: currentLines.length === 0, onClick: clearVisible }),
        onExport && /* @__PURE__ */ jsx(IconButton, { label: "\uB85C\uADF8 \uB0B4\uBCF4\uB0B4\uAE30", icon: "download", disabled: shown.length === 0, onClick: () => onExport(shown) })
      ] })
    ] }),
    /* @__PURE__ */ jsx(VisuallyHidden, { role: "status", "aria-live": "polite", "aria-atomic": "true", children: announcement }),
    /* @__PURE__ */ jsxs("div", { ref: boxRef, role: "log", "aria-live": "off", "aria-label": ariaLabel, tabIndex: 0, onScroll: updateScrollState, style: { height, overflow: "auto", scrollbarGutter: "stable", padding: metrics.panelPadding, borderRadius: "var(--radius-md)", background: "var(--color-semantic-inverse-background)", border: "1px solid var(--color-semantic-inverse-line-normal)", fontFamily: "var(--font-mono)", fontSize: metrics.fontSize, lineHeight: metrics.lineHeight }, children: [
      ...
      visibleLines.map((line, visibleIndex) => {
        ...
        return /* @__PURE__ */ jsxs("div", { style: { display: "grid", gridTemplateColumns, columnGap: 10, alignItems: "baseline", minHeight: metrics.rowMinHeight, height: virtualActive ? rowHeight : void 0, overflow: virtualActive ? "hidden" : void 0, whiteSpace: virtualActive || !wrap ? "nowrap" : "pre-wrap", wordBreak: virtualActive || !wrap ? "normal" : "break-word" }, children: [
          /* @__PURE__ */ jsx("span", { style: { color: "var(--color-semantic-inverse-label-neutral-soft)", fontVariantNumeric: "tabular-nums" }, children: line.time }),
          /* @__PURE__ */ jsx("span", { style: { color: cfg.log, fontWeight: "var(--fw-bold)" }, children: cfg.label }),
          /* @__PURE__ */ jsx("span", { style: { color: "var(--color-semantic-inverse-label-neutral-soft)", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }, children: line.source }),
          /* @__PURE__ */ jsx("span", { style: { color: "var(--color-semantic-inverse-label)", minWidth: 0, overflow: virtualActive || !wrap ? "hidden" : "visible", textOverflow: virtualActive || !wrap ? "ellipsis" : "clip" }, children: line.text }),
          copyable && /* @__PURE__ */ jsx(
            "button",
            {
              ...
              children: /* @__PURE__ */ jsx(Icon, { name: copied ? "circle-check" : "copy", size: 14, "aria-hidden": "true" })
            }
          )
        ] }, index);
      }),
      virtualActive && bottomSpacer > 0 && /* @__PURE__ */ jsx("div", { "aria-hidden": "true", style: { height: bottomSpacer } })
    ] })
  ] });
}
...
//# sourceMappingURL=chunk-MNDP6CDJ.js.map