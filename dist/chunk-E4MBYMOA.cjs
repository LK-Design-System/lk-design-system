      ...
      children: [
        /* @__PURE__ */ _jsxruntime.jsxs.call(void 0,
          "button",
          {
            ...
            style: { display: "inline-flex", alignItems: "center", gap: "var(--component-input-gap)", width: full ? "100%" : void 0, height: h, padding: "0 var(--component-input-padding-x)", minWidth: full ? 0 : 200, boxSizing: "border-box", background: disabled ? "var(--color-semantic-fill-normal)" : "var(--component-input-bg)", border: `1px solid ${borderColor}`, borderRadius: "var(--component-input-radius)", boxShadow: focused || open ? "var(--component-input-focus-shadow)" : "none", cursor: disabled ? "not-allowed" : "pointer", fontFamily: "var(--font-sans)", ..._chunkIDTVAPZEcjs.fieldTypography.call(void 0, size), color: disabled ? "var(--color-semantic-label-disable)" : sel ? "var(--color-semantic-label-normal)" : "var(--color-semantic-label-alternative)", transition: "border-color var(--dur-fast) var(--ease-out), box-shadow var(--dur-fast) var(--ease-out)" },
            children: [
...
//# sourceMappingURL=chunk-E4MBYMOA.cjs.map