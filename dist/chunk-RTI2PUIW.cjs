...
function Pagination({
  ...
  const Arrow = ({ dir, disabled }) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
    "button",
    {
      ...
      children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkVHQHPPYQcjs.Icon, { name: dir === "prev" ? "chevron-left-small" : "chevron-right-small", size: 18, "aria-hidden": "true" })
    }
  );
...
//# sourceMappingURL=chunk-RTI2PUIW.cjs.map