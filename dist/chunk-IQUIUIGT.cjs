  ...
  const items = locales.map((locale) => ({
    icon: /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
      "span",
      {
        ...
        children: locale.value === value && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkVHQHPPYQcjs.Icon, { name: "check", size: 16, "aria-hidden": "true" })
      }
    ),
    iconPosition: "end",
...
//# sourceMappingURL=chunk-IQUIUIGT.cjs.map