...
function resolveDecimalSeparator(locale) {
  try {
    return _nullishCoalesce(_optionalChain([new Intl.NumberFormat(locale), 'access', _ => _.formatToParts, 'call', _2 => _2(1.1), 'access', _3 => _3.find, 'call', _4 => _4((part) => part.type === "decimal"), 'optionalAccess', _5 => _5.value]), () => ( "."));
  } catch (e) {
    return ".";
  }
}
...
function VirtualKeypad({
  ...
  const currentValue = String(_nullishCoalesce(value, () => ( "")));
  ...
  const preserveTargetFocus = (event) => {
    ...
    if (_optionalChain([target, 'optionalAccess', _6 => _6.tagName]) === "INPUT" && ownerDocument.activeElement === target) {
  ...
  return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, 
    "div",
    {
      ...rest,
      role: "group",
      "aria-label": _nullishCoalesce(ariaLabel, () => ( (ariaLabelledBy ? void 0 : "\uC22B\uC790 \uD0A4\uD328\uB4DC"))),
      "aria-labelledby": ariaLabelledBy,
      ...
      children: [
        ...
        /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
          _chunkYQ33OVLEcjs.Button,
          {
            ...
            onClick: () => _optionalChain([onConfirm, 'optionalCall', _7 => _7(currentValue)]),
...
exports.VirtualKeypad = VirtualKeypad;
//# sourceMappingURL=chunk-J7VSTN64.cjs.map