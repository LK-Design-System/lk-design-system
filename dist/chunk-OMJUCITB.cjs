      ...
      children: [
        ...
        legend && segments.length > 0 && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "div", { "aria-hidden": "true", style: { display: "flex", flex: "1 1 132px", minWidth: 0, flexDirection: "column", gap: 8 }, children: segments.map((segment, index) => {
          ...
          return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "span", { style: { display: "grid", gridTemplateColumns: "10px minmax(0, 1fr) auto", alignItems: "center", gap: 8, minWidth: 0, fontFamily: "var(--font-sans)", fontSize: "var(--label2-size)", color: "var(--color-semantic-label-neutral)" }, children: [
            ...
            /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "b", { style: { marginLeft: 2, color: "var(--color-semantic-label-normal)", fontVariantNumeric: "tabular-nums" }, children: [
              percentage,
              "%"
            ] })
          ] }, _nullishCoalesce(segment.id, () => ( index)));
...
//# sourceMappingURL=chunk-OMJUCITB.cjs.map