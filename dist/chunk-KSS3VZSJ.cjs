            ...
            children: sources.map((source, index) => {
              ...
              const rowSummary = /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, 
                "span",
                {
                  ...
                  children: [
                    identity,
                    /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkWZUH43FEcjs.StatusBadge, { className: "lk-source-disclosure__status", tone: availability.tone, style: { flexShrink: 0, whiteSpace: "nowrap" }, children: _nullishCoalesce(source.availabilityLabel, () => ( availability.label)) }),
