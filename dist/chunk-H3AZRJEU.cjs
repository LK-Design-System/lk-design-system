...
var _chunkCO4GX3SJcjs = require('./chunk-CO4GX3SJ.cjs');
...
function UserMenu({ name, detail, src, status, items = [], collapsed = false, style, ...rest }) {
  ...
  const { menuRef, requestItemFocus, closeMenu, handleMenuKeyDown } = _chunkCO4GX3SJcjs.useMenuKeyboard.call(void 0, {
    open,
  ...
  return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "div", { ref, style: { position: "relative", ...style }, ...rest, children: [
    ...
    /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, 
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunk77QMSMN6cjs.Avatar, { name: typeof name === "string" ? name : void 0, src, status, size: 30, style: { flexShrink: 0 } }),
          !collapsed && /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "span", { style: { flex: 1, minWidth: 0, display: "flex", flexDirection: "column", gap: 1 }, children: [
          ...
          !collapsed && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkVGM7HVYYcjs.Icon, { name: "chevron-up-small", size: 14, color: "var(--color-semantic-label-assistive)", "aria-hidden": "true", style: { flexShrink: 0, transform: open ? "rotate(180deg)" : "none", transition: "transform var(--dur-fast) var(--ease-out)" } })
        ]
      }
    )
  ] });
...
//# sourceMappingURL=chunk-H3AZRJEU.cjs.map