...
function SourceTag({ children, label = "SOURCE", href, tone = "default", style, ...rest }) {
  ...
  return /* @__PURE__ */ jsxs(
    Comp,
    {
      ...
      ...rest,
      children: [
        /* @__PURE__ */ jsx("span", { style: { fontFamily: MONO, fontSize: "var(--caption2-size)", fontWeight: 700, letterSpacing: 1, textTransform: "uppercase", color: onDark ? "var(--color-semantic-primary-normal)" : "var(--color-semantic-primary-heavy)" }, children: label }),
...
//# sourceMappingURL=chunk-OHASSHQD.js.map