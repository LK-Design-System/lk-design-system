...
function actionIcon(icon) {
  if (typeof icon === "string") return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkMND2ABGOcjs.Icon, { name: icon, size: 16, "aria-hidden": "true" });
  return icon;
}
  ...
  if (showHistory) {
    groups.push({
      ...
      node: /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
        _chunkO4R6ALPPcjs.HistoryToolbar,
        {
          label: historyLabel,
          canUndo,
          canRedo,
...
//# sourceMappingURL=chunk-TWSWEMMK.cjs.map