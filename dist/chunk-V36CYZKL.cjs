...
// packages/core/dist/chunk-OWOSZXP5.js
...
var Tooltip = _react2.default.forwardRef(function Tooltip2({
  ...
  const [visible, setVisible] = _chunkCXNCDZQYcjs.useControllableOpen.call(void 0, { open, defaultOpen, onOpenChange });
  const requestedPlace = position || placement || "top";
  const wrapperRef = _react2.default.useRef(null);
  const mergedWrapperRef = _chunkCXNCDZQYcjs.useMergedRefs.call(void 0, wrapperRef, forwardedRef);
  const bubbleRef = _react2.default.useRef(null);
  const tooltipId = _react2.default.useId();
  const getTrigger = _react2.default.useCallback(() => _chunkCXNCDZQYcjs.findOverlayTrigger.call(void 0, wrapperRef.current), []);
  const floating = _chunkCXNCDZQYcjs.useFloatingPosition.call(void 0, {
    open: visible,
  ...
  const layer = _chunkCXNCDZQYcjs.useLightDismiss.call(void 0, {
    open: visible,
    rootRef: wrapperRef,
    getTrigger,
    onDismiss: () => {
  ...
  const renderedChildren = validTrigger ? _react2.default.cloneElement(children, {
    ...
    "aria-describedby": _chunkCXNCDZQYcjs.appendAriaReference.call(void 0, children.props["aria-describedby"], tooltipId)
  }) : children;
  return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0,
    "span",
    {
      ...
      style: { ..._chunkCXNCDZQYcjs.componentVars.call(void 0, vars, "--lds-tooltip-"), position: "relative", display: "inline-flex", ..._chunkCXNCDZQYcjs.partStyle.call(void 0, styles, "root"), ...style },
      ...
      children: [
        renderedChildren,
        /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkCXNCDZQYcjs.OverlayPortal, { open: visible, withinPortal, portalTarget, anchorRef: wrapperRef, layer: "anchored", children: /* @__PURE__ */ _jsxruntime.jsxs.call(void 0,
          "span",
          {
            ref: bubbleRef,
            id: tooltipId,
            "data-slot": "bubble",
            className: _chunkCXNCDZQYcjs.partClassName.call(void 0, classNames, "bubble") || void 0,
            role: "tooltip",
            "aria-hidden": visible ? false : void 0,
            "data-placement": place,
            style: {
              ..._chunkCXNCDZQYcjs.componentVars.call(void 0, vars, "--lds-tooltip-"),
              ...
              ..._chunkCXNCDZQYcjs.partStyle.call(void 0, styles, "bubble")
            },
            children: [
              bubblePath && /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
                "svg",
                {
                  ...
                  "data-slot": "surface",
                  className: _chunkCXNCDZQYcjs.partClassName.call(void 0, classNames, "surface") || void 0,
                  ...
                  style: {
                    ...
                    overflow: "visible",
                    pointerEvents: "none",
                    ..._chunkCXNCDZQYcjs.partStyle.call(void 0, styles, "surface")
                  },
                ...
                "span",
                {
                  ...
                  children: [
                    ...
                    shortcut != null && /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
                      ...
                      {
                        "data-slot": "shortcut",
                        className: _chunkCXNCDZQYcjs.partClassName.call(void 0, classNames, "shortcut") || void 0,
                        style: {
                          color: "var(--color-semantic-inverse-label-alternative-soft)",
                          fontWeight: "var(--fw-bold)",
                          ..._chunkCXNCDZQYcjs.partStyle.call(void 0, styles, "shortcut")
                        },
                        children: shortcut
                      }
                    )
...
//# sourceMappingURL=chunk-V36CYZKL.cjs.map