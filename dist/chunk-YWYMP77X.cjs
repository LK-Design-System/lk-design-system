...
var PIN_PATH = _chunkYXXTXTP5cjs.NAV_PIN.path;
function FacilityTransition({
  ...
  const stateBadges = [
    ...
    stale ? { kind: "stale", tone: "var(--viewer-muted, var(--color-semantic-label-alternative))", dash: _chunkYXXTXTP5cjs.NAV_DASH.staleRing } : null
  ...
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
    "g",
    {
      ...
      children: /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "g", { transform: `scale(${inverseScale})`, "data-transition-screen-space": "", children: [
        /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "path", { d: PIN_PATH, transform: _chunkYXXTXTP5cjs.NAV_PIN.shadow.transform, fill: _chunkYXXTXTP5cjs.NAV_PIN.shadow.fill, opacity: _chunkYXXTXTP5cjs.NAV_PIN.shadow.opacity, pointerEvents: "none", "data-transition-shadow": "" }),
        activeFocus && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "path", { d: PIN_PATH, transform: `scale(${_chunkYXXTXTP5cjs.NAV_PIN.focusRing.scale})`, fill: "none", stroke: "var(--color-semantic-focus-indicator)", strokeWidth: _chunkYXXTXTP5cjs.NAV_PIN.focusRing.strokeWidth, strokeLinejoin: "round", vectorEffect: "non-scaling-stroke", pointerEvents: "none", "data-transition-focus-ring": "" }),
        selected && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "path", { d: PIN_PATH, transform: `scale(${_chunkYXXTXTP5cjs.NAV_PIN.selectionRing.scale})`, fill: "none", stroke: "var(--viewer-accent, var(--color-semantic-primary-normal))", strokeWidth: _chunkYXXTXTP5cjs.NAV_PIN.selectionRing.strokeWidth, strokeLinejoin: "round", vectorEffect: "non-scaling-stroke", pointerEvents: "none", "data-transition-selection-ring": "" }),
        ...
        /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
          _chunk7QTG7XVGcjs.FacilityGlyph,
          {
        ...
        stateBadges.length > 0 && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "g", { ...obstacle(`facility:${transition.id}:states`), "data-transition-state-slot-layer": "", pointerEvents: "none", children: stateBadges.map((state) => /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, 
          "g",
          {
...
//# sourceMappingURL=chunk-YWYMP77X.cjs.map