...
function NumberField({ value, defaultValue = 0, min = -Infinity, max = Infinity, step = 1, onChange, label, helper, error, invalid = false, required = false, size = "md", disabled = false, readOnly = false, placeholder, id, fieldStyle, style, "aria-label": ariaLabel, "aria-describedby": ariaDescribedBy, onFocus, onBlur, onKeyDown, ...rest }) {
  ...
  const metadata = _chunkZF2ZP65Lcjs.useFieldMetadata.call(void 0, { prefix: "number-field", id, label, helper, error, describedBy: ariaDescribedBy });
  ...
  const arrow = (dir) => {
    ...
    return /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
      "button",
      {
        ...
        children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunk7OXVB7WXcjs.Icon, { name: dir < 0 ? "chevron-down-small" : "chevron-up-small", size: 12, "aria-hidden": "true" })
      }
    );
  };
  const control = /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "div", { style: { display: "inline-flex", alignItems: "stretch", width: "fit-content", height: h, border: `1px solid ${_chunkZF2ZP65Lcjs.fieldBorderColor.call(void 0, { disabled, readOnly, invalid: isInvalid, focused })}`, borderRadius: "var(--component-input-radius)", background: _chunkZF2ZP65Lcjs.fieldBackground.call(void 0, { disabled, readOnly }), boxShadow: focused ? "var(--component-input-focus-shadow)" : "none", overflow: "hidden", transition: "border-color var(--dur-fast) var(--ease-out), box-shadow var(--dur-fast) var(--ease-out)", ...style }, children: [
    /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
      "input",
      {
        ...
        style: { width: 92, padding: "0 var(--component-input-padding-x)", border: "none", outline: "none", background: "transparent", fontFamily: "var(--font-sans)", ..._chunkZF2ZP65Lcjs.fieldTypography.call(void 0, size), fontWeight: "var(--fw-semibold)", color: disabled ? "var(--color-semantic-label-disable)" : "var(--color-semantic-label-normal)" }
      }
    ),
...
//# sourceMappingURL=chunk-E6X6QFAD.cjs.map