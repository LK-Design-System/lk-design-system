    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxs("div", { style: { position: "relative", height: 24 }, children: [
          ...
          /* @__PURE__ */ jsx("div", { style: { position: "absolute", top: 9, height: 6, borderRadius: "var(--radius-pill)", background: disabled ? "var(--color-semantic-interaction-inactive)" : "var(--color-semantic-primary-normal)", left: `${pctLo}%`, right: `${100 - pctHi}%` } }),
          /* @__PURE__ */ jsx(
            "input",
            {
...
//# sourceMappingURL=chunk-VBH4TFXU.js.map