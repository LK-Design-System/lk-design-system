    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: 12, minWidth: 0, marginBottom: 16 }, children: [
          label != null && /* @__PURE__ */ jsx("span", { id: labelId, style: { minWidth: 0, fontSize: "var(--caption1-size)", lineHeight: "var(--caption1-line)", fontWeight: "var(--fw-bold)", letterSpacing: "var(--ls-overline)", textTransform: "uppercase", overflowWrap: "anywhere", color: "var(--color-semantic-label-alternative)" }, children: label }),
...
//# sourceMappingURL=chunk-4LCYKJYY.js.map