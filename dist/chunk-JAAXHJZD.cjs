...
var Popover = _react2.default.forwardRef(function Popover2({
  ...
  const [visible, setVisible] = _chunk7ECMFW7Hcjs.useControllableOpen.call(void 0, { open, defaultOpen, onOpenChange });
  ...
  const getTrigger = _react2.default.useCallback(() => _chunk7ECMFW7Hcjs.findOverlayTrigger.call(void 0, rootRef.current), []);
  ...
  const layer = _chunk7ECMFW7Hcjs.useLightDismiss.call(void 0, {
    open: visible,
    rootRef,
    getTrigger,
  ...
  const triggerProps = {
    ...
    "aria-controls": visible ? _chunk7ECMFW7Hcjs.appendAriaReference.call(void 0, _optionalChain([trigger, 'optionalAccess', _5 => _5.props, 'optionalAccess', _6 => _6["aria-controls"]]), panelId) : _optionalChain([trigger, 'optionalAccess', _7 => _7.props, 'optionalAccess', _8 => _8["aria-controls"]]),
    onClick: toggle
  };
        ...
        /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkF4O2CAUIcjs.OverlayPortal, { open: visible, withinPortal, portalTarget, anchorRef: rootRef, layer: "anchored", children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
          "div",
          {
            ...
            style: {
              ...
              ...withinPortal ? { position: "fixed", top: _nullishCoalesce(position.y, () => ( -9999)), left: _nullishCoalesce(position.x, () => ( -9999)), right: "auto", bottom: "auto", translate: "none" } : _chunk7ECMFW7Hcjs.inlineFloatingStyle.call(void 0, { placement: position.placement, align, offset, shiftX: position.shiftX, shiftY: position.shiftY }),
              zIndex: layer.zIndex,
...
//# sourceMappingURL=chunk-JAAXHJZD.cjs.map