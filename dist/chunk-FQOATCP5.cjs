...
function BackToTopButton() {
  ...
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
    "button",
    {
      ...
      children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkX5XHQEI5cjs.Icon, { name: "chevron-up", size: 22, "aria-hidden": "true" })
    }
  );
}
function Footer({
  ...
  if (compact) {
    return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "footer", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", gap: "8px 24px", flexWrap: "wrap", padding: "14px 2px", borderTop: "1px solid var(--color-semantic-line-normal-normal)", fontFamily: "var(--font-sans)", ...style }, ...rest, children: [
      ...
      links.length > 0 && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "ul", { style: { ...plainList, display: "flex", alignItems: "center", gap: 18 }, children: links.map((l, i) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "li", { style: { display: "inline-flex" }, children: linkEl("c" + i, l, "var(--color-semantic-label-alternative)", "var(--color-semantic-label-normal)", "var(--caption1-size)") }, i)) })
    ] });
  }
  ...
  return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "footer", { style: { background: "var(--color-semantic-inverse-background)", padding: "32px 0 40px", fontFamily: "var(--font-sans)", ...style }, ...rest, children: [
    ...
    /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "div", { style: { maxWidth, margin: "0 auto", padding: "0 32px", boxSizing: "border-box" }, children: [
      (brand != null || columns.length > 0) && /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, _react2.default.Fragment, { children: [
        /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "div", { style: { display: "flex", flexWrap: "wrap", alignItems: "flex-start", gap: "36px 48px", paddingTop: 20 }, children: [
          ...
          columns.map((col, ci) => /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "nav", { "aria-label": typeof col.heading === "string" ? col.heading : void 0, style: { display: "flex", flexDirection: "column", gap: linkColumnGap, minWidth: 108 }, children: [
            col.heading != null && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "span", { role: "heading", "aria-level": 3, style: { fontSize: "var(--body2-size)", fontWeight: 800, letterSpacing: 0, lineHeight: 1.5, color: "var(--color-semantic-inverse-label)", marginBottom: 2, wordBreak: "keep-all" }, children: col.heading }),
            (col.links || []).length > 0 && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "ul", { style: { ...plainList, display: "flex", flexDirection: "column", gap: linkColumnGap }, children: (col.links || []).map((l, li) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "li", { style: { display: "flex" }, children: linkEl(ci + "-" + li, l, "var(--color-semantic-inverse-label-alternative-soft)", "var(--color-semantic-inverse-label-strong-soft)", "var(--label2-size)") }, li)) })
          ] }, ci))
        ] }),
      ...
      /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "div", { style: { display: "flex", flexDirection: "column", alignItems: "flex-start", gap: 8, fontSize: "var(--label2-size)", lineHeight: 1.6, color: "var(--color-semantic-inverse-label-neutral-soft)", wordBreak: "keep-all" }, children: [
        ...
        /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "div", { style: { marginTop: 18, display: "flex", flexWrap: "wrap", alignItems: "center", gap: "4px 20px", color: "var(--color-semantic-inverse-label-alternative-soft)" }, children: [
          copyright,
          links.length > 0 && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "ul", { style: { ...plainList, display: "flex", alignItems: "center", gap: 16 }, children: links.map((l, i) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "li", { style: { display: "inline-flex" }, children: linkEl("p" + i, l, "var(--color-semantic-inverse-label-alternative-soft)", "var(--color-semantic-inverse-label-strong-soft)", "var(--caption1-size)") }, i)) })
        ] })
      ] })
    ] })
  ] });
...
//# sourceMappingURL=chunk-FQOATCP5.cjs.map