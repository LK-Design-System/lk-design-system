...
function Footer({
  ...
  const linkEl = (key, l, base, hover, size, weight) => /* @__PURE__ */ jsx(
    "a",
    {
      href: l.href || "#",
  ...
  if (compact) {
    return /* @__PURE__ */ jsxs("footer", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", gap: "8px 24px", flexWrap: "wrap", padding: "14px 2px", borderTop: "1px solid var(--color-semantic-line-normal-normal)", fontFamily: "var(--font-sans)", ...style }, ...rest, children: [
      ...
      links.length > 0 && /* @__PURE__ */ jsx("span", { style: { display: "flex", alignItems: "center", gap: 18 }, children: links.map((l, i) => linkEl("c" + i, l, "var(--color-semantic-label-alternative)", "var(--color-semantic-label-normal)", "var(--caption1-size)")) })
    ] });
  }
  ...
  return /* @__PURE__ */ jsxs("footer", { style: { background: "var(--color-semantic-inverse-background)", padding: "32px 0 40px", fontFamily: "var(--font-sans)", ...style }, ...rest, children: [
    ...
    /* @__PURE__ */ jsxs("div", { style: { maxWidth, margin: "0 auto", padding: "0 32px", boxSizing: "border-box" }, children: [
      (brand != null || columns.length > 0) && /* @__PURE__ */ jsxs(React.Fragment, { children: [
        /* @__PURE__ */ jsxs("div", { style: { display: "flex", flexWrap: "wrap", alignItems: "flex-start", gap: "36px 48px", paddingTop: 20 }, children: [
          brand != null && /* @__PURE__ */ jsx("div", { style: { flex: "1 1 240px", minWidth: 220 }, children: brand }),
          columns.map((col, ci) => /* @__PURE__ */ jsxs("nav", { "aria-label": typeof col.heading === "string" ? col.heading : void 0, style: { display: "flex", flexDirection: "column", gap: 11, minWidth: 108 }, children: [
            col.heading != null && /* @__PURE__ */ jsx("span", { style: { fontSize: "var(--body2-size)", fontWeight: 800, letterSpacing: 0, lineHeight: 1.5, color: "var(--color-semantic-inverse-label)", marginBottom: 2, wordBreak: "keep-all" }, children: col.heading }),
      ...
      /* @__PURE__ */ jsxs("div", { style: { display: "flex", flexDirection: "column", alignItems: "flex-start", gap: 8, fontSize: "var(--label2-size)", lineHeight: 1.6, color: "var(--color-semantic-inverse-label-neutral-soft)", wordBreak: "keep-all" }, children: [
        ...
        /* @__PURE__ */ jsxs("span", { style: { marginTop: 18, display: "flex", flexWrap: "wrap", alignItems: "center", gap: "4px 20px", color: "var(--color-semantic-inverse-label-alternative-soft)" }, children: [
          copyright,
          links.length > 0 && /* @__PURE__ */ jsx("span", { style: { display: "flex", alignItems: "center", gap: 16 }, children: links.map((l, i) => linkEl("p" + i, l, "var(--color-semantic-inverse-label-alternative-soft)", "var(--color-semantic-inverse-label-strong-soft)", "var(--caption1-size)")) })
        ] })
      ] })
    ] })
  ] });
...
//# sourceMappingURL=chunk-A44Q64FG.js.map