...
var Input = _react2.default.forwardRef(function Input2({
  ...
  usePlaceholderStyle();
  const ring = _chunk544Y73GCcjs.fieldBorderColor.call(void 0, { disabled, readOnly, invalid: isInvalid, status, focused: activeFocus, hovered: activeHover });
  ...
  return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0,
    "div",
    {
      ...
      style: {
        ...
        */
        ..._chunkGWMGPLNWcjs.componentVars.call(void 0, vars, "--lds-input-"),
        display: "flex",
            ...
            children: [
              ...
              /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
                "input",
                {
                  ...
                  "aria-describedby": _chunk544Y73GCcjs.mergeIds.call(void 0, rest["aria-describedby"], messageId),
                  ...
                  style: { flex: 1, minWidth: 0, height: "100%", boxSizing: "border-box", border: "none", outline: "none", background: "transparent", cursor: disabled ? "not-allowed" : readOnly ? "text" : void 0, fontFamily: "var(--font-sans)", ..._chunk544Y73GCcjs.fieldTypography.call(void 0, normalizedSize), color: disabled ? "var(--color-semantic-label-disable)" : "var(--color-semantic-label-normal)", ..._chunkGWMGPLNWcjs.partStyle.call(void 0, styles, "input"), ...inputStyle }
                }
              ),
...
exports.Input = Input;
//# sourceMappingURL=chunk-OB6YCFMZ.cjs.map