...
function SourceTag({ children, label = "SOURCE", href, tone = "default", style, ...rest }) {
  ...
  return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, 
    Comp,
    {
      ...
      ...rest,
      children: [
        /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "span", { style: { fontFamily: MONO, fontSize: "var(--caption2-size)", fontWeight: 700, letterSpacing: 1, textTransform: "uppercase", color: onDark ? "var(--color-semantic-primary-normal)" : "var(--color-semantic-primary-heavy)" }, children: label }),
...
//# sourceMappingURL=chunk-PYFN42IH.cjs.map