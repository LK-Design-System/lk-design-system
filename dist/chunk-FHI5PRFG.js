  ...
  return /* @__PURE__ */ jsxs(
    Root,
    {
      ...
      children: [
        ...
        visible.length === 0 ? /* @__PURE__ */ jsx("p", { style: mutedLineStyle, children: withheldLine ?? emptyMessage }) : variant === "chips" ? /* @__PURE__ */ jsx("ul", { style: { margin: 0, padding: 0, listStyle: "none", display: "flex", flexWrap: "wrap", gap: "var(--space-2)", minWidth: 0 }, children: visible.map((source) => renderSourceChip(source, onSourceActivate)) }) : /* @__PURE__ */ jsx(
          "ul",
          {
            style: {
              margin: 0,
            ...
            children: visible.map((source, index) => /* @__PURE__ */ jsx(SourceRow, { source, first: index === 0, onSourceActivate }, source.id))
          }
        ),
