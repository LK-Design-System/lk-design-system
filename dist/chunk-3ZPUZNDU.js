...
function Breadcrumb({ items = [], style, ...rest }) {
  return /* @__PURE__ */ jsx("nav", { "aria-label": "breadcrumb", style: { display: "flex", alignItems: "center", flexWrap: "wrap", gap: 8, fontFamily: "var(--font-sans)", fontSize: "var(--label2-size)", ...style }, ...rest, children: items.map((it, i) => {
...
//# sourceMappingURL=chunk-3ZPUZNDU.js.map