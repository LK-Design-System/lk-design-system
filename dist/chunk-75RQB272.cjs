...
function FileUpload({
  ...
  const { fieldId: inputId, describedBy } = _chunkGYQC2LMQcjs.useFieldMetadata.call(void 0, { prefix: "file-upload", describedBy: inputAriaDescribedBy });
...
//# sourceMappingURL=chunk-75RQB272.cjs.map