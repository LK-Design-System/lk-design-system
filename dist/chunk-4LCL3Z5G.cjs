...
function DirectoryOpenButton({ entry, disabled, onNavigate }) {
  ...
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
    "button",
    {
      ...
      children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkVGM7HVYYcjs.Icon, { name: "chevron-right", size: 14, "aria-hidden": "true" })
    }
  );
}
function FileBrowser({
  ...
  return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, 
    ...
    {
      role: "group",
      "aria-label": _nullishCoalesce(ariaLabel, () => ( "File browser")),
        ...
        /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "header", { style: { display: "flex", alignItems: "center", gap: "var(--space-2)", minWidth: 0, padding: "var(--space-2) var(--space-3)", borderBottom: "1px solid var(--color-semantic-line-normal-normal)", background: "var(--color-semantic-background-elevated-alternative)" }, children: [
          /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
            "button",
            {
              ...
              children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkVGM7HVYYcjs.Icon, { name: "arrow-up", size: 15, "aria-hidden": "true" })
            }
          ),
          /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "code", { "aria-label": `\uD604\uC7AC \uACBD\uB85C ${path}`, title: path, style: { minWidth: 0, flex: 1, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap", color: "var(--color-semantic-label-strong)", fontFamily: "var(--font-mono)", fontSize: "var(--label2-size)" }, children: path })
        ] }),
        /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "ul", { "aria-label": "Files and folders", style: { display: "grid", gap: 2, margin: 0, padding: 4, overflow: "auto", maxHeight, listStyle: "none" }, children: loading ? /* @__PURE__ */ _jsxruntime.jsx.call(void 0, StateRow, { role: "status", children: loadingMessage }) : error != null ? /* @__PURE__ */ _jsxruntime.jsx.call(void 0, StateRow, { role: "alert", children: error }) : entries.length === 0 ? /* @__PURE__ */ _jsxruntime.jsx.call(void 0, StateRow, { children: emptyMessage }) : entries.map((entry) => {
          ...
          return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "li", { style: { display: "grid", gridTemplateColumns: "minmax(0, 1fr) auto", gap: 4, alignItems: "center" }, children: [
            /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, 
              "button",
              {
                ...
                children: [
                  /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkVGM7HVYYcjs.Icon, { name: directory ? "folder" : "document", size: 18, "aria-hidden": "true" }),
...
//# sourceMappingURL=chunk-4LCL3Z5G.cjs.map