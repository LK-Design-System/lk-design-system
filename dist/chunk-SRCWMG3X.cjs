...
function SearchableMultiSelect({
  ...
  const {
    ...
    messageId,
    describedBy
  } = _chunk4KUVQPIKcjs.useFieldMetadata.call(void 0, { prefix: "searchable-multi-select", label, helper, error });
  ...
  return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, 
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunk4KUVQPIKcjs.FieldMessage, { id: messageId, message, error })
      ]
    }
  );
}
...
//# sourceMappingURL=chunk-SRCWMG3X.cjs.map