...
function ToolbarButton({ item, active, disabled, onAction, index, tabIndex, onFocus }) {
  ...
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
    "button",
    {
      ...
      children: item.icon ? /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkF72KSGF7cjs.Icon, { name: item.icon, size: 17, "aria-hidden": "true" }) : item.children
    }
  );
}
...
//# sourceMappingURL=chunk-MFYWU6ED.cjs.map