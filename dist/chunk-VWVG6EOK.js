...
function SideNav({
  ...
  const panelContent = /* @__PURE__ */ jsxs("div", { id: panelId, className: "lk-sidenav__panel-content", "data-collapsed": col ? "true" : "false", style: { display: "flex", flexDirection: "column", flex: "1 1 auto", minHeight: 0 }, children: [
    ...
    /* @__PURE__ */ jsx("ul", { className: "lk-scroll-surface lk-sidenav__scroll", "data-scrollbar": "compact", "data-scroll-gutter": col ? "auto" : "stable", style: { display: "flex", flexDirection: "column", gap: "var(--space-0-5)", flex: "1 1 auto", minHeight: 0, margin: 0, padding: 0, listStyle: "none", overflowX: col ? "visible" : "hidden", overflowY: col ? "visible" : "auto" }, children: items.map((o, i) => {
    ...
    /* @__PURE__ */ jsx("div", { style: { marginTop: "auto", paddingTop: 8 }, children: footer != null && /* @__PURE__ */ jsx("div", { style: { paddingTop: "var(--space-2-5)", marginLeft: "var(--space-0-5)", marginRight: "var(--space-0-5)", borderTop: "1px solid var(--color-semantic-line-solid-normal)" }, children: footer }) })
  ] });
  return /* @__PURE__ */ jsx(
    "nav",
    {
...
//# sourceMappingURL=chunk-VWVG6EOK.js.map