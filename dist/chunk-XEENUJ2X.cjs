...
var Select = _react2.default.forwardRef(function Select2({
  ...
  const overlayLayer = _chunkGJS3WBHUcjs.useLightDismiss.call(void 0, {
    open: open && !locked,
    rootRef: ref,
  ...
  const dropdownPosition = _chunkGJS3WBHUcjs.useFloatingPosition.call(void 0, {
    open: visualOpen,
          ...
          /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkF4O2CAUIcjs.OverlayPortal, { open: visualOpen, withinPortal, portalTarget, anchorRef: triggerRef, layer: "anchored", children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
            "div",
            {
              ...
              style: {
                ...
                ...withinPortal ? { position: "fixed", top: _nullishCoalesce(dropdownPosition.y, () => ( -9999)), left: _nullishCoalesce(dropdownPosition.x, () => ( -9999)), right: "auto", bottom: "auto", translate: "none" } : _chunkGJS3WBHUcjs.inlineFloatingStyle.call(void 0, { placement: dropdownPosition.placement, align, offset, shiftX: dropdownPosition.shiftX, shiftY: dropdownPosition.shiftY }),
...
//# sourceMappingURL=chunk-XEENUJ2X.cjs.map