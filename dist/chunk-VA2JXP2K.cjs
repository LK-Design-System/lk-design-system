...
function Tooltip({
  ...
  const getTrigger = _react2.default.useCallback(() => _chunkE2R2I4Q2cjs.findOverlayTrigger.call(void 0, wrapperRef.current), []);
  const floating = _chunkE2R2I4Q2cjs.useFloatingPosition.call(void 0, {
    open: visible,
  ...
  const renderedChildren = validTrigger ? _react2.default.cloneElement(children, {
    ...
    "aria-describedby": _chunkE2R2I4Q2cjs.appendAriaReference.call(void 0, children.props["aria-describedby"], tooltipId)
  }) : children;
...
//# sourceMappingURL=chunk-VA2JXP2K.cjs.map