...
function MetricCard({
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      ...rest,
      children: [
        /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: 12, minWidth: 0, marginBottom: 16 }, children: [
          label != null && /* @__PURE__ */ jsx("span", { id: labelId, style: { minWidth: 0, fontSize: "var(--caption1-size)", lineHeight: "var(--caption1-line)", fontWeight: "var(--fw-bold)", letterSpacing: 0, textTransform: "uppercase", overflowWrap: "anywhere", color: "var(--color-semantic-label-alternative)" }, children: label }),
          icon && /* @__PURE__ */ jsx("span", { "data-metric-icon": true, style: { color: "var(--color-semantic-label-alternative)", display: "inline-flex" }, children: icon })
        ] }),
        body,
        showFooter && /* @__PURE__ */ jsxs("div", { "data-metric-footer": true, style: { display: "flex", alignItems: "center", justifyContent: "space-between", gap: "var(--space-3)", minWidth: 0, flexWrap: "wrap", marginTop: 16, paddingTop: 16, borderTop: "1px solid var(--color-semantic-line-normal-alternative)" }, children: [
...
//# sourceMappingURL=chunk-6777UAEX.js.map