...
function AutoComplete({
  ...
  const {
    ...
    describedBy,
    hasMetadata
  } = _chunk64JQMMMOcjs.useFieldMetadata.call(void 0, { prefix: "autocomplete", id, label, helper, error, describedBy: ariaDescribedBy });
  ...
  const borderColor = _chunk64JQMMMOcjs.fieldBorderColor.call(void 0, { disabled, readOnly, invalid: isInvalid, status, focused, hovered });
      ...
      children: [
        ...
        popupOpen && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
          "div",
          {
              ...
              return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
                "div",
                {
                  ...
                  style: {
                    ...
                    color: option.disabled ? "var(--color-semantic-label-disable)" : selected ? "var(--color-semantic-primary-heavy)" : "var(--color-semantic-label-normal)",
            ...
            }) : /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "div", { role: "status", "aria-live": "polite", style: { padding: "var(--space-4)", color: "var(--color-semantic-label-neutral)", fontSize: "var(--caption1-size)", textAlign: "center" }, children: emptyLabel })
          }
        )
      ]
    }
...
//# sourceMappingURL=chunk-3K6MNCT2.cjs.map