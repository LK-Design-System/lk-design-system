  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        ...
        (state === "success" || state === "error") && /* @__PURE__ */ jsxs("span", { id: statusId, "data-export-status": state, style: { display: "inline-flex", alignItems: "center", gap: "var(--space-1)", color: state === "error" ? "var(--color-semantic-status-negative-text)" : "var(--color-semantic-status-positive-text)", fontSize: "var(--caption1-size)", lineHeight: "var(--caption1-line)" }, children: [
        ...
        /* @__PURE__ */ jsx("span", { "data-export-live": "polite", role: "status", "aria-live": "polite", "aria-atomic": "true", style: SR_ONLY_STYLE, children: state === "success" ? successMessage : "" }),
        /* @__PURE__ */ jsx("span", { "data-export-live": "assertive", role: "alert", "aria-live": "assertive", "aria-atomic": "true", style: SR_ONLY_STYLE, children: state === "error" ? errorMessage : "" })
      ]
    }
  );
}
...
//# sourceMappingURL=chunk-SNZAXMQI.js.map