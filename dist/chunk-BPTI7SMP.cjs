        ...
        "div",
        {
          ...
          children: [
            (title != null || onClose) && /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", gap: "var(--space-4)", padding: "var(--space-5) var(--space-6)", borderBottom: "1px solid var(--color-semantic-line-solid-normal)" }, children: [
              ...
              onClose && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkNFE2XSRZcjs.IconButton, { size: "sm", variant: "plain", label: "\uB2EB\uAE30", onClick: onClose, children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkX5XHQEI5cjs.Icon, { name: "close", size: 20, "aria-hidden": "true" }) })
            ] }),
            /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "div", { id: descriptionId, className: "lk-scroll-surface", "data-scrollbar": "auto", "data-scroll-gutter": "stable", style: { padding: "var(--space-5) var(--space-6)", overflow: "auto", scrollbarGutter: "stable", fontSize: "var(--body2-size)", lineHeight: 1.7, color: "var(--color-semantic-label-neutral)", wordBreak: "keep-all" }, children }),
...
exports.Modal = Modal;
//# sourceMappingURL=chunk-BPTI7SMP.cjs.map