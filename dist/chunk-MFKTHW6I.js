  ...
  return /* @__PURE__ */ jsx("div", { role: "presentation", onClick: (e) => {
    ...
    /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", gap: 12, padding: "16px 20px", borderBottom: "1px solid var(--color-semantic-line-solid-normal)" }, children: [
      ...
      /* @__PURE__ */ jsx("input", { ref: inputRef, role: "combobox", "aria-autocomplete": "list", "aria-expanded": "true", "aria-controls": listboxId, "aria-activedescendant": filtered.length > 0 ? `${optionIdBase}-${activeIndex}` : void 0, value: q, onChange: (e) => {
        setQ(e.target.value);
        setActiveIndex(0);
      }, onKeyDown: onInputKeyDown, placeholder, "aria-label": typeof placeholder === "string" ? placeholder : "\uBA85\uB839 \uAC80\uC0C9", style: { flex: 1, minWidth: 0, border: "none", borderRadius: "var(--radius-sm)", outline: "none", background: "transparent", fontFamily: "var(--font-sans)", fontSize: "var(--headline2-size)", color: "var(--color-semantic-label-normal)" } })
    ] }),
    /* @__PURE__ */ jsxs("div", { ref: listRef, className: "lk-scroll-surface", "data-scrollbar": "compact", "data-scroll-gutter": "stable", style: { maxHeight: 340, overflowY: "auto", scrollbarGutter: "stable", padding: 8 }, children: [
      ...
      filtered.length === 0 && /* @__PURE__ */ jsx("div", { "data-command-palette-empty": true, style: { padding: "var(--space-8)", textAlign: "center", color: "var(--color-semantic-label-alternative)", fontSize: "var(--label1-size)" }, children: resultsText })
    ] }),
...
//# sourceMappingURL=chunk-MFKTHW6I.js.map