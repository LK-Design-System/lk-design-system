  ...
  const renderStepBtn = (kind) => {
    ...
    return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
      "button",
      {
        ...
        children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkX5XHQEI5cjs.Icon, { name: isMinus ? "minus" : "plus", size: 18, "aria-hidden": "true" })
      },
      kind
    );
  };
...
//# sourceMappingURL=chunk-WX4ID2RF.cjs.map