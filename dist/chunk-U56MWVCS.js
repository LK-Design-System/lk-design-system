...
var SideNav = React.forwardRef(function SideNav2({
  ...
  const activeGroupValue = autoExpandActiveGroup ? items.find((item) => item && !item.heading && item.children?.some((child) => child.value === val))?.value : void 0;
...
//# sourceMappingURL=chunk-U56MWVCS.js.map