...
function PinInput({ length = 6, value, defaultValue = "", onChange, onComplete, mask = false, disabled = false, size = "md", style, "aria-label": ariaLabel, ...rest }) {
  ...
  return /* @__PURE__ */ jsx("div", { ...rest, role: "group", "aria-label": ariaLabel ?? "PIN", style: { display: "inline-flex", gap: 8, ...style }, children: Array.from({ length: normalizedLength }).map((_, i) => /* @__PURE__ */ jsx(
    "input",
    {
      ref: (el) => {
        refs.current[i] = el;
...
//# sourceMappingURL=chunk-NEMJ56KR.js.map