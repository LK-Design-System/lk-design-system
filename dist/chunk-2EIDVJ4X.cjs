...
var listStyle = { listStyle: "none", margin: 0, padding: 0, display: "flex", flexDirection: "column", gap: 2 };
...
function Anchor({ items = [], active, onChange, style, ...rest }) {
  ...
  const renderNodes = (nodes) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "ul", { style: listStyle, children: nodes.map(({ item: it, children }) => {
    ...
    return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "li", { style: { display: "flex", flexDirection: "column", gap: 2 }, children: [
...
//# sourceMappingURL=chunk-2EIDVJ4X.cjs.map