...
function Combobox({
  ...
  const {
    ...
    describedBy,
    hasMetadata
  } = _chunkIDTVAPZEcjs.useFieldMetadata.call(void 0, { prefix: "combobox", id, label, helper, error, describedBy: ariaDescribedBy });
  ...
  const borderColor = _chunkIDTVAPZEcjs.fieldBorderColor.call(void 0, { disabled, readOnly, invalid: isInvalid, status, focused: open, hovered });
        ...
        /* @__PURE__ */ _jsxruntime.jsxs.call(void 0,
          "button",
          {
            ...
            style: {
              ...
              background: _chunkIDTVAPZEcjs.fieldBackground.call(void 0, { disabled, readOnly }),
  ...
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkIDTVAPZEcjs.FieldStack, { fieldId, labelId, label, required, messageId, message, error, status, fieldStyle, children: control });
}



exports.Combobox = Combobox;
//# sourceMappingURL=chunk-5UR7NOEU.cjs.map