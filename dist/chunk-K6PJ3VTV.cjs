...
function DataExportAction({
  ...
  const scope = scopes.some((option) => option.value === requestedScope) ? requestedScope : _nullishCoalesce(_optionalChain([scopes, 'access', _3 => _3[0], 'optionalAccess', _4 => _4.value]), () => ( ""));
  ...
  const setFormat = (next) => {
    ...
    _optionalChain([onFormatChange, 'optionalCall', _5 => _5(next)]);
  };
  const setScope = (next) => {
    if (!scopeControlled) setInternalScope(next);
    _optionalChain([onScopeChange, 'optionalCall', _6 => _6(next)]);
  };
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "div", { style: { display: "flex", alignItems: "center", gap: "var(--space-2)", flexWrap: "wrap", minWidth: 0 }, children: [
          ...
          /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, 
            _chunk3BBCS67Wcjs.Button,
            {
              ...
              onClick: () => allowed && !processing && _optionalChain([onExport, 'optionalCall', _7 => _7({ format, scope })]),
              children: [
                !processing && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkVGM7HVYYcjs.Icon, { name: "download", size: 16, "aria-hidden": "true" }),
                exportLabel
              ]
            }
          )
        ...
        !allowed && unavailableReason != null && /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "span", { id: reasonId, "data-unavailable-reason": true, style: { display: "inline-flex", alignItems: "flex-start", gap: "var(--space-1)", color: "var(--color-semantic-label-neutral)", fontSize: "var(--caption1-size)", lineHeight: "var(--caption1-line)" }, children: [
          /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkVGM7HVYYcjs.Icon, { name: "lock", size: 15, "aria-hidden": "true", style: { flexShrink: 0 } }),
          /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "span", { children: unavailableReason })
        ] }),
        (state === "success" || state === "error") && /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "span", { id: statusId, role: state === "error" ? "alert" : "status", style: { display: "inline-flex", alignItems: "center", gap: "var(--space-1)", color: state === "error" ? "var(--color-semantic-status-negative-text)" : "var(--color-semantic-status-positive-text)", fontSize: "var(--caption1-size)", lineHeight: "var(--caption1-line)" }, children: [
          /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkVGM7HVYYcjs.Icon, { name: state === "error" ? "circle-close-fill" : "circle-check-fill", size: 15, "aria-hidden": "true" }),
...
//# sourceMappingURL=chunk-K6PJ3VTV.cjs.map