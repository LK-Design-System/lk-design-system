...
function Select({
  ...
  const describedBy = _chunk3NOYASLPcjs.mergeIds.call(void 0, ariaDescribedBy, messageId);
  ...
  const ring = _chunk3NOYASLPcjs.fieldBorderColor.call(void 0, { disabled: disabledState, readOnly, invalid: isInvalid, status, focused: activeFocus, hovered: activeHover });
  _react2.default.useEffect(() => {
  ...
  return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "div", { "data-readonly": readOnly ? "true" : void 0, style: { display: "flex", flexDirection: "column", gap: "var(--component-input-stack-gap)", ...style }, children: [
    /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunk3NOYASLPcjs.FieldLabel, { id: labelId, htmlFor: selId, label, required }),
      ...
      /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, 
        "button",
        {
          ...
          style: {
            ...
            background: _chunk3NOYASLPcjs.fieldBackground.call(void 0, { disabled: disabledState, readOnly }),
...
//# sourceMappingURL=chunk-2GW7KA7V.cjs.map