...
var SearchField = _react2.default.forwardRef(function SearchField2({
  ...
  const metadata = _chunkIDTVAPZEcjs.useFieldMetadata.call(void 0, {
    prefix: "search-field",
    id,
    label,
    helper,
  ...
  const borderColor = _chunkIDTVAPZEcjs.fieldBorderColor.call(void 0, {
    disabled,
    readOnly,
    invalid: isInvalid,
    status,
...
//# sourceMappingURL=chunk-WJH2TSIK.cjs.map