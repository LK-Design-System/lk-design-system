...
function RailItemTooltip({ label, collapsed, enabled = true, children }) {
  ...
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkUIJV762Icjs.Tooltip, { content: label, placement: "right", size: "small", open: collapsed ? open : false, onOpenChange: setOpen, style: { width: "100%" }, children });
}
function SideNav({
  items = [],
  value,
...
//# sourceMappingURL=chunk-66KZJWYR.cjs.map