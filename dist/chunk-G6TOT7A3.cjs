...
function AutoComplete({
  ...
  const {
    ...
    describedBy,
    hasMetadata
  } = _chunkZF2ZP65Lcjs.useFieldMetadata.call(void 0, { prefix: "autocomplete", id, label, helper, error, describedBy: ariaDescribedBy });
  ...
  const borderColor = _chunkZF2ZP65Lcjs.fieldBorderColor.call(void 0, { disabled, readOnly, invalid: isInvalid, status, focused, hovered });
...
//# sourceMappingURL=chunk-G6TOT7A3.cjs.map