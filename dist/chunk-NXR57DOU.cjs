...
function FileUpload({
  ...
  const { fieldId: inputId, describedBy } = _chunkZF2ZP65Lcjs.useFieldMetadata.call(void 0, { prefix: "file-upload", describedBy: inputAriaDescribedBy });
...
//# sourceMappingURL=chunk-NXR57DOU.cjs.map