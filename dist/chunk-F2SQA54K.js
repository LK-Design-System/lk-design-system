...
var DotMatrixPreview = React.forwardRef(function DotMatrixPreview2({
  columns = 128,
  rows = 32,
  bitmap,
  pixels,
  ...
  return /* @__PURE__ */ jsxs(
    "figure",
    {
      ...
      ...rest,
      children: [
        /* @__PURE__ */ jsxs("figcaption", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", gap: "var(--space-2) var(--space-3)", flexWrap: "wrap", minWidth: 0 }, children: [
          /* @__PURE__ */ jsx("span", { style: { fontSize: "var(--label1-size)", lineHeight: "var(--label1-line)", fontWeight: "var(--fw-semibold)", color: "var(--color-semantic-label-strong)", minWidth: 0, overflowWrap: "anywhere" }, children: label }),
          status != null && /* @__PURE__ */ jsx("span", { style: { display: "inline-flex", alignItems: "center", gap: "var(--space-2)", flexShrink: 0 }, children: status })
        ] }),
        /* @__PURE__ */ jsx(
          "div",
          {
        ...
        /* @__PURE__ */ jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsx("span", { style: { minWidth: 0, overflowWrap: "anywhere" }, children: summary }),
              /* @__PURE__ */ jsxs("span", { style: { flexShrink: 0, fontVariantNumeric: "tabular-nums" }, children: [
                columns,
                "\xD7",
                rows,
                " \xB7 \uBC1D\uAE30 ",
...
//# sourceMappingURL=chunk-F2SQA54K.js.map