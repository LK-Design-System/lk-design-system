  ...
  const items = locales.map((locale) => ({
    icon: /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
      "span",
      {
        ...
        children: locale.value === value && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunk7OXVB7WXcjs.Icon, { name: "check", size: 16, "aria-hidden": "true" })
      }
    ),
    iconPosition: "end",
...
//# sourceMappingURL=chunk-6DYQJ673.cjs.map