...
function ChoiceCard({
  ...
  const inheritedDensity = _chunkZAM5AMCOcjs.useResolvedDensity.call(void 0, void 0, "comfortable");
  const resolvedPadding = _nullishCoalesce(padding, () => ( (inheritedDensity === "compact" ? "sm" : "md")));
  ...
  const frameBorder = disabled ? "var(--color-semantic-line-normal-normal)" : status === "negative" ? "var(--color-semantic-status-negative-foreground)" : selected || activeFocus ? "var(--color-semantic-primary-normal)" : activeHover ? "var(--color-semantic-line-solid-normal)" : "var(--color-semantic-line-normal-normal)";
  ...
  const frameStyle = {
    position: "relative",
    display: "block",
    padding: _nullishCoalesce(paddingMap[resolvedPadding], () => ( paddingMap.md)),
    ...
    Root,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "div", { style: isFrame ? void 0 : { flex: 1, minWidth: 0 }, children: [
          !isFrame && title != null && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "div", { id: titleId, style: { fontSize: "var(--body2-size)", lineHeight: "var(--body2-line)", fontWeight: "var(--fw-bold)", letterSpacing: 0, color: disabled ? "var(--color-semantic-label-disable)" : "var(--color-semantic-label-strong)", wordBreak: "keep-all" }, children: title }),
          !isFrame && description != null && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "div", { id: descriptionId, style: { marginTop: "var(--space-1)", fontSize: "var(--label2-size)", lineHeight: "var(--label2-line)", color: disabled ? "var(--color-semantic-label-disable)" : "var(--color-semantic-label-neutral)", wordBreak: "keep-all" }, children: description }),
          children
        ] }),
        !isFrame && showIndicator && /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
          "span",
          {
            ...
            children: selected && (multiple ? /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunk7OXVB7WXcjs.Icon, { name: "check", size: 12, "aria-hidden": "true" }) : /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "span", { style: { width: 12, height: 12, borderRadius: "50%", background: "currentColor" } }))
          }
        )
      ]
    }
...
//# sourceMappingURL=chunk-26Q2UV5Y.cjs.map