  ...
  const renderStepBtn = (kind) => {
    ...
    return /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
      "button",
      {
        ...
        children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkB6GRMPJUcjs.Icon, { name: isMinus ? "minus" : "plus", size: 18, "aria-hidden": "true" })
      },
      kind
    );
  };
...
//# sourceMappingURL=chunk-LMUWBJZK.cjs.map