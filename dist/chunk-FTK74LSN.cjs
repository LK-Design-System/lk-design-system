...
var _chunkCXJRK2V3cjs = require('./chunk-CXJRK2V3.cjs');
...
var _chunk5R6MQTQFcjs = require('./chunk-5R6MQTQF.cjs');
...
function TelemetryGauge({
  ...
  const resolvedStatusLabel = hasCustomStatusLabel ? statusLabel : tone != null || inferredTone != null ? _chunkCXJRK2V3cjs.TELEMETRY_STATUS_LABEL[resolvedTone] : null;
  const normalizedUnit = _chunk5R6MQTQFcjs.normalizeUnit.call(void 0, unit);
  const unitSeparator = _chunk5R6MQTQFcjs.getUnitSeparator.call(void 0, normalizedUnit);
  const attachedUnit = _chunk5R6MQTQFcjs.isAttachedUnit.call(void 0, normalizedUnit);
  ...
  const renderedValue = typeof formatterResult === "string" || typeof formatterResult === "number" ? _chunk5R6MQTQFcjs.normalizeValueText.call(void 0, formatterResult) : formattedNumber;
  const baseValueText = _chunk5R6MQTQFcjs.formatValueWithUnit.call(void 0, renderedValue, normalizedUnit);
  const resolvedValueText = valueText != null ? _chunk5R6MQTQFcjs.normalizeValueText.call(void 0, valueText) : typeof resolvedStatusLabel === "string" ? `${baseValueText}, ${resolvedStatusLabel}` : baseValueText;
    ...
    "div",
    {
      ...
      children: [
        ...
        (label != null || resolvedStatusLabel != null) && /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "div", { style: { display: "flex", alignItems: "center", justifyContent: "center", gap: "var(--space-2)", maxWidth: "100%", minWidth: 0, flexWrap: "wrap" }, children: [
          ...
          resolvedStatusLabel != null && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkGW3BLGYBcjs.StatusBadge, { tone: resolvedTone, children: resolvedStatusLabel })
        ] })
      ]
    }
  );
...
//# sourceMappingURL=chunk-FTK74LSN.cjs.map