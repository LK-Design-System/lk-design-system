...
function Calendar({ value, defaultValue, onChange, isDateDisabled, minDate, maxDate, autoFocus = false, style, ...rest }) {
  ...
  const [view, setView] = _react2.default.useState(() => new Date(initialDate.getFullYear(), initialDate.getMonth(), 1));
  ...
  return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, 
    "div",
    {
      ...
      ...rest,
      children: [
        /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 14 }, children: [
          ...
          /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "div", { style: { display: "flex", gap: 4 }, children: [
            /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "button", { type: "button", "aria-label": "\uC774\uC804 \uB2EC", onClick: () => navigateMonth(-1), style: navigationButtonStyle, children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkVGM7HVYYcjs.Icon, { name: "chevron-left-small", size: 16, "aria-hidden": "true" }) }),
            /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "button", { type: "button", "aria-label": "\uB2E4\uC74C \uB2EC", onClick: () => navigateMonth(1), style: navigationButtonStyle, children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkVGM7HVYYcjs.Icon, { name: "chevron-right-small", size: 16, "aria-hidden": "true" }) })
          ] })
        ] }),
        /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "div", { role: "grid", "aria-label": `${view.getFullYear()}\uB144 ${view.getMonth() + 1}\uC6D4`, children: [
          /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "div", { role: "row", style: { display: "grid", gridTemplateColumns: "repeat(7, 1fr)", gap: 2, marginBottom: 6 }, children: WEEKDAYS.map((weekday, index) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
            "div",
            {
              role: "columnheader",
          ...
          weeks.map((week, weekIndex) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "div", { role: "row", style: { display: "grid", gridTemplateColumns: "repeat(7, 1fr)", gap: 2 }, children: week.map((date, dayIndex) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "div", { role: "gridcell", "aria-selected": date ? Boolean(selected && ymd(selected) === ymd(date)) : void 0, children: date && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
            DayCell,
            {
              date,
...
//# sourceMappingURL=chunk-LTT2YMNX.cjs.map