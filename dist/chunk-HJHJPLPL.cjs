          ...
          "g",
          {
            ...
            children: [
              invalid && /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "g", { transform: "translate(0 -18)", "data-region-invalid-mark": "", children: [
                /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "circle", { r: "7", fill: "var(--viewer-surface-elevated, var(--color-semantic-background-elevated-normal))", stroke: "var(--color-semantic-status-negative-foreground)", strokeWidth: "1.5", vectorEffect: "non-scaling-stroke" }),
                /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkYUEYO4K6cjs.NavigationStateGlyph, { kind: "invalid", size: 10.5, color: "var(--viewer-foreground, var(--color-semantic-label-strong))" })
              ] }),
              stale && /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "g", { transform: `translate(0 ${invalid ? 18 : -18})`, "data-region-stale-mark": "", children: [
                ...
                /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkYUEYO4K6cjs.NavigationStateGlyph, { kind: "stale", size: 10.5, color: "var(--viewer-foreground, var(--color-semantic-label-strong))" })
              ] })
            ]
          }
        ),
...
//# sourceMappingURL=chunk-HJHJPLPL.cjs.map