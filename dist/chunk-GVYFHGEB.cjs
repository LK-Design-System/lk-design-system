  ...
  return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "span", { style: { position: "relative", display: "inline-flex" }, children: [
    /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
      "select",
      {
        ...
        style: {
          ...
          ..._chunk544Y73GCcjs.fieldTypography.call(void 0, size),
    ...
    /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
      "span",
      {
        ...
        children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkB6GRMPJUcjs.Icon, { name: "chevron-down-small", size: 16, "aria-hidden": "true" })
      }
    )
  ] });
}
function TimePicker({
  ...
  return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0,
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ _jsxruntime.jsx.call(void 0, TimeSelect, { value: hour, options: hours, onChange: (nextHour) => commit(nextHour, minute), height, size, ariaLabel: hourLabel, disabled }),
        ...
        /* @__PURE__ */ _jsxruntime.jsx.call(void 0, TimeSelect, { value: minute, options: minutes, onChange: (nextMinute) => commit(hour, nextMinute), height, size, ariaLabel: minuteLabel, disabled })
      ]
    }
  );
}
...
//# sourceMappingURL=chunk-GVYFHGEB.cjs.map