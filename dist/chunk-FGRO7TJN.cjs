    ...
    /* @__PURE__ */ _jsxruntime.jsxs.call(void 0,
      "button",
      {
        ...
        children: [
          ...
          !collapsed && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkVHQHPPYQcjs.Icon, { name: "chevron-up-small", size: 14, color: "var(--color-semantic-label-assistive)", "aria-hidden": "true", style: { flexShrink: 0, transform: open ? "rotate(180deg)" : "none", transition: "transform var(--dur-fast) var(--ease-out)" } })
        ]
      }
    )
  ] });
...
//# sourceMappingURL=chunk-FGRO7TJN.cjs.map