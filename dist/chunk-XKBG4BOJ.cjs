...
function trajectoryProgressGeometry(points, pointIndex) {
...
function progressCarrierPath(point, angle, inverseScale) {
...
function NavigationProgressHeadDefs({
  ...
  const dimensions = _chunkA43SMF67cjs.NAV_PROGRESS_HEAD[role];
  const marker = (layer, stroke, strokeWidth) => _react2.default.createElement("marker", {
    key: layer,
    id: `${idPrefix}-${layer}`,
    viewBox: _chunkA43SMF67cjs.NAV_PROGRESS_HEAD.viewBox,
    refX: _chunkA43SMF67cjs.NAV_PROGRESS_HEAD.refX,
    refY: _chunkA43SMF67cjs.NAV_PROGRESS_HEAD.refY,
    markerWidth: _chunkA43SMF67cjs.NAV_PROGRESS_HEAD.width * inverseScale,
    markerHeight: _chunkA43SMF67cjs.NAV_PROGRESS_HEAD.height * inverseScale,
    markerUnits: "userSpaceOnUse",
    orient: "auto",
    overflow: "visible"
  }, _react2.default.createElement("path", {
    "data-navigation-progress-head-definition": layer,
    d: _chunkA43SMF67cjs.NAV_PROGRESS_HEAD.path,
    fill: "none",
    stroke,
    strokeWidth,
    strokeLinecap: "round",
...
function ProgressHeadObstacle({ obstacle, id, point, angle, inverseScale, dataPrefix }) {
  const bounds = _chunkA43SMF67cjs.NAV_PROGRESS_HEAD.obstacle;
...
exports.routeProgressGeometry = routeProgressGeometry; exports.trajectoryProgressGeometry = trajectoryProgressGeometry; exports.progressCarrierPath = progressCarrierPath; exports.NavigationProgressHeadDefs = NavigationProgressHeadDefs; exports.ProgressHeadObstacle = ProgressHeadObstacle;
//# sourceMappingURL=chunk-XKBG4BOJ.cjs.map