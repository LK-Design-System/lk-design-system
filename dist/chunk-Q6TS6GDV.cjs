...
function Stat({
  ...
  const displayUnit = typeof unit === "string" ? _chunk5R6MQTQFcjs.normalizeUnit.call(void 0, unit) : unit;
  const attachedUnit = typeof displayUnit === "string" && _chunk5R6MQTQFcjs.isAttachedUnit.call(void 0, displayUnit);
...
exports.Stat = Stat;
//# sourceMappingURL=chunk-Q6TS6GDV.cjs.map