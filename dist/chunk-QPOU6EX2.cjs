...
function CommandPalette({
  ...
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "div", { role: "presentation", onClick: (e) => {
    ...
    /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "div", { style: { display: "flex", alignItems: "center", gap: 12, padding: "16px 20px", borderBottom: "1px solid var(--color-semantic-line-solid-normal)" }, children: [
      /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkX5XHQEI5cjs.Icon, { name: "search", size: 20, color: "var(--color-semantic-label-assistive)", "aria-hidden": "true" }),
    ...
    /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "div", { ref: listRef, style: { maxHeight: 340, overflowY: "auto", padding: 8 }, children: [
      ...
      filtered.length === 0 && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "div", { "data-command-palette-empty": true, style: { padding: 28, textAlign: "center", color: "var(--color-semantic-label-alternative)", fontSize: "var(--label1-size)" }, children: resultsText })
    ] }),
...
//# sourceMappingURL=chunk-QPOU6EX2.cjs.map