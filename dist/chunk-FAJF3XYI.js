...
function TagInput({
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      ...rest,
      children: [
        tags.map((t) => /* @__PURE__ */ jsxs("span", { style: { display: "inline-flex", alignItems: "center", gap: "var(--space-0-5)", height: 28, padding: "0 2px 0 11px", background: "var(--color-semantic-primary-surface-strong)", color: "var(--color-semantic-label-normal)", borderRadius: "var(--radius-pill)", fontFamily: "var(--font-sans)", fontSize: "var(--label2-size)", fontWeight: "var(--fw-semibold)" }, children: [
          t,
          /* @__PURE__ */ jsx(
            "button",
            {
...
//# sourceMappingURL=chunk-FAJF3XYI.js.map