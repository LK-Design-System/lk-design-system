...
function Popover({
  ...
  const getTrigger = _react2.default.useCallback(() => _chunkT7L6VXSAcjs.findOverlayTrigger.call(void 0, rootRef.current), []);
  ...
  const triggerProps = {
    ...
    "aria-controls": visible ? _chunkT7L6VXSAcjs.appendAriaReference.call(void 0, _optionalChain([trigger, 'optionalAccess', _5 => _5.props, 'optionalAccess', _6 => _6["aria-controls"]]), panelId) : _optionalChain([trigger, 'optionalAccess', _7 => _7.props, 'optionalAccess', _8 => _8["aria-controls"]]),
    onClick: toggle
  };
...
//# sourceMappingURL=chunk-BO2XZA5L.cjs.map