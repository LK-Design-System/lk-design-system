...
var _chunkXAGJKIDNcjs = require('./chunk-XAGJKIDN.cjs');
...
var _chunkD5WHCR6Lcjs = require('./chunk-D5WHCR6L.cjs');


var _chunkP65KUIKJcjs = require('./chunk-P65KUIKJ.cjs');
...
// packages/core/dist/chunk-KXXJ42H7.js
...
function useMenuKeyboard({ open, onClose, getTrigger, menuKey = 0, zIndex, focusOnOpen = true }) {
  const { zIndex: resolvedZIndex, isTopmost } = _chunkLDSQW2RPcjs.useOverlayLayer.call(void 0, { open, zIndex });
...
function useSubmenuBranch({ disabled = false } = {}) {
  ...
  const renderPanel = (children, panelStyle) => {
    if (!open) return null;
    return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkLDSQW2RPcjs.OverlayPortal, { open, anchorRef: triggerRef, layer: "anchored", children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
      "div",
      {
        ref: panelRef,
        "data-menu-portal": "",
...
// packages/core/dist/chunk-45WYDA7D.js
...
function CheckMark({ variant, checked, disabled }) {
  ...
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
    "span",
    {
      ...
      children: checked && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunk3DMHJIWScjs.Icon, { name: "check", size: 11, "aria-hidden": "true" })
    }
  );
}
...
function MenuItemButton({ item, variant, itemMetrics, onSelect, trailing, haspopup, onTriggerKeyDown, classNames, styles }) {
  ...
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
    "button",
    {
      ...
      className: _chunkEBP5HCWAcjs.partClassName.call(void 0, classNames, "item", item.className) || void 0,
      type: "button",
      ...
      style: { ...menuItemVisualStyle({ selected: current, checked, hovered: hover, disabled, danger: item.danger, hasDescription: Boolean(description), metrics: itemMetrics }), ..._chunkEBP5HCWAcjs.partStyle.call(void 0, styles, "item"), ...item.style },
      children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, MenuItemContent, { item, variant, checked, disabled, description, trailing })
    }
  );
}
var SUBMENU_CHEVRON = /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunk3DMHJIWScjs.Icon, { name: "chevron-right-small", size: 16, "aria-hidden": "true", style: { flexShrink: 0, color: "var(--color-semantic-label-alternative)" } });
function DrillHeader({ title, onBack, itemMetrics }) {
  return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0,
    "button",
    {
      ...
      children: [
        /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunk3DMHJIWScjs.Icon, { name: "chevron-left-small", size: 16, "aria-hidden": "true" }),
  ...
  return items.map((item, index) => {
    if (item.divider) {
      return /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
        ...
        {
          "data-slot": "divider",
          className: _chunkEBP5HCWAcjs.partClassName.call(void 0, ctx.classNames, "divider") || void 0,
          role: "separator",
          style: { height: 1, background: "var(--color-semantic-line-solid-normal)", margin: "6px 4px", ..._chunkEBP5HCWAcjs.partStyle.call(void 0, ctx.styles, "divider") }
        },
        index
      );
    }
      ...
      children: [
        /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
          "button",
          {
            ...
            disabled,
            ...sub.triggerHandlers,
            style: { ...menuItemVisualStyle({ active: sub.open, hovered: hover, disabled, danger: item.danger, hasDescription: Boolean(description), metrics: itemMetrics }), ..._chunkEBP5HCWAcjs.partStyle.call(void 0, styles, "item"), ...item.style },
            children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
              MenuItemContent,
              {
                ...
                disabled,
                description,
                trailing: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunk3DMHJIWScjs.Icon, { name: "chevron-right-small", size: 16, "aria-hidden": "true", style: { flexShrink: 0, color: "var(--color-semantic-label-alternative)" } })
              }
            )
          }
        ),
    ...
    if (item.divider) {
      return /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
        "div",
        {
          ...
          className: _chunkEBP5HCWAcjs.partClassName.call(void 0, ctx.classNames, "divider") || void 0,
          role: "separator",
          style: { height: 1, flexShrink: 0, background: "var(--color-semantic-line-solid-normal)", margin: "6px 4px", ..._chunkEBP5HCWAcjs.partStyle.call(void 0, ctx.styles, "divider") }
        },
        index
      );
    }
...
var DropdownMenu = _react2.default.forwardRef(function DropdownMenu2({
  ...
  const mergedRootRef = _chunkEBP5HCWAcjs.useMergedRefs.call(void 0, ref, forwardedRef);
  const panelRef = _react2.default.useRef(null);
  ...
  const position = _chunkLDSQW2RPcjs.useFloatingPosition.call(void 0, {
    open: visible,
    anchorRef: ref,
    panelRef,
  ...
  return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0,
    "div",
    {
      ...
      style: { ..._chunkEBP5HCWAcjs.componentVars.call(void 0, vars, "--lds-dropdown-menu-"), position: "relative", display: "inline-block", ..._chunkEBP5HCWAcjs.partStyle.call(void 0, styles, "root"), ...style },
      ...rest,
      children: [
        /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
          "span",
          {
            "data-slot": "trigger",
            className: _chunkEBP5HCWAcjs.partClassName.call(void 0, classNames, "trigger") || void 0,
            style: { display: "inline-flex", ..._chunkEBP5HCWAcjs.partStyle.call(void 0, styles, "trigger") },
            children: renderedTrigger
          }
        ),
        /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkLDSQW2RPcjs.OverlayPortal, { open: visible, withinPortal, portalTarget, anchorRef: ref, layer: "anchored", children: /* @__PURE__ */ _jsxruntime.jsxs.call(void 0,
          "div",
          {
            ref: panelRef,
            "data-slot": "panel",
            ...
            className: _chunkEBP5HCWAcjs.partClassName.call(void 0, classNames, "panel") || void 0,
            "data-placement": position.placement,
            style: {
              ..._chunkEBP5HCWAcjs.componentVars.call(void 0, vars, "--lds-dropdown-menu-"),
              ...withinPortal ? { position: "fixed", top: _nullishCoalesce(position.y, () => ( -9999)), left: _nullishCoalesce(position.x, () => ( -9999)), right: "auto", bottom: "auto", translate: "none" } : _chunkLDSQW2RPcjs.inlineFloatingStyle.call(void 0, { placement: position.placement, align, offset, shiftX: position.shiftX, shiftY: position.shiftY }),
              ...
              flexDirection: "column",
              gap: "var(--component-menu-gap)",
              ..._chunkEBP5HCWAcjs.partStyle.call(void 0, styles, "panel"),
            ...
            children: [
              /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
                "div",
                {
                  ref: menuRef,
                  "data-slot": "menu",
                  className: _chunkEBP5HCWAcjs.partClassName.call(void 0, classNames, "menu", "lk-scroll-surface") || void 0,
                  ...
                  style: {
                    ...
                    ..._chunkEBP5HCWAcjs.partStyle.call(void 0, styles, "menu"),
              ...
              showActionArea && /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
                "div",
                {
                  ...
                  className: _chunkEBP5HCWAcjs.partClassName.call(void 0, classNames, "actionArea") || void 0,
                  role: "group",
                  "aria-label": "\uBA54\uB274 \uC791\uC5C5",
                  ...
                  style: {
                    ...
                    flexShrink: 0,
                    ..._chunkEBP5HCWAcjs.partStyle.call(void 0, styles, "actionArea")
                  },
                  children: action || /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, _jsxruntime.Fragment, { children: [
                    onCancel && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkXAGJKIDNcjs.Button, { variant: "outlined", color: "assistive", size: "sm", onClick: () => finishAction(onCancel), children: cancelLabel }),
                    onApply && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkXAGJKIDNcjs.Button, { size: "sm", onClick: () => finishAction(onApply), children: applyLabel })
                  ] })
                }
              )
            ]
      ...
      /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "h4", { style: { margin: 0, font: "inherit", color: "inherit" }, children: /* @__PURE__ */ _jsxruntime.jsxs.call(void 0,
        "button",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunk3DMHJIWScjs.Icon, { name: expanded ? "chevron-up-small" : "chevron-down-small", size: 16, "aria-hidden": "true" })
          ]
        }
      ) })
    ...
    hasMenu && /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
      DropdownMenu,
      {
        ...
        trigger: (
          ...
          /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkP65KUIKJcjs.IconButton, { type: "button", size: "sm", variant: "plain", round: false, label: menuLabel, children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunk3DMHJIWScjs.Icon, { name: "more-vertical", size: 16, "aria-hidden": "true" }) })
        )
      }
    ),
    canClearSelection && /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
      _chunkP65KUIKJcjs.IconButton,
      {
        type: "button",
        size: "sm",
        variant: "plain",
        ...
        children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunk3DMHJIWScjs.Icon, { name: "close", size: 16, "aria-hidden": "true" })
      }
    )
  ] }) : null;
    ...
    "section",
    {
      ...
      children: [
        /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "header", { style: { display: "grid", gap: "var(--space-2)", minWidth: 0, padding: headerHasContent ? "var(--space-3) var(--space-4)" : 0, borderBottom: headerHasContent ? "1px solid var(--color-semantic-line-normal-normal)" : "none", boxSizing: "border-box" }, children: [
          ...
          hasItem && /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "div", { style: { display: "grid", gap: "var(--space-2)", minWidth: 0 }, children: [
            ...
            /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "div", { style: { display: "flex", alignItems: "center", gap: "var(--space-2)", minWidth: 0, flexWrap: "wrap" }, children: [
              ...
              item.status != null && (item.statusPresentation === "indicator" ? /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkDKANR6BIcjs.StatusIndicator, { tone: item.statusTone || "signal", children: item.status }) : /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkD5WHCR6Lcjs.StatusBadge, { tone: item.statusTone || "signal", children: item.status }))
            ] })
          ] })
        ] }),
        /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "div", { style: { minHeight: 0, overflow: "auto", padding: hasItem ? "0 var(--space-4) var(--space-4)" : "var(--space-4)", boxSizing: "border-box" }, children: hasItem ? /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, _jsxruntime.Fragment, { children: [
          ...
          /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunk3DMHJIWScjs.Icon, { name: "crosshair", size: 24, "aria-hidden": "true" }),
...
//# sourceMappingURL=chunk-RKPFFCEF.cjs.map