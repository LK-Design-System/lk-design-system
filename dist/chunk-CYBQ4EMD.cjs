...
function Button({
  ...
  const composed = {
    ...
    background: blocked ? disabledBg : pressed ? pressedTone(p.bgHover || p.bg) : hover ? `color-mix(in srgb, ${p.bgHover || p.bg} 96%, var(--color-semantic-label-normal))` : p.bg,
    ...
    Comp,
    {
      ...
      children: [
        loading && /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, _jsxruntime.Fragment, { children: [
          /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "span", { "aria-hidden": "true", style: { position: "absolute", inset: 0, display: "inline-flex", alignItems: "center", justifyContent: "center" }, children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkQH63OZLCcjs.Spinner, { size: 16, color: "currentColor" }) }),
...
//# sourceMappingURL=chunk-CYBQ4EMD.cjs.map