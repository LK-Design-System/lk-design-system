...
function RangeSlider({ value, defaultValue = [20, 80], min = 0, max = 100, step = 1, onChange, showValue = false, style, ...rest }) {
  ...
  return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "div", { style: { ...style }, ...rest, children: [
    /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "div", { style: { position: "relative", height: 24 }, children: [
      ...
      /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "div", { style: { position: "absolute", top: 9, height: 6, borderRadius: "var(--radius-pill)", background: "var(--color-semantic-primary-normal)", left: `${pctLo}%`, right: `${100 - pctHi}%` } }),
      /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "input", { className: "lk-rangeslider", type: "range", min, max, step, value: lo, onChange: (e) => set(Number(e.target.value), hi), "aria-label": "minimum" }),
      /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "input", { className: "lk-rangeslider", type: "range", min, max, step, value: hi, onChange: (e) => set(lo, Number(e.target.value)), "aria-label": "maximum" })
    ] }),
...
//# sourceMappingURL=chunk-PLGQKSEG.cjs.map