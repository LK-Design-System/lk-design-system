...
function FacilityGlyph({ kind, color }) {
  const d = _nullishCoalesce(FACILITY_GLYPH_PATHS[kind], () => ( FACILITY_GLYPH_PATHS.dock));
...
exports.FACILITY_GLYPH_PATHS = FACILITY_GLYPH_PATHS; exports.FacilityGlyph = FacilityGlyph;
//# sourceMappingURL=chunk-7QTG7XVG.cjs.map