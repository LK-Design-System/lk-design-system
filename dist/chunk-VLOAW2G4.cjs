...
var _chunkXE4ID5ONcjs = require('./chunk-XE4ID5ON.cjs');
...
function actionIcon(icon) {
  if (typeof icon === "string") return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkJPRLXPYNcjs.Icon, { name: icon, size: 16, "aria-hidden": "true" });
  return icon;
}
  ...
  if (showHistory) {
    groups.push({
      ...
      node: /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
        _chunkXE4ID5ONcjs.HistoryToolbar,
        {
          label: historyLabel,
          canUndo,
          canRedo,
...
//# sourceMappingURL=chunk-VLOAW2G4.cjs.map