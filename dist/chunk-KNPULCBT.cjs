...
function Textarea({
  ...
  usePlaceholderStyle();
  const ring = _chunk64JQMMMOcjs.fieldBorderColor.call(void 0, { disabled, readOnly, invalid: isInvalid, status, focused: activeFocus, hovered: activeHover });
  ...
  return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "div", { "data-readonly": readOnly ? "true" : void 0, style: { display: "flex", flexDirection: "column", gap: "var(--component-input-stack-gap)", ...style }, children: [
    /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunk64JQMMMOcjs.FieldLabel, { htmlFor: taId, label, required }),
    /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "div", { style: { position: "relative" }, children: [
      /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
        "textarea",
        {
          ...
          readOnly,
          required,
          "aria-describedby": _chunk64JQMMMOcjs.mergeIds.call(void 0, rest["aria-describedby"], messageId),
      ...
      (isInvalid || status === "positive") && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "span", { style: { position: "absolute", top: "var(--space-3)", right: "var(--space-3)", display: "inline-flex", pointerEvents: "none" }, children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunk64JQMMMOcjs.FieldStatusIcon, { invalid: isInvalid, status }) })
    ] }),
...
//# sourceMappingURL=chunk-KNPULCBT.cjs.map