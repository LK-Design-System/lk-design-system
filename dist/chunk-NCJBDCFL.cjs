...
function Map2DCanvas({
  ...
  const interactionState = _chunk3NZIYNUEcjs.resolveViewerState.call(void 0, {
    state,
    availability,
    connection,
    freshness,
  ...
  const interactionBlocked = _chunk3NZIYNUEcjs.VIEWER_BLOCKING_STATES.includes(interactionState);
  const {
    rootRef,
    renderedViewport,
    commitViewport,
...
//# sourceMappingURL=chunk-NCJBDCFL.cjs.map