  ...
  _react2.default.useLayoutEffect(() => {
    ...
    if (!blocking) {
      ...
      if (wasBlocking && focusInsideBlockingLayerRef.current && focusNeedsRestore) {
        ...
        const exactTargetAvailable = exactTarget instanceof HTMLElement && _optionalChain([rootRef, 'access', _4 => _4.current, 'optionalAccess', _5 => _5.contains, 'call', _6 => _6(exactTarget)]) && !exactTarget.matches('[disabled], [aria-disabled="true"]') && !exactTarget.closest("[inert]");
        const restoredTarget = exactTargetAvailable ? exactTarget : _nullishCoalesce(_optionalChain([rootRef, 'access', _7 => _7.current, 'optionalAccess', _8 => _8.querySelector, 'call', _9 => _9(
          '[data-viewer-toolbar] [data-lk-viewer-toolbar-item]:not([disabled]):not([aria-disabled="true"])'
        )]), () => ( rootRef.current));
        _optionalChain([restoredTarget, 'optionalAccess', _10 => _10.focus, 'optionalCall', _11 => _11({ preventScroll: true })]);
      }
    ...
    const blockedRegions = _nullishCoalesce(_optionalChain([rootRef, 'access', _12 => _12.current, 'optionalAccess', _13 => _13.querySelectorAll, 'call', _14 => _14("[data-viewer-blocked-region]")]), () => ( []));
    ...
    const focusTarget = _nullishCoalesce(_optionalChain([blockingLayerRef, 'access', _15 => _15.current, 'optionalAccess', _16 => _16.querySelector, 'call', _17 => _17([
      "button:not([disabled])",
      "a[href]",
      "input:not([disabled])",
      "select:not([disabled])",
    ...
    _optionalChain([focusTarget, 'optionalAccess', _18 => _18.focus, 'optionalCall', _19 => _19({ preventScroll: true })]);
  ...
  return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, 
    "div",
    {
      ...
      onFocusCapture: (event) => {
        ...
        focusInsideBlockingLayerRef.current = Boolean(_optionalChain([event, 'access', _20 => _20.target, 'access', _21 => _21.closest, 'optionalCall', _22 => _22("[data-viewer-blocking-state]")]));
        setFocusWithin(true);
        _optionalChain([onFocusCapture, 'optionalCall', _23 => _23(event)]);
      },
      onBlurCapture: (event) => {
        if (!event.currentTarget.contains(event.relatedTarget)) setFocusWithin(false);
        _optionalChain([onBlurCapture, 'optionalCall', _24 => _24(event)]);
      },
      onPointerEnter: (event) => {
        setPointerWithin(true);
        _optionalChain([onPointerEnter, 'optionalCall', _25 => _25(event)]);
      },
      onPointerLeave: (event) => {
        setPointerWithin(false);
        _optionalChain([onPointerLeave, 'optionalCall', _26 => _26(event)]);
      },
      onPointerDown: (event) => {
        setPointerWithin(true);
        _optionalChain([onPointerDown, 'optionalCall', _27 => _27(event)]);
      },
      ...
      children: [
        ...
        (source != null || badges != null || hud != null || topToolbar != null || presentation.corner) && /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, 
          "div",
          {
            "data-viewer-topbar": "",
            inert: blocking ? true : void 0,
            ...
            children: [
              (source != null || badges != null || hud != null || presentation.corner) && /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, 
                "div",
                {
                  ...
                  children: [
                    (source != null || badges != null || presentation.corner) && /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, 
                      "div",
                      {
                        style: {
                          display: "flex",
                    ...
                    hud != null && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
                      "div",
                      {
                        ...
                        style: {
                          minWidth: 0,
                          maxWidth: "100%",
                          padding: source != null || badges != null || presentation.corner ? "7px 10px 8px" : "8px 10px",
                          borderTop: source != null || badges != null || presentation.corner ? "1px solid var(--viewer-border)" : void 0,
                          color: "var(--viewer-foreground)"
                        },
                        children: hud
                      }
...
//# sourceMappingURL=chunk-3KG4UK6U.cjs.map