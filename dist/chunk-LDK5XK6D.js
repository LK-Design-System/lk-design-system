      ...
      children: [
        ...
        /* @__PURE__ */ jsxs("div", { style: { display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(min(100%, 200px), 1fr))", gap: "var(--space-2)", minWidth: 0 }, children: [
          /* @__PURE__ */ jsxs("div", { style: { display: "grid", gap: "var(--space-1)", minWidth: 0 }, children: [
            showFieldLabels && /* @__PURE__ */ jsx("span", { style: { color: "var(--component-input-label-color)", fontSize: "var(--component-input-label-font-size)", fontWeight: "var(--component-input-label-font-weight)", lineHeight: "var(--component-input-label-line-height)" }, children: startLabel }),
            /* @__PURE__ */ jsx(
              DatePicker,
              {
                value: range.start,
          ...
          /* @__PURE__ */ jsxs("div", { style: { display: "grid", gap: "var(--space-1)", minWidth: 0 }, children: [
            showFieldLabels && /* @__PURE__ */ jsx("span", { style: { color: "var(--component-input-label-color)", fontSize: "var(--component-input-label-font-size)", fontWeight: "var(--component-input-label-font-weight)", lineHeight: "var(--component-input-label-line-height)" }, children: endLabel }),
            /* @__PURE__ */ jsx(
              DatePicker,
              {
                value: range.end,
        ...
        resolvedInvalid && /* @__PURE__ */ jsx("span", { id: messageId, role: "alert", style: { color: "var(--color-semantic-status-negative-text)", fontSize: "var(--caption1-size)", lineHeight: "var(--caption1-line)" }, children: errorMessage })
      ]
    }
  );
}
...
//# sourceMappingURL=chunk-LDK5XK6D.js.map