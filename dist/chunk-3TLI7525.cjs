      ...
      children: [
        /* @__PURE__ */ _jsxruntime.jsxs.call(void 0,
          "button",
          {
            ...
            style: { display: "inline-flex", alignItems: "center", gap: "var(--component-input-gap)", width: full ? "100%" : void 0, height: h, padding: "0 var(--component-input-padding-x)", minWidth: full ? 0 : 200, boxSizing: "border-box", background: disabled ? "var(--color-semantic-fill-normal)" : "var(--component-input-bg)", border: `1px solid ${borderColor}`, borderRadius: "var(--component-input-radius)", boxShadow: focused || open ? "var(--component-input-focus-shadow)" : "none", cursor: disabled ? "not-allowed" : "pointer", fontFamily: "var(--font-sans)", ..._chunkDSYH34X7cjs.fieldTypography.call(void 0, size), color: disabled ? "var(--color-semantic-label-disable)" : sel ? "var(--color-semantic-label-normal)" : "var(--color-semantic-label-alternative)", transition: "border-color var(--dur-fast) var(--ease-out), box-shadow var(--dur-fast) var(--ease-out)" },
            children: [
              /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunk3ATRKSQ7cjs.Icon, { name: "calendar", size: 18, color: "var(--color-semantic-label-alternative)", "aria-hidden": "true" }),
              /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "span", { style: { flex: 1, textAlign: "left" }, children: formattedValue || placeholder })
            ]
          }
        ),
        expanded && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "div", { id: popupId, role: "dialog", "aria-label": _nullishCoalesce(ariaLabel, () => ( placeholder)), style: { position: "absolute", top: "calc(100% + 8px)", left: 0, zIndex: 40 }, children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkWPAA5AK2cjs.Calendar, { value: sel || void 0, onChange: pick, isDateDisabled, minDate, maxDate, autoFocus: true }) })
      ]
    }
  );
}
...
//# sourceMappingURL=chunk-3TLI7525.cjs.map