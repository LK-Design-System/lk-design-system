    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxs("header", { style: { display: "flex", alignItems: "center", gap: "var(--space-2)", minWidth: 0, padding: "var(--space-2) var(--space-3)", borderBottom: "1px solid var(--color-semantic-line-normal-normal)", background: "var(--color-semantic-background-elevated-alternative)" }, children: [
          ...
          /* @__PURE__ */ jsx("code", { "aria-label": `\uD604\uC7AC \uACBD\uB85C ${path}`, title: path, style: { minWidth: 0, flex: 1, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap", color: "var(--color-semantic-label-strong)", fontFamily: "var(--font-mono)", fontSize: "var(--label2-size)" }, children: path })
        ] }),
        /* @__PURE__ */ jsx("ul", { "aria-label": "Files and folders", style: { display: "grid", gap: 2, margin: 0, padding: 4, overflow: "auto", maxHeight, listStyle: "none" }, children: loading ? /* @__PURE__ */ jsx(StateRow, { role: "status", children: loadingMessage }) : error != null ? /* @__PURE__ */ jsx(StateRow, { role: "alert", children: error }) : entries.length === 0 ? /* @__PURE__ */ jsx(StateRow, { children: emptyMessage }) : entries.map((entry) => {
...
//# sourceMappingURL=chunk-BN2T6V4D.js.map