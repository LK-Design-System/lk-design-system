...
function HistoryToolbar({
  ...
  const actions = [
    { key: "undo", label: "\uC2E4\uD589 \uCDE8\uC18C", icon: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkO5WLSYUKcjs.Icon, { name: "flip-backward", size: 16, "aria-hidden": "true" }), enabled: undoEnabled, onClick: onUndo, shortcuts: undoKeyShortcuts },
    { key: "redo", label: "\uB2E4\uC2DC \uC2E4\uD589", icon: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "span", { style: { display: "inline-flex", transform: "scaleX(-1)" }, children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkO5WLSYUKcjs.Icon, { name: "flip-backward", size: 16, "aria-hidden": "true" }) }), enabled: redoEnabled, onClick: onRedo, shortcuts: redoKeyShortcuts },
    ...resetVisible ? [{ key: "reset", label: "\uBCC0\uACBD\uC0AC\uD56D \uCD08\uAE30\uD654", icon: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkO5WLSYUKcjs.Icon, { name: "reset", size: 16, "aria-hidden": "true" }), enabled: true, onClick: onReset }] : []
  ];
...
//# sourceMappingURL=chunk-ZCUQVB5V.cjs.map