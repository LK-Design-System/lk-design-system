...
function Combobox({
  ...
  const {
    ...
    describedBy,
    hasMetadata
  } = _chunk64JQMMMOcjs.useFieldMetadata.call(void 0, { prefix: "combobox", id, label, helper, error, describedBy: ariaDescribedBy });
  ...
  const borderColor = _chunk64JQMMMOcjs.fieldBorderColor.call(void 0, { disabled, readOnly, invalid: isInvalid, status, focused: open, hovered });
      ...
      children: [
          ...
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "span", { style: { display: "flex", minWidth: 0, flexWrap: "wrap", gap: "var(--space-1)", alignItems: "center" }, children: selectedValues.length ? selectedValues.map((selectedValue) => {
                ...
                return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "span", { style: { display: "inline-flex", alignItems: "center", maxWidth: "100%", height: 24, padding: "0 9px", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap", borderRadius: "var(--radius-pill)", background: "var(--color-semantic-primary-surface-strong)", color: "var(--color-semantic-primary-heavy)", fontSize: "var(--label2-size)", fontWeight: "var(--fw-semibold)" }, children: _nullishCoalesce(_optionalChain([option, 'optionalAccess', _14 => _14.label]), () => ( selectedValue)) }, selectedValue);
              }) : placeholder }),
              /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "span", { style: { display: "inline-flex", alignItems: "center", gap: "var(--space-2)", flex: "0 0 auto" }, children: [
                ...
                /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkVGM7HVYYcjs.Icon, { name: "chevron-down-small", size: 18, color: "var(--color-semantic-label-alternative)", "aria-hidden": "true", style: { transform: open ? "rotate(180deg)" : "none", transition: "var(--component-button-transition)" } })
              ] })
            ]
          }
        ),
        open && !locked && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
          "div",
          {
            ...
            style: { position: "absolute", top: "calc(100% + 6px)", left: 0, right: 0, zIndex: 40, maxHeight: 260, overflowY: "auto", padding: 6, display: "flex", flexDirection: "column", gap: 2, border: "var(--component-input-border-width) solid var(--color-semantic-line-solid-normal)", borderRadius: "var(--radius-lg)", background: "var(--color-semantic-background-elevated-normal)", boxShadow: "var(--shadow-md)" },
            children: normalized.map((option, index) => {
              ...
              return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, 
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "span", { "aria-hidden": "true", style: { width: 18, height: 18, borderRadius: "var(--radius-5)", border: `1.5px solid ${selected ? "var(--color-semantic-primary-normal)" : "var(--color-semantic-line-solid-normal)"}`, background: selected ? "var(--color-semantic-primary-normal)" : "var(--color-semantic-background-elevated-normal)", display: "inline-flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }, children: selected && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkVGM7HVYYcjs.Icon, { name: "check", size: 16, color: "var(--color-semantic-static-white)", "aria-hidden": "true" }) }),
  ...
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunk64JQMMMOcjs.FieldStack, { fieldId, labelId, label, required, messageId, message, error, status, fieldStyle, children: control });
}



exports.Combobox = Combobox;
//# sourceMappingURL=chunk-XAZNUE2U.cjs.map