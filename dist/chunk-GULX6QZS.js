...
function TimePicker({
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsx(TimeSelect, { value: hour, options: hours, onChange: (nextHour) => commit(nextHour, minute), height, ariaLabel: hourLabel, disabled }),
        ...
        /* @__PURE__ */ jsx(TimeSelect, { value: minute, options: minutes, onChange: (nextMinute) => commit(hour, nextMinute), height, ariaLabel: minuteLabel, disabled })
      ]
    }
  );
}
...
//# sourceMappingURL=chunk-GULX6QZS.js.map