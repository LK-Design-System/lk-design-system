...
function Bookmark({
  ...
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
    "button",
    {
      ...
      ...rest,
      children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunk7OXVB7WXcjs.Icon, { name: on ? "bookmark-fill" : "bookmark", size, "aria-hidden": "true" })
    }
  );
}
...
//# sourceMappingURL=chunk-3VVI2YGX.cjs.map