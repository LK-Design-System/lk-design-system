    ...
    "section",
    {
      ...
      children: [
        ...
        isGrid ? (
          ...
          /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkX5XHQEI5cjs.Icon, { name: "document", size: 22, color: "var(--color-semantic-label-neutral)", "aria-hidden": "true" }),
        ...
        items.length === 0 && !(isGrid && trigger != null) ? /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "div", { role: "status", style: { padding: "var(--space-6) var(--space-4)", color: "var(--color-semantic-label-neutral)", textAlign: "center", fontSize: "var(--label1-size)", lineHeight: "var(--label1-line)" }, children: emptyLabel }) : /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, 
          "ul",
          {
            ...
            children: [
              ...
              items.map((item, index) => {
                ...
                const actionsNode = hasActions ? /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "div", { className: "lk-file-upload-queue__actions", style: { alignSelf: "center", display: "inline-flex", alignItems: "center", justifyContent: "flex-end", justifySelf: "end", gap: "var(--space-1)", flexWrap: "wrap" }, children: [
                  item.status === "failed" && onRetry && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkCYBQ4EMDcjs.Button, { variant: "ghost", size: "sm", "aria-label": `${item.name} \uB2E4\uC2DC \uC2DC\uB3C4`, onClick: () => onRetry(item), children: "\uB2E4\uC2DC \uC2DC\uB3C4" }),
                  item.status === "succeeded" && onOpen && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkCYBQ4EMDcjs.Button, { variant: "ghost", size: "sm", "aria-label": `${item.name} \uC5F4\uAE30`, onClick: () => onOpen(item), children: "\uC5F4\uAE30" }),
                  busy && onCancel && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkCYBQ4EMDcjs.Button, { variant: "ghost", size: "sm", "aria-label": `${item.name} \uCC98\uB9AC \uCDE8\uC18C`, onClick: () => onCancel(item), children: "\uCDE8\uC18C" }),
                  canRemove && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkCYBQ4EMDcjs.Button, { variant: "flat", size: "sm", "aria-label": `${item.name} ${item.status === "succeeded" ? "\uBAA9\uB85D\uC5D0\uC11C \uC81C\uAC70" : "\uC81C\uAC70"}`, onClick: () => onRemove(item), children: "\uC81C\uAC70" })
                ] }) : null;
                if (isGrid) {
                      ...
                      "li",
                      {
                        ...
                        children: [
                          /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "div", { style: { display: "flex", alignItems: "center", gap: "var(--space-3)", height: 88, boxSizing: "border-box", padding: "var(--space-3)", border: "1px solid var(--color-semantic-line-normal-normal)", borderRadius: "var(--radius-md)", background: "var(--color-semantic-background-elevated-normal)", minWidth: 0 }, children: [
                            /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "span", { "aria-hidden": "true", style: { flexShrink: 0, width: 48, height: 48, borderRadius: "var(--radius-md)", background: "var(--color-semantic-fill-normal)", color: "var(--color-semantic-label-neutral)", display: "grid", placeItems: "center" }, children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkX5XHQEI5cjs.Icon, { name: "document", size: 22, "aria-hidden": "true" }) }),
                            ...
                            item.status === "failed" && onRetry && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkITIFTVTBcjs.IconButton, { variant: "ghost", round: true, size: "sm", label: `${item.name} \uB2E4\uC2DC \uC2DC\uB3C4`, onClick: () => onRetry(item), style: { flexShrink: 0 }, children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkX5XHQEI5cjs.Icon, { name: "refresh", size: 16, "aria-hidden": "true" }) })
                          ] }),
                          cornerAction && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "span", { style: { position: "absolute", top: "calc(-1 * var(--space-2))", right: "calc(-1 * var(--space-2))" }, children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkITIFTVTBcjs.IconButton, { variant: "ghost", round: true, size: "sm", label: cornerAction.label, onClick: cornerAction.onClick, style: { boxShadow: "var(--shadow-md)" }, children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkX5XHQEI5cjs.Icon, { name: "close", size: 14, "aria-hidden": "true" }) }) }),
                    ...
                    "li",
                    {
                      ...
                      children: [
                        /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "div", { style: { position: "relative", width: "100%", aspectRatio: "1 / 1", borderRadius: "var(--radius-md)", overflow: "hidden", background: "var(--color-semantic-fill-normal)", display: "grid", placeItems: "center", color: "var(--color-semantic-label-neutral)" }, children: [
                          ...
                          item.status === "failed" && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "div", { style: { position: "absolute", inset: 0, display: "grid", placeItems: "center", background: "var(--scrim-dark)" }, children: onRetry && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkITIFTVTBcjs.IconButton, { variant: "on-dark", round: true, size: "sm", label: `${item.name} \uB2E4\uC2DC \uC2DC\uB3C4`, onClick: () => onRetry(item), children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkX5XHQEI5cjs.Icon, { name: "refresh", size: 16, "aria-hidden": "true" }) }) }),
                      ...
                      /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "div", { style: { display: "grid", gap: "var(--space-1)", minWidth: 0 }, children: [
                        /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "div", { style: { display: "grid", gap: "var(--space-1)", minWidth: 0 }, children: [
                          /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "div", { style: { display: "flex", alignItems: "center", gap: "var(--space-2)", minWidth: 0, flexWrap: "wrap" }, children: [
                            ...
                            /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkWZUH43FEcjs.StatusBadge, { tone: meta.tone, style: { flexShrink: 0 }, children: _nullishCoalesce(item.label, () => ( meta.label)) })
                          ] }),
...
//# sourceMappingURL=chunk-T4PGFVN7.cjs.map