...
function StatusBadge({ children, tone = "positive", pulse = false, style, ...rest }) {
  ...
  return /* @__PURE__ */ jsxs(
    "span",
    {
      ...
      ...rest,
      children: [
        /* @__PURE__ */ jsx("span", { style: { position: "relative", width: 6, height: 6, borderRadius: "50%", background: c, flexShrink: 0 }, children: (pulse || tone === "critical") && /* @__PURE__ */ jsx("span", { "data-lds-status-pulse": "", style: { position: "absolute", inset: 0, borderRadius: "50%", background: c, animation: "lk-status-pulse 1.7s var(--ease-out) infinite" } }) }),
        children
      ]
    }
  );
...
//# sourceMappingURL=chunk-BNPFEXZC.js.map