...
var ICONS = {
  ...
  positive: {
    ...
    name: _chunkMBKOVB2Kcjs.statusToneStyle.call(void 0, "positive").icon
  },
  cautionary: {
    color: "var(--color-semantic-status-cautionary)",
    name: _chunkMBKOVB2Kcjs.statusToneStyle.call(void 0, "cautionary").icon
  },
  negative: {
    color: "var(--color-semantic-status-negative)",
    name: _chunkMBKOVB2Kcjs.statusToneStyle.call(void 0, "negative").icon
  }
};
      ...
      children: [
        leadingIcon && /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
          "span",
          {
            ...
            children: icon || /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkVHQHPPYQcjs.Icon, { name: t.name, size: 22, "aria-hidden": "true" })
          }
        ),
        ...
        onClose && /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
          "button",
          {
            ...
            children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkVHQHPPYQcjs.Icon, { name: "close", size: 16, "aria-hidden": "true" })
          }
        )
      ]
    }
...
exports.Toast = Toast;
//# sourceMappingURL=chunk-OM64PCTE.cjs.map