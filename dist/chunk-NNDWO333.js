...
function ElevatorColumn({ building, elevator }) {
  ...
  const positionSummary = offline ? `${elevator.name} \uB9C8\uC9C0\uB9C9 \uD655\uC778 \uC704\uCE58 ${elevator.currentFloor}, ${elevator.statusLabel ?? status}` : `${elevator.name} \uD604\uC7AC \uC704\uCE58 ${elevator.currentFloor}, ${elevator.directionLabel ?? "\uC815\uC9C0"}, ${elevator.statusLabel ?? status}`;
  return /* @__PURE__ */ jsxs(
    "article",
    {
            ...
            children: [
              ...
              /* @__PURE__ */ jsx2(
                "div",
                {
                  ...
                  children: floors.map((floor) => /* @__PURE__ */ jsx2(
                    FloorRow,
                    {
                      floor,
          ...
          ScrollArea,
          {
            ...
            children: /* @__PURE__ */ jsx2(
              "div",
              {
                ...
                children: buildings.map((building) => /* @__PURE__ */ jsx2(
                  BuildingGroup,
                  {
                    building,
                    headingLevel
...
//# sourceMappingURL=chunk-NNDWO333.js.map