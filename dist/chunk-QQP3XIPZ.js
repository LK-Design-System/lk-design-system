...
import {
  StatusIndicator
} from "./chunk-RW2LQT6L.js";
import {
  Button
} from "./chunk-MIPOPDG3.js";
import {
  OverlayPortal,
  inlineFloatingStyle,
  useFloatingPosition,
  useOverlayLayer
} from "./chunk-CJJ6KAG5.js";
import {
  componentVars,
  partClassName,
  partStyle,
  useMergedRefs
} from "./chunk-KI5XEAUE.js";
import {
  StatusBadge
} from "./chunk-NGIJI44Y.js";
import {
  IconButton
} from "./chunk-2J5G2DSM.js";
import {
  Icon
} from "./chunk-WRPMEJH5.js";
import {
  getUnitSeparator,
  isAttachedUnit,
  normalizeUnit,
...
function CheckMark({ variant, checked, disabled }) {
  ...
  return /* @__PURE__ */ jsx4(
    "span",
    {
      ...
      children: checked && /* @__PURE__ */ jsx4(Icon, { name: "check", size: 11, "aria-hidden": "true" })
    }
  );
}
...
function MenuItemContent({ item, variant, checked, disabled, description, trailing }) {
  const indicator = item.icon || /* @__PURE__ */ jsx4(CheckMark, { variant, checked, disabled });
  const indicatorAtEnd = item.iconPosition === "end";
  return /* @__PURE__ */ jsxs2(Fragment, { children: [
    !indicatorAtEnd && indicator,
    /* @__PURE__ */ jsxs2("span", { style: { display: "grid", gap: 4, minWidth: 0, flex: 1 }, children: [
      /* @__PURE__ */ jsx4("span", { style: { overflowWrap: "anywhere" }, children: item.label }),
...
function MenuItemButton({ item, variant, itemMetrics, onSelect, trailing, haspopup, onTriggerKeyDown, classNames, styles }) {
  ...
  return /* @__PURE__ */ jsx4(
    "button",
    {
      ...
      children: /* @__PURE__ */ jsx4(MenuItemContent, { item, variant, checked, disabled, description, trailing })
    }
  );
}
var SUBMENU_CHEVRON = /* @__PURE__ */ jsx4(Icon, { name: "chevron-right-small", size: 16, "aria-hidden": "true", style: { flexShrink: 0, color: "var(--color-semantic-label-alternative)" } });
function DrillHeader({ title, onBack, itemMetrics }) {
  return /* @__PURE__ */ jsxs2(
    "button",
    {
      ...
      children: [
        /* @__PURE__ */ jsx4(Icon, { name: "chevron-left-small", size: 16, "aria-hidden": "true" }),
        /* @__PURE__ */ jsx4("span", { style: { overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }, children: title })
      ]
    }
  );
}
          ...
          "button",
          {
            ...
            children: /* @__PURE__ */ jsx4(
              MenuItemContent,
              {
                ...
                disabled,
                description,
                trailing: /* @__PURE__ */ jsx4(Icon, { name: "chevron-right-small", size: 16, "aria-hidden": "true", style: { flexShrink: 0, color: "var(--color-semantic-label-alternative)" } })
              }
            )
          }
        ),
...
var DropdownMenu = React5.forwardRef(function DropdownMenu2({
  trigger,
  items = [],
  align = "left",
  ...
  const [drillPath, setDrillPath] = React5.useState([]);
  const ref = React5.useRef(null);
  const mergedRootRef = useMergedRefs(ref, forwardedRef);
  const panelRef = React5.useRef(null);
  const actionAreaRef = React5.useRef(null);
  const menuId = React5.useId();
  const generatedTriggerId = React5.useId();
  ...
  const renderedTrigger = React5.isValidElement(trigger) && trigger.type !== React5.Fragment ? React5.cloneElement(trigger, {
    id: triggerId,
    "aria-haspopup": "menu",
  ...
  const [menuScrollable, setMenuScrollable] = React5.useState(false);
  ...
  return /* @__PURE__ */ jsxs2(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx4(OverlayPortal, { open: visible, withinPortal, portalTarget, anchorRef: ref, layer: "anchored", children: /* @__PURE__ */ jsxs2(
          "div",
          {
            ref: panelRef,
            "data-slot": "panel",
            ...
            children: [
              /* @__PURE__ */ jsx4(
                "div",
                {
                  ...
                  children: drill ? /* @__PURE__ */ jsxs2(Fragment, { children: [
                    drillLevel && /* @__PURE__ */ jsx4(DrillHeader, { title: drillLevel.label, onBack: drillBack, itemMetrics }),
              ...
              showActionArea && /* @__PURE__ */ jsx4(
                "div",
                {
                  ...
                  children: action || /* @__PURE__ */ jsxs2(Fragment, { children: [
                    onCancel && /* @__PURE__ */ jsx4(Button, { variant: "outlined", color: "assistive", size: "sm", onClick: () => finishAction(onCancel), children: cancelLabel }),
                    onApply && /* @__PURE__ */ jsx4(Button, { size: "sm", onClick: () => finishAction(onApply), children: applyLabel })
                  ] })
                }
              )
            ]
...
function FieldValue({ field }) {
  ...
  return /* @__PURE__ */ jsxs3(
    "span",
    {
      ...
      children: [
        /* @__PURE__ */ jsx5("span", { children: renderedValue }),
        normalizedUnit !== "" && /* @__PURE__ */ jsxs3("span", { style: { color: "var(--color-semantic-label-neutral)", fontWeight: "var(--fw-medium)" }, children: [
          unitSeparator,
          normalizedUnit
        ] })
      ]
...
function InspectorFields({ fields = [] }) {
  return /* @__PURE__ */ jsx5("div", { children: fields.map((field, index) => /* @__PURE__ */ jsxs3(
    "div",
    {
      style: {
        display: "grid",
      ...
      children: [
        /* @__PURE__ */ jsx5("span", { style: { minWidth: 0, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap", color: "var(--color-semantic-label-neutral)", fontSize: "var(--label2-size)", lineHeight: "var(--label2-line)", fontWeight: "var(--fw-medium)", letterSpacing: 0 }, children: field.label }),
        field.valueNode != null ? displayValueNode(field.valueNode, field.mixed) : /* @__PURE__ */ jsx5(FieldValue, { field })
      ]
    },
    `${field.label}-${index}`
  )) });
...
function InspectorSection({ section }) {
  ...
  const [expanded, setExpanded] = React6.useState(section.defaultExpanded !== false);
  const contentId = React6.useId();
  const content = /* @__PURE__ */ jsxs3("div", { id: contentId, hidden: collapsible && !expanded, children: [
    /* @__PURE__ */ jsx5(InspectorFields, { fields: section.fields }),
    section.children
  ] });
  return /* @__PURE__ */ jsxs3("section", { style: { minWidth: 0, borderTop: "1px solid var(--color-semantic-line-normal-alternative)" }, children: [
    section.title != null && (collapsible ? (
      ...
      /* @__PURE__ */ jsx5("h4", { style: { margin: 0, font: "inherit", color: "inherit" }, children: /* @__PURE__ */ jsxs3(
        "button",
        {
          type: "button",
          ...
          children: [
            /* @__PURE__ */ jsx5("span", { style: { fontSize: "var(--label2-size)", lineHeight: "var(--label2-line)", fontWeight: "var(--fw-bold)" }, children: section.title }),
            /* @__PURE__ */ jsx5(Icon, { name: expanded ? "chevron-up-small" : "chevron-down-small", size: 16, "aria-hidden": "true" })
          ]
        }
      ) })
    ) : /* @__PURE__ */ jsx5("h4", { style: { minHeight: 40, display: "flex", alignItems: "center", margin: 0, fontSize: "var(--label2-size)", lineHeight: "var(--label2-line)", fontWeight: "var(--fw-bold)", color: "var(--color-semantic-label-strong)" }, children: section.title })),
    content
  ] });
}
function SelectionInspector({
  ...
  const controls = hasMenu || canClearSelection ? /* @__PURE__ */ jsxs3("span", { style: { display: "flex", alignItems: "center", gap: "var(--space-1)", marginInlineStart: "auto", flexShrink: 0 }, children: [
    hasMenu && /* @__PURE__ */ jsx5(
      DropdownMenu,
      {
        align: "right",
        items: menuItems,
        trigger: (
          ...
          /* @__PURE__ */ jsx5(IconButton, { type: "button", size: "sm", variant: "plain", round: false, label: menuLabel, children: /* @__PURE__ */ jsx5(Icon, { name: "more-vertical", size: 16, "aria-hidden": "true" }) })
        )
      }
    ),
    canClearSelection && /* @__PURE__ */ jsx5(
      IconButton,
      {
        type: "button",
        size: "sm",
        ...
        children: /* @__PURE__ */ jsx5(Icon, { name: "close", size: 16, "aria-hidden": "true" })
      }
    )
  ] }) : null;
  ...
  return /* @__PURE__ */ jsxs3(
    "section",
    {
      ...
      ...rest,
      children: [
        /* @__PURE__ */ jsxs3("header", { style: { display: "grid", gap: "var(--space-2)", minWidth: 0, padding: headerHasContent ? "var(--space-3) var(--space-4)" : 0, borderBottom: headerHasContent ? "1px solid var(--color-semantic-line-normal-normal)" : "none", boxSizing: "border-box" }, children: [
          !titleVisuallyHidden && /* @__PURE__ */ jsxs3("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", gap: "var(--space-2)", minWidth: 0 }, children: [
            /* @__PURE__ */ jsx5("strong", { style: { minWidth: 0, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap", fontSize: "var(--label2-size)", lineHeight: "var(--label2-line)", fontWeight: "var(--fw-bold)", color: "var(--color-semantic-label-neutral)" }, children: title }),
            controls
          ] }),
          hasItem && /* @__PURE__ */ jsxs3("div", { style: { display: "grid", gap: "var(--space-2)", minWidth: 0 }, children: [
            /* @__PURE__ */ jsxs3("div", { style: { display: "flex", alignItems: "center", gap: "var(--space-2)", minWidth: 0 }, children: [
              /* @__PURE__ */ jsx5("h3", { style: { flex: 1, minWidth: 0, margin: 0, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap", fontSize: "var(--headline2-size)", lineHeight: "var(--headline2-line)", fontWeight: "var(--fw-bold)", color: "var(--color-semantic-label-strong)", letterSpacing: 0 }, children: selectionName }),
              titleVisuallyHidden && controls
            ] }),
            /* @__PURE__ */ jsxs3("div", { style: { display: "flex", alignItems: "center", gap: "var(--space-2)", minWidth: 0, flexWrap: "wrap" }, children: [
              item.kind != null && /* @__PURE__ */ jsx5(Tag, { tone: "neutral", children: item.kind }),
              item.status != null && (item.statusPresentation === "indicator" ? /* @__PURE__ */ jsx5(StatusIndicator, { tone: item.statusTone || "signal", children: item.status }) : /* @__PURE__ */ jsx5(StatusBadge, { tone: item.statusTone || "signal", children: item.status }))
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsx5("div", { style: { minHeight: 0, overflow: "auto", padding: hasItem ? "0 var(--space-4) var(--space-4)" : "var(--space-4)", boxSizing: "border-box" }, children: hasItem ? /* @__PURE__ */ jsxs3(Fragment2, { children: [
          sections.map((section, index) => /* @__PURE__ */ jsx5(InspectorSection, { section }, `${section.title || "section"}-${index}`)),
          children
        ] }) : /* @__PURE__ */ jsxs3("div", { role: "status", style: { minHeight: 180, display: "grid", placeItems: "center", alignContent: "center", gap: "var(--space-3)", color: "var(--color-semantic-label-neutral)", textAlign: "center" }, children: [
          /* @__PURE__ */ jsx5(Icon, { name: "crosshair", size: 24, "aria-hidden": "true" }),
          /* @__PURE__ */ jsx5("span", { style: { maxWidth: 220, fontSize: "var(--label2-size)", lineHeight: "var(--label2-line)", fontWeight: "var(--fw-medium)" }, children: emptyLabel })
        ] }) }),
        hasItem && actions != null && /* @__PURE__ */ jsx5(ActionArea, { compact: true, align: "end", children: actions })
      ]
    }
  );
}
...
//# sourceMappingURL=chunk-QQP3XIPZ.js.map