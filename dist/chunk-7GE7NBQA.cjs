  ...
  if (showFollow || showMenu) {
    trailing = /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "div", { style: { display: "flex", alignItems: "center", gap: "var(--space-2)", marginLeft: "var(--space-2)" }, children: [
      ...
      showMenu && /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
        _chunkUKW6QXD7cjs.DropdownMenu,
        {
          align: "right",
          items: menuItems,
          trigger: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkMBZNMP7Bcjs.IconButton, { variant: "plain", round: true, size: "sm", label: menuLabel, style: { color: "var(--color-semantic-label-alternative)" }, children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunk7OXVB7WXcjs.Icon, { name: "more-vertical", size: 20, "aria-hidden": "true" }) })
        }
      )
    ] });
  }
...
//# sourceMappingURL=chunk-7GE7NBQA.cjs.map