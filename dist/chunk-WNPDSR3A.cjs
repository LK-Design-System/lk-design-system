...
// packages/core/dist/chunk-S2QN6NWO.js
...
// packages/core/dist/chunk-BEHEWEDL.js
...
function Tooltip({
  ...
  const showTooltip = (event) => {
    _optionalChain([onMouseEnter, 'optionalCall', _26 => _26(event)]);
    schedule(true, delays.open);
  };
  const hideTooltip = (event) => {
    _optionalChain([onMouseLeave, 'optionalCall', _27 => _27(event)]);
...
//# sourceMappingURL=chunk-WNPDSR3A.cjs.map