...
function actionIcon(icon) {
  if (typeof icon === "string") return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkVGM7HVYYcjs.Icon, { name: icon, size: 16, "aria-hidden": "true" });
  return icon;
}
  ...
  if (showHistory) {
    groups.push({
      ...
      node: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
        _chunkOGZ2JVEKcjs.HistoryToolbar,
        {
          label: historyLabel,
          canUndo,
          canRedo,
...
//# sourceMappingURL=chunk-HFUDRORG.cjs.map