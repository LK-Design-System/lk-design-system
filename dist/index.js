...
function SocialButton({
  ...
  const [press, setPress] = React9.useState(false);
...
function Stat({
  ...
  return /* @__PURE__ */ jsxs12(
    "div",
    {
      ...
      ...rest,
      children: [
        /* @__PURE__ */ jsx18("span", { style: { fontSize: "40px", fontWeight: "var(--fw-extra)", letterSpacing: "-1.6px", lineHeight: 1, color: valColor, fontVariantNumeric: "tabular-nums" }, children: value }),
      ...
      /* @__PURE__ */ jsxs55(
        "button",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx73("svg", { width: "18", height: "18", viewBox: "0 0 24 24", fill: "none", stroke: "var(--label-alternative)", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", style: { flexShrink: 0, transform: open ? "rotate(180deg)" : "none", transition: "transform var(--dur-fast) var(--ease-out)" }, children: /* @__PURE__ */ jsx73("path", { d: "m6 9 6 6 6-6" }) })
          ]
        }
      ),
  ...
  return /* @__PURE__ */ jsx92("nav", { style: { display: "flex", alignItems: "stretch", background: "var(--bw-white)", borderTop: "1px solid var(--bw-border)", ...style }, ...rest, children: items.map((o) => {
    ...
    return /* @__PURE__ */ jsxs60(
      "button",
      {
        ...
        children: [
          o.icon,
          /* @__PURE__ */ jsx92("span", { style: { fontFamily: "var(--font-sans)", fontSize: 11, fontWeight: active ? "var(--fw-bold)" : "var(--fw-medium)", letterSpacing: "-0.1px" }, children: o.label })
        ]
      },
      o.value
    );
...
function SideNav({
  ...
  const labelSpan = (active, children) => /* @__PURE__ */ jsx99("span", { style: { flex: 1, minWidth: 0, fontSize: 14, fontWeight: active ? "var(--fw-bold)" : "var(--fw-medium)", letterSpacing: "-0.1px", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }, children });
          ...
          !col && isOpen && /* @__PURE__ */ jsx99("div", { style: { display: "flex", flexDirection: "column", gap: 2, margin: "0 0 4px" }, children: kids.map((c) => {
            ...
            return /* @__PURE__ */ jsxs66(
              "button",
              {
                ...
                children: [
                  /* @__PURE__ */ jsx99("span", { style: { flex: 1, minWidth: 0, fontSize: 13.5, fontWeight: ca ? "var(--fw-bold)" : "var(--fw-medium)", letterSpacing: "-0.1px", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }, children: c.label }),
      ...
      children: /* @__PURE__ */ jsxs80(
        "div",
        {
          ...
          children: [
            ...
            title != null && /* @__PURE__ */ jsx115("div", { style: { padding: "14px 22px 4px", fontSize: 18, fontWeight: "var(--fw-extra)", letterSpacing: "-0.4px", color: "var(--label-normal)" }, children: title }),
  ...
  return /* @__PURE__ */ jsxs81(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx116("span", { style: { flex: 1, fontSize: 14, lineHeight: 1.5, letterSpacing: "-0.1px", color: "var(--label-neutral)", wordBreak: "keep-all" }, children }),
  ...
  return /* @__PURE__ */ jsxs97(
    "div",
    {
      ...
      children: [
        ...
        title != null && /* @__PURE__ */ jsx134("div", { style: { fontSize: 18, fontWeight: "var(--fw-bold)", letterSpacing: "-0.3px", color: "var(--label-normal)" }, children: title }),
