    ...
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxs(
        "div",
        {
          ...
          children: [
            (title != null || subtitle != null || onClose) && /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", gap: "var(--space-4)", padding: isCompact ? "var(--space-4) var(--space-5)" : "var(--space-5) var(--space-6)", borderBottom: "1px solid var(--color-semantic-line-solid-normal)" }, children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "lk-scroll-surface", "data-scrollbar": "auto", "data-scroll-gutter": "stable", style: { flex: 1, padding: isCompact ? "var(--space-4) var(--space-5)" : "var(--space-5) var(--space-6)", overflow: "auto", scrollbarGutter: "stable", fontSize: isCompact ? "var(--label1-size)" : "var(--body2-size)", lineHeight: isCompact ? "var(--label1-line)" : 1.7, letterSpacing: isCompact ? "var(--label1-spacing)" : void 0, color: "var(--color-semantic-label-neutral)", wordBreak: "keep-all", ...bodyStyle }, children: /* @__PURE__ */ jsx(ComponentDensityScope, { density: resolvedDensity, children }) }),
            footer != null && /* @__PURE__ */ jsx("div", { style: { padding: isCompact ? "var(--space-3) var(--space-5)" : "var(--space-4) var(--space-6)", borderTop: "1px solid var(--color-semantic-line-solid-normal)", display: "flex", justifyContent: "flex-end", gap: "var(--space-2)" }, children: footer })
          ]
        }
      )
    }
...
//# sourceMappingURL=chunk-5ZFMLJT5.js.map