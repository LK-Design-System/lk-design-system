      ...
      children: [
        nativeChoice && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
          "input",
          {
            ...
            "aria-label": _nullishCoalesce(_nullishCoalesce(ariaLabel, () => ( inputProps["aria-label"])), () => ( (typeof title === "string" ? title : void 0))),
            onChange: (event) => {
        ...
        !isFrame && icon != null && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
          "span",
          {
            ...
            style: {
              flexShrink: 0,
              color: disabled ? "var(--color-semantic-label-disable)" : selected ? "var(--color-semantic-primary-heavy)" : "var(--color-semantic-label-neutral)",
              display: "inline-flex"
            },
            children: icon
          }
        ...
        /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "div", { style: isFrame ? void 0 : { flex: 1, minWidth: 0 }, children: [
          !isFrame && title != null && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "div", { style: { fontSize: "var(--body2-size)", fontWeight: "var(--fw-bold)", letterSpacing: 0, color: disabled ? "var(--color-semantic-label-disable)" : "var(--color-semantic-label-strong)", wordBreak: "keep-all" }, children: title }),
          !isFrame && description != null && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "div", { style: { marginTop: 3, fontSize: "var(--label2-size)", lineHeight: 1.55, color: disabled ? "var(--color-semantic-label-disable)" : "var(--color-semantic-label-alternative)", wordBreak: "keep-all" }, children: description }),
          children
        ] }),
        !isFrame && showIndicator && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
          "span",
          {
            ...
            children: selected && (multiple ? /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkVGM7HVYYcjs.Icon, { name: "check", size: 12, "aria-hidden": "true" }) : /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "span", { style: { width: 12, height: 12, borderRadius: "50%", background: "currentColor" } }))
          }
        )
      ]
    }
...
//# sourceMappingURL=chunk-QLIG5NM6.cjs.map