...
var Input = _react2.default.forwardRef(function Input2({
  ...
  usePlaceholderStyle();
  const ring = _chunkIF75VIWIcjs.fieldBorderColor.call(void 0, { disabled, readOnly, invalid: isInvalid, status, focused: activeFocus, hovered: activeHover });
            ...
            children: [
              ...
              /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
                "input",
                {
                  ...
                  "aria-describedby": _chunkIF75VIWIcjs.mergeIds.call(void 0, rest["aria-describedby"], messageId),
                  ...
                  style: { flex: 1, minWidth: 0, height: "100%", boxSizing: "border-box", border: "none", outline: "none", background: "transparent", cursor: disabled ? "not-allowed" : readOnly ? "text" : void 0, fontFamily: "var(--font-sans)", ..._chunkIF75VIWIcjs.fieldTypography.call(void 0, normalizedSize), color: disabled ? "var(--color-semantic-label-disable)" : "var(--color-semantic-label-normal)", ..._chunkGWMGPLNWcjs.partStyle.call(void 0, styles, "input"), ...inputStyle }
                }
              ),
...
exports.Input = Input;
//# sourceMappingURL=chunk-KEWHPKKE.cjs.map