...
function FloorSelector({ floors = [], value, defaultValue, onChange, appearance = "light", size = "sm", style, ...rest }) {
  ...
  return /* @__PURE__ */ jsx("div", { role: "radiogroup", "aria-label": "\uCE35 \uC120\uD0DD", "data-floor-selector-size": size, onKeyDown: handleKeyDown, style: {
    display: "inline-flex",
    ...
    return /* @__PURE__ */ jsx(
      "button",
      {
        ...
        style: {
          ...
          background: on ? "var(--color-semantic-primary-fill)" : "transparent",
...
//# sourceMappingURL=chunk-IKHIFBRY.js.map