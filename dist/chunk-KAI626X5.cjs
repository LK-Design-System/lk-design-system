...
function IconPicker({
  ...
  const focusAndPick = (index) => {
    ...
    setFocusIndex(index);
    pick(option);
    window.requestAnimationFrame(() => _optionalChain([optionRefs, 'access', _7 => _7.current, 'access', _8 => _8[index], 'optionalAccess', _9 => _9.focus, 'call', _10 => _10()]));
  };
  const handleKeyDown = (event, index) => {
    if (disabled || _optionalChain([options, 'access', _11 => _11[index], 'optionalAccess', _12 => _12.disabled])) return;
    const keyMap = {
...
//# sourceMappingURL=chunk-KAI626X5.cjs.map