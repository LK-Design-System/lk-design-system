...
var _chunk67KN2FP2cjs = require('./chunk-67KN2FP2.cjs');
...
function Map2DCanvas({
  ...
  const interactionState = _chunk67KN2FP2cjs.resolveViewerState.call(void 0, {
    state,
    availability,
    connection,
    freshness,
  ...
  const interactionBlocked = _chunk67KN2FP2cjs.VIEWER_BLOCKING_STATES.includes(interactionState);
  const {
    rootRef,
    renderedViewport,
    commitViewport,
...
//# sourceMappingURL=chunk-3FVRJWWL.cjs.map