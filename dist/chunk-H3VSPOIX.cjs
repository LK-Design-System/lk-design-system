...
function Select({
  ...
  const describedBy = _chunk64JQMMMOcjs.mergeIds.call(void 0, ariaDescribedBy, messageId);
  ...
  const ring = _chunk64JQMMMOcjs.fieldBorderColor.call(void 0, { disabled: disabledState, readOnly, invalid: isInvalid, status, focused: activeFocus, hovered: activeHover });
  _react2.default.useEffect(() => {
  ...
  return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "div", { "data-readonly": readOnly ? "true" : void 0, style: { display: "flex", flexDirection: "column", gap: "var(--component-input-stack-gap)", ...style }, children: [
    /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunk64JQMMMOcjs.FieldLabel, { id: labelId, htmlFor: selId, label, required }),
      ...
      /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, 
        "button",
        {
          ...
          style: {
            ...
            background: _chunk64JQMMMOcjs.fieldBackground.call(void 0, { disabled: disabledState, readOnly }),
          ...
          children: [
            /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "span", { style: { display: "inline-flex", alignItems: "center", gap: 8, minWidth: 0, overflow: "hidden" }, children: [
              ...
              curr && render === "chip" ? /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "span", { style: { display: "inline-flex", alignItems: "center", maxWidth: "100%", height: 24, padding: "0 9px", borderRadius: "var(--radius-pill)", background: "var(--color-semantic-primary-surface-strong)", color: "var(--color-semantic-primary-heavy)", fontSize: "var(--label2-size)", fontWeight: "var(--fw-semibold)", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }, children: curr.label }) : /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "span", { style: { overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }, children: curr ? curr.label : placeholder })
            ] }),
            /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "span", { style: { display: "inline-flex", alignItems: "center", gap: "var(--component-input-gap)", flex: "0 0 auto" }, children: [
              ...
              /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkVGM7HVYYcjs.Icon, { name: "chevron-down-small", size: 18, color: "var(--color-semantic-label-alternative)", "aria-hidden": "true", style: { flexShrink: 0, transform: visualOpen ? "rotate(180deg)" : "none", transition: "var(--component-button-transition)" } })
            ] })
          ]
        }
      ),
        ...
        return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, 
          "div",
          {
            ...
            children: [
              ...
              on && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkVGM7HVYYcjs.Icon, { name: "check", size: 15, color: o.disabled ? "var(--color-semantic-label-disable)" : void 0, "aria-hidden": "true", style: { flexShrink: 0 } })
            ]
          },
          o.value
        );
    ...
    /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunk64JQMMMOcjs.FieldMessage, { id: messageId, message, error, status })
  ] });
}
...
//# sourceMappingURL=chunk-H3VSPOIX.cjs.map