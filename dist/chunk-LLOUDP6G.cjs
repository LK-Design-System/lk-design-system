...
function FeedCard({
  ...
  if (showFollow || showMenu) {
    trailing = /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "div", { style: { display: "flex", alignItems: "center", gap: "var(--space-2)", marginLeft: "var(--space-2)" }, children: [
      showFollow && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkE2EQSM2Kcjs.Button, { variant: following ? "ghost" : "secondary", size: "sm", onClick: onFollowToggle, children: resolvedFollowLabel }),
      showMenu && /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
        _chunkMAKSCRB2cjs.DropdownMenu,
        {
          align: "right",
          items: menuItems,
          trigger: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkI6NJHF3Lcjs.IconButton, { variant: "plain", round: true, size: "sm", label: menuLabel, style: { color: "var(--color-semantic-label-alternative)" }, children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkF72KSGF7cjs.Icon, { name: "more-vertical", size: 20, "aria-hidden": "true" }) })
        }
      )
    ] });
  }
  return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0,
    "article",
    {
      ...
      children: [
        ...
        hasReactions && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "div", { style: { padding: "var(--space-2) var(--space-4) var(--space-3)" }, children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunk5BBO23AMcjs.ReactionBar, { like, comment, share }) })
      ]
    }
  );
}
...
//# sourceMappingURL=chunk-LLOUDP6G.cjs.map