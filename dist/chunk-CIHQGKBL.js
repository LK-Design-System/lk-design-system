...
function NavRail({ items = [], value, defaultValue, onChange, renderLink, style, ...rest }) {
  ...
  return /* @__PURE__ */ jsx("nav", { style: { display: "inline-flex", flexDirection: "column", width: "fit-content", maxWidth: "100%", boxSizing: "border-box", gap: 6, padding: 10, background: "var(--color-semantic-background-elevated-normal)", border: "1px solid var(--color-semantic-line-solid-normal)", borderRadius: "var(--radius-xl)", ...style }, ...rest, children: items.map((o) => {
...
//# sourceMappingURL=chunk-CIHQGKBL.js.map