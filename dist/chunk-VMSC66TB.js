...
function NewsCard({ image, category, title, excerpt, source, date, cta, href = "#", style, ...rest }) {
  ...
  return /* @__PURE__ */ jsxs(
    "a",
    {
      ...
      ...rest,
      children: [
        image && /* @__PURE__ */ jsx("div", { style: { aspectRatio: "16 / 9", overflow: "hidden", background: "var(--color-semantic-background-normal-alternative)" }, children: /* @__PURE__ */ jsx("img", { src: image, alt: "", style: { width: "100%", height: "100%", objectFit: "cover", transform: hover ? "scale(1.03)" : "scale(1)", transition: "transform 520ms var(--ease-out)" } }) }),
        /* @__PURE__ */ jsxs("div", { style: { padding: "18px 20px 20px", display: "flex", flexDirection: "column", gap: 9, flex: 1 }, children: [
          ...
          title && /* @__PURE__ */ jsx("h3", { style: { margin: 0, fontSize: "var(--headline1-size)", fontWeight: "var(--fw-extra)", letterSpacing: 0, lineHeight: 1.36, color: "var(--color-semantic-label-strong)", wordBreak: "keep-all" }, children: title }),
          ...
          (source || date || cta) && /* @__PURE__ */ jsxs("div", { style: { marginTop: "auto", paddingTop: 12, display: "flex", alignItems: "center", gap: 8, fontSize: "var(--caption1-size)", color: "var(--color-semantic-label-alternative)" }, children: [
            ...
            date && /* @__PURE__ */ jsx("span", { style: { fontVariantNumeric: "tabular-nums" }, children: date }),
            cta && /* @__PURE__ */ jsxs("span", { style: { marginLeft: "auto", display: "inline-flex", alignItems: "center", gap: 5, fontWeight: 700, color: "var(--color-semantic-primary-normal)", whiteSpace: "nowrap" }, children: [
              cta,
...
//# sourceMappingURL=chunk-VMSC66TB.js.map