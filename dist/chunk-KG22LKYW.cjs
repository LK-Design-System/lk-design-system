...
var Tooltip = _react2.default.forwardRef(function Tooltip2({
  ...
  const getTrigger = _react2.default.useCallback(() => _chunkGJS3WBHUcjs.findOverlayTrigger.call(void 0, wrapperRef.current), []);
  const floating = _chunkGJS3WBHUcjs.useFloatingPosition.call(void 0, {
    open: visible,
  ...
  const renderedChildren = validTrigger ? _react2.default.cloneElement(children, {
    ...
    "aria-describedby": _chunkGJS3WBHUcjs.appendAriaReference.call(void 0, children.props["aria-describedby"], tooltipId)
  }) : children;
...
//# sourceMappingURL=chunk-KG22LKYW.cjs.map