...
function FileUpload({
  ...
  const { fieldId: inputId, describedBy } = _chunkDSYH34X7cjs.useFieldMetadata.call(void 0, { prefix: "file-upload", describedBy: inputAriaDescribedBy });
...
//# sourceMappingURL=chunk-ZQHG4D6E.cjs.map