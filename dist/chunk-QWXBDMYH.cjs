    ...
    /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, 
      "button",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkX5XHQEI5cjs.Icon, { name: "chevron-down-small", size: 18, color: "var(--color-semantic-label-alternative)", "aria-hidden": "true", style: { transform: open ? "rotate(180deg)" : "none", transition: "transform var(--dur-base) var(--ease-out)", flexShrink: 0 } })
        ]
      }
    ),
    /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "div", { id: panelId, role: "region", "aria-labelledby": triggerId, inert: open ? void 0 : true, style: { display: "grid", gridTemplateRows: open ? "1fr" : "0fr", transition: "grid-template-rows var(--dur-base) var(--ease-out)" }, children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "div", { style: { overflow: "hidden" }, children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "div", { style: { padding: "0 4px 14px", fontFamily: "var(--font-sans)", fontSize: "var(--label1-size)", lineHeight: 1.7, color: "var(--color-semantic-label-neutral)", wordBreak: "keep-all" }, children }) }) })
  ] });
}
...
//# sourceMappingURL=chunk-QWXBDMYH.cjs.map