...
function InputGroup({
  ...
  const metadata = _chunk4KUVQPIKcjs.useFieldMetadata.call(void 0, {
    prefix: "input-group",
    id,
    label,
    helper,
  ...
  const describedBy = _chunk4KUVQPIKcjs.mergeIds.call(void 0, metadata.describedBy, prefixId, suffixId);
  const {
  ...
  const borderColor = _chunk4KUVQPIKcjs.fieldBorderColor.call(void 0, {
    disabled,
    readOnly,
    invalid: isInvalid,
    status,
      ...
      children: /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, 
        "div",
        {
          ...
          children: [
            ...
            (isInvalid || status === "positive") && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "span", { style: { display: "inline-flex", alignItems: "center", paddingInline: suffix == null ? "var(--space-2)" : 0 }, children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunk4KUVQPIKcjs.FieldStatusIcon, { invalid: isInvalid, status }) }),
...
//# sourceMappingURL=chunk-CKCBELGC.cjs.map