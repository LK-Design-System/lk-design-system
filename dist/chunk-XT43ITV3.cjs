...
function NumberField({ value, defaultValue = 0, min = -Infinity, max = Infinity, step = 1, onChange, label, helper, error, invalid = false, required = false, size = "md", disabled = false, readOnly = false, placeholder, id, fieldStyle, style, "aria-label": ariaLabel, "aria-describedby": ariaDescribedBy, onFocus, onBlur, onKeyDown, ...rest }) {
  ...
  const metadata = _chunk4KUVQPIKcjs.useFieldMetadata.call(void 0, { prefix: "number-field", id, label, helper, error, describedBy: ariaDescribedBy });
  ...
  const control = /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "div", { style: { display: "inline-flex", alignItems: "stretch", width: "fit-content", height: h, border: `1px solid ${_chunk4KUVQPIKcjs.fieldBorderColor.call(void 0, { disabled, readOnly, invalid: isInvalid, focused })}`, borderRadius: "var(--component-input-radius)", background: _chunk4KUVQPIKcjs.fieldBackground.call(void 0, { disabled, readOnly }), boxShadow: focused ? "var(--component-input-focus-shadow)" : "none", overflow: "hidden", transition: "border-color var(--dur-fast) var(--ease-out), box-shadow var(--dur-fast) var(--ease-out)", ...style }, children: [
...
//# sourceMappingURL=chunk-XT43ITV3.cjs.map