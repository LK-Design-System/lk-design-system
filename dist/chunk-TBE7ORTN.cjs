...
var _chunkCXNCDZQYcjs = require('./chunk-CXNCDZQY.cjs');
...
function useMenuKeyboard({ open, onClose, getTrigger, menuKey = 0, zIndex, focusOnOpen = true }) {
  const { zIndex: resolvedZIndex, isTopmost } = _chunkCXNCDZQYcjs.useOverlayLayer.call(void 0, { open, zIndex });
...
function useSubmenuBranch({ disabled = false } = {}) {
  ...
  const renderPanel = (children, panelStyle) => {
    if (!open) return null;
    return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkCXNCDZQYcjs.OverlayPortal, { open, anchorRef: triggerRef, layer: "anchored", children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
      "div",
      {
        ref: panelRef,
        "data-menu-portal": "",
...
var Button = _react2.default.forwardRef(function Button2({
  ...
  const composed = {
    ..._chunkCXNCDZQYcjs.componentVars.call(void 0, vars, "--lds-button-"),
    display: "inline-flex",
    alignItems: "center",
    ...
    ..._chunkCXNCDZQYcjs.partStyle.call(void 0, styles, "root"),
    ...style
  };
  const Comp = as;
  return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0,
    Comp,
    {
      ...
      className: _chunkCXNCDZQYcjs.partClassName.call(void 0, classNames, "root", "lk-btn", `lk-btn--${wdsVariant}`, className),
      style: composed,
      ...
      children: [
        loading === true && /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, _jsxruntime.Fragment, { children: [
          /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
            "span",
            {
              "aria-hidden": "true",
              "data-slot": "loader",
              className: _chunkCXNCDZQYcjs.partClassName.call(void 0, classNames, "loader") || void 0,
              style: { position: "absolute", inset: 0, display: "inline-flex", alignItems: "center", justifyContent: "center", ..._chunkCXNCDZQYcjs.partStyle.call(void 0, styles, "loader") },
        ...
        /* @__PURE__ */ _jsxruntime.jsxs.call(void 0,
          ...
          {
            "data-slot": "content",
            className: _chunkCXNCDZQYcjs.partClassName.call(void 0, classNames, "content") || void 0,
            ...
            style: {
              ...
              ..._chunkCXNCDZQYcjs.partStyle.call(void 0, styles, "content")
            },
            children: [
...
// packages/core/dist/chunk-L6DM3H7S.js
...
function MenuItemButton({ item, variant, itemMetrics, onSelect, trailing, haspopup, onTriggerKeyDown, classNames, styles }) {
  ...
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
    "button",
    {
      ...
      className: _chunkCXNCDZQYcjs.partClassName.call(void 0, classNames, "item", item.className) || void 0,
      type: "button",
      ...
      style: { ...menuItemVisualStyle({ selected: current, checked, hovered: hover, disabled, danger: item.danger, hasDescription: Boolean(description), metrics: itemMetrics }), ..._chunkCXNCDZQYcjs.partStyle.call(void 0, styles, "item"), ...item.style },
  ...
  return items.map((item, index) => {
    if (item.divider) {
      return /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
        ...
        {
          "data-slot": "divider",
          className: _chunkCXNCDZQYcjs.partClassName.call(void 0, ctx.classNames, "divider") || void 0,
          role: "separator",
          style: { height: 1, background: "var(--color-semantic-line-solid-normal)", margin: "6px 4px", ..._chunkCXNCDZQYcjs.partStyle.call(void 0, ctx.styles, "divider") }
        },
        index
      );
    }
      ...
      children: [
        /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
          "button",
          {
            ...
            disabled,
            ...sub.triggerHandlers,
            style: { ...menuItemVisualStyle({ active: sub.open, hovered: hover, disabled, danger: item.danger, hasDescription: Boolean(description), metrics: itemMetrics }), ..._chunkCXNCDZQYcjs.partStyle.call(void 0, styles, "item"), ...item.style },
    ...
    if (item.divider) {
      return /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
        "div",
        {
          ...
          className: _chunkCXNCDZQYcjs.partClassName.call(void 0, ctx.classNames, "divider") || void 0,
          role: "separator",
          style: { height: 1, flexShrink: 0, background: "var(--color-semantic-line-solid-normal)", margin: "6px 4px", ..._chunkCXNCDZQYcjs.partStyle.call(void 0, ctx.styles, "divider") }
        },
        index
      );
    }
...
var DropdownMenu = _react2.default.forwardRef(function DropdownMenu2({
  ...
  const mergedRootRef = _chunkCXNCDZQYcjs.useMergedRefs.call(void 0, ref, forwardedRef);
  const panelRef = _react2.default.useRef(null);
  ...
  const position = _chunkCXNCDZQYcjs.useFloatingPosition.call(void 0, {
    open: visible,
    anchorRef: ref,
    panelRef,
  ...
  return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0,
    "div",
    {
      ...
      className: _chunkCXNCDZQYcjs.partClassName.call(void 0, classNames, "root", className) || void 0,
      style: { ..._chunkCXNCDZQYcjs.componentVars.call(void 0, vars, "--lds-dropdown-menu-"), position: "relative", display: "inline-block", ..._chunkCXNCDZQYcjs.partStyle.call(void 0, styles, "root"), ...style },
      ...rest,
      children: [
        /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
          "span",
          {
            "data-slot": "trigger",
            className: _chunkCXNCDZQYcjs.partClassName.call(void 0, classNames, "trigger") || void 0,
            style: { display: "inline-flex", ..._chunkCXNCDZQYcjs.partStyle.call(void 0, styles, "trigger") },
            children: renderedTrigger
          }
        ),
        /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkCXNCDZQYcjs.OverlayPortal, { open: visible, withinPortal, portalTarget, anchorRef: ref, layer: "anchored", children: /* @__PURE__ */ _jsxruntime.jsxs.call(void 0,
          "div",
          {
            ref: panelRef,
            "data-slot": "panel",
            ...
            className: _chunkCXNCDZQYcjs.partClassName.call(void 0, classNames, "panel") || void 0,
            "data-placement": position.placement,
            style: {
              ..._chunkCXNCDZQYcjs.componentVars.call(void 0, vars, "--lds-dropdown-menu-"),
              ...withinPortal ? { position: "fixed", top: _nullishCoalesce(position.y, () => ( -9999)), left: _nullishCoalesce(position.x, () => ( -9999)), right: "auto", bottom: "auto", translate: "none" } : _chunkCXNCDZQYcjs.inlineFloatingStyle.call(void 0, { placement: position.placement, align, offset, shiftX: position.shiftX, shiftY: position.shiftY }),
              ...
              flexDirection: "column",
              gap: "var(--component-menu-gap)",
              ..._chunkCXNCDZQYcjs.partStyle.call(void 0, styles, "panel"),
            ...
            children: [
              /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
                "div",
                {
                  ref: menuRef,
                  "data-slot": "menu",
                  className: _chunkCXNCDZQYcjs.partClassName.call(void 0, classNames, "menu", "lk-scroll-surface") || void 0,
                  ...
                  style: {
                    ...
                    ..._chunkCXNCDZQYcjs.partStyle.call(void 0, styles, "menu"),
              ...
              showActionArea && /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
                "div",
                {
                  ...
                  className: _chunkCXNCDZQYcjs.partClassName.call(void 0, classNames, "actionArea") || void 0,
                  role: "group",
                  "aria-label": "\uBA54\uB274 \uC791\uC5C5",
                  ...
                  style: {
                    ...
                    flexShrink: 0,
                    ..._chunkCXNCDZQYcjs.partStyle.call(void 0, styles, "actionArea")
                  },
...
//# sourceMappingURL=chunk-TBE7ORTN.cjs.map