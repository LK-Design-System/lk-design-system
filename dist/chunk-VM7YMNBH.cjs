...
function SaveButton({ saved = false, onClick }) {
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
    "button",
    {
      ...
      children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunk7OXVB7WXcjs.Icon, { name: saved ? "bookmark-fill" : "bookmark", size: 17, "aria-hidden": "true" })
    }
  );
}
...
var Card = _react2.default.forwardRef(function Card2({
  ...
  const resolvedElevation = _nullishCoalesce(elevation, () => ( "none"));
...
exports.Card = Card;
//# sourceMappingURL=chunk-VM7YMNBH.cjs.map