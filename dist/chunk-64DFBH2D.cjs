...
var AVAILABILITY_PRESENTATION = {
  ...
  unknown: {
    ...
    dash: _chunkGCBNKQWDcjs.NAV_DASH.unknown
  }
};
var KIND_LABELS = {
  door: "\uBB38 \uC804\uC774",
...
function FacilityTransition({
  ...
  const dash = invalid ? _chunkGCBNKQWDcjs.NAV_DASH.invalid : stale ? _chunkGCBNKQWDcjs.NAV_DASH.staleShape : availability.dash;
  ...
  const stateBadges = [
    ...
    stale ? { kind: "stale", tone: "var(--viewer-muted, var(--color-semantic-label-alternative))", dash: _chunkGCBNKQWDcjs.NAV_DASH.staleRing } : null
  ...
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
    "g",
    {
      ...
      children: /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "g", { transform: `scale(${inverseScale})`, "data-transition-screen-space": "", children: [
        /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "path", { d: PIN_PATH, transform: _chunkGCBNKQWDcjs.NAV_PIN.shadow.transform, fill: _chunkGCBNKQWDcjs.NAV_PIN.shadow.fill, opacity: _chunkGCBNKQWDcjs.NAV_PIN.shadow.opacity, pointerEvents: "none", "data-transition-shadow": "" }),
        activeFocus && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "path", { d: PIN_PATH, transform: `scale(${_chunkGCBNKQWDcjs.NAV_PIN.focusRing.scale})`, fill: "none", stroke: "var(--color-semantic-focus-indicator)", strokeWidth: _chunkGCBNKQWDcjs.NAV_PIN.focusRing.strokeWidth, strokeLinejoin: "round", vectorEffect: "non-scaling-stroke", pointerEvents: "none", "data-transition-focus-ring": "" }),
...
//# sourceMappingURL=chunk-64DFBH2D.cjs.map