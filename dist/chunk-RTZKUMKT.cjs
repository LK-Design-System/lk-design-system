...
var BRAND_LETTER_COUNT = _chunkCLUXE6YLcjs.LK_PATHS.length + _chunkCLUXE6YLcjs.ROBOTICS_PATHS.length;
var brandDelay = (order) => (BRAND_LETTER_COUNT > 1 ? order / (BRAND_LETTER_COUNT - 1) * 0.55 : 0).toFixed(3);
var BRAND_WAVE_AMPLITUDE = 7;
var ROBOTICS_WAVE_AMPLITUDE = (BRAND_WAVE_AMPLITUDE / _chunkCLUXE6YLcjs.ROBOTICS_INLINE_SCALE).toFixed(6);
...
function Spinner({ size, thickness, color = "var(--color-semantic-primary-normal)", label, variant = "circular", style, ...rest }) {
  ...
  if (variant === "brand") {
    const mark = /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "svg", { viewBox: _chunkCLUXE6YLcjs.LK_LOGO_VIEWBOX.inline, height: resolvedSize, "aria-hidden": "true", style: { display: "block", overflow: "visible" }, children: /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "g", { fill: _chunkCLUXE6YLcjs.LK_LOGO_COLORS.navy, fillRule: "nonzero", children: [
      _chunkCLUXE6YLcjs.LK_PATHS.map((path, i) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "g", { transform: path.transform, children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "path", { "data-wave": true, d: path.d, style: { animation: `lk-brand-wave-lk 1.15s ease-in-out ${brandDelay(i)}s infinite` } }) }, `lk${i}`)),
      /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "g", { transform: _chunkCLUXE6YLcjs.ROBOTICS_INLINE_TRANSFORM, children: _chunkCLUXE6YLcjs.ROBOTICS_PATHS.map((path, i) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "g", { transform: path.transform, children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "path", { "data-wave": true, d: path.d, style: { animation: `lk-brand-wave-robo 1.15s ease-in-out ${brandDelay(_chunkCLUXE6YLcjs.LK_PATHS.length + i)}s infinite` } }) }, `ro${i}`)) })
    ] }) });
...
//# sourceMappingURL=chunk-RTZKUMKT.cjs.map