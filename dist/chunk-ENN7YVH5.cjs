...
function useLightDismiss({
  ...
  _react2.default.useEffect(() => {
    ...
    const containsTarget = (target) => _optionalChain([rootRef, 'access', _6 => _6.current, 'optionalAccess', _7 => _7.contains, 'call', _8 => _8(target)]) || optionsRef.current.insideRefs.some((insideRef) => _optionalChain([insideRef, 'optionalAccess', _9 => _9.current, 'optionalAccess', _10 => _10.contains, 'call', _11 => _11(target)]));
    const onPointerDown = (event) => {
      if (!isTopmost()) return;
      if (!optionsRef.current.outsidePress || containsTarget(event.target)) return;
      if (vetoed("outside-press", event)) return;
      _optionalChain([optionsRef, 'access', _12 => _12.current, 'access', _13 => _13.onDismiss, 'optionalCall', _14 => _14("outside-press")]);
    };
    const onKeyDown = (event) => {
      ...
      const trigger = _optionalChain([optionsRef, 'access', _15 => _15.current, 'access', _16 => _16.getTrigger, 'optionalCall', _17 => _17()]);
      const activeElement = ownerDocument.activeElement;
      const ownsFocus = !!activeElement && containsTarget(activeElement);
      if (ownsFocus) latchDismissedTrigger();
      _optionalChain([optionsRef, 'access', _18 => _18.current, 'access', _19 => _19.onDismiss, 'optionalCall', _20 => _20("escape")]);
      if (!ownsFocus || activeElement === trigger) return;
      view.requestAnimationFrame(() => {
        if (_optionalChain([trigger, 'optionalAccess', _21 => _21.isConnected]) && typeof trigger.focus === "function") {
...
function useFloatingPosition({
  ...
  useSafeLayoutEffect(() => {
    ...
    const view = _nullishCoalesce(_optionalChain([anchor, 'access', _22 => _22.ownerDocument, 'optionalAccess', _23 => _23.defaultView]), () => ( window));
    let frame;
    let layoutFrame;
    let disposed = false;
    const update = () => {
    ...
    _optionalChain([observer, 'optionalAccess', _24 => _24.observe, 'call', _25 => _25(anchor)]);
    _optionalChain([observer, 'optionalAccess', _26 => _26.observe, 'call', _27 => _27(panel)]);
    return () => {
      disposed = true;
      view.cancelAnimationFrame(frame);
      ...
      _optionalChain([observer, 'optionalAccess', _28 => _28.disconnect, 'call', _29 => _29()]);
    };
...
function findOverlayTrigger(root) {
  return _nullishCoalesce(_optionalChain([root, 'optionalAccess', _30 => _30.querySelector, 'call', _31 => _31('[data-anchored-overlay-trigger], button, [role="button"], a[href], input, select, textarea')]), () => ( null));
}
...
//# sourceMappingURL=chunk-ENN7YVH5.cjs.map