...
function StateMark({ presentation, icon, size = 22 }) {
  ...
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
    "span",
    {
      ...
      children: _nullishCoalesce(icon, () => ( /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkO5WLSYUKcjs.Icon, { name: _nullishCoalesce(presentation.icon, () => ( "circle-info")), size })))
    }
  );
}
...
//# sourceMappingURL=chunk-I5V6J64F.cjs.map