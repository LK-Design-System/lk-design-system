...
var PORTAL_LOCKUP_VIEWBOX = "343 149.2 416.43 64.163";
...
function Lockup({ variant = "inline", tone = "ink", color, height, title, decorative = false, style, ...rest }) {
  ...
  const vb = variant === "portal" ? PORTAL_LOCKUP_VIEWBOX : _chunkCLUXE6YLcjs.LK_LOGO_VIEWBOX[variant] || _chunkCLUXE6YLcjs.LK_LOGO_VIEWBOX.inline;
  const h = height != null ? height : variant === "mark" ? 32 : variant === "stacked" ? 64 : 28;
  const accessibleTitle = _nullishCoalesce(title, () => ( (variant === "portal" ? "LK Portal" : "LK ROBOTICS")));
  ...
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "svg", { viewBox: vb, height: h, ...a11y, style: { display: "block", ...style }, ...rest, children: /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "g", { fill, fillRule: "nonzero", children: [
    ...
    variant === "portal" && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "g", { transform: PORTAL_INLINE_TRANSFORM, children: PORTAL_PATHS.map((path, index) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "path", { d: path.d }, `${path.letter}-${index}`)) })
  ] }) });
}
...
//# sourceMappingURL=chunk-WFMQMP5A.cjs.map