...
function resolveTone(tone) {
  if (tone === "critical") return _chunk3UPIIXAKcjs.statusToneStyle.call(void 0, "negative");
  return _chunk3UPIIXAKcjs.statusToneStyle.call(void 0, tone);
}
...
//# sourceMappingURL=chunk-DODPA3HJ.cjs.map