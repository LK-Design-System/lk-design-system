...
function BottomNav({ items = [], value, defaultValue, onChange, renderLink, style, ...rest }) {
  ...
  return /* @__PURE__ */ jsx("nav", { style: { display: "flex", alignItems: "stretch", width: "100%", maxWidth: "100%", minWidth: 0, overflow: "hidden", background: "var(--color-semantic-background-elevated-normal)", borderTop: "1px solid var(--color-semantic-line-solid-normal)", ...style }, ...rest, children: items.map((o) => {
...
//# sourceMappingURL=chunk-FD73EFSQ.js.map