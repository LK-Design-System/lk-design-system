...
function Input({
  ...
  return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "div", { "data-readonly": readOnly ? "true" : void 0, style: { display: "flex", flexDirection: "column", gap: "var(--component-input-stack-gap)", ...style }, children: [
    /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkGYQC2LMQcjs.FieldLabel, { htmlFor: inputId, label, required, disabled }),
        ...
        children: [
          ...
          /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
            "input",
            {
              ...
              style: { flex: 1, minWidth: 0, height: "100%", boxSizing: "border-box", border: "none", outline: "none", background: "transparent", cursor: disabled ? "not-allowed" : readOnly ? "text" : void 0, fontFamily: "var(--font-sans)", ..._chunkGYQC2LMQcjs.fieldTypography.call(void 0, normalizedSize), color: disabled ? "var(--color-semantic-label-disable)" : "var(--color-semantic-label-normal)" }
            }
          ),
          ...
          !endIcon && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkGYQC2LMQcjs.FieldStatusIcon, { invalid: isInvalid, status }),
...
exports.Input = Input;
//# sourceMappingURL=chunk-XNE2NETC.cjs.map