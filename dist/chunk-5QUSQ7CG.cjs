...
function DropdownMenu({
  ...
  const position = _chunkT7L6VXSAcjs.useFloatingPosition.call(void 0, {
    open: visible,
    anchorRef: ref,
    panelRef,
    placement: "bottom"
              ...
              /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
                "div",
                {
                  ...
                  onFocus: (event) => {
                    ...
                    const cameFromMenu = event.relatedTarget && _optionalChain([menuRef, 'access', _28 => _28.current, 'optionalAccess', _29 => _29.contains, 'call', _30 => _30(event.relatedTarget)]);
                    ...
                    _optionalChain([nextTarget, 'optionalAccess', _31 => _31.focus, 'call', _32 => _32({ preventScroll: true })]);
                  },
...
//# sourceMappingURL=chunk-5QUSQ7CG.cjs.map