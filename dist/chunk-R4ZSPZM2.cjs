      ...
      children: [
        icon != null && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
          "span",
          {
            ...
            style: {
              ...
              background: tone ? _chunk3UPIIXAKcjs.statusToneStyle.call(void 0, tone).surface : "var(--color-semantic-fill-normal)",
              display: "inline-flex",
              alignItems: "center",
              justifyContent: "center",
              color: tone ? _chunk3UPIIXAKcjs.statusToneStyle.call(void 0, tone).foreground : "var(--color-semantic-primary-heavy)"
            },
            children: icon
          }
        ),
        /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "div", { style: { minWidth: 0 }, children: [
          /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "div", { style: { display: "flex", alignItems: "baseline", justifyContent: "space-between", gap: "var(--space-3)", minWidth: 0 }, children: [
            ...
            time != null && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "time", { dateTime, style: { flexShrink: 0, color: "var(--color-semantic-label-alternative)", fontSize: "var(--caption1-size)", lineHeight: "var(--caption1-line)", letterSpacing: "var(--caption1-spacing)" }, children: time })
          ] }),
          description != null && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "div", { style: { marginTop: "var(--space-1)", overflow: "hidden", textOverflow: "ellipsis", color: "var(--color-semantic-label-alternative)", fontSize: "var(--label2-size)", lineHeight: "var(--label2-line)", letterSpacing: "var(--label2-spacing)", wordBreak: "keep-all" }, children: description })
        ] })
      ]
    }
  );
...
//# sourceMappingURL=chunk-R4ZSPZM2.cjs.map