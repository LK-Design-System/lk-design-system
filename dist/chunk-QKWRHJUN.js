    ...
    return /* @__PURE__ */ jsx(
      Checkbox,
      {
        ...
        label: /* @__PURE__ */ jsxs("span", { children: [
          ...
          o.description != null && /* @__PURE__ */ jsx("span", { style: { display: "block", marginTop: 2, fontSize: "var(--label2-size)", color: "var(--color-semantic-label-alternative)" }, children: o.description })
        ] })
      },
      o.value
    );
...
//# sourceMappingURL=chunk-QKWRHJUN.js.map