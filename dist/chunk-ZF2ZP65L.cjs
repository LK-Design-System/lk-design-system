...
function FieldLabel({ htmlFor, id, label, required = false, disabled = false, className, style, ...rest }) {
  ...
  return _react2.default.createElement(
    ...
    label,
    required && _react2.default.createElement("span", { style: { color: "var(--color-semantic-status-negative-foreground)" } }, " *")
  );
}
...
function FieldStatusIcon({ invalid = false, status = "normal", size = 16 }) {
  ...
  return _react2.default.createElement(_chunk7OXVB7WXcjs.Icon, {
...
//# sourceMappingURL=chunk-ZF2ZP65L.cjs.map