...
function Wizard({ steps = [], current, defaultCurrent = 0, onStepChange, onBeforeStepChange, onComplete, completeLabel = "\uC644\uB8CC", labelPolicy, children, footer, style, ...rest }) {
  ...
  return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "div", { style: { fontFamily: "var(--font-sans)", ...style }, ...rest, children: [
    /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkBHT4ZLMHcjs.Steps, { steps, current: cur, labelPolicy, style: { marginBottom: "var(--space-8)" } }),
    ...
    footer === null ? null : typeof footer === "function" ? footer(footerContext) : footer !== void 0 ? footer : /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "div", { style: { display: "flex", justifyContent: "space-between", marginTop: "var(--space-6)" }, children: [
      /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkE2EQSM2Kcjs.Button, { variant: "outlined", color: "assistive", onClick: footerContext.back, disabled: cur === 0 || pending, children: "\uC774\uC804" }),
      /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkE2EQSM2Kcjs.Button, { variant: "solid", color: "primary", onClick: footerContext.next, disabled: nextDisabled, children: nextIsComplete ? completeLabel : "\uB2E4\uC74C" })
    ] })
  ] });
}
...
//# sourceMappingURL=chunk-SBOQ3YGS.cjs.map