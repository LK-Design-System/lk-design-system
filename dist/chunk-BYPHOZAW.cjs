...
function FeedCard({
  ...
  if (showFollow || showMenu) {
    trailing = /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "div", { style: { display: "flex", alignItems: "center", gap: "var(--space-2)", marginLeft: "var(--space-2)" }, children: [
      showFollow && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunk3NWU3G2Pcjs.Button, { variant: following ? "ghost" : "secondary", size: "sm", onClick: onFollowToggle, children: resolvedFollowLabel }),
      showMenu && /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
        _chunkQ3ERUW7Jcjs.DropdownMenu,
        {
          align: "right",
          items: menuItems,
...
//# sourceMappingURL=chunk-BYPHOZAW.cjs.map