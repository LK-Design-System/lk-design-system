...
function Combobox({
  ...
  const {
    ...
    describedBy,
    hasMetadata
  } = _chunkIF75VIWIcjs.useFieldMetadata.call(void 0, { prefix: "combobox", id, label, helper, error, describedBy: ariaDescribedBy });
  ...
  const borderColor = _chunkIF75VIWIcjs.fieldBorderColor.call(void 0, { disabled, readOnly, invalid: isInvalid, status, focused: open, hovered });
        ...
        /* @__PURE__ */ _jsxruntime.jsxs.call(void 0,
          "button",
          {
            ...
            style: {
              ...
              background: _chunkIF75VIWIcjs.fieldBackground.call(void 0, { disabled, readOnly }),
            ...
            children: [
              ...
              /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "span", { style: { display: "inline-flex", alignItems: "center", gap: "var(--space-2)", flex: "0 0 auto" }, children: [
                ...
                /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkOZR3K6TYcjs.Icon, { name: "chevron-down-small", size: 18, color: "var(--color-semantic-label-alternative)", "aria-hidden": "true", style: { transform: open ? "rotate(180deg)" : "none", transition: "var(--component-button-transition)" } })
              ] })
            ]
          }
        ),
            ...
            children: normalized.map((option, index) => {
              ...
              return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0,
                "div",
                {
                  ...
                  style: { display: "flex", alignItems: "center", gap: "var(--space-2)", padding: "9px 10px", borderRadius: "var(--radius-md)", background: selected ? "var(--color-semantic-primary-surface-strong)" : active ? "var(--color-semantic-fill-normal)" : "transparent", color: option.disabled ? "var(--color-semantic-label-disable)" : "var(--color-semantic-label-normal)", cursor: option.disabled ? "not-allowed" : "pointer", fontFamily: "var(--font-sans)", ..._chunkIF75VIWIcjs.fieldTypography.call(void 0, normalizedSize) },
                  children: [
                    /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "span", { "aria-hidden": "true", style: { width: 18, height: 18, borderRadius: "var(--radius-5)", border: `1.5px solid ${selected ? "var(--color-semantic-primary-normal)" : "var(--color-semantic-line-solid-normal)"}`, background: selected ? "var(--color-semantic-primary-normal)" : "var(--color-semantic-background-elevated-normal)", display: "inline-flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }, children: selected && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkOZR3K6TYcjs.Icon, { name: "check", size: 16, color: "var(--color-semantic-static-white)", "aria-hidden": "true" }) }),
  ...
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkIF75VIWIcjs.FieldStack, { fieldId, labelId, label, required, messageId, message, error, status, fieldStyle, children: control });
}



exports.Combobox = Combobox;
//# sourceMappingURL=chunk-T3KAMMA4.cjs.map