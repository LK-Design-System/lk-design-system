...
// ../../lk-workspace/shared/lk-design-system/packages/core/dist/chunk-WJN7GSBY.js
...
function normalizeStatusTone(tone, fallback = "offline") {
  const normalized = _nullishCoalesce(STATUS_TONE_ALIASES[tone], () => ( tone));
...
exports.normalizeStatusTone = normalizeStatusTone; exports.statusToneStyle = statusToneStyle;
//# sourceMappingURL=chunk-BXV3SAGJ.cjs.map