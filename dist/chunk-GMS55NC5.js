...
var SideNav = React.forwardRef(function SideNav2({
  ...
  const dot = /* @__PURE__ */ jsx("span", { "data-slot": "badge", className: partClassName(classNames, "badge") || void 0, style: { position: "absolute", top: 7, right: 7, width: 7, height: 7, borderRadius: "50%", background: appearanceTokens.badgeDot, ...partStyle(styles, "badge") } });
  ...
  const panelContent = /* @__PURE__ */ jsxs("div", { id: panelId, "data-slot": "panel", className: partClassName(classNames, "panel", "lk-sidenav__panel-content") || void 0, "data-collapsed": col ? "true" : "false", style: { display: "flex", flexDirection: "column", flex: "1 1 auto", minHeight: 0, ...partStyle(styles, "panel") }, children: [
    ...
    /* @__PURE__ */ jsx("div", { "data-slot": "footer", className: partClassName(classNames, "footer") || void 0, style: { marginTop: "auto", paddingTop: footerGap, ...partStyle(styles, "footer") }, children: resolvedFooter != null && /* @__PURE__ */ jsx("div", { style: { paddingTop: "var(--space-2-5)", marginLeft: "var(--space-0-5)", marginRight: "var(--space-0-5)", borderTop: `1px solid ${appearanceTokens.divider}` }, children: resolvedFooter }) })
  ] });
  return /* @__PURE__ */ jsx(
    "nav",
    {
...
//# sourceMappingURL=chunk-GMS55NC5.js.map