  ...
  return /* @__PURE__ */ jsx("ol", { style: { display: "flex", alignItems: "flex-start", listStyle: "none", margin: 0, padding: 0, ...style }, ...rest, children: steps.map((s, i) => {
    ...
    return /* @__PURE__ */ jsxs("li", { "aria-current": active ? "step" : void 0, style: { display: "flex", alignItems: "flex-start", flex: last ? "0 0 auto" : "1 1 auto" }, children: [
      /* @__PURE__ */ jsxs("div", { style: { display: "flex", flexDirection: "column", alignItems: "center", gap: 8, flexShrink: 0 }, children: [
        ...
        /* @__PURE__ */ jsxs("span", { style: labelVisible ? { fontFamily: "var(--font-sans)", fontSize: "var(--label2-size)", fontWeight: active ? "var(--fw-bold)" : "var(--fw-medium)", letterSpacing: 0, color: active ? "var(--color-semantic-label-normal)" : "var(--color-semantic-label-alternative)", whiteSpace: "nowrap" } : srOnly, children: [
          label,
          /* @__PURE__ */ jsx("span", { style: srOnly, children: done ? " \uC644\uB8CC" : active ? " \uD604\uC7AC \uB2E8\uACC4" : " \uC608\uC815" })
        ] })
      ] }),
      !last && /* @__PURE__ */ jsx("span", { "aria-hidden": "true", style: { flex: 1, height: 2, marginTop: "var(--space-4)", background: i < current ? "var(--color-semantic-primary-normal)" : "var(--color-semantic-line-solid-normal)", minWidth: 24 } })
    ] }, i);
  }) });
}
...
//# sourceMappingURL=chunk-N7ZSCOUF.js.map