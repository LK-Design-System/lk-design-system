...
function Select({
  ...
  const describedBy = _chunkGYQC2LMQcjs.mergeIds.call(void 0, ariaDescribedBy, messageId);
  ...
  const ring = _chunkGYQC2LMQcjs.fieldBorderColor.call(void 0, { disabled: disabledState, readOnly, invalid: isInvalid, status, focused: activeFocus, hovered: activeHover });
  ...
  return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "div", { "data-select-root": "", "data-readonly": readOnly ? "true" : void 0, style: { display: "flex", flexDirection: "column", gap: "var(--component-input-stack-gap)", minWidth: intrinsicMinWidth == null ? void 0 : `min(100%, ${intrinsicMinWidth}px)`, maxWidth: "100%", ...style }, children: [
    /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkGYQC2LMQcjs.FieldLabel, { id: labelId, htmlFor: selId, label, required }),
      ...
      /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, 
        "button",
        {
          ...
          style: {
            ...
            padding: "0 var(--component-input-padding-x)",
            boxSizing: "border-box",
            background: _chunkGYQC2LMQcjs.fieldBackground.call(void 0, { disabled: disabledState, readOnly }),
          ...
          children: [
            ...
            /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "span", { style: { display: "inline-flex", alignItems: "center", gap: "var(--component-input-gap)", flex: "0 0 auto" }, children: [
              /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkGYQC2LMQcjs.FieldStatusIcon, { invalid: isInvalid, status }),
      ...
      visualOpen && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "div", { id: listboxId, role: "listbox", "aria-label": ariaLabel, "aria-labelledby": !ariaLabel && label ? labelId : void 0, style: { position: "absolute", top: "calc(100% + 6px)", left: 0, right: 0, zIndex: 40, maxHeight: 260, overflowY: "auto", background: "var(--color-semantic-background-elevated-normal)", border: "1px solid var(--color-semantic-line-solid-normal)", borderRadius: "var(--radius-lg)", boxShadow: "var(--shadow-md)", padding: "var(--space-1-5)", display: "flex", flexDirection: "column", gap: "var(--space-0-5)" }, children: norm.map((o, index) => {
        ...
        return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, 
          "div",
          {
            ...
            style: { display: "flex", alignItems: "center", justifyContent: "space-between", gap: "var(--space-2-5)", padding: "9px 12px", borderRadius: "var(--radius-md)", cursor: o.disabled ? "not-allowed" : "pointer", fontFamily: "var(--font-sans)", ..._chunkGYQC2LMQcjs.fieldTypography.call(void 0, normalizedSize), color: o.disabled ? "var(--color-semantic-label-disable)" : "var(--color-semantic-label-normal)", background: o.disabled && on ? "var(--color-semantic-fill-strong)" : on ? "var(--color-semantic-primary-surface-strong)" : isActive ? "var(--color-semantic-fill-normal)" : "transparent", boxShadow: isActive && !o.disabled ? "inset 0 0 0 2px var(--color-semantic-primary-normal)" : "none", fontWeight: on ? "var(--fw-bold)" : "var(--fw-medium)" },
            children: [
...
//# sourceMappingURL=chunk-KNZFPPY5.cjs.map