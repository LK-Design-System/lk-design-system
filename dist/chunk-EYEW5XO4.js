    ...
    Root,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs("div", { style: isFrame ? void 0 : { flex: 1, minWidth: 0 }, children: [
          !isFrame && title != null && /* @__PURE__ */ jsx("div", { id: titleId, style: { fontSize: "var(--body2-size)", fontWeight: "var(--fw-bold)", letterSpacing: 0, color: disabled ? "var(--color-semantic-label-disable)" : "var(--color-semantic-label-strong)", wordBreak: "keep-all" }, children: title }),
          !isFrame && description != null && /* @__PURE__ */ jsx("div", { id: descriptionId, style: { marginTop: "var(--space-1)", fontSize: "var(--label2-size)", lineHeight: 1.55, color: disabled ? "var(--color-semantic-label-disable)" : "var(--color-semantic-label-neutral)", wordBreak: "keep-all" }, children: description }),
          children
        ] }),
...
//# sourceMappingURL=chunk-EYEW5XO4.js.map