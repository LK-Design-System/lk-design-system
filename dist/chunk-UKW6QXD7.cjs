...
var _chunk3XBWOCOFcjs = require('./chunk-3XBWOCOF.cjs');
...
function CheckMark({ variant, checked, disabled }) {
  ...
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
    "span",
    {
      ...
      children: checked && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunk7OXVB7WXcjs.Icon, { name: "check", size: 11, "aria-hidden": "true" })
    }
  );
}
...
var SUBMENU_CHEVRON = /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunk7OXVB7WXcjs.Icon, { name: "chevron-right-small", size: 16, "aria-hidden": "true", style: { flexShrink: 0, color: "var(--color-semantic-label-alternative)" } });
function DrillHeader({ title, onBack, itemMetrics }) {
  return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0,
    "button",
    {
      ...
      children: [
        /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunk7OXVB7WXcjs.Icon, { name: "chevron-left-small", size: 16, "aria-hidden": "true" }),
...
function MenuBranch({ item, variant, itemMetrics, closeAll, classNames, styles }) {
  ...
  const disabled = Boolean(item.disabled || item.disable);
  const description = _nullishCoalesce(item.description, () => ( item.captionContent));
  const sub = _chunk3H62VNPDcjs.useSubmenuBranch.call(void 0, { disabled });
  return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0,
    "div",
    {
          ...
          "button",
          {
            ...
            children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
              MenuItemContent,
              {
                ...
                disabled,
                description,
                trailing: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunk7OXVB7WXcjs.Icon, { name: "chevron-right-small", size: 16, "aria-hidden": "true", style: { flexShrink: 0, color: "var(--color-semantic-label-alternative)" } })
              }
            )
          }
        ),
...
var DropdownMenu = _react2.default.forwardRef(function DropdownMenu2({
  ...
  const { menuRef, requestItemFocus, closeMenu, handleMenuKeyDown, zIndex: resolvedZIndex, isTopmost } = _chunk3XBWOCOFcjs.useMenuKeyboard.call(void 0, {
    open: visible,
  ...
  return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0,
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkXGKLO45Tcjs.OverlayPortal, { open: visible, withinPortal, portalTarget, anchorRef: ref, layer: "anchored", children: /* @__PURE__ */ _jsxruntime.jsxs.call(void 0,
          "div",
          {
            ref: panelRef,
            "data-slot": "panel",
            ...
            style: {
              ...
              ...withinPortal ? { position: "fixed", top: _nullishCoalesce(position.y, () => ( -9999)), left: _nullishCoalesce(position.x, () => ( -9999)), right: "auto", bottom: "auto", translate: "none" } : _chunkZRHSDRSMcjs.inlineFloatingStyle.call(void 0, { placement: position.placement, align, offset, shiftX: position.shiftX, shiftY: position.shiftY }),
              ...
              showActionArea && /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
                "div",
                {
                  ...
                  children: action || /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, _jsxruntime.Fragment, { children: [
                    onCancel && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkE2EQSM2Kcjs.Button, { variant: "outlined", color: "assistive", size: "sm", onClick: () => finishAction(onCancel), children: cancelLabel }),
                    onApply && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkE2EQSM2Kcjs.Button, { size: "sm", onClick: () => finishAction(onApply), children: applyLabel })
                  ] })
                }
              )
            ]
...
//# sourceMappingURL=chunk-UKW6QXD7.cjs.map