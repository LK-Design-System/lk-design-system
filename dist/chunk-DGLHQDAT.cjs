...
function SearchableMultiSelect({
  ...
  const {
    ...
    messageId,
    describedBy
  } = _chunkGPBXTTEHcjs.useFieldMetadata.call(void 0, { prefix: "searchable-multi-select", label, helper, error });
  ...
  return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0,
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkGPBXTTEHcjs.FieldLabel, { htmlFor: inputId, label, required, disabled }),
                ...
                selectedOptions.map((option) => /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, _chunkBCWCCXJXcjs.Chip, { size: "sm", variant: "outlined", disabled, style: { maxWidth: "100%", paddingRight: locked ? void 0 : "var(--space-0)" }, children: [
                  ...
                  /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
                    _chunkI6NJHF3Lcjs.IconButton,
                    {
                      ...
                      style: { flex: "0 0 auto" },
                      children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkF72KSGF7cjs.Icon, { name: "close", size: 14, "aria-hidden": "true" })
                    }
                  )
                ] }, String(option.value))),
                /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
            ...
            /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "div", { id: listboxId, role: "listbox", "aria-multiselectable": "true", "aria-busy": loading || void 0, style: { maxHeight: 248, overflowY: "auto", display: "flex", flexDirection: "column", gap: "var(--space-0-5)" }, children: hasOptionList && filteredOptions.map((option, index) => {
              ...
              return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0,
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "span", { "aria-hidden": "true", style: { display: "grid", placeItems: "center", width: 18, height: 18, boxSizing: "border-box", border: `1.5px solid ${selectedOption ? "var(--color-semantic-primary-normal)" : "var(--color-semantic-line-solid-normal)"}`, borderRadius: "var(--radius-5)", background: selectedOption ? "var(--color-semantic-primary-normal)" : "var(--color-semantic-background-elevated-normal)", color: "var(--color-semantic-static-white)" }, children: selectedOption && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkF72KSGF7cjs.Icon, { name: "check", size: 12, "aria-hidden": "true" }) }),
        ...
        /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkGPBXTTEHcjs.FieldMessage, { id: messageId, message, error })
      ]
    }
  );
}
...
//# sourceMappingURL=chunk-DGLHQDAT.cjs.map