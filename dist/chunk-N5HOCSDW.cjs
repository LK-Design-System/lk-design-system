...
function ToolbarButton({ item, active, disabled, onAction, index, tabIndex, onFocus }) {
  ...
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
    "button",
    {
      ...
      children: item.icon ? /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkOZR3K6TYcjs.Icon, { name: item.icon, size: 17, "aria-hidden": "true" }) : item.children
    }
  );
}
...
//# sourceMappingURL=chunk-N5HOCSDW.cjs.map