...
function SpatialRegion({
  ...
  const stateDash = invalid ? _chunkVRML72ABcjs.NAV_DASH.invalid : stale ? _chunkVRML72ABcjs.NAV_DASH.staleShape : unknownTerrain ? _chunkVRML72ABcjs.NAV_DASH.unknown : void 0;
