...
function Lockup({ variant = "inline", tone = "ink", color, height, title, decorative = false, style, ...rest }) {
  ...
  const fill = color || (tone === "white" ? _chunk3IQWXGU2cjs.LK_LOGO_COLORS.white : tone === "current" ? "currentColor" : _chunk3IQWXGU2cjs.LK_LOGO_COLORS.navy);
...
//# sourceMappingURL=chunk-DRK3GXVL.cjs.map