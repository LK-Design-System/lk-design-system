...
function CommandPalette({
  ...
  return /* @__PURE__ */ jsx("div", { role: "presentation", onClick: (e) => {
    ...
    /* @__PURE__ */ jsx("div", { id: listboxId, role: "listbox", "aria-label": "\uBA85\uB839", style: { maxHeight: 340, overflowY: "auto", padding: 8 }, children: filtered.length === 0 ? /* @__PURE__ */ jsx("div", { role: "status", style: { padding: 28, textAlign: "center", color: "var(--color-semantic-label-alternative)", fontSize: "var(--label1-size)" }, children: "\uACB0\uACFC \uC5C6\uC74C" }) : filtered.map((c, i) => /* @__PURE__ */ jsxs(
      "button",
      {
        id: `${optionIdBase}-${i}`,
        type: "button",
...
//# sourceMappingURL=chunk-JCCD2UUW.js.map