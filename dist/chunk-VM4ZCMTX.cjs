...
function SearchableMultiSelect({
  ...
  const {
    ...
    messageId,
    describedBy
  } = _chunkGYQC2LMQcjs.useFieldMetadata.call(void 0, { prefix: "searchable-multi-select", label, helper, error });
  ...
  return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, 
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkGYQC2LMQcjs.FieldMessage, { id: messageId, message, error })
      ]
    }
  );
}
...
//# sourceMappingURL=chunk-VM4ZCMTX.cjs.map