...
var STATUS_PRESENTATION = {
  normal: {
    ...
    currentText: "var(--color-semantic-primary-normal)"
  },
  maintenance: {
    tone: "cautionary",
    accent: "var(--color-semantic-status-cautionary-border)",
    currentSurface: "var(--color-semantic-status-cautionary-surface)",
    currentText: "var(--color-semantic-status-cautionary-text)"
  },
  fault: {
    tone: "negative",
    accent: "var(--color-semantic-status-negative-border)",
  ...
  return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, 
    "span",
    {
      ...
      style: {
        ...
        borderInline: active ? `1px solid ${presentation.accent}` : "1px solid transparent",
        background: active ? presentation.currentSurface : "transparent",
...
function ElevatorColumn({ building, elevator }) {
  ...
  const positionSummary = offline ? `${elevator.name} \uB9C8\uC9C0\uB9C9 \uD655\uC778 \uC704\uCE58 ${elevator.currentFloor}, ${_nullishCoalesce(elevator.statusLabel, () => ( status))}` : `${elevator.name} \uD604\uC7AC \uC704\uCE58 ${elevator.currentFloor}, ${_nullishCoalesce(elevator.directionLabel, () => ( "\uC815\uC9C0"))}, ${_nullishCoalesce(elevator.statusLabel, () => ( status))}`;
  return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, 
    "article",
    {
            ...
            children: [
              ...
              /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
                "div",
                {
                  ...
                  children: floors.map((floor) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
                    FloorRow,
                    {
                      floor,
...
function BuildingGroup({ building, headingLevel }) {
  ...
  return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, 
    "section",
    {
      "aria-labelledby": `lk-elevator-building-${building.id}`,
          ...
          "header",
          {
            ...
            children: [
              /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
                Heading,
                {
                  id: `lk-elevator-building-${building.id}`,
                  style: {
                    margin: 0,
                    color: "var(--color-semantic-label-strong)",
                    fontSize: "var(--body1-size)",
          ...
          ScrollArea,
          {
            ...
            children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
              "div",
              {
                ...
                children: buildings.map((building) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
                  BuildingGroup,
                  {
                    building,
                    headingLevel
...
//# sourceMappingURL=chunk-TDDG5WQM.cjs.map