...
function LaneOverlay({
  ...
  return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, 
    "g",
    {
      ...
      onFocus: (event) => {
        if (!pointerOnly) setHasFocus(_chunkYUEYO4K6cjs.isFocusVisibleTarget.call(void 0, event.currentTarget));
      ...
      children: [
        ...
        pathData && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
          "path",
          {
            ...
            d: _chunkYUEYO4K6cjs.NAVIGATION_DIRECTION_PATH,
        ...
        showEndpoints && endpointMarker(points[0], _optionalChain([lane, 'optionalAccess', _29 => _29.entry]), "entry", entryDirection, inverseScale),
        showEndpoints && endpointMarker(points[points.length - 1], _optionalChain([lane, 'optionalAccess', _30 => _30.exit]), "exit", exitDirection, inverseScale),
        ...
        showLabel && (_optionalChain([lane, 'optionalAccess', _31 => _31.label]) || metadata) && /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, 
          "g",
          {
            "data-lane-label": "",
...
//# sourceMappingURL=chunk-L5I63CKZ.cjs.map