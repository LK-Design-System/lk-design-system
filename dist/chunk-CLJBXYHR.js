...
function StateRow({ children, role }) {
  return /* @__PURE__ */ jsx("li", { role, style: { minHeight: 104, display: "grid", placeItems: "center", padding: "var(--space-4)", color: "var(--color-semantic-label-strong)", fontSize: "var(--label1-size)", textAlign: "center" }, children });
}
function DirectoryOpenButton({ entry, disabled, onNavigate }) {
  ...
  return /* @__PURE__ */ jsx(
    "button",
    {
      ...
      children: /* @__PURE__ */ jsx(Icon, { name: "chevron-right", size: 14, "aria-hidden": "true" })
    }
  );
}
function FileBrowser({
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      ...rest,
      children: [
        /* @__PURE__ */ jsxs("header", { style: { display: "flex", alignItems: "center", gap: "var(--space-2)", minWidth: 0, padding: "var(--space-2) var(--space-3)", borderBottom: "1px solid var(--color-semantic-line-normal-normal)", background: "var(--color-semantic-background-elevated-alternative)" }, children: [
          /* @__PURE__ */ jsx(
            "button",
            {
              type: "button",
              ...
              children: /* @__PURE__ */ jsx(Icon, { name: "arrow-up", size: 15, "aria-hidden": "true" })
            }
          ),
          /* @__PURE__ */ jsx("span", { style: SR_ONLY_STYLE, children: pathLabel }),
          /* @__PURE__ */ jsx("code", { title: path, style: { minWidth: 0, flex: 1, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap", color: "var(--color-semantic-label-strong)", fontFamily: "var(--font-mono)", fontSize: "var(--label2-size)" }, children: path })
        ] }),
        /* @__PURE__ */ jsx("ul", { "aria-label": listLabel, style: { display: "grid", gap: "var(--space-0-5)", margin: 0, padding: 4, overflow: "auto", maxHeight, listStyle: "none" }, children: loading ? /* @__PURE__ */ jsx(StateRow, { role: "status", children: loadingMessage }) : error != null ? /* @__PURE__ */ jsx(StateRow, { role: "alert", children: error }) : entries.length === 0 ? /* @__PURE__ */ jsx(StateRow, { children: emptyMessage }) : entries.map((entry) => {
          ...
          return /* @__PURE__ */ jsxs("li", { style: { display: "grid", gridTemplateColumns: "minmax(0, 1fr) auto", gap: 4, alignItems: "center" }, children: [
            /* @__PURE__ */ jsxs(
              "button",
              {
                type: "button",
                ...
                children: [
                  /* @__PURE__ */ jsx(Icon, { name: directory ? "folder" : "document", size: 18, "aria-hidden": "true" }),
                  /* @__PURE__ */ jsx("span", { style: { minWidth: 0, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap", fontSize: "var(--label1-size)", fontWeight: directory || selected ? "var(--fw-semibold)" : "var(--fw-medium)" }, children: entry.name }),
                  entry.meta != null && /* @__PURE__ */ jsx("span", { style: { color: rowDisabled ? "var(--color-semantic-label-disable)" : "var(--color-semantic-label-neutral)", fontSize: "var(--caption1-size)", whiteSpace: "nowrap" }, children: entry.meta })
                ]
              }
            ),
            directory && primarySelects && /* @__PURE__ */ jsx(DirectoryOpenButton, { entry, disabled: rowDisabled || navigationDisabled, onNavigate })
          ] }, key);
        }) })
      ]
    }
...
//# sourceMappingURL=chunk-CLJBXYHR.js.map