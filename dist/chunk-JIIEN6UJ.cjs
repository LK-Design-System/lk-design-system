...
function SourceBadges({ source }) {
  ...
  return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "span", { className: "lk-source-disclosure__status", style: { display: "inline-flex", flexWrap: "wrap", gap: "var(--space-1)", flexShrink: 0 }, children: [
    source.badge != null && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkQZQRMOCIcjs.StatusBadge, { tone: _nullishCoalesce(source.badge.tone, () => ( "neutral")), style: { whiteSpace: "nowrap" }, children: source.badge.label }),
    availability != null && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkQZQRMOCIcjs.StatusBadge, { tone: availability.tone, style: { whiteSpace: "nowrap" }, children: _nullishCoalesce(source.availabilityLabel, () => ( availability.label)) })
  ] });
}
...
//# sourceMappingURL=chunk-JIIEN6UJ.cjs.map