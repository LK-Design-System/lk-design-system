...
function edgePath(from, to, metrics) {
  ...
  if (metrics.shape === "dot") {
    ...
    const seat = metrics.parallelCount > 1 ? (_nullishCoalesce(metrics.parallelIndex, () => ( 0))) - (metrics.parallelCount - 1) / 2 : 0;
...
function NetworkGraph({
  ...
  const laidOutEdges = _react2.default.useMemo(() => {
    ...
    const entries = edges.map((edge) => ({
      ...
      curve: edgePath(anchors.get(edge.from), anchors.get(edge.to), {
        ...metrics,
        shape: nodeShape,
        parallelCount: _nullishCoalesce(pairCounts.get([edge.from, edge.to].sort().join("\u2192")), () => ( 1)),
        parallelIndex: (() => {
          const key = [edge.from, edge.to].sort().join("\u2192");
          const seen = _nullishCoalesce(pairSeen.get(key), () => ( 0));
  ...
  const lastScaleRef = _react2.default.useRef(null);
  _react2.default.useEffect(() => {
  ...
  const focusOrder = _react2.default.useMemo(() => {
    ...
    ordered.forEach((node) => {
      ...
      (_nullishCoalesce(leaving.get(node.id), () => ( []))).forEach((edge) => {
  ...
  function stopKeyDown(event, stop) {
    if (event.key === "Enter" || event.key === " ") {
      ...
      else if (stop.kind === "edge") _optionalChain([onSelectEdge, 'optionalCall', _14 => _14(stop.edge)]);
      else _optionalChain([onSelectNode, 'optionalCall', _15 => _15(stop.node)]);
      return;
    }
      ...
      children: [
        /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
          _chunk677EM4M2cjs.VisuallyHidden,
          {
            ...
            "aria-live": "polite",
            "aria-atomic": "true",
            "data-network-announcement": true,
        ...
        !hasData ? (
          ...
          "svg",
          {
            ...
            children: [
              /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "style", { children: "@keyframes ldsNetworkEnter { from { opacity: 0; transform: scale(0.72); } }[data-network-focus-ring]{opacity:0;}[data-network-node]:focus-visible [data-network-focus-ring],[data-network-collapse-cue]:focus-visible [data-network-focus-ring]{opacity:1;}[data-network-edge]:has([data-network-edge-control]:focus-visible) [data-network-focus-ring]{opacity:1;}[data-network-node]:focus,[data-network-collapse-cue]:focus,[data-network-edge-control]:focus{outline:none;}" }),
              ...
              /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "g", { "data-network-edges": true, children: laidOutEdges.map(({ edge, curve, text, fullText, label: labelPoint }) => {
                ...
                return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "g", { "data-network-edge": edge.id, "data-state": _nullishCoalesce(edge.state, () => ( "normal")), children: [
                  ...
                  onSelectEdge && (() => {
                    ...
                    const fromName = nodeText(_optionalChain([nodeById, 'access', _16 => _16.get, 'call', _17 => _17(edge.from), 'optionalAccess', _18 => _18.label])) || edge.from;
                    const toName = nodeText(_optionalChain([nodeById, 'access', _19 => _19.get, 'call', _20 => _20(edge.to), 'optionalAccess', _21 => _21.label])) || edge.to;
                    ...
                    return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, _jsxruntime.Fragment, { children: [
                      ...
                      /* @__PURE__ */ _jsxruntime.jsxs.call(void 0,
                        "g",
                        {
                          "data-network-edge-control": true,
                  ...
                  /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
                    "g",
                    {
                      ...
                      onClick: () => {
                        ...
                        _optionalChain([onSelectNode, 'optionalCall', _22 => _22(node)]);
                      },
                      onDoubleClick: () => {
                        if (hasCue(node)) _optionalChain([onToggleNode, 'optionalCall', _23 => _23(node)]);
                      },
...
//# sourceMappingURL=chunk-LT4YO6W4.cjs.map