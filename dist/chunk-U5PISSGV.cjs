...
function LogViewer({
  ...
  return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "div", { style: { display: "grid", gap: "var(--space-2)", width: "100%", maxWidth: "100%", fontFamily: "var(--font-sans)", ...style }, ...rest, children: [
    (streamStatus != null || lastUpdatedAt != null || droppedCount > 0) && /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", gap: "var(--space-3)", flexWrap: "wrap", color: "var(--color-semantic-label-neutral)", fontSize: "var(--caption1-size)" }, children: [
      ...
      droppedCount > 0 && /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "span", { style: { color: "var(--color-semantic-status-cautionary-text)", fontWeight: "var(--fw-semibold)" }, children: [
        "\uB204\uB77D ",
        droppedCount,
        "\uC904"
      ] })
    ...
    (filter || search || tools) && /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "div", { style: { display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap" }, children: [
      ...
      search && /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "label", { style: { flex: "1 1 180px", maxWidth: 260, minWidth: 160, height: 28, display: "inline-flex", alignItems: "center", gap: "var(--space-2)", padding: "0 9px", boxSizing: "border-box", border: "1px solid var(--color-semantic-line-normal-normal)", borderRadius: "var(--radius-sm)", background: "var(--color-semantic-background-elevated-normal)", color: "var(--color-semantic-label-assistive)" }, children: [
        /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunk7OXVB7WXcjs.Icon, { name: "search", size: 14, "aria-hidden": "true" }),
        ...
        query && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "button", { type: "button", "aria-label": "\uAC80\uC0C9\uC5B4 \uC9C0\uC6B0\uAE30", onClick: () => setQuery(""), style: { width: 18, height: 18, border: "none", background: "transparent", color: "var(--color-semantic-label-assistive)", cursor: "pointer", padding: 0, display: "inline-flex", alignItems: "center", justifyContent: "center" }, children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunk7OXVB7WXcjs.Icon, { name: "close", size: 12, "aria-hidden": "true" }) })
      ] }),
      tools && /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "div", { role: "group", "aria-label": "\uB85C\uADF8 \uB3C4\uAD6C", style: { display: "inline-flex", gap: "var(--space-1-5)", flex: "0 0 auto" }, children: [
        /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
          _chunkSMSPAH2Mcjs.ToggleIcon,
          {
            ...
            children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunk7OXVB7WXcjs.Icon, { name: paused ? "play" : "pause", size: 15, "aria-hidden": "true" })
          }
        ),
        /* @__PURE__ */ _jsxruntime.jsxs.call(void 0,
          _chunkLRPJVRUDcjs.IconButton,
          {
            variant: "ghost",
            round: false,
            size: "custom",
            ...
            children: [
              /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunk7OXVB7WXcjs.Icon, { name: "arrow-down", size: 15, "aria-hidden": "true" }),
              /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "span", { "aria-hidden": "true", style: { position: "absolute", left: 8, right: 8, bottom: 6, height: 1.5, borderRadius: "var(--radius-pill)", background: "currentColor" } }),
              latestCount > 0 && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, "span", { "aria-hidden": "true", style: { position: "absolute", top: -5, right: -5, minWidth: 16, height: 16, padding: "0 4px", boxSizing: "border-box", borderRadius: "var(--radius-pill)", background: "var(--color-semantic-status-negative-fill)", color: "var(--color-semantic-status-negative-on-fill)", fontSize: "var(--caption2-size)", lineHeight: "16px", fontWeight: "var(--fw-bold)" }, children: latestCount > 99 ? "99+" : `+${latestCount}` })
            ]
          }
        ),
        /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkLRPJVRUDcjs.IconButton, { variant: "ghost", round: false, size: "custom", label: "\uD45C\uC2DC \uB85C\uADF8 \uC9C0\uC6B0\uAE30", title: "\uD45C\uC2DC \uB85C\uADF8 \uC9C0\uC6B0\uAE30", disabled: currentLines.length === 0, onClick: clearVisible, children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunk7OXVB7WXcjs.Icon, { name: "trash", size: 15, "aria-hidden": "true" }) }),
        onExport && /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkLRPJVRUDcjs.IconButton, { variant: "ghost", round: false, size: "custom", label: "\uB85C\uADF8 \uB0B4\uBCF4\uB0B4\uAE30", title: "\uB85C\uADF8 \uB0B4\uBCF4\uB0B4\uAE30", disabled: shown.length === 0, onClick: () => onExport(shown), children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunk7OXVB7WXcjs.Icon, { name: "download", size: 15, "aria-hidden": "true" }) })
      ] })
    ] }),
    ...
    /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "div", { ref: boxRef, className: "lk-scroll-surface", "data-scrollbar": "auto", "data-scroll-gutter": "stable", role: "log", "aria-live": "off", "aria-label": ariaLabel, tabIndex: 0, onScroll: updateScrollState, "data-theme": "light", style: { height, colorScheme: "dark", overflow: "auto", scrollbarGutter: "stable", padding: metrics.panelPadding, borderRadius: "var(--radius-md)", background: "var(--color-semantic-inverse-background)", border: "1px solid var(--color-semantic-inverse-line-normal)", fontFamily: "var(--font-mono)", fontSize: metrics.fontSize, lineHeight: metrics.lineHeight }, children: [
        ...
        return /* @__PURE__ */ _jsxruntime.jsxs.call(void 0, "div", { style: { display: "grid", gridTemplateColumns, columnGap: "var(--space-2-5)", alignItems: "baseline", minHeight: metrics.rowMinHeight, height: virtualActive ? rowHeight : void 0, overflow: virtualActive ? "hidden" : void 0, whiteSpace: virtualActive || !wrap ? "nowrap" : "pre-wrap", wordBreak: virtualActive || !wrap ? "normal" : "break-word" }, children: [
          ...
          copyable && /* @__PURE__ */ _jsxruntime.jsx.call(void 0,
            "button",
            {
              ...
              children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunk7OXVB7WXcjs.Icon, { name: copied ? "circle-check" : "copy", size: 14, "aria-hidden": "true" })
            }
          )
        ] }, index);
      }),
...
//# sourceMappingURL=chunk-U5PISSGV.cjs.map