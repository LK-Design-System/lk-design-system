...
function SaveButton({ saved = false, onClick }) {
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, 
    "button",
    {
      ...
      children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunk3ATRKSQ7cjs.Icon, { name: saved ? "bookmark-fill" : "bookmark", size: 17, "aria-hidden": "true" })
    }
  );
}
...
exports.Card = Card;
//# sourceMappingURL=chunk-PIVDETH6.cjs.map