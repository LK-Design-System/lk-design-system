...
function LaneOverlay({
  ...
  return /* @__PURE__ */ jsxs(
    "g",
    {
      ...
      children: [
        pathData && /* @__PURE__ */ jsx("defs", { "aria-hidden": "true", children: /* @__PURE__ */ jsxs("mask", { id: directionMaskId, maskUnits: "userSpaceOnUse", children: [
          /* @__PURE__ */ jsx(
            "rect",
            {
          ...
          /* @__PURE__ */ jsx("g", { transform: `translate(${directionPoint.x} ${directionPoint.y}) rotate(${directionPoint.angle}) scale(${inverseScale})`, children: /* @__PURE__ */ jsx(
            "rect",
            {
...
//# sourceMappingURL=chunk-HDFX5XIZ.js.map