...
var Tooltip = _react2.default.forwardRef(function Tooltip2({
  ...
  const getTrigger = _react2.default.useCallback(() => _chunkENN7YVH5cjs.findOverlayTrigger.call(void 0, wrapperRef.current), []);
  const floating = _chunkENN7YVH5cjs.useFloatingPosition.call(void 0, {
    open: visible,
  ...
  const layer = _chunkENN7YVH5cjs.useLightDismiss.call(void 0, {
    open: visible,
    rootRef: wrapperRef,
    getTrigger,
    onDismiss: () => {
...
//# sourceMappingURL=chunk-WKAMY7SM.cjs.map