...
function FileUpload({
  ...
  const { fieldId: inputId, describedBy } = _chunkHYN6PXKLcjs.useFieldMetadata.call(void 0, { prefix: "file-upload", describedBy: inputAriaDescribedBy });
...
//# sourceMappingURL=chunk-VAH45CWN.cjs.map