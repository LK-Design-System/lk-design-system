...
function toneIcon(tone) {
  ...
  return /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _chunkX5XHQEI5cjs.Icon, { name: _chunkMBKOVB2Kcjs.statusToneStyle.call(void 0, tone).icon, size: 22, "aria-hidden": "true" });
}
function Snackbar({
  heading,
  description,
...
//# sourceMappingURL=chunk-DECCUF2Z.cjs.map