...
function SecretField({
  ...
  return /* @__PURE__ */ jsxs("div", { style: { display: "grid", gap: "var(--space-1)", ...style }, children: [
    /* @__PURE__ */ jsx(
      Input,
      {
        ...rest,
    ...
    /* @__PURE__ */ jsx("span", { role: "status", "aria-live": "polite", style: { position: "absolute", width: 1, height: 1, padding: 0, margin: -1, overflow: "hidden", clip: "rect(0, 0, 0, 0)", whiteSpace: "nowrap", border: 0 }, children: copyState === "success" || copyState === "error" ? copyActionLabel : "" })
  ] });
}
...
//# sourceMappingURL=chunk-7NZVQAKK.js.map