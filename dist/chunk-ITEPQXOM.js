          ...
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ jsx("span", { style: { display: "flex", minWidth: 0, flexWrap: "wrap", gap: "var(--space-1)", alignItems: "center" }, children: selectedValues.length ? selectedValues.map((selectedValue) => {
                ...
                return /* @__PURE__ */ jsx("span", { style: { display: "inline-flex", alignItems: "center", maxWidth: "100%", height: 24, padding: "0 9px", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap", borderRadius: "var(--radius-pill)", background: "var(--color-semantic-primary-surface-strong)", color: "var(--color-semantic-primary-heavy)", fontSize: "var(--label2-size)", fontWeight: "var(--fw-semibold)" }, children: option?.label ?? selectedValue }, selectedValue);
              }) : placeholder }),
...
//# sourceMappingURL=chunk-ITEPQXOM.js.map