...
var SearchField = _react2.default.forwardRef(function SearchField2({
  ...
  const metadata = _chunk26AXEFA6cjs.useFieldMetadata.call(void 0, {
    prefix: "search-field",
    id,
    label,
    helper,
  ...
  const borderColor = _chunk26AXEFA6cjs.fieldBorderColor.call(void 0, {
    disabled,
    readOnly,
    invalid: isInvalid,
    status,
...
//# sourceMappingURL=chunk-45F635XM.cjs.map