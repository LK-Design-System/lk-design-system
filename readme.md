...
패키지 진입 파일은 현재 181개의 React 컴포넌트 소스 파일(`components/**/*.jsx`) 기준으로 생성됩니다.
...
현재 public Storybook sidebar는 `LDS Core/Foundation`, `LDS Core/Components`, `LDS Theme`, `LDS Product`, `LDS Robotics` 아래의 컴포넌트와 패턴 표면 226개 story를 다룹니다.
