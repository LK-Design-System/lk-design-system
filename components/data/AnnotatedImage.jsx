...
import { Collapsible } from '../content/Collapsible.jsx';
  ...
  return (
    ...
    >
      ...
      {(caption != null || annotations > 0) && (
        <figcaption style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: 'var(--space-2) var(--space-3)', flexWrap: 'wrap', color: 'var(--color-semantic-label-neutral)', fontSize: 'var(--caption1-size)', lineHeight: 'var(--caption1-line)' }}>
          ...
          {annotations > 0 && (
            ...
            >
              <ol style={{ margin: 0, paddingLeft: 'var(--space-5)', color: 'var(--color-semantic-label-neutral)', fontSize: 'var(--caption1-size)', lineHeight: 'var(--caption1-line)' }}>
