    ...
    <div style={{ display: 'inline-flex', alignItems: 'center', gap: 20, ...style }} {...rest}>
      <span style={{ position: 'relative', width: size, height: size }}>
        ...
        {(showTotal || centerLabel != null) && (
          <span style={{ position: 'absolute', inset: 0, display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: 'var(--font-sans)', fontSize: size * 0.2, fontWeight: 'var(--fw-extra)', color: 'var(--color-semantic-label-normal)', fontVariantNumeric: 'tabular-nums' }}>{centerLabel != null ? centerLabel : total}</span>
        )}
      </span>
