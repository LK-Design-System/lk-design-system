...
/** A standalone two-state action button with aria-pressed semantics. */
export function ToggleButton({
  ...
  return (
    <button
      ...
      onMouseLeave={(event) => { setHover(false); setPointerPressed(false); onMouseLeave?.(event); }}
      onMouseDown={(event) => { if (!blocked) setPointerPressed(true); onMouseDown?.(event); }}
      onMouseUp={(event) => { setPointerPressed(false); onMouseUp?.(event); }}
      onKeyDown={(event) => {
