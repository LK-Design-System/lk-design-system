**ToggleButton** — "켜짐" 상태를 유지하는 상태 버튼. 아이콘 및/또는 라벨; 눌림 = 시안 워시 + 시그널 잉크, 기본 = 헤어라인. 뷰 옵션, 북마크형 토글에 씁니다.

```jsx
<ToggleButton icon={<Icon name="eye" size={18} />} onChange={setPreview}>미리보기</ToggleButton>
