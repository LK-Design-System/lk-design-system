...
// traversable facility or as a hazard. See docs/references/ATTRIBUTIONS.md.
// FIT recenters the 960u artwork (center 480,-480) onto the pin-head origin
// and scales it to the ~21px badge slot.
const HAZARD_GLYPHS = {
