 ...
 * Connecting/reconnecting/stale states blink. Bars fill by strength; colour
 * follows the state. Recovery actions and freshness details belong in a
 * product composition with DescriptionList and ActionArea.
 */
