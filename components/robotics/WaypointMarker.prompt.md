...
- Pass the actual parent `viewportScale`. Marker geometry and labels apply the inverse scale, strokes use `vector-effect="non-scaling-stroke"`, and the transparent activation circle remains at least 24 CSS px on screen.
