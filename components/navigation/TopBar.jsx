  ...
  return (
    ...
    >
      ...
      {children != null
        ...
        : <div style={{ flex: 1 }} />}
      {actions != null && (
        <div data-top-bar-actions style={{ minWidth: 0, maxWidth: '100%', flex: '0 1 auto', overflowX: 'auto', overflowY: 'hidden', scrollbarWidth: 'none', WebkitOverflowScrolling: 'touch' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10, width: 'max-content', minWidth: '100%' }}>{actions}</div>
        </div>
      )}
    </header>
  );
