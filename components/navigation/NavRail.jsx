...
export function NavRail({ items = [], value, defaultValue, onChange, style, ...rest }) {
  ...
  return (
    <nav style={{ display: 'inline-flex', flexDirection: 'column', gap: 6, padding: 10, background: 'var(--bw-white)', border: '1px solid var(--bw-border)', borderRadius: 'var(--radius-xl)', ...style }} {...rest}>
      {items.map((o) => {
