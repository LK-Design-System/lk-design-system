        ...
        return (
          <React.Fragment key={i}>
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 8, flexShrink: 0 }}>
              ...
              <span style={{ fontFamily: 'var(--font-sans)', fontSize: 13, fontWeight: active ? 'var(--fw-bold)' : 'var(--fw-medium)', letterSpacing: 0, color: active ? 'var(--label-normal)' : 'var(--label-alternative)', whiteSpace: 'nowrap' }}>{label}</span>
            </div>
