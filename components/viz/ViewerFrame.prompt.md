...
- **LK Context Hub** — revision `de124084b7e50049350a46f92c4ea4476269c58c`; `src/app/page.tsx`, `src/app/projects/page.tsx`, and `src/components/chat/PortalChatPanel.tsx`. **Not applicable.** The pinned frontend owns project/evidence/chat workflows and exposes no map, 3D, or video viewport-local navigation contract.
