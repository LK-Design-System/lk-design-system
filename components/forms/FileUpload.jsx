  ...
  return (
    <div
      ...
      style={{
        ...
        border: `1.5px dashed ${drag ? 'var(--lk-accent-ink)' : 'var(--bw-border)'}`, borderRadius: 'var(--radius-xl)',
      ...
      {...rest}
    >
      <span style={{ display: 'inline-flex', width: 44, height: 44, borderRadius: 'var(--radius-lg)', background: 'var(--lk-accent-tint)', color: 'var(--lk-accent-ink)', alignItems: 'center', justifyContent: 'center' }}>
      ...
      <div style={{ fontSize: 14, fontWeight: 'var(--fw-semibold)', color: names.length ? 'var(--label-normal)' : 'var(--label-neutral)', wordBreak: 'break-all' }}>{names.length ? names.join(', ') : hint}</div>
