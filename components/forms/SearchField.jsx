...
export function SearchField({ value, defaultValue, onChange, onSearch, placeholder = '검색', size = 'md', disabled = false, style, 'aria-label': ariaLabel, ...rest }) {
  ...
  return (
    <div style={{
      ...
      background: 'var(--bw-white)', border: `1px solid ${focus ? 'var(--color-semantic-primary-normal)' : 'var(--bw-border)'}`, borderRadius: 'var(--radius-input)',
      boxShadow: focus ? '0 0 0 4px var(--focus-ring)' : 'none', opacity: disabled ? 0.5 : 1,
