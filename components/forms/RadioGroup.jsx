      ...
      {norm.map((o) => {
        ...
        return (
          <label key={o.value} style={{ display: 'inline-flex', alignItems: 'flex-start', gap: 10, cursor: o.disabled ? 'not-allowed' : 'pointer', opacity: o.disabled ? 0.5 : 1, fontFamily: 'var(--font-sans)' }}>
            ...
            <span style={{ marginTop: 1, flexShrink: 0, width: 20, height: 20, borderRadius: '50%', border: `2px solid ${on ? 'var(--lk-accent-ink)' : 'var(--bw-gray-300)'}`, display: 'inline-flex', alignItems: 'center', justifyContent: 'center', transition: 'border-color var(--dur-fast) var(--ease-out)' }}>
