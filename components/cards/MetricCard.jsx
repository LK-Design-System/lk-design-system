...
export function MetricCard({
  ...
  return (
    ...
    >
      ...
      {body}
      {showFooter && (
        <div data-metric-footer style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 'var(--space-3)', minWidth: 0, flexWrap: 'wrap', marginTop: 16, paddingTop: 16, borderTop: '1px solid var(--color-semantic-line-normal-alternative)' }}>
