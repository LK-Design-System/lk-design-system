...
외부 기준은 [GitHub Flavored Markdown 명세](https://github.github.com/gfm/)(조판할 요소 집합의 권위 출처)와 마크다운 렌더 산문의 관용 타이포그래피(GitHub `markdown-body`, Tailwind Typography `prose`의 요소 계약)입니다. 벤치마크한 seed-design에도 `Article`이 같은 역할로 있습니다. 이들은 카테고리 기대치 확인용이며 스타일을 그대로 복제하지 않습니다.
