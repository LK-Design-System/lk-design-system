...
export function Avatar({
  ...
  return (
    <span
      ...
      data-interaction={
        interaction === true ? "normal" : interaction || undefined
      }
      style={{
        position: "relative",
        display: "inline-flex",
