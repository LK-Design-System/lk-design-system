...
live in [`EXPRESSION_PROFILE_CONTRACT.json`](references/architecture/EXPRESSION_PROFILE_CONTRACT.json),
...
- UI primary와 브랜드색의 관계: primary(`#3878B3`, HSL 209°)는 브랜드 LK Navy(`#05132B`, 218°)와
  ...
  UI 토큰으로 대체하지 않는다([로고 표준 §6](brand/LK_LOGO_STANDARD.md#6-색상과-배경)).
