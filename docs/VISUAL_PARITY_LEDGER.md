...
| React component entry exports | 210 | Public package component entries covered by checks |
| Named public exports | 223 | Public package surface covered by type checks |
| Storybook public stories | 515 | Component and pattern surfaces only |
| Storybook hidden visual parity stories | 99 | Tagged `visual-parity` and `!dev` |
| Visual inventory React stories | 746 | Current implementation stories checked by the accessibility guard |
| Accessibility checked implementation stories | 746 | Current implementation stories checked by the accessibility guard |
