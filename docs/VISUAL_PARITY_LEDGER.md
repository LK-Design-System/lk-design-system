...
| React component entry exports | 157 | Public package component entries covered by checks |
| Named public exports | 161 | Public package surface covered by type checks |
| Storybook public stories | 118 | Component and pattern surfaces only |
| Storybook hidden visual parity stories | 82 | Tagged `visual-parity` and `!dev` |
| Visual inventory React stories | 210 | Current implementation stories checked by the accessibility guard |
| Accessibility checked implementation stories | 210 | Current implementation stories checked by accessibility guard |
