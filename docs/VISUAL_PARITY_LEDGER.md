...
| React component entry exports | 209 | Public package component entries covered by checks |
| Named public exports | 222 | Public package surface covered by type checks |
| Storybook public stories | 512 | Component and pattern surfaces only |
| Storybook hidden visual parity stories | 98 | Tagged `visual-parity` and `!dev` |
| Visual inventory React stories | 742 | Current implementation stories checked by the accessibility guard |
| Accessibility checked implementation stories | 742 | Current implementation stories checked by the accessibility guard |
