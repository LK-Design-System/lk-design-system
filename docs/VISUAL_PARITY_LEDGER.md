...
| React component entry exports | 169 | Public package component entries covered by checks |
| Named public exports | 173 | Public package surface covered by type checks |
| Storybook public stories | 130 | Component and pattern surfaces only |
| Storybook hidden visual parity stories | 82 | Tagged `visual-parity` and `!dev` |
| Visual inventory React stories | 222 | Current implementation stories checked by the accessibility guard |
| Accessibility checked implementation stories | 222 | Current implementation stories checked by accessibility guard |
