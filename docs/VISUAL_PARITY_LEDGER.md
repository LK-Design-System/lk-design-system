...
| React component entry exports | 208 | Public package component entries covered by checks |
| Named public exports | 221 | Public package surface covered by type checks |
| Storybook public stories | 504 | Component and pattern surfaces only |
| Storybook hidden visual parity stories | 97 | Tagged `visual-parity` and `!dev` |
| Visual inventory React stories | 733 | Current implementation stories checked by the accessibility guard |
| Accessibility checked implementation stories | 733 | Current implementation stories checked by the accessibility guard |
