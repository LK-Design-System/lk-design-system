...
- **Phase 5 — 합성 씬 이관 + 충돌 재귀속**: Viewer/Navigation Viewer 신설(SemanticMirror 이관), Viewer 그룹 storySort 편집, 충돌 계약을 Annotation Layer로. Route는 RouteOverlay만 남음. 위험 **높음**(신규 페이지+새 IA/coverage/baseline).
