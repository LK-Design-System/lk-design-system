...
| R4-3 아카이브 | 릴리스 사이클 2회(약 2분기) 연속으로 소비자 0 && 커밋 0이면 아카이브를 기본값으로 심사한다. infographics가 첫 적용 사례. **예외(2026-08-16 소유자 확인): 소유자가 선행 구축으로 선언한 위성(현재 lds-3d)은 소비자 0이 실패 신호가 아니다.** 심사 질문은 "쓰이나"가 아니라 "예정된 용처가 아직 유효한가"로 바꾼다 |
