...
2026-07-26 검토에서는 운영용 `Overview`·`Progress Board`를 정적 문서로 옮기고 Loading을 교차 컴포넌트 패턴 Docs로 연결했다. 이후 현재 195개 페이지와 730개 스토리의 owner, role, visibility, disposition은 감사 원장을 따른다.
