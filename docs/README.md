...
| [`TYPE_RAMP_DISPLAY0_PROPOSAL.md`](TYPE_RAMP_DISPLAY0_PROPOSAL.md) | Proposed plan — 투영 매체(Slides·Motion)용 램프 최상단 `display0` 한 단 추가 제안; Slides는 calc 조합으로 자립 운영 중, 승격 시 한 줄 마이그레이션 |
