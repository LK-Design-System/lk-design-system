...
| Document | Status |
| --- | --- |
| [`PACKAGE_AND_REPOSITORY_SEPARATION_PLAN.md`](PACKAGE_AND_REPOSITORY_SEPARATION_PLAN.md) | In progress — Wave 0 package ownership·consumer baseline, 조건부 Robotics 저장소 추출과 LDS3D 호환성 gate |
