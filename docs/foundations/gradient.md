...
gradient를 정보 의미가 아니라 제한된 전환·fade·브랜드 강조에 사용하고 임의 각도와 stop 확산을 막습니다.
...
| 브랜드 stage | 승인된 semantic gradient | 새 hex stop |
...
| Hero | 승인된 brand-stage gradient 위 텍스트 대비를 light/dark에서 검증 |
...
- [SEED Gradient](https://seed-design.io/foundations/gradient)
