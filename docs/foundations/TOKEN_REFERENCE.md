...
| `semantic.colorRoles.brand-canvas-from` | color | `--color-semantic-brand-canvas-from` | `light: #141C3C; dark: #141C3C` | — |
| `semantic.colorRoles.brand-canvas-to` | color | `--color-semantic-brand-canvas-to` | `light: #0C1024; dark: #0C1024` | — |
| `semantic.colorRoles.brand-ink` | color | `--color-semantic-brand-ink` | `light: #0E1329; dark: #E7EAF2` | — |
| `semantic.colorRoles.brand-stage-from` | color | `--color-semantic-brand-stage-from` | `light: #161D33; dark: #161D33` | — |
| `semantic.colorRoles.brand-stage-to` | color | `--color-semantic-brand-stage-to` | `light: #0E1329; dark: #0E1329` | — |
| `semantic.colorRoles.brand-surface-raised` | color | `--color-semantic-brand-surface-raised` | `light: #2A3042; dark: #2A3247` | — |
...
| `runtimeCoverage` | runtime-projection | `--component-button-flat-fg` | `var(--color-semantic-brand-ink)` | Runtime variable is not yet promoted into a primitive, semantic, or component token object; it remains explicitly inventoried and drift-checked. (tokens/components.css) |
...
| `runtimeCoverage` | runtime-projection | `--component-button-secondary-fg` | `var(--color-semantic-inverse-label)` | Runtime variable is not yet promoted into a primitive, semantic, or component token object; it remains explicitly inventoried and drift-checked. (tokens/components.css) |
...
| `runtimeCoverage` | runtime-projection | `--component-menu-item-hover-bg` | `var(--color-semantic-fill-normal)` | Runtime variable is not yet promoted into a primitive, semantic, or component token object; it remains explicitly inventoried and drift-checked. (tokens/components.css) |
| `runtimeCoverage` | runtime-projection | `--component-menu-padding-x` | `20px` | Runtime variable is not yet promoted into a primitive, semantic, or component token object; it remains explicitly inventoried and drift-checked. (tokens/components.css) |
| `runtimeCoverage` | runtime-projection | `--component-menu-padding-y` | `8px` | Runtime variable is not yet promoted into a primitive, semantic, or component token object; it remains explicitly inventoried and drift-checked. (tokens/components.css) |
| `runtimeCoverage` | runtime-projection | `--component-menu-radius` | `var(--radius-16)` | Runtime variable is not yet promoted into a primitive, semantic, or component token object; it remains explicitly inventoried and drift-checked. (tokens/components.css) |
