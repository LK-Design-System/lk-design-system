...
| 위성 | 축 | 자기 버전 | LDS 핀 | 상태 |
| --- | --- | --- | --- | --- |
| `robotics-ui` | domain-pack | 0.1.0-rc.21 | `lds-core` >=0.1.0-rc.69.19 <0.2.0 — peerDependencies<br>`lds-product` >=0.1.0-rc.69.19 <0.2.0 — peerDependencies<br>`lds-theme` 0.1.0-rc.69.19 — devDependencies | 현행 |
