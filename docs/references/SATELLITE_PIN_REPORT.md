...
| 위성 | 축 | 자기 버전 | LDS 핀 | 상태 |
| --- | --- | --- | --- | --- |
| `robotics-ui` | domain-pack | 0.1.0-rc.28 | `lds-core` >=0.1.0-rc.69.26 <0.2.0 — peerDependencies<br>`lds-product` >=0.1.0-rc.69.26 <0.2.0 — peerDependencies<br>`lds-theme` 0.1.0-rc.69.26 — devDependencies | 현행 |
| `slides-ui` | domain-pack | 0.1.0-alpha.7 | `lds-core` >=0.1.0-rc.69.26 <0.2.0 — peerDependencies<br>`lds-core` (vendored tgz) — devDependencies<br>`lds-product` >=0.1.0-rc.69.26 <0.2.0 — peerDependencies<br>`lds-product` (vendored tgz) — devDependencies<br>`lds-theme` >=0.1.0-rc.69.26 <0.2.0 — peerDependencies<br>`lds-theme` (vendored tgz) — devDependencies | 현행 |
