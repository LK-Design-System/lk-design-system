...
| Card | elevation, interactive/dark, structured slots, semantic heading, `titleWrap="truncate|wrap"`, platform density, skeleton/save/toggle affordances | heading and nested-interactive guards, long-title wrap assertion, desktop/mobile structured-card stories |
