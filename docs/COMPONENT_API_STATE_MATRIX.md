...
| SideNav | native `nav` / 같은 root | panel·brand·list·item·child list·footer parts; leaf-owned selected/disclosure/collapsed 표현, 접힌 active-descendant의 시각 선택 프록시, route·permission 소유권 분리 |
