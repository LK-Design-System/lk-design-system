...
- 워크스페이스 orchestrator: `@lk-design-system/lds-workspace@0.4.0` · `private: true`
- Core: `@lk-design-system/lds-core@0.4.0` · source entry 94개 · named export 95개
- Theme: `@lk-design-system/lds-theme@0.4.0` · source entry 4개 · named export 8개
- Product: `@lk-design-system/lds-product@0.4.0` · source entry 123개 · named export 131개
...
- 외부 Robotics: `@lk-design-system/lds-robotics-ui@0.1.0-rc.50` · source entry 23개 · named export 53개
