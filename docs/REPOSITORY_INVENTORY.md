...
- React 컴포넌트 소스 파일: 206개
- 공개 named export: 218개
- 루트 aggregate export: Core 85개 · Theme 7개 · Product 126개 = 218개
...
- `docs/components/`: 206개 entry, 174개 의사결정 가이드, 정적 reference·platform register, LLM bundle과 machine-readable component registry
...
- 현재 React component entry export: 206개
- 공개 named export: 218개
- Storybook 전체 story: 686개
- Storybook public story: 472개
