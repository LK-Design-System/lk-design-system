...
- 워크스페이스 orchestrator: `@lk-design-system/lds-workspace@0.2.7` · `private: true`
- Core: `@lk-design-system/lds-core@0.2.7` · source entry 93개 · named export 94개
- Theme: `@lk-design-system/lds-theme@0.2.7` · source entry 4개 · named export 8개
- Product: `@lk-design-system/lds-product@0.2.7` · source entry 123개 · named export 131개
- 로컬 owner-package canonical unique surface: source entry 211개 · named export 224개
- Product deprecated compatibility projection: source entry 9개 · named export 9개
- 외부 Robotics: `@lk-design-system/lds-robotics-ui@0.1.0-rc.42` · source entry 23개 · named export 53개
...
- Storybook 전체 story: 755개
- Storybook public story: 521개
- Storybook hidden story: 229개
- 숨김 visual parity story: 100개
- visual inventory React story: 755개
- 접근성 guard 검사 대상 implementation story: 755개
