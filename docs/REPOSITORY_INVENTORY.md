...
- 워크스페이스 orchestrator: `@lk-design-system/lds-workspace@0.2.4` · `private: true`
- Core: `@lk-design-system/lds-core@0.2.4` · source entry 93개 · named export 94개
- Theme: `@lk-design-system/lds-theme@0.2.4` · source entry 4개 · named export 8개
- Product: `@lk-design-system/lds-product@0.2.4` · source entry 122개 · named export 130개
...
- 외부 Robotics: `@lk-design-system/lds-robotics-ui@0.1.0-rc.39` · source entry 23개 · named export 53개
...
- `docs/components/`: 210개 entry, 177개 의사결정 가이드, 정적 reference·platform register, LLM bundle과 machine-readable component registry
