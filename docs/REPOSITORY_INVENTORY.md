...
Storybook의 524개 스토리 역할·공개 여부·소유 컴포넌트와 165개 페이지 판정은 [`STORYBOOK_INFORMATION_ARCHITECTURE.md`](STORYBOOK_INFORMATION_ARCHITECTURE.md) 및 `references/quality/STORYBOOK_INFORMATION_ARCHITECTURE_AUDIT.json`을 기준으로 한다.
...
- React 컴포넌트 소스 파일: 179개
- 공개 named export: 182개
- 루트 aggregate export: Core 83개 · Theme 2개 · Product 97개 = 182개
...
- `docs/components/`: 179개 entry, 148개 의사결정 가이드, 정적 reference·platform register, LLM bundle과 machine-readable component registry
...
- Storybook public story: 369개
- Storybook hidden story: 155개
