...
Storybook의 635개 스토리 역할·공개 여부·소유 컴포넌트와 190개 페이지 판정은 [`STORYBOOK_INFORMATION_ARCHITECTURE.md`](STORYBOOK_INFORMATION_ARCHITECTURE.md) 및 `references/quality/STORYBOOK_INFORMATION_ARCHITECTURE_AUDIT.json`을 기준으로 한다.
...
- 루트 aggregate export: Core 85개 · Theme 2개 · Product 123개 = 210개
...
- `docs/components/`: 202개 entry, 172개 의사결정 가이드, 정적 reference·platform register, LLM bundle과 machine-readable component registry
...
- 공개 named export: 210개
- Storybook 전체 story: 635개
- Storybook public story: 455개
- Storybook hidden story: 180개
- 숨김 visual parity story: 88개
- visual inventory React story: 635개
- 접근성 guard 검사 대상 implementation story: 635개
