...
Storybook의 640개 스토리 역할·공개 여부·소유 컴포넌트와 190개 페이지 판정은 [`STORYBOOK_INFORMATION_ARCHITECTURE.md`](STORYBOOK_INFORMATION_ARCHITECTURE.md) 및 `references/quality/STORYBOOK_INFORMATION_ARCHITECTURE_AUDIT.json`을 기준으로 한다.
...
- 공개 named export: 211개
- 루트 aggregate export: Core 85개 · Theme 2개 · Product 124개 = 211개
...
- `docs/components/`: 203개 entry, 172개 의사결정 가이드, 정적 reference·platform register, LLM bundle과 machine-readable component registry
...
- 현재 React component entry export: 203개
- 공개 named export: 211개
- Storybook 전체 story: 640개
- Storybook public story: 457개
- Storybook hidden story: 183개
- 숨김 visual parity story: 89개
- visual inventory React story: 640개
- 접근성 guard 검사 대상 implementation story: 640개
