...
| Audit snapshot | `61b437f31e1d8b04e98d21266abebb49ffa67425` (local `main` source observation; clean-main baseline 아님) |
...
- CI 설치 정책은 npm으로 고정했고 local `main@61b437f`에서 legacy pnpm lockfile이
...
- 일곱 consumer evidence report는 Git 추적 상태로 고정해 consumer evidence blocker를
  ...
  local `main@61b437f`까지 통합했다. origin 동기화와 clean main/tag,
