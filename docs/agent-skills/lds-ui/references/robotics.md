...
정본: `@lk-design-system/lds-robotics-ui/docs/domain/*.md` (특히 `NAVIGATION_EXPRESSION_CONVENTIONS.md`, `NAVIGATION_COORDINATE_CONTRACT.md`, `OCCUPANCY_MAP_CONVENTIONS.md`, `ROBOTICS_UI_ADOPTION.md`). 산문과 컴포넌트 동작이 다르면 배포 Storybook의 play 단언이 정본이다.
