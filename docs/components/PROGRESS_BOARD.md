...
| [Text Primitives](guides/core-components-content-text-primitives.md) | Core / Content | `Blockquote`, `Code`, `Kbd`, `SourceTag` | mapped | implemented | not-tracked | not-tracked | 1 public / 1 hidden |
...
| [Scroll and Accessibility](guides/core-components-layout-scroll-and-accessibility.md) | Core / Layout | `AspectRatio`, `Center`, `ScrollArea`, `VisuallyHidden` | not-tracked | implemented | not-tracked | not-tracked | 1 public / 2 hidden |
...
| [Status Indicator](guides/core-components-status-status-indicator.md) | Core / Status | `StatusIndicator` | mapped | implemented | not-tracked | not-tracked | 2 public / 0 hidden |
...
| [Editor Toolbar](guides/product-editor-editor-toolbar.md) | Product / Editor | `EditorToolbar` | not-tracked | implemented | not-tracked | not-tracked | 4 public / 0 hidden |
| [History Toolbar](guides/product-editor-history-toolbar.md) | Product / Editor | `HistoryToolbar` | not-tracked | implemented | not-tracked | not-tracked | 3 public / 0 hidden |
| [Layer Panel](guides/product-editor-layer-panel.md) | Product / Editor | `LayerPanel` | not-tracked | implemented | not-tracked | not-tracked | 6 public / 0 hidden |
| [Selection Inspector](guides/product-editor-selection-inspector.md) | Product / Editor | `SelectionInspector` | not-tracked | implemented | not-tracked | not-tracked | 5 public / 2 hidden |
| [Viewport Status Bar](guides/product-editor-viewport-status-bar.md) | Product / Editor | `ViewportStatusBar` | not-tracked | implemented | not-tracked | not-tracked | 4 public / 0 hidden |
...
| [Searchable Multi Select](guides/product-selection-and-input-searchable-multi-select.md) | Product / Selection and Input | `SearchableMultiSelect` | not-tracked | implemented | not-tracked | not-tracked | 7 public / 0 hidden |
