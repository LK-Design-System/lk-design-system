...
- Public component entries: **206**
- Named exports: **218**
- Component and Theme/Product decision guides: **174**
- Entries without an owned Storybook page: **10** — reference registry에서 source·type·prompt 계약을 계속 추적합니다.
