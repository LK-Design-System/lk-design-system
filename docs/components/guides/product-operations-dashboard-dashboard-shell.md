...
side-first와 header-first 토폴로지, docked 탐색, 건너뛰기 링크, 넓은·좁은 화면 탐색 전환을 검증합니다.

> Canonical guide: [reference](product-navigation-dashboard-navigation.md). This page documents only its evidence-backed differences.
