...
| Storybook | `LDS Product/Operations Dashboard/Dashboard Shell` |
| Source | `../component-content.json#product-operations-dashboard-dashboard-shell` |
...
| State | Contract |
| --- | --- |
| 변형·상태 · 다크 표면 | variants-states 공개 스토리에서 렌더링 및 상호작용 증거를 유지합니다. |
| 변형·상태 · 헤더 우선 | variants-states 공개 스토리에서 렌더링 및 상호작용 증거를 유지합니다. |
| 반응형 · 320px 하단 탐색 | responsive 공개 스토리에서 렌더링 및 상호작용 증거를 유지합니다. |
| 반응형 · 좁은 화면의 대체 탐색 | responsive 공개 스토리에서 렌더링 및 상호작용 증거를 유지합니다. |
...
- `stories/LayoutDashboardShell.stories.jsx`
