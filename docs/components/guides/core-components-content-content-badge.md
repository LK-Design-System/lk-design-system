...
| 명시 규칙 2 | 원색 신호 토큰은 이 조건을 만족하지 않습니다 — --color-semantic-status-positive-signal #13BE4C ≈ 2.5:1, -cautionary #EB9C33 ≈ 2.3:1, -negative #EE5656 ≈ 3.2:1. accent(#3878B3 ≈ 4.7:1)만 통과합니다. |
