...
| Layer | Other / LDS |
| Owner | `Link` |
| Storybook | `LDS/Directory` |
| Source | `../component-content.json#lds-directory` |
...
- `stories/DesignSystemDirectory.stories.jsx`

## Sources

- Link prompt contract: `components/buttons/Link.prompt.md`
- Storybook implementation evidence: `stories/DesignSystemDirectory.stories.jsx`
