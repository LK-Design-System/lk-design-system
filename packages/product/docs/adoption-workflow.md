...
전환 중 shared component, token, asset, pattern의 변경 필요가 발견되어도 제품 전환 요청이 그 변경 권한을 자동으로 부여하지 않습니다. 해당 변경은 [컴포넌트 워크플로](https://github.com/LK-Design-System/lk-design-system/blob/lds-v0.1.1/docs/COMPONENT_WORKFLOW.md), [토큰 거버넌스](https://github.com/LK-Design-System/lk-design-system/blob/lds-v0.1.1/docs/TOKEN_GOVERNANCE.md), 저장소의 scope escalation gate를 따로 적용합니다.
...
2. [Foundation index](https://github.com/LK-Design-System/lk-design-system/blob/lds-v0.1.1/docs/foundations/README.md)에서 관련 원리와 선택 기준을 읽습니다. 단일 AI context가 필요하면 [Foundation LLM bundle](https://github.com/LK-Design-System/lk-design-system/blob/lds-v0.1.1/docs/foundations/llms.txt)을 대신 사용합니다.
3. 관련 CSS 이름과 설명을 [token source](https://github.com/LK-Design-System/lk-design-system/blob/lds-v0.1.1/tokens/source.json)에서 확인합니다. generated CSS 값만 보고 의미를 추론하지 않습니다.
4. 후보 component를 정한 뒤 [component index](https://github.com/LK-Design-System/lk-design-system/blob/lds-v0.1.1/docs/components/README.md)와 해당 targeted guide를 읽습니다. 전체 [component LLM bundle](https://github.com/LK-Design-System/lk-design-system/blob/lds-v0.1.1/docs/components/llms.txt)은 retrieval/indexing 용도이며 매 작업에서 통째로 읽는 필수 입력이 아닙니다.
...
- [docs/TOKEN_GOVERNANCE.md](https://github.com/LK-Design-System/lk-design-system/blob/lds-v0.1.1/docs/TOKEN_GOVERNANCE.md)
- [docs/PACKAGE_MIGRATION_GUIDE.md](https://github.com/LK-Design-System/lk-design-system/blob/lds-v0.1.1/docs/PACKAGE_MIGRATION_GUIDE.md)
- [docs/foundations/design-token.md](https://github.com/LK-Design-System/lk-design-system/blob/lds-v0.1.1/docs/foundations/design-token.md)
- [docs/foundations/color.md](https://github.com/LK-Design-System/lk-design-system/blob/lds-v0.1.1/docs/foundations/color.md)
- [tokens/source.json](https://github.com/LK-Design-System/lk-design-system/blob/lds-v0.1.1/tokens/source.json)
...
- [docs/foundations/typography.md](https://github.com/LK-Design-System/lk-design-system/blob/lds-v0.1.1/docs/foundations/typography.md)
- [docs/foundations/layout.md](https://github.com/LK-Design-System/lk-design-system/blob/lds-v0.1.1/docs/foundations/layout.md)
- [docs/foundations/spacing.md](https://github.com/LK-Design-System/lk-design-system/blob/lds-v0.1.1/docs/foundations/spacing.md)
- [docs/foundations/radius.md](https://github.com/LK-Design-System/lk-design-system/blob/lds-v0.1.1/docs/foundations/radius.md)
- [docs/foundations/elevation.md](https://github.com/LK-Design-System/lk-design-system/blob/lds-v0.1.1/docs/foundations/elevation.md)
- [docs/foundations/gradient.md](https://github.com/LK-Design-System/lk-design-system/blob/lds-v0.1.1/docs/foundations/gradient.md)
- [docs/foundations/aspect-ratio.md](https://github.com/LK-Design-System/lk-design-system/blob/lds-v0.1.1/docs/foundations/aspect-ratio.md)
...
- [docs/foundations/state.md](https://github.com/LK-Design-System/lk-design-system/blob/lds-v0.1.1/docs/foundations/state.md)
- [docs/foundations/motion.md](https://github.com/LK-Design-System/lk-design-system/blob/lds-v0.1.1/docs/foundations/motion.md)
...
- [docs/foundations/iconography.md](https://github.com/LK-Design-System/lk-design-system/blob/lds-v0.1.1/docs/foundations/iconography.md)
- [packages/core/assets/icons/manifest.json](https://github.com/LK-Design-System/lk-design-system/blob/lds-v0.1.1/packages/core/assets/icons/manifest.json)
...
- [docs/foundations/writing.md](https://github.com/LK-Design-System/lk-design-system/blob/lds-v0.1.1/docs/foundations/writing.md)
- [docs/foundations/voice-and-tone.md](https://github.com/LK-Design-System/lk-design-system/blob/lds-v0.1.1/docs/foundations/voice-and-tone.md)
- [docs/foundations/international-design.md](https://github.com/LK-Design-System/lk-design-system/blob/lds-v0.1.1/docs/foundations/international-design.md)
- [docs/COPY_REVIEW_CONTRACT.md](https://github.com/LK-Design-System/lk-design-system/blob/lds-v0.1.1/docs/COPY_REVIEW_CONTRACT.md)
...
- [docs/foundations/inclusive-design.md](https://github.com/LK-Design-System/lk-design-system/blob/lds-v0.1.1/docs/foundations/inclusive-design.md)
- [docs/ACCESSIBILITY_CONTRACTS.md](https://github.com/LK-Design-System/lk-design-system/blob/lds-v0.1.1/docs/ACCESSIBILITY_CONTRACTS.md)
...
- [docs/components/README.md](https://github.com/LK-Design-System/lk-design-system/blob/lds-v0.1.1/docs/components/README.md)
- [docs/PACKAGE_MIGRATION_GUIDE.md](https://github.com/LK-Design-System/lk-design-system/blob/lds-v0.1.1/docs/PACKAGE_MIGRATION_GUIDE.md)
- [docs/COMPONENT_WORKFLOW.md](https://github.com/LK-Design-System/lk-design-system/blob/lds-v0.1.1/docs/COMPONENT_WORKFLOW.md)
...
소비 저장소에 [config schema](https://github.com/LK-Design-System/lk-design-system/blob/lds-v0.1.1/packages/conformance/schemas/lds-ui-adoption-config.schema.json)를 따르는 `.lds/adoption.config.json`을 둡니다. 기본 report 경로는 `.lds/adoption-report.json`이며 config의 `reportDirectory`와 CLI `--report`로 명시적으로 바꿀 수 있습니다.

에이전트로 UI를 조립하는 소비 저장소는 셋업 단계에서 [consumer agent skill](https://github.com/LK-Design-System/lk-design-system/blob/lds-v0.1.1/docs/agent-skills/lds-ui/SKILL.md)도 함께 설치합니다 — 규칙이 조립 시점에 push 로드되는 채널입니다. Claude Code는 설치된 `@lk-design-system/lds-core/docs/agent-skills/lds-ui/`를 `.claude/skills/lds-ui/`로 복사하고, AGENTS.md 기반 에이전트(Codex 등)는 SKILL.md 설치 섹션의 라우팅 블록을 저장소 AGENTS.md에 추가합니다. `check-adoption`은 둘 다 없으면 `AGENT_SKILL_MISSING` 경고를 출력합니다(advisory — 판정을 차단하지는 않습니다).
