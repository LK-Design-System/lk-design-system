...
전환 중 shared component, token, asset, pattern의 변경 필요가 발견되어도 제품 전환 요청이 그 변경 권한을 자동으로 부여하지 않습니다. 해당 변경은 [컴포넌트 워크플로](https://github.com/LK-Design-System/lk-design-system/blob/lds-v0.1.0-rc.69.14/docs/COMPONENT_WORKFLOW.md), [토큰 거버넌스](https://github.com/LK-Design-System/lk-design-system/blob/lds-v0.1.0-rc.69.14/docs/TOKEN_GOVERNANCE.md), 저장소의 scope escalation gate를 따로 적용합니다.
...
2. [Foundation index](https://github.com/LK-Design-System/lk-design-system/blob/lds-v0.1.0-rc.69.14/docs/foundations/README.md)에서 관련 원리와 선택 기준을 읽습니다. 단일 AI context가 필요하면 [Foundation LLM bundle](https://github.com/LK-Design-System/lk-design-system/blob/lds-v0.1.0-rc.69.14/docs/foundations/llms.txt)을 대신 사용합니다.
3. 관련 CSS 이름과 설명을 [token source](https://github.com/LK-Design-System/lk-design-system/blob/lds-v0.1.0-rc.69.14/tokens/source.json)에서 확인합니다. generated CSS 값만 보고 의미를 추론하지 않습니다.
4. 후보 component를 정한 뒤 [component index](https://github.com/LK-Design-System/lk-design-system/blob/lds-v0.1.0-rc.69.14/docs/components/README.md)와 해당 targeted guide를 읽습니다. 전체 [component LLM bundle](https://github.com/LK-Design-System/lk-design-system/blob/lds-v0.1.0-rc.69.14/docs/components/llms.txt)은 retrieval/indexing 용도이며 매 작업에서 통째로 읽는 필수 입력이 아닙니다.
...
- [docs/TOKEN_GOVERNANCE.md](https://github.com/LK-Design-System/lk-design-system/blob/lds-v0.1.0-rc.69.14/docs/TOKEN_GOVERNANCE.md)
- [docs/PACKAGE_MIGRATION_GUIDE.md](https://github.com/LK-Design-System/lk-design-system/blob/lds-v0.1.0-rc.69.14/docs/PACKAGE_MIGRATION_GUIDE.md)
- [docs/foundations/design-token.md](https://github.com/LK-Design-System/lk-design-system/blob/lds-v0.1.0-rc.69.14/docs/foundations/design-token.md)
- [docs/foundations/color.md](https://github.com/LK-Design-System/lk-design-system/blob/lds-v0.1.0-rc.69.14/docs/foundations/color.md)
- [tokens/source.json](https://github.com/LK-Design-System/lk-design-system/blob/lds-v0.1.0-rc.69.14/tokens/source.json)
...
- [docs/foundations/typography.md](https://github.com/LK-Design-System/lk-design-system/blob/lds-v0.1.0-rc.69.14/docs/foundations/typography.md)
- [docs/foundations/layout.md](https://github.com/LK-Design-System/lk-design-system/blob/lds-v0.1.0-rc.69.14/docs/foundations/layout.md)
- [docs/foundations/spacing.md](https://github.com/LK-Design-System/lk-design-system/blob/lds-v0.1.0-rc.69.14/docs/foundations/spacing.md)
- [docs/foundations/radius.md](https://github.com/LK-Design-System/lk-design-system/blob/lds-v0.1.0-rc.69.14/docs/foundations/radius.md)
- [docs/foundations/elevation.md](https://github.com/LK-Design-System/lk-design-system/blob/lds-v0.1.0-rc.69.14/docs/foundations/elevation.md)
- [docs/foundations/gradient.md](https://github.com/LK-Design-System/lk-design-system/blob/lds-v0.1.0-rc.69.14/docs/foundations/gradient.md)
- [docs/foundations/aspect-ratio.md](https://github.com/LK-Design-System/lk-design-system/blob/lds-v0.1.0-rc.69.14/docs/foundations/aspect-ratio.md)
...
- [docs/foundations/state.md](https://github.com/LK-Design-System/lk-design-system/blob/lds-v0.1.0-rc.69.14/docs/foundations/state.md)
- [docs/foundations/motion.md](https://github.com/LK-Design-System/lk-design-system/blob/lds-v0.1.0-rc.69.14/docs/foundations/motion.md)
...
- [docs/foundations/iconography.md](https://github.com/LK-Design-System/lk-design-system/blob/lds-v0.1.0-rc.69.14/docs/foundations/iconography.md)
- [packages/core/assets/icons/manifest.json](https://github.com/LK-Design-System/lk-design-system/blob/lds-v0.1.0-rc.69.14/packages/core/assets/icons/manifest.json)
...
- [docs/foundations/writing.md](https://github.com/LK-Design-System/lk-design-system/blob/lds-v0.1.0-rc.69.14/docs/foundations/writing.md)
- [docs/foundations/voice-and-tone.md](https://github.com/LK-Design-System/lk-design-system/blob/lds-v0.1.0-rc.69.14/docs/foundations/voice-and-tone.md)
- [docs/foundations/international-design.md](https://github.com/LK-Design-System/lk-design-system/blob/lds-v0.1.0-rc.69.14/docs/foundations/international-design.md)
- [docs/COPY_REVIEW_CONTRACT.md](https://github.com/LK-Design-System/lk-design-system/blob/lds-v0.1.0-rc.69.14/docs/COPY_REVIEW_CONTRACT.md)
...
- [docs/foundations/inclusive-design.md](https://github.com/LK-Design-System/lk-design-system/blob/lds-v0.1.0-rc.69.14/docs/foundations/inclusive-design.md)
- [docs/ACCESSIBILITY_CONTRACTS.md](https://github.com/LK-Design-System/lk-design-system/blob/lds-v0.1.0-rc.69.14/docs/ACCESSIBILITY_CONTRACTS.md)
...
- [docs/components/README.md](https://github.com/LK-Design-System/lk-design-system/blob/lds-v0.1.0-rc.69.14/docs/components/README.md)
- [docs/PACKAGE_MIGRATION_GUIDE.md](https://github.com/LK-Design-System/lk-design-system/blob/lds-v0.1.0-rc.69.14/docs/PACKAGE_MIGRATION_GUIDE.md)
- [docs/COMPONENT_WORKFLOW.md](https://github.com/LK-Design-System/lk-design-system/blob/lds-v0.1.0-rc.69.14/docs/COMPONENT_WORKFLOW.md)
...
소비 저장소에 [config schema](https://github.com/LK-Design-System/lk-design-system/blob/lds-v0.1.0-rc.69.14/packages/conformance/schemas/lds-ui-adoption-config.schema.json)를 따르는 `.lds/adoption.config.json`을 둡니다. 기본 report 경로는 `.lds/adoption-report.json`이며 config의 `reportDirectory`와 CLI `--report`로 명시적으로 바꿀 수 있습니다.
...
GitHub Actions에서는 [composite action](https://github.com/LK-Design-System/lk-design-system/blob/lds-v0.1.0-rc.69.14/.github/actions/lds-adoption/action.yml)을 immutable LDS commit SHA로 pin합니다. diff base를 읽을 수 있게 caller의 `actions/checkout`에 `fetch-depth: 0`을 설정합니다.
