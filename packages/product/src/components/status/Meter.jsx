...
export function Meter({
  ...
  return (
    <div style={{ ...style }} {...rest}>
      {showCaption && (
        <div style={{ display: 'flex', justifyContent: 'space-between', gap: 12, marginBottom: 'var(--space-1-5)', fontFamily: 'var(--font-sans)', fontSize: 'var(--label2-size)', fontWeight: 'var(--fw-semibold)', color: 'var(--color-semantic-label-neutral)' }}>
