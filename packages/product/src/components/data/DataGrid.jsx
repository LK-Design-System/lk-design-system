  ...
  return (
    ...
    >
      ...
      <table
        ...
        style={{ width: '100%', height: resourceState ? '100%' : undefined, borderCollapse: 'collapse', fontFamily: 'var(--font-sans)' }}
      >
        <thead>
          {selecting && (
            <tr style={{ height: 0 }}>
                ...
                return (
                  ...
                  >
                    {column.sortable ? (
                      ...
                      <span style={{ display: 'inline-flex', alignItems: 'center', gap: 'var(--space-1-5)' }}>{column.label}</span>
                    )}
                  </th>
                );
              })}
        ...
        <tbody>
          {resourceState && (
            <tr data-grid-state={resourceState} style={{ height: '100%' }}>
              <td colSpan={colSpan} style={{ height: '100%', padding: 'var(--space-4)', textAlign: 'center', verticalAlign: 'middle', borderBottom: 0 }}>
                ...
                <div className="lk-data-grid__state" style={{ display: 'grid', placeItems: 'center', minHeight: 'var(--space-16)' }}>
