 ...
 * centre row. It supports controlled/uncontrolled values, disabled/read-only
 * states, keyboard navigation, and option-level disabled rows.
 */
export function WheelPicker({
  ...
  const [internal, setInternal] = React.useState(() => {
    ...
    return firstEnabledIndex >= 0 ? opts[firstEnabledIndex]?.value : undefined;
  });
  ...
  const activeOptionId = activeIndex >= 0 ? getOptionId(listId, activeIndex) : undefined;
  ...
  return (
    <div
      data-disabled={inactive ? 'true' : undefined}
          ...
          return (
            <li
              ...
              style={{
                ...
                transition:
                  'opacity var(--dur-fast) var(--ease-out), transform var(--dur-fast) var(--ease-out), color var(--dur-fast) var(--ease-out)',
                userSelect: 'none',
              }}
            >
              <span
