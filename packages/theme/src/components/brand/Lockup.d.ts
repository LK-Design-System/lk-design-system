...
export interface LockupProps extends Omit<React.SVGProps<SVGSVGElement>, 'color'> {
  /** 'mark'(심볼만) · 'stacked' · 'inline'(가로) · 'portal'(승인된 LK Portal 제품 로크업). @default "inline" */
...
/** 규정된 커스텀 LK 심볼과 Montserrat ExtraBold 800 아웃라인 기반 기업·제품 로고. width/viewBox/style override는 호환용이며 브랜드 규격 사용에서는 금지합니다. */
