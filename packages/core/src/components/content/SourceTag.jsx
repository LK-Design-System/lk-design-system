...
export function SourceTag({ children, label = 'SOURCE', href, tone = 'default', style, ...rest }) {
  ...
  return (
    <Comp
      ...
      style={{
        display: 'inline-flex', alignItems: 'center', gap: 8, height: 'var(--component-tag-height)', paddingInline: 'var(--space-3)',
        ...
        fontFamily: 'var(--font-sans)', fontSize: 'var(--caption1-size)', whiteSpace: 'nowrap', textDecoration: 'none',
