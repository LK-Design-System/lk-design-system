  ...
  return (
    ...
    >
      ...
      <div ref={gridRef} role="grid" aria-label={`${view.getFullYear()}년 ${view.getMonth() + 1}월`}>
        <div role="row" style={{ display: 'grid', gridTemplateColumns: 'repeat(7, 1fr)', gap: 'var(--space-0-5)', marginBottom: 'var(--space-1-5)' }}>
        ...
        {weeks.map((week, weekIndex) => (
          <div key={weekIndex} role="row" style={{ display: 'grid', gridTemplateColumns: 'repeat(7, 1fr)', gap: 'var(--space-0-5)' }}>
