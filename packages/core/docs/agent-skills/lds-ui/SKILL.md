...
1. 설치된 패키지의 AI 진입점을 읽는다: `node_modules/@lk-design-system/lds-core/llms.txt`. 로보틱스 UI면 `@lk-design-system/lds-robotics-ui/llms.txt`와 `/design-system.json`도 읽고, [references/robotics.md](./references/robotics.md)를 로드한다.
...
| 로보틱스 도메인 계약 | `lds-robotics-ui/llms.txt`, `/design-system.json`, `/docs/domain/*.md` |
